...
class z_rev_vers_php1{
    ...
    */
    constructor( nom_de_la_variable , module_rev , module_html ){
        ...
        this.#objet_conversion_rev_vers_sql=new z_rev_vers_sql1( '#objet_conversion_rev_vers_sql' , module_rev );
    }
    /*
      =============================================================================================================
    */
                ...
                switch (this.#tb[i][1]){
                    case 'php' :
                        ...
                        if(obj.__xst === __xsu){
                            ...
                            return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2()} ));
                        }
                    ...
                    case 'definir' :
                        ...
                        if(this.#tb[i + 2][2] === 'f' && this.#tb[i + 2][1] === 'appelf'){
                            ...
                            if(obj.__xst === __xsu){
                                ...
                                return(this.#rev_php_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2() + this.#tb[i][1]} ));
                            }
                            ...
                            if(obj1.__xst === __xsu){
                                ...
                                return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + this.#tb[i][1]} ));
                            }
                        }
                        t+=');';
                        break;
                    ...
                    case 'sortir' :
                        if(this.#tb[i][8] === 0){
                            ...
                            t+='exit(' + this.__rev1.ma_constante( this.#tb[i + 1] ) + ')';
                        }else{
                    ...
                    case 'mourir' :
                        if(this.#tb[i][8] === 0){
                            ...
                            t+='die(' + this.__rev1.ma_constante( this.#tb[i + 1] ) + ')';
                        }else{
                            var obj1=this.#php_traiteElement( i + 1 , niveau , {} );
                            if(obj1.__xst === __xsu){
                                t+='die(' + obj1.__xva + ')';
                    ...
                    case 'revenir' :
                        if(this.#tb[i][8] === 0){
                            ...
                            return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' pas d\'argument'} ));
                        }
                        break;
                            ...
                            for( j=positionDeclarationFonction + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                                if(this.#tb[j][1] === 'nom'){
                                    if(this.#tb[j][8] === 1){
                                        ...
                                        return({"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + this.#tb[i][1]});
                                    }
                                    ...
                                    for( k=j + 1 ; k < this.#l02 ; k=this.#tb[k][12] ){
                                        if(this.#tb[k][2] === 'c'){
                                            ...
                                            if(this.#tb[k][1] === 'valeur_defaut'){
                                                ...
                                                comm='/*' + this.__rev1.tr_co_src( this.#tb[k][13] , niveau , k ) + '*/';
                                            }else{
                                                return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + this.#tb[i][1]} ));
                                            }
                                        }
                            ...
                            if(nomFonction != ''){
                                ...
                                if(this.#tb[positionContenu][8] === 0){
                                    ...
                                    if(obj.__xst === __xsu){
                                        ...
                                        return({"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' problème sur le contenu de la fonction "' + nomFonction + '"'});
                                    }
                                }
                            }
                        }else{
                    ...
                    case 'faire_tant_que' :
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if(this.#tb[j][1] === 'condition'){
                                ...
                                return(this.#rev_php_le( {"__xst" : __xer ,"id" : id ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ',syntaxe : condition(),initialisation(),incrément(),faire()'} ));
                            }
                        }
                        var condition='';
                        var faire='';
                            ...
                            if(tabchoix[j][1] === '#'){
                                    ...
                                    if(obj.__xst === __xsu){
                                        if(obj.__xva.length > 120){
                                            ...
                                            if(obj.__xst === __xsu){
                                                ...
                                                return(this.#rev_php_le( {"__xst" : __xer ,"id" : tabchoix[j][0] ,"__xme" : this.__rev1.nl2() + this.#tb[i][1]} ));
                                            }
                                        }else{
                                            condition+=obj.__xva;
                                        }
                                    }else{
                                        return(this.#rev_php_le( {"__xst" : __xer ,"id" : tabchoix[j][0] ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' condition '} ));
                                    }
                                }
                                ...
                                if(this.#tb[tabchoix[j][0]][8] > 0){
                                    ...
                                    if(obj.__xst === __xsu){
                                        ...
                                        return(this.#rev_php_le( {"__xst" : __xer ,"id" : tabchoix[j][0] ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' faire'} ));
                                    }
                                }
                            }
                        }
                            ...
                            if(tabchoix[j][1] === '#'){
                                ...
                                if(this.#tb[tabchoix[j][0]][8] > 0){
                                    ...
                                    if(obj.__xst === __xsu){
                                        ...
                                        return(this.#rev_php_le( {"__xst" : __xer ,"id" : tabchoix[j][0] ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' incrément'} ));
                                    }
                                }
                            }else if(tabchoix[j][1] === 'faire'){
                                if(this.#tb[tabchoix[j][0]][8] > 0){
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if(this.#tb[j][1] === 'faire' && this.#tb[j][2] === 'f'){
                                ...
                                if(this.#tb[j][8] === 2){
                                    ...
                                    return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' 2 arguments sierreur(err(Error $e),faire())'} ));
                                }
                            }
                        }
                        t+='try{';
                            ...
                            if(this.#tb[j][1] === 'condition'){
                                ...
                                if(this.#tb[j][8] === 0){
                                    ...
                                    if(obj.__xst === __xsu){
                                        ...
                                        return(this.#rev_php_le( {"__xst" : __xer ,"id" : j ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' faire '} ));
                                    }
                                }
                            }else if(this.#tb[j][1] === '#'){
                                t+=un_espace_p0;
                                t+='/*' + this.__rev1.tr_co_src( this.#tb[j][13] , niveau , j ) + '*/';
                            }
                        }
                        ne_pas_mettre_de_terminateur=true;
                        break;
                    ...
                    case 'choix' :
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if((this.#tb[j][1] === 'si'
                                ...
                                return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' "' + this.#tb[j][1] + '" inconnu dans un choix '} ));
                            }
                        }
                        for( j=0 ; j < tabchoix.length ; j++ ){
                            if(tabchoix[j][1] === '#'){
                                t+=un_espace_p0;
                                t+='/*' + this.__rev1.tr_co_src( this.#tb[tabchoix[j][0]][13] , niveau , tabchoix[j][0] ) + '*/';
                                ...
                                if(obj.__xst === __xsu){
                                    if(obj.__xva.length > 120){
                                        ...
                                        if(obj.__xst === __xsu){
                                            ...
                                            return(this.#rev_php_le( {"__xst" : __xer ,"id" : tabchoix[j][0] ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' condition du choix '} ));
                                        }
                                    }else{
                                        t+=obj.__xva;
                                    }
                                ...
                                if(tabchoix[j][2] > 0 && tabchoix[j][4] > 0){
                                    ...
                                    if(obj.__xst === __xsu){
                                        ...
                                        return(this.#rev_php_le( {"__xst" : __xer ,"id" : tabchoix[j][0] ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' alors '} ));
                                    }
                                }
                                if(aDesSinonSi){
                                }else{
                    ...
                    case 'html_dans_php' :
                        ...
                        if(this.#tb[i][8] === 0){
                            ...
                            let obj2=this.__rev1.matrice_vers_source_rev1( this.#tb , i , true , i + 1 );
                            if(obj2.__xst === __xsu){
                            ...
                            if(this.#tb[j][1] === 'quand' && this.#tb[j][2] === 'f'){
                                if(this.#tb[j][8] === 1 && this.#tb[j + 1][2] === 'c'){
                                    ...
                                    if(obj.__xst === __xsu){
                                        ...
                                        return(this.#rev_php_le( {"__xst" : __xer ,"id" : ind ,"__xme" : this.__rev1.nl2() + this.#tb[i][1]} ));
                                    }
                                }
                                    ...
                                    if(this.#tb[k][1] === 'valeurNonPrevue' && this.#tb[k][2] === 'f' && this.#tb[k][8] === 0){
                                        ...
                                        if(this.#tb[k + 1][2] === 'f'){
                                            ...
                                            if(obj.__xst === __xsu){
                                                ...
                                                return(this.#rev_php_le( {"__xst" : __xer ,"id" : j ,"__xme" : this.__rev1.nl2() + this.#tb[i][1]} ));
                                            }
                                        }else{
                                        ...
                                        return(this.#rev_php_le( {"__xst" : __xer ,"id" : j ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' il ne doit y avoir que "valeur" et "faire" '} ));
                                    }
                                }
                                ...
                                le_cas=this.__rev1.resps( niveau + 1 );
                                if(valeurCas === null){
                                    le_cas+='default:';
                                }else{
                                ...
                                le_cas+=this.__rev1.resps( niveau + 2 );
                                ...
                                return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' il ne doit y avoir que "quand" et "est" '} ));
                            }
                        }
                        ...
                        for( j=0 ; j < tableau_des_cas.length ; j++ ){
                            if(tableau_des_cas[j].le_cas !== ''){
                                for( var k=0 ; k < tableau_des_cas[j].les_commentaires.length ; k++ ){
                                    t+=this.__rev1.resps( niveau + 2 ) + '/*' + this.__rev1.tr_co_src( tableau_des_cas[j].les_commentaires[k][13] , niveau + 2 , i ) + '*/';
                                }
                                        ...
                                        for( var l=k + 1 ; l < this.#l02 ; l=this.#tb[l][12] ){
                                            ...
                                            if(obj1.__xst === __xsu){
                                                if(this.#tb[k][8] === 3){
                                                    ...
                                                    return(this.#rev_php_le( {"__xst" : __xer ,"id" : k ,"__xme" : this.__rev1.nl2() + this.#tb[i][1]} ));
                                                }
                                            }else{
                                                return(this.#rev_php_le( {"__xst" : __xer ,"id" : k ,"__xme" : this.__rev1.nl2() + this.#tb[i][1]} ));
                                            }
                    ...
                    case 'globale' :
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if(this.#tb[j][2] === 'c'){
                                les_globales+=',' + this.__rev1.ma_constante( this.#tb[j] );
                    ...
                    case '#' :
                        t+='/*' + this.__rev1.tr_co_src( this.#tb[i][13] , niveau , i ) + '*/';
                        ne_pas_mettre_de_terminateur=true;
                        break;
                    ...
                    default:
                        ...
                        if(obj.__xst === __xsu){
                            ...
                            return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' cas non prévu'} ));
                        }
        ...
        switch (this.#tb[ind][1]){
            case 'nouveau' :
                ...
                if(obj.__xst === __xsu){
                    ...
                    return(this.#rev_php_le( {"__xst" : __xer ,"id" : ind ,"__xme" : this.__rev1.nl2() + this.#tb[ind][1]} ));
                }
                break;
            ...
            case 'casttableau' :
                ...
                if(obj1.__xst === __xsu){
                    ...
                    return(this.#rev_php_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2() + this.#tb[ind][1]} ));
                }
                break;
                    ...
                    if(this.#tb[i][2] === 'c'){
                        ...
                        if(this.#tb[i][1] === 'nomc'){
                            ...
                            if(obj1.__xst === __xsu){
                                ...
                                return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + this.#tb[ind][1]} ));
                            }
                            ...
                            return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[ind][1]) + ' "' + this.#tb[i][1] + '"'} ));
                        }
                    }
                }
            ...
            case 'méthode' :
                ...
                for( i=ind + 1 ; i < this.#l02 ; i=this.#tb[i][12] ){
                    if(this.#tb[i][1] === 'definition' && this.#tb[i][2] === 'f'){
                                    ...
                                    if(this.#tb[k][2] === 'c'){
                                        ...
                                        if(this.#tb[k][1] === 'valeur_defaut'){
                                            ...
                                            if(obj1.__xst === __xsu){
                                                ...
                                                return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[ind][1]) + ' arguments passés à la méthode'} ));
                                            }
                        ...
                        les_commentaires_methode+=this.__rev1.resps( niveau );
                        les_commentaires_methode+='/*' + this.__rev1.tr_co_src( this.#tb[i][13] , niveau , i ) + '*/';
                    }else{
                        return(this.#rev_php_le( {"__xst" : __xer ,"id" : ind ,"__xme" : this.__rev1.nl2() + this.#tb[ind][1]} ));
                    }
                }
                ...
                if(this.#tb[ind][8] === 2){
                    ...
                    for( var i=ind + 1 ; i < this.#l02 ; i=this.#tb[i][12] ){
                        ...
                        if(obj1.__xst === __xsu){
                            ...
                            return(this.#rev_php_le( {"__xst" : __xer ,"ind" : ind ,"__xme" : this.__rev1.nl2() + this.#tb[ind][1]} ));
                        }
                    }
                    t+=element + '->' + propriete;
                }else{
            ...
            case 'testEnLigne' :
                ...
                for( j=0 ; j < testEnLigne.length ; j++ ){
                    if(testEnLigne[j][1] === 'condition'){
                        ...
                        if(objCondition.__xst === __xsu){
                            ...
                            return(this.#rev_php_le( {"__xst" : __xer ,"ind" : testEnLigne[j][0] ,"__xme" : this.__rev1.nl2() + this.#tb[ind][1]} ));
                        }
                ...
                if(options.hasOwnProperty( 'retour_de_ligne' ) && options.retour_de_ligne === true){
                    t=(par_gauche + objCondition.__xva) + ' ?' + (si_vrai === '' ? ( '' ) : ( this.__rev1.resps( niveau ) + ' ' + si_vrai + ' ' )) + ': ' + this.__rev1.resps( niveau ) + objSiFaux.__xva + par_droite;
                }else{
            ...
            case 'directive' :
                ...
                if(faire !== ''){
                    t+=this.__rev1.resps( niveau );
                    t+='declare(' + texte + '){' + faire + this.__rev1.resps( niveau ) + '}';
                }else{
                    t+='declare(' + texte + ')';
                }
                break;
            ...
            default:
                ...
                if(obj.__xst === __xsu){
                    ...
                    return(this.#rev_php_le( {"__xst" : __xer ,"id" : ind ,"__xme" : (this.__rev1.nl2() + this.#tb[ind][1]) + ' non traité'} ));
                }
                break;
                
        }
        if(options.hasOwnProperty( 'terminateur' ) && options.terminateur !== ''){
            t=this.__rev1.resps( niveau ) + t + options.terminateur;
        }
        return({"__xst" : __xsu ,"__xva" : t});
    }
    /*
    ...
    */
            ...
            if(this.#tb[j][1] === 'nomt' && this.#tb[j][2] === 'f'){
                ...
                if(this.#tb[j][8] === 1 && this.#tb[j + 1][2] === 'c'){
                    ...
                    if(obj1.__xst === __xsu){
                        ...
                        return(this.#rev_php_le( {"__xst" : __xer ,"id" : j ,"__xme" : this.__rev1.nl2()} ));
                    }
                }
                break;
            }
                ...
                if(this.#tb[j][2] === 'f'){
                    if(this.#tb[j][1] === 'nomt' || this.#tb[j][1] === 'p' || this.#tb[j][1] === '#' || this.#tb[j][1] === 'prop'){
                        ...
                        this.#rev_php_le( {
                                "__xst" : __xer ,
                                "id" : i ,
                                "__xme" : this.__rev1.nl2() + ' les seuls paramètres de tableau sont nomt,p,prop et pas "' + this.#tb[j][1] + '"'
                            } );
                    }
                }
            }
        ...
        for( var i=id + 1 ; i < this.#l02 && this.#tb[i][3] > this.#tb[id][3] ; i=this.#tb[i][12] ){
            if(this.#tb[i][9] === 1){
                ...
                if(obj.__xst === __xsu){
                    ...
                    return(this.#rev_php_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2()} ));
                }
    ...
    #php_traiteNew( ind , niveau ){
        ...
        if(obj.__xst === __xsu){
            ...
            return(this.#rev_php_le( {"__xst" : __xer ,"id" : ind ,"__xme" : this.__rev1.nl2()} ));
        }
        return({"__xst" : __xsu ,"__xva" : t});
    }
    /* ✍===================================================================================================================== */
    ...
    */
    #php_traiteOperation( id , niveau , ajouter_des_sauts_de_lignes ){
        ...
        if(!this.#tableau_precedences_php.hasOwnProperty( this.#tb[id][1] )){
            return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : 'Le mot clé est inconnu "' + this.#tb[id][1] + '" ' + this.__rev1.nl2() + ' '} ));
        }
        ...
        if(operandes.length === 0){
            ...
            if(ajouter_des_sauts_de_lignes !== undefined && ajouter_des_sauts_de_lignes === true){
                sauts=true;
                un_espace_p0=this.__rev1.resps( niveau - 1 );
            }
        ...
        for( var i=ind + 1 ; i < this.#l02 ; i=this.#tb[i][12] ){
            if(this.#tb[i][7] === ind && this.#tb[i][2] === 'f'){
                if(this.#tb[i][1] === "nom_classe" && this.#tb[i][8] === 1 && this.#tb[i + 1][2] === 'c'){
                    nom_de_classe=this.__rev1.ma_constante( this.#tb[i + 1] );
                }else if(this.#tb[i][1] === "contenu" && this.#tb[i][2] === 'f'){
                    if(this.#tb[i][8] > 0){
    ...
    */
    #php_traite_arguments_definition_fonction( i , niveau ){
        ...
        if(contient_des_commentaires === true){
            esps=this.__rev1.resps( niveau + 1 );
        }
                ...
                if(this.#tb[indice + 1][2] === 'c'){
                    ...
                    if(this.#tb[indice + 1][1] === 'appelf'){
                        ...
                        if(obindice.__xst === __xsu){
                            ...
                            return(this.#rev_php_le( {"__xst" : __xer ,"id" : indice ,"__xme" : this.__rev1.nl2()} ));
                        }
                        ...
                        if(obje.__xst === __xsu){
                            ...
                            return(this.#rev_php_le( {"__xst" : __xer ,"id" : indice ,"__xme" : this.__rev1.nl2() + ' inconnue ' + this.#tb[indice + 1][1]} ));
                        }
                    }
                }else{
                    return(this.#rev_php_le( {"__xst" : __xer ,"id" : indice ,"__xme" : this.__rev1.nl2() + ' element'} ));
                }
            }else if(this.#tb[j][1] === 'p' && this.#tb[j][3] === this.#tb[i][3] + 1){
                if(this.#tb[j][8] === 1 && this.#tb[j + 1][2] === 'c'){
                    ...
                    for( var k=j + 1 ; k < this.#l02 ; k=this.#tb[k][12] ){
                        if(this.#tb[k][2] === 'f' && this.#tb[k][1] === '#'){
                            ...
                            if(obj1.__xst === __xsu){
                                ...
                                return(this.#rev_php_le( {"__xst" : __xer ,"id" : j ,"__xme" : this.__rev1.nl2() + ' p() '} ));
                            }
                        }
                    }
                }
        ...
        if(contient_des_commentaires === true){
            argumentsFonction+=this.__rev1.resps( niveau );
        }
        return({
                "__xst" : __xsu ,
    ...
    */
    #php_traiteAppelCloturee( i , dansConditionOuDansFonction , niveau ){
        ...
        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
            if(this.#tb[j][1] === 'argument' || this.#tb[j][1] === 'adresseArgument'){
                    ...
                    if(this.#tb[k][2] === 'c'){
                        ...
                        if(this.#tb[k][1] === 'valeur_defaut'){
                            ...
                            if(obj1.__xst === __xsu){
                                ...
                                return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + this.#tb[j][1]} ));
                            }
                        }else if(this.#tb[k][1] === 'type_argument' && this.#tb[k][8] === 1 && this.#tb[k + 1][2] === 'c'){
                            type_argument=this.#tb[k + 1][1].replace( /\\\\/g , '\\' ) + ' ';
                            ...
                            if('valeur_constante' === this.#tb[k + 1][1]
                                ...
                                return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + ' arguments "' + this.#tb[k][1] + '"'} ));
                            }
                        }else if(this.#tb[k][1] === '#'){
                        }else{
                            debugger;
                ...
                if(obj.__xst === __xsu){
                    ...
                    return({"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + ' de la fonction "' + nomFonction + '"'});
                }
                        ...
                        if(this.#tb[k][2] === 'c'){
                            ...
                            if(this.#tb[k][1] === 'valeur_defaut'){
                                ...
                                if(obj1.__xst === __xsu){
                                    ...
                                    return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + ' utilise '} ));
                                }
                            }else if(this.#tb[k][1] === 'type_argument' && this.#tb[k][8] === 1 && this.#tb[k + 1][2] === 'c'){
                                type_argument=this.#tb[k + 1][1].replace( /\\\\/g , '\\' ) + ' ';
                            }else if(this.#tb[k][1] === '#'){
        ...
        t=statique + 'function(' + argumentsFonction + ')' + type_retour + les_utilisations + '{' + contenu + this.__rev1.resps( niveau + 1 ) + '}';
        return({"__xst" : __xsu ,"__xva" : t});
    }
    /*
      =============================================================================================================
    */
    #php_traiteAffectOp( i , dansConditionOuDansFonction , niveau ){
        ...
        for( var j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
            ...
            if(this.#tb[j][2] === 'f' && this.#tb[j][1] === '#'){
                if(!dansConditionOuDansFonction){
                    commentaire+=this.__rev1.resps( niveau );
                }
                commentaire+='/' + '*' + this.__rev1.tr_co_src( this.#tb[j][13] , niveau , j ) + '*' + '/';
                continue;
            ...
            if(avantEgal === ''){
                ...
                if(apresEgal !== ''){
                    return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + ' vérifiez les paramètres de affecteop   '} ));
                }else{
                    apresEgal=elt;
                }
            }
        ...
        if(this.#tb[i][8] === 4 && commentaire === ''){
            return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + ' ne doit contenir que 2 ou 3 arguments et le 3ème doit être un commentaire'} ));
        }
        return({"__xst" : __xsu ,"__xva" : t});
    }
    /*
    ...
    #php_traiteAffecte( i , niveau , opt ){
        ...
        for( var j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
            ...
            if(avantEgal === ''){
                ...
                if(apresEgal !== ''){
                    return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + ' paramètres de affecte ( 2 + commentaires uniquement )  '} ));
                }else{
                    apresEgal=elt;
                }
            }
        ...
        if(this.#tb[i][8] === 3 && commentaire === ''){
            return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + ' 2 ou 3 arguments et le 3ème doit être un commentaire non vide '} ));
        }
        return({"__xst" : __xsu ,"__xva" : t});
    }
    /*
    ...
    #php_traiteAppelFonction( i , niveau ){
                ...
                if(this.#tb[j][8] === 1){
                    if(this.#tb[j + 1][2] === 'c'){
                        ...
                        if(objf.__xst === __xsu){
                            ...
                            return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + ' nom fonction'} ));
                        }
                        ...
                        return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + ' nom fonction  "' + this.#tb[j + 1][1] + '" '} ));
                    }
                }
            }
        }
        if(positionAppelFonction > 0 && nomFonction != ''){
            ...
            if(obj.__xst === __xsu){
                ...
                return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + ' arguments'} ));
            }
            ...
            if(nomFonction === 'use'){
                ...
                if(tableau_des_arguments.length >= 1 && __gi1.est_num( tableau_des_arguments[0] )){
                    let saut=this.__rev1.resps( niveau + 1 );
                    t+='/*sql_inclure_deb*/';
                    t+=saut;
                    t+='/* sql_' + tableau_des_arguments[0] + '()';
                    t+=saut;
                    if(__gi1 && __gi1.hasOwnProperty( '__liste_des_sql' ) && __gi1.__liste_des_sql.hasOwnProperty( tableau_des_arguments[0] )){
                        t+=__gi1.__liste_des_sql[tableau_des_arguments[0]]['cht_sql_requete'].replace( /\/\*/g , '/ ***' ).replace( /\*\//g , '*** /' ).replace( /\r/g , '' ).replace( /\n/g , saut );
                    }else{
                        debugger;
            ...
            return(this.#rev_php_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + ' il faut un nom de fonction à appeler n(xxxx)'} ));
        }
        return({"__xst" : __xsu ,"__xva" : t});
    }
    /*
    ...
    #php_traiteDefinitionTableau( id , niveau , options={} ){
        ...
        for( j=id + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
            ...
            if(this.#tb[j][1] === '#' && this.#tb[j][2] === 'f'){
                if(nombre_elements_dans_tableau > seuil_elements_dans_tableau){
                    if(a_un_tbel === false){
                        sortie+=this.__rev1.resps( niveau + 1 );
                    }
                }
                sortie+='/*' + this.__rev1.tr_co_src( this.#tb[j][13] , niveau + 1 , j ) + '*/';
                ...
                if(this.#tb[j][8] >= 2){
                    ...
                    if(valeur === '' && cle !== ''){
                        ...
                        return(this.#rev_php_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2() + ' clé valeur'} ));
                    }
    ...
    */
    c_tab_vers_php( tbl_en_entree , les_options ){
        ...
        if(obj.__xst === __xsu){
            ...
            return(this.#rev_php_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2()} ));
        }
    }
    /*
      =============================================================================================================
...
export{z_rev_vers_php1 as z_rev_vers_php1};