...
/*
  ...
  =====================================================================================================================
*/
class z_ast_phpnikic_vers_rev1{
    #nom_de_la_variable='';
    #options_traitement={};
    ...
    */
    constructor( nom_de_la_variable , module_rev , module_html ){
        ...
        this.objet_conversion_ast_sql_parseur_cst_vers_rev1=new z_ast_sql_parseur_cst_vers_rev1( 'objet_conversion_ast_sql_parseur_cst_vers_rev1' , module_rev );
    }
    /*
      =============================================================================================================
    */
    ...
    */
    /*
      ...
      default:
      return(this.#astphp_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + '"' + s + '" ' ,"element" : element} ));
    ...
    */
    #php_traite_Stmt_ClassMethod( element , niveau , options_traitement ){
        ...
        if(element.flags === 33){
            ...
            return(this.#astphp_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + element.flags ,"element" : element} ));
        }
        if(type_retour !== ''){
    ...
    */
    #php_traite_Expr_AssignOp_General( element , niveau , nodeType ){
        ...
        if("Expr_AssignOp_Concat" === nodeType){
            ...
            return(this.#astphp_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + ' "' + nodeType + '"' ,"element" : element} ));
        }
        var t='';
        var gauche='';
        if(element.var){
            ...
            if(element.declares[i].nodeType === 'DeclareItem'){
                if(element.declares[i].key.nodeType === 'Identifier'){
                    if(element.declares[i].value.nodeType === 'Scalar_Int'){
                        ...
                        return({"__xst" : __xer ,"__xme" : this.__rev1.nl2() ,"element" : element});
                    }
                }else{
                    return({"__xst" : __xer ,"__xme" : this.__rev1.nl2() ,"element" : element});
                }
                ...
                if(rv.substr( i , 1 ) === '\\'){
                    ...
                    if(i === l01){
                        ...
                        if(rv.length > 2 && l01 > 1 && i > 1 && rv.substr( i - 1 , 1 ) === '\\'){
                            ...
                            return(this.#astphp_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + 'entislash en dernière position  ' ,"element" : element} ));
                        }
                    }else{
                        if(i > 1){
                            /*
                    ...
                    if(i >= 2 && rv.substr( i - 1 , 1 ) === '\\'){
                        ...
                        return(this.#astphp_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + '<br />il doit y avoir un backslash avant un apostrophe ' ,"element" : element} ));
                    }
                }else if(rv.substr( i , 1 ) === '"' && rv.substr( 0 , 1 ) === '"'){
                    if(i >= 2 && rv.substr( i - 1 , 1 ) === '\\'){
                        nouvelle_chaine='\\"' + nouvelle_chaine;
                        ...
                        return(this.#astphp_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + '<br />il doit y avoir un backslash avant un guillemet ' ,"element" : element} ));
                    }
                }else{
                    nouvelle_chaine=rv.substr( i , 1 ) + nouvelle_chaine;
                }
            ...
            switch (element.nodeType){
                ...
                case "NullableType" :
                    if(element.type.nodeType === 'Name'){
                        ...
                        return(this.#astphp_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + element.nodeType ,"element" : element} ));
                    }
                    break;
                ...
                default:
                    return(this.#astphp_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + 'non traité : ' + element.nodeType ,"element" : element} ));
                    break;
    ...
    */
    #php_traite_Expr_BinaryOp_General( element , niveau , parent , options_traitement ){
        ...
        if(element.nodeType === 'Expr_BinaryOp_BooleanOr'){
            ...
            return(this.#astphp_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + 'non prévu ' + element.nodeType ,"element" : element} ));
        }
        if(t.substr( 0 , 14 ) === 'concat(concat('
            ...
            if(o.__xst === __xsu){
                ...
                var obj=this.__rev1.matrice_vers_source_rev1( nouveauTableau , 0 , true , 1 );
                if(obj.__xst === __xsu){
                    t=obj.__xva;
                }
            }
        ...
        if(obj.__xst === __xsu){
            ...
            */
            if(obj.__xva.substr( 0 , 1 ) === '(' && obj.__xva.substr( obj.__xva.length - 1 , 1 ) === ')'){
                var matrice=this.__rev1.rev_tcm( obj.__xva );
                if(matrice.__xst === __xsu && matrice.__xva.length >= 2){
                    if(matrice.__xva[1][1] === ''){
                        ...
                        if(tout_est_superieur === true){
                            var nouveauTableau=this.__rev1.baisser_le_niveau_et_supprimer( matrice.__xva , 1 , 0 );
    ...
    #php_traite_Stmt_Class( element , niveau , options_traitement ){
        ...
        if(element.extends){
            if(element.extends.nodeType === 'Name'){
                ...
                debugger;
                return(this.#astphp_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + ' "' + element.extends.nodeType + '"' ,"element" : element} ));
            }
        }
            ...
            for( i=0 ; i < stmts.length ; i++ ){
                ...
                if(stmts[i].nodeType.substr( 0 , 14 ) === "Expr_AssignOp_"){
                    ...
                    if(obj.__xst === __xsu){
                        ...
                        return(this.#astphp_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() ,"element" : stmts[i]} ));
                    }
                    ...
                    if(obj.__xst === __xsu){
                        ...
                        return(this.#astphp_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + stmts[i].nodeType ,"element" : stmts[i]} ));
                    }
                }else{
                    switch (stmts[i].nodeType){
                        ...
                        case "Stmt_InlineHTML" :
                            ...
                            if(obj.__xst === __xsu){
                                ...
                                if(obj.hasOwnProperty( 'cumul_message' ) && obj.cumul_message === __xer){
                                    cumul_message=__xer;
                                    let lig_col=[stmts[i].attributes.startLine,0];
                        ...
                        default:
                            return(this.#astphp_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + 'non prévu "' + stmts[i].nodeType + '"' ,"element" : stmts[i]} ));
        ...
        */
        if(ast_de_php.length > 0){
            ...
            if(obj.__xst === __xsu){
                ...
                if(obj.hasOwnProperty( 'cumul_message' ) && obj.cumul_message === __xer){
                    cumul_message=__xer;
                    return({"__xst" : __xer ,"__xme" : this.__rev1.nl2() ,"element" : ast_de_php ,"cumul_message" : cumul_message});
                }else{
                    return(this.#astphp_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() ,"element" : ast_de_php} ));
                }
            }
        }
        if(t.substr( 0 , 2 ) === '\r\n'){
    ...
    */
    recupere_ast_de_php_du_serveur( source_php , opt , fonction_traitement_apres_recuperation_ast_de_php2_ok , fonction_traitement_apres_recuperation_ast_de_php2_ko ){
        ...
        r.onerror=function( e ){
            debugger;
            console.error( 'e=' , e );
            return({"__xst" : __xer ,"__xme" : this.__rev1.nl2()});
        };
        ...
        r.ontimeout=function( e ){
            /* console.error( 'e=' , e ); */
            var message_erreur={"__xst" : __xer ,"__xme" : this.__rev1.nl2() + 'le temps admis pour l\'exécution est écoulé'};
            __gi1.ajoute_message( message_erreur );
                ...
                if(r.readyState === 4 && r.status === 200){
                    ...
                    if(r.status === 404){
                        if(0 === numero_de_message++){
                            __gi1.ajoute_message( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + '<br />404 page "' + page + '" non trouvée'} );
                            __gi1.remplir_et_afficher_les_messages1( '' );
                        }
                        return;
                    }else if(r.status >= 500){
                        if(0 === numero_de_message++){
                            __gi1.ajoute_message( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + '<br />erreur du serveur, peut-être une limite de temps de traitement atteinte'} );
                            __gi1.remplir_et_afficher_les_messages1( '' );
                        }
                        /*
                ...
                try{
                            ...
                            if(json_retour.signaux.hasOwnProperty( tableau_des_signaux[j] )){
                                for(let i in json_retour.signaux[tableau_des_signaux[j]]){
                                    if(tableau_des_signaux[j] === __xer){
                                        ...
                                        /*  */
                                        if(le_message.indexOf( ' on line ' ) > 0 && __gi1.est_num( le_message.substr( le_message.indexOf( ' on line ' ) + 9 ) )){
                                            ...
                                            __gi1.ajoute_message( {"__xst" : tableau_des_signaux[j] ,"__xme" : json_retour.signaux[tableau_des_signaux[j]][i] ,"ligne" : la_ligne ,"masquee" : false} );
                                        }else{
                                            /* en cas d'erreur dans le source php coté serveur */
                                            __gi1.ajoute_message( {"__xst" : tableau_des_signaux[j] ,"__xme" : json_retour.signaux[tableau_des_signaux[j]][i] ,"masquee" : false} );
                                        }
                                    }else{
                                        __gi1.ajoute_message( {"__xst" : tableau_des_signaux[j] ,"__xme" : json_retour.signaux[tableau_des_signaux[j]][i] ,"masquee" : false} );
                                    }
                    ...
                    if(json_retour.__xst === __xsu){
                        if(fonction_traitement_apres_recuperation_ast_de_php2_ok !== undefined){
                            ...
                            __gi1.ajoute_message( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + 'Il manque une fonction de traitement de retour OK'} );
...
export{z_ast_phpnikic_vers_rev1 as z_ast_phpnikic_vers_rev1};