...
/*
  ...
  rev_tm : texte au format rev vers matrice sans constante dans la racine
  ajoute_message
  entitees_html
  nl2
  espacesnrev
  ...
  tb_vers_matrice
  supprimer_un_element_de_la_matrice
  baisser_le_niveau_et_supprimer
...
class __rev1{
    ...
    */
    ajoute_message( obj ){
        try{
            return(__gi1.ajoute_message( obj ));
        }catch{
            return obj;
        }
    }
    ...
    */
    ...
    /*
      =============================================================================================================
      Des fonctions raccourcies __m__rev1.rev_tcm ( texte au format rev vers matrice avec constante dans la racine ) 
      =============================================================================================================
    */
    rev_tcm( texte_rev ){
        var tableau1=this.txt_en_tableau( texte_rev );
    ...
    ma_constante_inverse( eltTab ){
        ...
        switch (eltTab[4]){
            case 1 :
                ...
                t=eltTab[1].replace( /\\\'/g , '\'' ).replace( /\\\\/g , '\\' );
                break;
    ...
    */
    ...
    /*
      =============================================================================================================
      fonction entitees_html (__m__rev1.entitees_html)  transforme un texte pour qu'il  soit visible en html, par exemple &nbsp; ou bien <
      =============================================================================================================
    */
    entitees_html( s ){
    ...
    /*
      =============================================================================================================
      numéro de ligne courant du js (__m__rev1.nl2)( n l 1 )
      =============================================================================================================
    */
    nl2( e_originale ){
        var e=null;
    ...
    /*
      ...
      =============================================================================================================
    */
    tr_commentaire__rev1( texte , niveau , ind ){
        var s='';
    ...
    /*
      =============================================================================================================
      fonction tr_co_src : (__m__rev1.tr_co_src) transforme un commentaire pour un fichier js/php/sql ... traiteCommentaire2
    */
    ...
    */
    ...
    /*#
      =====================================================================================================================
      fonction matrice_vers_source_rev1 (__m__rev1.matrice_vers_source_rev1)
    ...
    */
                ...
                */
                if(tab[i][2] === 'c'){
                    ...
                    */
                    ...
                    commentaire=this.tr_commentaire__rev1( tab[i][13] , tab[i][3] , i );
    ...
    /*
      ...
      - la profondeur[10]
      __m__rev1.indicer_le_tableau reIndicerLeTableau
      =============================================================================================================
    */
    ...
    */
    ...
    /*
      =============================================================================================================
      Des fonctions raccourcies __m__rev1.rev_parenthe1 ( recherche de parenthèses )
      =============================================================================================================
    */
    ...
    /*
      =============================================================================================================
      fonction txt_en_tableau (__m__rev1.txt_en_tableau) : transforme un texte en tableau, 
      =============================================================================================================
    */
    txt_en_tableau( str ){
        let l01=0;
    ...
    /*
      =============================================================================================================
      function formatter_une_erreur_rev __m__rev1 formatter uns erreur dans le rev pour la rendre plus facilement détectable
      =============================================================================================================
    */
    ...
    /*#
      ...
      __m__rev1.tb_vers_matrice (ancien functionToArray2)
      =====================================================================================================================
      =====================================================================================================================
      =====================================================================================================================
    */
            ...
            if(dans_commentaire === true){
                ...
                if(c === '"'){
                    if(autoriserCstDansRacine !== true){
                        if(i === l01 - 1){
                            ...
                            */
                            if(niveau > 0){
                                return(this.ajoute_message( this.formatter_une_erreur_rev( {
                                        "__xst" : __xer ,
                                        "ind" : i ,
                    ...
                    */
                    ...
                    if(i === l01 - 1){
                        return(this.ajoute_message( {"__xst" : __xer ,"__xva" : T ,"id" : i ,"__xme" : this.nl2() + 'un antislash ne doit pas terminer une constante en i=' + i} ));
                    }
                    /*  */
                    c1=tableauEntree[i + 1][0];
                    if(c1 === '\\'
                ...
                */
                if(c === '/'){
                    if(autoriserCstDansRacine !== true){
                        if(i === l01 - 1){
                            return(this.ajoute_message( {"__xst" : __xer ,"id" : i ,"__xva" : T ,"__xme" : this.nl2() + 'la racine ne peut pas contenir des constantes'} ));
                        }
                    }
                    if(i + 1 < l01){
                        c1=tableauEntree[i + 1][0];
                    ...
                    */
                    ...
                    if(i === l01 - 1){
                        return(this.ajoute_message( {"__xst" : __xer ,"__xva" : T ,"id" : i ,"__xme" : this.nl2() + 'un antislash ne doit pas terminer une fonction'} ));
                    }
                    /*  */
                    c1=tableauEntree[i + 1][0];
                    if(texte === ''){
                ...
                */
                switch (c){
                    ...
                    case '\\' :
                        ...
                        */
                        if(!dansCstSimple){
                            return(this.ajoute_message( {"__xst" : __xer ,"__xva" : T ,"id" : i ,"__xme" : this.nl2() + 'un antislash doit être dans une constante en i=' + i} ));
                        }
                        if(!dansCstDouble){
                            return(this.ajoute_message( {"__xst" : __xer ,"__xva" : T ,"id" : i ,"__xme" : this.nl2() + 'un antislash doit être dans une constante en i=' + i} ));
                        }
                    ...
                    case ',' :
                        ...
                        */
                        if(texte !== ''){
                            if(autoriserCstDansRacine !== true){
                                if(niveau === 0){
                                    return(this.ajoute_message( {"__xst" : __xer ,"__xva" : T ,"id" : i ,"__xme" : this.nl2() + 'la racine ne peut pas contenir des constantes'} ));
                                }
                            }
                            indice++;
                            chaine_tableau+=',[' + indice + ',"' + texte + '","c",' + niveau + ',' + constanteQuotee + ',' + premier + ',' + dernier + ',0,0,0,0,' + pos_ouv_par + ',0,""]';
