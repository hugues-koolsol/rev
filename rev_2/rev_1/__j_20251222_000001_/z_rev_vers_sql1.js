...
class z_rev_vers_sql1{
    ...
    */
    #recuperer_operateur_sqlite( op ){
        ...
        if(op === ''){
            ...
            return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + ' inconnu opérateur "' + op + '" <br />n_est_pas , pas_comme, ?'} ));
        }
    ...
    traite_sqlite_fonction_de_champ( tab , id , niveau , options ){
        ...
        if(tab[id][1] === 'champ' && tab[id][2] === 'f'){
            if(tab[id][8] === 1 && tab[id + 1][2] === 'c'){
                t+=__gi1.__rev1.ma_constante( tab[id + 1] );
                t_js+=__gi1.__rev1.ma_constante( tab[id + 1] ).replace(/`/g,'\\`');
                /*
                ...
                */
                ...
                t+=__gi1.__rev1.ma_constante( tab[id + 1] ) + '.' + __gi1.__rev1.ma_constante( tab[id + 2] );
                t_js+=__gi1.__rev1.ma_constante( tab[id + 1] ).replace(/`/g,'\\`') + '.' + __gi1.__rev1.ma_constante( tab[id + 2] ).replace(/`/g,'\\`');
                            ...
                            for(var j in options.tableau_des_tables_utilisees[i].champs){
                                try{
                                    if(options.tableau_des_tables_utilisees[i].champs[j].hasOwnProperty( 'nom_du_champ' )
                                        ...
                                        options.nom_du_champ_pour_where=__gi1.__rev1.ma_constante( tab[id + 1] ) + '.' + __gi1.__rev1.ma_constante( tab[id + 2] );
                                        break;
                                    }
                                }catch(e){
                                    debugger;
                ...
                return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2()} ));
            }
        }
        ...
        if(operateur_rev === 'sql'){
            ...
            */
            debugger;
            return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + 'problème sur sql dans sql '} ));
        }
        var operateur='';
        ...
        if(obj_op.__xst === __xsu){
            ...
            return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + 'problème sur l\'opérateur'} ));
        }
        ...
        for( var i=id + 1 ; i < l01 ; i=tab[i][12] ){
            ...
            if(tab[i][2] === 'c'){
                ...
                if(obj.__xst === __xsu){
                    ...
                    return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + '"' + tab[i][1] + '"'} ));
                }
            }
        }
    ...
    */
    #rev_sql1( id , niveau , options ){
        ...
        var un_espace=__gi1.__rev1.resps( niveau );
        var meta='';
        let nom_de_la_table='';
        ...
        for( i=id + 1 ; i < this.#l02 ; i=this.#tb[i][12] ){
            ...
            if(this.#tb[i][2] === 'c'){
                return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + 'constante non traitée'} ));
            }else{
                switch (this.#tb[i][1]){
                    case 'sql' : 
                        ...
                        */
                                                    ...
                                                    if(this.#tb[n][1] === 'nom_de_la_table'){
                                                        ...
                                                        for( o=n + 1 ; o < this.#l02 ; o=this.#tb[o][12] ){
                                                            if(this.#tb[o][2] === 'c'){
                                                                ...
                                                                return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + 'nom_de_la_table doit avoir que 1 ou 2 ou 3 paramètre(s) "' + this.#tb[n][1] + '"'} ));
                                                            }
                                                        }
                                                        if(nom_de_la_table === ''){
                                                            return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + 'nom_de_la_table non trouvé'} ));
                                                        }
                                                        if(options.au_format_php === true){
                                                        ...
                                                        if(this.#tb[l][1] === 'jointure_gauche'){
                                                            if(options.au_format_php === true){
                                                                if(options.sur_base_principale === 1){
                                                                    liste_des_tables_php+=CRLF + '       LEFT JOIN ' + nom_de_la_table + '' + (nom_de_l_alias !== '' ? ( ' ' + nom_de_l_alias ) : ( '' )) + '';
                                                            ...
                                                            if(options.au_format_php === true){
                                                                if(options.sur_base_principale === 1){
                                                                    liste_des_tables_php+='      FROM ' + nom_de_la_table + '' + (nom_de_l_alias !== '' ? ( ' ' + nom_de_l_alias ) : ( '' )) + '';
                                                            ...
                                                            if(options.au_format_php === true){
                                                                if(options.sur_base_principale === 1){
                                                                    liste_des_tables_php+='      , ' + CRLF + '           ' + nom_de_la_table + '' + (nom_de_l_alias !== '' ? ( ' ' + nom_de_l_alias ) : ( '' )) + '';
                                                            ...
                                                            return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + 'type jointure non prévue "' + this.#tb[l][1] + '"'} ));
                                                        }
                                                        if(nom_de_l_alias !== ''){
                                                        ...
                                                        return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + ' inconnu  "' + this.#tb[n][1] + '"'} ));
                                                    }
                                                }
                                            }
                                        }
                                        for( m=l + 1 ; m < this.#l02 ; m=this.#tb[m][12] ){
                                            if(this.#tb[m][1] === 'contrainte'){
                                                ...
                                                if(obj.__xst === __xsu){
                                                    ...
                                                    return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + 'erreur contrainte "' + this.#tb[l][1] + '"'} ));
                                                }
                                            }
                                        }
                                    }
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if(this.#tb[j][1] === 'valeurs' && this.#tb[j][8] >= 1){
                                ...
                                for( l=j + 1 ; l < this.#l02 ; l=this.#tb[l][12] ){
                                    if(la_valeur !== ''){
                                        ...
                                        if(numero_de_champ% 5 === 0){
                                            la_valeur+=__gi1.__rev1.resps( niveau );
                                        }
                                    }
                                    if(this.#tb[l][2] === 'f' && this.#tb[l][1] === '#'){
                                        ...
                                        if(this.#tb[l][8] === 1 && this.#tb[l + 1][2] === 'c'){
                                            ...
                                            */
                                            nom_du_champ=__gi1.__rev1.ma_constante( this.#tb[l + 1] );
                                            if(options.au_format_php === true){
                                            ...
                                            */
                                            ...
                                            if(tableau_des_alias.length > 0 && dans_tableau_des_alias >= 0){
                                                nom_du_champ='`' + tableau_des_alias[dans_tableau_des_alias].original + '`.' + __gi1.__rev1.ma_constante( this.#tb[l + 2] );
                                                if(options.au_format_php === true){
                                                ...
                                                return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + 'select champ "' + this.#tb[l + 1][1] + '"'} ));
                                            }
                                            ...
                                            nom_du_champ=__gi1.__rev1.ma_constante( this.#tb[l + 1] ) + ' as ' + __gi1.__rev1.ma_constante( this.#tb[l + 3] );
                                            if(options.au_format_php === true){
                                                tableau_des_champs_pour_select_php.push( {"type" : 'champ' ,"nom_du_champ" : this.#tb[l + 2][1] ,"alias_champ" : __gi1.__rev1.ma_constante( this.#tb[l + 3] )} );
                                            }
                                            ...
                                            if(tableau_des_alias.length > 0 && dans_tableau_des_alias >= 0){
                                                nom_du_champ='`' + tableau_des_alias[dans_tableau_des_alias].original + '`.' + __gi1.__rev1.ma_constante( this.#tb[l + 2] ) + ' as ' + __gi1.__rev1.ma_constante( this.#tb[l + 4] );
                                                if(options.au_format_php === true){
                                                    tableau_des_champs_pour_select_php.push( {
                                                            "type" : 'champ' ,
                                                            "alias" : tableau_des_alias[dans_tableau_des_alias].original ,
                                                            "nom_du_champ" : this.#tb[l + 2][1] ,
                                                            "alias_champ" : __gi1.__rev1.ma_constante( this.#tb[l + 4] )
                                                        } );
                                                }
                                            }else{
                                                return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + 'select champ "' + this.#tb[l + 1][1] + '"'} ));
                                        ...
                                        if(this.#tb[l][2] === 'f'){
                                            ...
                                            if(obj.__xst === __xsu){
                                                ...
                                                return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + 'fonction dans select "' + this.#tb[l][1] + '"'} ));
                                            }
                                        }else{
                                            if(this.#tb[l][1].toLowerCase() === 'null'){
                                                ...
                                                */
                                                ...
                                                if(this.#tb[l][4] === 1){
                                                    ...
                                                    nom_du_champ=__gi1.__rev1.ma_constante( this.#tb[l] );
                                                }
                                                if(options.au_format_php === true){
                                                    tableau_des_champs_pour_select_php.push( {"type" : 'constante' ,"valeur" : nom_du_champ} );
                                                }
                                ...
                                if(la_valeur !== ''){
                                    liste_des_valeurs+=__gi1.__rev1.resps( niveau );
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if(this.#tb[j][1] === 'conditions' && this.#tb[j][8] >= 1){
                                ...
                                if(obj.__xst === __xsu){
                                    ...
                                    return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + 'conditions dans select '} ));
                                }
                            }
                        }
                        ...
                        if(liste_des_valeurs !== ''){
                            ...
                            if(options.au_format_php === true){
                                options.liste_des_tables_pour_select_php=liste_des_tables_php;
                                options.liste_des_tables_pour_select_js=liste_des_tables_js;
                            }
                        }else{
                            return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + 'select, pas de valeurs sélectionnées'} ));
                        }
                        break;
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            ...
                            if(this.#tb[j][1] === 'sql' && this.#tb[j][8] >= 1){
                                ...
                                if(obj.__xst === __xsu){
                                    ...
                                    return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + 'insert update delete'} ));
                                }
                                            ...
                                            if(this.#tb[m][2] === 'f' && this.#tb[m][1] === 'champ'){
                                                ...
                                                if(this.#tb[m][2] === 'f'){
                                                    ...
                                                    if(obj.__xst === __xsu){
                                                        ...
                                                        return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + 'fonction dans update conditions "' + this.#tb[l][1] + '"'} ));
                                                    }
                                                }else{
                            ...
                            if(this.#tb[i][1] === 'supprimer'){
                                ...
                                if(sous_requete_insert === true){
                                    if(options.au_format_php === true){
                                        ...
                                        t+='INTO ';
                                        if(nom_de_la_base !== '' && options.sur_base_principale === 0){
                                    ...
                                    if(options.au_format_php === true){
                                        ...
                                        if(nom_de_la_base !== '' && options.sur_base_principale === 0){
                                            t+='`\'.$GLOBALS[__BDD][BDD_NUMERO_' + nom_de_la_base + '][PREFIXE_BDD].\'`.';
                                            t_js+='`+(par.base && par.base[\'b' + nom_de_la_base + '\']?par.base[\'b' + nom_de_la_base + '\']+\'.\':\'\')+`'; // $GLOBALS[__BDD][BDD_NUMERO_' + nom_de_la_base + '][PREFIXE_BDD]
                                        }
                                        t+='`' + nom_de_la_table + '`(';
                                        ...
                                        if(nom_de_la_base !== '' && options.sur_base_principale === 0){
                                            options.debut_sql_pour_insert+='`\'.$GLOBALS[__BDD][BDD_NUMERO_' + nom_de_la_base + '][PREFIXE_BDD].\'`.';
                                            options.debut_sql_pour_insert_js+='`+(par.base && par.base[\'b' + nom_de_la_base + '\']?par.base[\'b' + nom_de_la_base + '\']+\'.\':\'\')+`'; // $GLOBALS[__BDD][BDD_NUMERO_' + nom_de_la_base + '][PREFIXE_BDD]
                                        }
                    ...
                    case 'add_index' :
                        return(this.#rev_sql_le( {"__xst" : __xer ,"__xva" : t ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + ' supprimer add_index et remplacer par ajouter_index'} ));
                        break;
                    ...
                    case 'ajouter_index' :
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            ...
                            if(this.#tb[j][1] === 'fields' && this.#tb[j][8] >= 1){
                                return(this.#rev_sql_le( {"__xst" : __xer ,"__xva" : t ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + 'mettre champs à la place de fields '} ));
                            }
                            ...
                            if(this.#tb[j][1] === 'meta' && this.#tb[j][2] === 'f' && this.#tb[j][8] > 0){
                                obj=__gi1.__rev1.matrice_vers_source_rev1( this.#tb , j , false , j + 1 );
                                if(obj.__xst === __xsu){
                                    meta=__gi1.__rev1.resps( niveau + 2 );
                                    meta+='/* meta(' + obj.__xva + ') */';
                                    meta+=__gi1.__rev1.resps( niveau + 2 );
                                }else{
                                    return(this.#rev_sql_le( {"__xst" : __xer ,"__xva" : t ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + 'index meta'} ));
                                }
                            }
                        }
                        if(nam !== '' && list !== '' && def !== ''){
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            ...
                            if(this.#tb[j][1] === 'new_def'){
                                ...
                                if(obj.__xst === __xsu){
                                    ...
                                    return(this.#rev_sql_le( {"__xst" : __xer ,"__xva" : t ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + 'change_field'} ));
                                }
                            }
                        }
                        if(nam !== '' && oldnam !== ''){
                    ...
                    case 'use' :
                        if(this.#tb[i][8] === 1 && this.#tb[i + 1][2] === 'c'){
                            ...
                            return(this.#rev_sql_le( {"__xst" : __xer ,"__xva" : t ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + 'use'} ));
                        }
                        break;
                    ...
                    case 'set' :
                        if(this.#tb[i][8] === 2 && this.#tb[i + 1][2] === 'c' && this.#tb[i + 2][2] === 'c'){
                            ...
                            return(this.#rev_sql_le( {"__xst" : __xer ,"__xva" : t ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + 'set'} ));
                        }
                        break;
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if(this.#tb[j][1] === 'auto_increment' && this.#tb[j][2] === 'f'){
                                ...
                                */
                                ...
                                definition_sql_du_champ+=__gi1.__rev1.resps( niveau );
                                ...
                                return(this.#rev_sql_le( {"__xst" : __xer ,"__xva" : t ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + 'remplacer not_null et notnull '} ));
                                ...
                                if(this.#tb[j + 1][1] === '1'){
                                    ...
                                    variables_pour_tableau_tables.defaut.valeur=__gi1.__rev1.ma_constante( this.#tb[j + 1] );
                                ...
                                definition_sql_du_champ+=' REFERENCES ' + __gi1.__rev1.ma_constante( this.#tb[j + 1] ) + '(' + __gi1.__rev1.ma_constante( this.#tb[j + 2] ) + ') ';
                                variables_pour_tableau_tables.reference.est_defini=true;
                                variables_pour_tableau_tables.reference.table=__gi1.__rev1.ma_constante( this.#tb[j + 1] );
                                variables_pour_tableau_tables.reference.champ=__gi1.__rev1.ma_constante( this.#tb[j + 2] );
                                ...
                                if(this.#tb[j][8] === 1){
                                    if(this.#tb[j + 1][2] === 'c'){
                                        ...
                                        if(this.#tb[j + 2][2] === 'c'){
                                            ...
                                            return(this.#rev_sql_le( {"__xst" : __xer ,"__xva" : t ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + 'field type'} ));
                                        }
                                    }
                                    ...
                                    return(this.#rev_sql_le( {"__xst" : __xer ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + 'field type'} ));
                                }
                            }else if(this.#tb[j][1] === 'meta' && this.#tb[j][8] > 0){
                                obj=__gi1.__rev1.matrice_vers_source_rev1( this.#tb , j , true , j + 1 );
                                if(obj.__xst === __xsu){
                                    meta_du_champ+=__gi1.__rev1.resps( niveau + 2 );
                                    ...
                                    return(this.#rev_sql_le( {"__xst" : __xer ,"__xva" : t ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + 'field meta'} ));
                                }
                            }else{
                                return(this.#rev_sql_le( {"__xst" : __xer ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + 'field ' + this.#tb[j][1]} ));
                            }
                        }
                        /*
                    ...
                    case 'create_table' :
                        return(this.#rev_sql_le( {"__xst" : __xer ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + ' plus de create_table svp'} ));
                        break;
                            ...
                            if(this.#tb[j][1] === 'ifexists' && this.#tb[j][8] === 0){
                                ...
                                if(obj.__xst === __xsu){
                                    ...
                                    */
                                    ...
                                    return(this.#rev_sql_le( {"__xst" : __xer ,"__xva" : t ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + 'create table field'} ));
                                }
                                ...
                                if(obj.__xst === __xsu){
                                    ...
                                    return(this.#rev_sql_le( {"__xst" : __xer ,"__xva" : t ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + 'create_table meta'} ));
                                }
                            }else{
                                return(this.#rev_sql_le( {"__xst" : __xer ,"__xva" : t ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + 'create table ' + this.#tb[j][1]} ));
                            }
                        }
                    ...
                    case 'drop_table' :
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if(this.#tb[j][1] === 'ifexists' && this.#tb[j][8] === 0){
                                ...
                                return(this.#rev_sql_le( {"__xst" : __xer ,"__xva" : t ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + 'drop table ' + this.#tb[j][1]} ));
                            }
                        }
                        t+=';';
                        break;
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if(this.#tb[j][3] === this.#tb[i][3] + 1){
                                if(this.#tb[j][1] === 'ifnotexists' && this.#tb[j][8] === 0){
                                    ...
                                    return(this.#rev_sql_le( {"__xst" : __xer ,"__xva" : t ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + 'create_database ' + this.#tb[j][1]} ));
                                }
                            }
                        }
                        t+=';';
                    ...
                    case '#' :
                        if(this.#tb[i][13] === ''){
                            ...
                            t+=__gi1.__rev1.resps( niveau );
                            t+='/*';
                            t+=__gi1.__rev1.tr_co_src( this.#tb[i][13] , niveau , i );
                            t+='*/';
                        }
                        break;
                    ...
                    case 'meta' :
                        /*
                          ...
                          return(this.#rev_sql_le( {"__xst" : __xer ,"__xva" : t ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + 'transaction'} ));
                          }
                          break;
                        */
                        obj=__gi1.__rev1.matrice_vers_source_rev1( this.#tb , i , false , i + 1 );
                        if(obj.__xst === __xsu){
                            t+=__gi1.__rev1.resps( niveau );
                            ...
                            return(this.#rev_sql_le( {"__xst" : __xer ,"__xva" : t ,"id" : i ,"__xme" : __gi1.__rev1.nl2() + 'meta'} ));
                        }
                        break;
                                ...
                                */
                                ...
                                for( k=j + 1 ; k < this.#l02 ; k=this.#tb[k][12] ){
                                    if(this.#tb[k][1] === 'drop_column' && this.#tb[k][2] === 'f' && this.#tb[k][8] === 1){
                                        ...
                                        return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : (__gi1.__rev1.nl2() + this.#tb[k][1]) + '"'} ));
                                    }
                                }
                            }else{
                                return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + 'fonction non traitée "' + this.#tb[j][1] + '"'} ));
                            }
                        }
                        if(drop_column !== ''){
                            t+='ALTER TABLE ' + nom_de_la_table + ' DROP COLUMN ' + drop_column;
                        }else{
                            return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + 'fonction non traitée "' + this.#tb[i][1] + '"'} ));
                        }
                        break;
            ...
            */
            ...
            for( i=0 ; i < l02 ; i++ ){
                ...
                if(dans_comm === true){
                    if(ci === '*'){
                        if(i === l02 - 1){
                            return({"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + ' erreur commentaire'});
                        }else{
                            if(txt.substr( i + 1 , 1 ) === '/'){
                                dans_comm=false;
                                i++;
            ...
            for( i=0 ; i < tab_meta.length ; i++ ){
                if(tab_meta[i].txt_meta.indexOf( 'meta' ) >= 0){
                    obj=__gi1.__rev1.rev_tm( tab_meta[i].txt_meta );
                    if(obj.__xst === __xsu){
                        ...
                        if(elt_meta === 'transform_table_sur_svg'){
                            for( j=1 ; j < tab.length ; j++ ){
                                if(tab[j][1] === 'transform_table_sur_svg'){
                                    var obj=__gi1.__rev1.matrice_vers_source_rev1( tab , j + 1 , false , j + 2 );
                                    if(obj.__xst === __xsu){
    ...
    */
    c_tab_vers_sql( tab , les_options ){
        ...
        if(les_options.hasOwnProperty( 'sur_base_principale' )){
            sur_base_principale=les_options.sur_base_principale;
        }
        var options={
            "au_format_php" : au_format_php ,
            "sur_base_principale" : sur_base_principale ,
        ...
        if(obj.__xst === __xsu){
            ...
            return(this.#rev_sql_le( {"__xst" : __xer ,"__xme" : __gi1.__rev1.nl2() + 'erreur de conversion en sql'} ));
        }
    }
}
export{z_rev_vers_sql1 as z_rev_vers_sql1};