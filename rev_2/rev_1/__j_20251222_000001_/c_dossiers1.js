class c_dossiers1{
    ...
    */
    tableau_des_filtres={
        "liste1" : {
            ...
            "T0_che_contient_genere_dossier" : {"type_filtre" : 'INTEGER' ,"défaut" : '' ,"masqué" : false ,"nom" : 'contient genere'} ,
            "T0_chx_parent_dossier" : {"type_filtre" : 'INTEGER' ,"défaut" : '' ,"masqué" : false ,"nom" : 'parent'} ,
            "T1_chp_nom_dossier" : {"type_filtre" : 'VARCHAR' ,"défaut" : '' ,"masqué" : false ,"nom" : 'nom dossier'} ,
            "T0_che_pour_les_js_dossier" : {"type_filtre" : 'INTEGER' ,"défaut" : '' ,"masqué" : false ,"nom" : 'pour les js'}
        } ,
        "sous_liste1" : {
            "$__num_page" : {"type_filtre" : 'entier' ,"défaut" : 0 ,"masqué" : true ,"nom" : '$__num_page'} ,
            "T0_chi_id_dossier" : {"type_filtre" : 'INTEGER' ,"défaut" : '' ,"masqué" : false ,"nom" : 'id'} ,
            ...
            "T0_che_contient_genere_dossier" : {"type_filtre" : 'INTEGER' ,"défaut" : '' ,"masqué" : false ,"nom" : 'contient genere'} ,
            "T0_chx_parent_dossier" : {"type_filtre" : 'INTEGER' ,"défaut" : '' ,"masqué" : false ,"nom" : 'parent'} ,
            "T1_chp_nom_dossier" : {"type_filtre" : 'VARCHAR' ,"défaut" : '' ,"masqué" : false ,"nom" : 'nom'} ,
            "T0_che_pour_les_js_dossier" : {"type_filtre" : 'INTEGER' ,"défaut" : '' ,"masqué" : false ,"nom" : 'pour les js'}
        }
    };
            ...
            if($__xva.$liste_des_fido[i].type_element === 'd'){
                ...
                */
                if($__xva.$liste_des_fido[i].present_en_base === __xsu){
                    ...
                    o1+=' $che_contient_genere_dossier(0)';
                    o1+=cmd;
                    o1+='))))';
                    o1+='">intégrer</div>';
                    o1+='<div';
                    ...
                    o1+=' $chx_parent_dossier(' + $__xva.$chi_id_dossier + ')';
                    o1+=' $provenance(' + $provenance + ')';
                    o1+=' $che_contient_genere_dossier(1)';
                    o1+=cmd;
                    o1+='))))';
    ...
    */
    verifier_modifier1( mat , d , données ){
        ...
        var __test=__gi1.__fnt1.test_du_nom_de_fichier1( fo1['chp_nom_dossier'] , 'nom' );
        ...
        if(fo1['che_contient_genere_dossier'] === ''){
            __gi1.ajoute_message( {"__xst" : __xer ,"__xme" : 'la valeur "contient genere" doit être renseigné'} );
            __gi1.affiche_les_messages();
            __gi1.retablir_les_boutons_masques();
            try{
                document.getElementById( 'che_contient_genere_dossier' ).focus();
            } catch {}
            return({"__xst" : __xsu});
        }
        if(fo1['che_pour_les_js_dossier'] === ''){
            __gi1.ajoute_message( {"__xst" : __xer ,"__xme" : 'la valeur "pour les js" doit être renseigné'} );
            __gi1.affiche_les_messages();
            __gi1.retablir_les_boutons_masques();
            try{
                document.getElementById( 'che_pour_les_js_dossier' ).focus();
            } catch {}
            return({"__xst" : __xsu});
        }
        ...
        fo1['che_contient_genere_dossier']=fo1['che_contient_genere_dossier'] === '' ?
          ( 
            null
          ) : ( 
            parseInt( fo1['che_contient_genere_dossier'] , 10 )
          );
        fo1['che_pour_les_js_dossier']=fo1['che_pour_les_js_dossier'] === '' ? ( null ) : ( parseInt( fo1['che_pour_les_js_dossier'] , 10 ) );
        /*
          tout a été vérifié
        */
        let __fo1={};
    ...
    */
    page_modification1( mat , d , le_message_du_serveur=null ){
        ...
        */
        ...
        o1+='      <input  type="text" id="chp_nom_dossier"  size="64"   maxlength="64"  value="' + __gi1.fi2( le_message_du_serveur.__xva.page_modification1.__xva[0]['T0.chp_nom_dossier'] ) + '"  autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" />';
        o1+='    </div>';
        o1+='  </div>';
        /*
          =====================================================================================================
        */
        ...
        o1+='</span>';
        o1+=__gi1.lien_parent( 'c_dossiers1' , 'chx_parent_dossier' , 'chx_parent_dossier_libelle' );
        o1+='    </div>';
        o1+='  </div>';
        /*
          =====================================================================================================
        */
        o1+='  <div class="yy_edition_champ1">';
        o1+='    <div class="yy_edition_libelle1">';
        o1+='      <span>contient genere</span>';
        o1+='    </div>';
        o1+='    <div class="yy_edition_valeur1">';
        o1+='        <input type="range" id="che_contient_genere_dossier" class="yy_ouinon" min="0" max="1" step="1" value="' + __gi1.fi2( le_message_du_serveur.__xva.page_modification1.__xva[0]['T0.che_contient_genere_dossier'] ) + '" >';
        o1+='    </div>';
        o1+='  </div>';
        /*
          =====================================================================================================
        */
        o1+='  <div class="yy_edition_champ1">';
        o1+='    <div class="yy_edition_libelle1">';
        o1+='      <span>pour les js</span>';
        o1+='    </div>';
        o1+='    <div class="yy_edition_valeur1">';
        o1+='        <input type="range" id="che_pour_les_js_dossier" class="yy_ouinon" min="0" max="1" step="1" value="' + __gi1.fi2( le_message_du_serveur.__xva.page_modification1.__xva[0]['T0.che_pour_les_js_dossier'] ) + '" >';
        o1+='    </div>';
        o1+='  </div>';
        /*
          =====================================================================================================
    ...
    */
    page_confirmation_supprimer1( mat , d , le_message_du_serveur=null ){
        ...
        */
        ...
        o1+='    </div>';
        o1+='    <div class="yy_edition_valeur1">';
        o1+='      <input disabled  type="text" id="chp_nom_dossier"  size="64"   maxlength="64"  value="' + __gi1.fi2( le_message_du_serveur.__xva.page_confirmation_supprimer1.__xva[0]['T0.chp_nom_dossier'] ) + '"  autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" />';
        o1+='    </div>';
        o1+='  </div>';
        /*
          =====================================================================================================
        */
        ...
        o1+='    <div class="yy_edition_valeur1">';
        o1+='        <input type="hidden" value="';
        o1+=le_message_du_serveur.__xva.page_confirmation_supprimer1.__xva[0]['T0.chx_parent_dossier'];
        o1+='"  id="chx_parent_dossier" />';
        o1+='        <span>';
        o1+='(' + le_message_du_serveur.__xva.page_confirmation_supprimer1.__xva[0]['T0.chx_parent_dossier'] + ') ';
        ...
        */
        ...
        o1+='    </div>';
        o1+='    <div class="yy_edition_valeur1">';
        o1+='        <input disabled type="range" id="che_contient_genere_dossier" class="yy_ouinon" min="0" max="1" step="1" value="' + __gi1.fi2( le_message_du_serveur.__xva.page_confirmation_supprimer1.__xva[0]['T0.che_contient_genere_dossier'] ) + '" >';
        o1+='    </div>';
        o1+='  </div>';
        /*
          =====================================================================================================
        */
        ...
        o1+='    </div>';
        o1+='    <div class="yy_edition_valeur1">';
        o1+='        <div class="rev_bouton" data-rev_click="m1(n1(c_sources1),f1(liste_du_menu0(';
        o1+='T0_chx_dossier_id_source(' + le_message_du_serveur.__xva.page_confirmation_supprimer1.__xva[0]['T0.chi_id_dossier'] + ')';
        o1+='T0_chi_id_source(\'\')';
        ...
        */
        ...
        o1+='    </div>';
        o1+='    <div class="yy_edition_valeur1">';
        o1+='        <input disabled type="range" id="che_pour_les_js_dossier" class="yy_ouinon" min="0" max="1" step="1" value="' + __gi1.fi2( le_message_du_serveur.__xva.page_confirmation_supprimer1.__xva[0]['T0.che_pour_les_js_dossier'] ) + '" >';
        o1+='    </div>';
        o1+='  </div>';
        /*
          =====================================================================================================
        */
        o1+='      <input type="hidden" id="chi_id_dossier" value="' + le_message_du_serveur.__xva.page_confirmation_supprimer1.__xva[0]['T0.chi_id_dossier'] + '" />';
        let cmd='';
        cmd+='liste1(';
        for(let i in this.tableau_des_filtres[this.fonction_liste]){
            if(this.$filtres[this.fonction_liste][i] !== ''){
    ...
    page_creer1( mat , d , dupliquer=null ){
        ...
        */
        ...
        if(dupliquer && dupliquer.hasOwnProperty( 'T0.chp_nom_dossier' )){
            o1+=__gi1.fi2( dupliquer['T0.chp_nom_dossier'] );
        }else{
            o1+='';
        }
        o1+='" />';
        ...
        */
        ...
        if(dupliquer && dupliquer.hasOwnProperty( 'T0.chx_parent_dossier' )){
            o1+=__gi1.fi2( dupliquer['T0.chx_parent_dossier'] );
        }else{
            o1+='1';
        }
        o1+='"';
        ...
        */
        ...
        o1+='    </div>';
        o1+='    <div class="yy_edition_valeur1">';
        o1+='        <input type="range" id="che_contient_genere_dossier" class="yy_ouinon" min="0" max="1" step="1" value="';
        if(dupliquer && dupliquer.hasOwnProperty( 'T0.che_contient_genere_dossier' )){
            o1+=__gi1.fi2( dupliquer['T0.che_contient_genere_dossier'] );
        }else{
            o1+='0';
        }
        o1+='" >';
    ...
    zones_sous_liste1( le_message_du_serveur ){
        ...
        if(le_message_du_serveur !== null && le_message_du_serveur.__xva.hasOwnProperty( this.fonction_liste )){
            ...
            for(let i in le_message_du_serveur.__xva[this.fonction_liste].__xva){
                ...
                */
                ...
                if(elem['T0.chp_nom_dossier'] !== null){
                    lst+=elem['T0.chp_nom_dossier'].substr( 0 , 100 ).replace( />/g , '&gt;' ).replace( /</g , '&lt;' );
                }
                lst+='</td>';
                /*
                */
                lst+='<td style="text-align:center;">';
                if(elem['T0.che_contient_genere_dossier'] !== null){
                    lst+=elem['T0.che_contient_genere_dossier'];
                }
                lst+='</td>';
                /*
                */
                ...
                */
                lst+='<td style="text-align:center;">';
                if(elem['T0.che_pour_les_js_dossier'] !== null){
                    lst+=elem['T0.che_pour_les_js_dossier'];
                }
                lst+='</td>';
                lst+='</tr>';
            }
            if(lst !== ''){
                ...
                o1+='<th>id</th>';
                o1+='<th>nom</th>';
                o1+='<th>contient genere</th>';
                o1+='<th>parent</th>';
                o1+='<th>nom dossier</th>';
                o1+='<th>pour les js</th>';
                o1+='</tr>';
                o1+=lst;
                o1+='</table>';
                o1+='</div>';
        ...
        if(le_message_du_serveur !== null && le_message_du_serveur.__xva.hasOwnProperty( this.fonction_liste )){
            ...
            for(let i in le_message_du_serveur.__xva[this.fonction_liste].__xva){
                ...
                if(elem['T0.chi_id_dossier'] > 1){
                    lst+='<div class="rev_b_svg yy__2" data-rev_click="pm1(m1(n1(' + this.moi + '),f1(page_confirmation_supprimer1(chi_id_dossier(' + elem['T0.chi_id_dossier'] + ')))))">' + __gi1.les_svg.poubelle + '</div>';
                    lst+='<div class="rev_b_svg yy__3" data-rev_click="pm1(m1(n1(' + this.moi + '),f1(page_modification1(chi_id_dossier(' + elem['T0.chi_id_dossier'] + ')))))">' + __gi1.les_svg.editer + '</div>';
                    lst+='<div class="rev_b_svg yy__4" data-rev_click="pm1(m1(n1(' + this.moi + '),f1(page_duplication1(chi_id_dossier(' + elem['T0.chi_id_dossier'] + ')))))">' + __gi1.les_svg.dupliquer + '</div>';
                    ...
                    lst+='<div class="rev_b_svg yy__4 yy__4_inactif">' + __gi1.les_svg.dupliquer + '</div>';
                    lst+='<div class="rev_bouton yy__1 yy__1_inactif">créer</div>';
                }
                lst+='<div class="rev_bouton" data-rev_click="m1(n1(c_sources1),f1(liste_du_menu0(T0_chx_dossier_id_source(' + elem['T0.chi_id_dossier'] + '),*(\'\'))))" title="liste des sources">sources</div>';
                lst+='</div>';
                lst+='</td>';
                /*
                */
                ...
                */
                lst+='<td style="text-align:center;">';
                if(elem['T0.chp_nom_dossier'] !== null){
                    lst+=__gi1.fi2( elem['T0.chp_nom_dossier'] );
                }
                lst+='</td>';
                /*
                */
                ...
                */
                lst+='<td style="text-align:center;">';
                if(elem['T0.che_pour_les_js_dossier'] !== null){
                    lst+='<input type="range" disabled id="che_est_souche_requete" class="yy_ouinon" min="0" max="1" step="1" value="' + elem['T0.che_pour_les_js_dossier'] + '">';
                }
                lst+='</td>';
                lst+='</tr>';
            }
...
export{c_dossiers1 as c_dossiers1};