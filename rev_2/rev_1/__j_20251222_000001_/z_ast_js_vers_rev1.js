...
class z_ast_js_vers_rev1{
        ...
        if(element.computed === false){
            ...
            if(type_parent === 'CallExpression'){
                ...
                if(type_propriete === 'Identifier' && type_objet === 'Identifier'){
                    ...
                    if(objet.endsWith( ']' ) && __gi1.est_num( propriete )){
                        t=objet + '[' + propriete + ']';
                    }else{
                        if((type_objet === 'Identifier' || type_objet === null) && __gi1.est_num( propriete )){
                            t=objet + '[' + propriete + ']';
                        }else{
                            t='tableau(nomt(' + objet + '),p(' + propriete + '))';
                        }
    ...
    */
    #traite_UnaryExpression( element , niveau , parent , tab_comm ){
        ...
        obj=this.#traite_element( element.argument , niveau + 1 , element , tab_comm , false );
        if(obj.__xst === __xsu){
            if((nomDuTestUnary === 'moins' || nomDuTestUnary === 'plus') && __gi1.est_num( obj.__xva )){
...
export{z_ast_js_vers_rev1 as z_ast_js_vers_rev1};