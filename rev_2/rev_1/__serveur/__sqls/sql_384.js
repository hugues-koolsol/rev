    ...
    */
    async sql(par,donnees_retournees){
        ...
        if(par['n_chx_dossier_menus_projet']==='' || par['n_chx_dossier_menus_projet'] === null ){
            tableau_champs.push('`chx_dossier_menus_projet` = NULL');
        }else{
            tableau_champs.push('`chx_dossier_menus_projet` = '+this.__gi1.__fnt1.sq0(par['n_chx_dossier_menus_projet'])+'');
        }
        ...
        if(par['n_chx_dossier_bdds_projet']==='' || par['n_chx_dossier_bdds_projet'] === null ){
        ...
        if(par['n_chx_dossier_js_projet']==='' || par['n_chx_dossier_js_projet'] === null ){
            tableau_champs.push('`chx_dossier_js_projet` = NULL');
        }else{
            tableau_champs.push('`chx_dossier_js_projet` = '+this.__gi1.__fnt1.sq0(par['n_chx_dossier_js_projet'])+'');
        }
