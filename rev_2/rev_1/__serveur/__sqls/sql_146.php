<?php
function sql_146($par,&$donnees_retournees,$that){
    $champs0='
    ...
    try{
        ...
        while(($tab0=$res0->fetchArray(SQLITE3_NUM))){
            $donnees0[]=array(
                ...
                'T0.cht_condition_menu' => $tab0[6],
                'T0.cht_condition_php_menu' => $tab0[7],
                'T1.chx_acces_autorisation' => $tab0[8],
                'T1.chx_source_autorisation' => $tab0[9],
                'T2.chp_nom_acces' => $tab0[10],
                'T3.chp_nom_source' => $tab0[11],
                'T3.che_binaire_source' => $tab0[12],
            );
        }
        return array(
           __xst  => __xsu  ,
