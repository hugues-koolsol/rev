...
function sql_154($par,&$donnees_retournees,$that){
    ...
    if($par['n_cht_parametres_acces']==='' || is_null($par['n_cht_parametres_acces']) ){
        $tableau_champs[]='`cht_parametres_acces` = NULL';
    }else{
        $tableau_champs[]='`cht_parametres_acces` = \''.sq0($par['n_cht_parametres_acces']).'\'';
    }
