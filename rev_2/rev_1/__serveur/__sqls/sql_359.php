<?php
function sql_359($par,&$donnees_retournees,$that){
    if($GLOBALS[DEVER_SRV]>=2){
        $donnees_retournees[__xsi][__xif][]='info <b>sql_359</b>';
    }
    $champs0='
    ...
    try{
        ...
        return array(
                __xst => __xer , 
                'sql0' => $sql0 ,
                'texte_requete' => 'la liste sur les revs' ,
                'exception' => $e ,
                'id_bdd' => BDD_NUMERO_1 
            );
    }
