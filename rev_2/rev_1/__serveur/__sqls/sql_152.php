<?php
function sql_152($par,&$donnees_retournees,$that){
    $champs0='
    ...
    ';
    $sql0.=$from0;
    $where0=' WHERE (`T1`.`chp_nom_source` LIKE '.sq3($par['T1_chp_nom_source']).' AND `T0`.`chx_acces_autorisation` > 1)'.PHP_EOL;
    $sql0.=$where0;
    $order0='
