...
function sql_331($par,&$donnees_retournees,$that){
    ...
    if($par['n_che_est_positif_genre']==='' || is_null($par['n_che_est_positif_genre']) ){
        $tableau_champs[]='`che_est_positif_genre` = NULL';
    }else{
        $tableau_champs[]='`che_est_positif_genre` = '.sq0($par['n_che_est_positif_genre']).'';
    }
    if($par['n_cht_particularités_genre']==='' || is_null($par['n_cht_particularités_genre']) ){
        $tableau_champs[]='`cht_particularités_genre` = NULL';
    }else{
        $tableau_champs[]='`cht_particularités_genre` = \''.sq0($par['n_cht_particularités_genre']).'\'';
    }
