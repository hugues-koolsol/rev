...
function sql_121($par,&$donnees_retournees,$that){
    ...
    ';
    $sql0.=$from0;
    $where0=' WHERE `T0`.`chi_id_utilisateur` = '.sq1($par['T0_chi_id_utilisateur']).''.PHP_EOL;
    $sql0.=$where0;
    $donnees0=array();
    ...
    try{
        ...
        while(($tab0=$res0->fetchArray(SQLITE3_NUM))){
            $donnees0[]=array(
                ...
                'T0.che__nur_utilisateur' => $tab0[5],
                'T0.chd__dtm_utilisateur' => $tab0[6],
                'T0.chd__dtc_utilisateur' => $tab0[7],
                'T0.chx_acces_utilisateur' => $tab0[8],
                'T1.chp_nom_acces' => $tab0[9],
