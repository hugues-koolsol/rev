<?php
function sql_384($par,&$donnees_retournees,$that){
    ...
    if($par['n_chx_dossier_bdds_projet']==='' || is_null($par['n_chx_dossier_bdds_projet']) ){
        $tableau_champs[]='`chx_dossier_bdds_projet` = NULL';
    }else{
        $tableau_champs[]='`chx_dossier_bdds_projet` = '.sq0($par['n_chx_dossier_bdds_projet']).'';
    }
    if($par['n_chx_dossier_js_projet']==='' || is_null($par['n_chx_dossier_js_projet']) ){
        $tableau_champs[]='`chx_dossier_js_projet` = NULL';
    }else{
        $tableau_champs[]='`chx_dossier_js_projet` = '.sq0($par['n_chx_dossier_js_projet']).'';
    }
