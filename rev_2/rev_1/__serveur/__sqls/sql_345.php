<?php
function sql_345($par,&$donnees_retournees,$that){
    $sql0='
    ...
    for($i=0;($i < count($par));$i++){
        ...
        $liste_des_valeurs.='(';
        $liste_des_valeurs.=PHP_EOL.'      '.sq1($par[$i]['chi_id_genre']).''.',';
        $liste_des_valeurs.=PHP_EOL.'      '.sq1($par[$i]['chp_nom_genre']).''.',';
        $liste_des_valeurs.=PHP_EOL.'      '.sq1($par[$i]['che_ordre_genre']).''.',';
        ...
        $liste_des_valeurs.=PHP_EOL.'      '.sq1($par[$i]['che_est_positif_genre']).''.',';
        $liste_des_valeurs.=PHP_EOL.'      '.sq1($par[$i]['cht_particularités_genre']).'';
        $liste_des_valeurs.=')';
    }
