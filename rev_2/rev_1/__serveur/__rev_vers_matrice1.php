    ...
    public function tb_vers_matrice($tableauEntree,$quitter_si_erreur_niveau,$autoriserCstDansRacine){
        ...
        */
        ...
        /*
          ...
          T.push(Array(0,$texte,"i",-1,$constante_quotee,$premier,$dernier,0,0,0,0,$pos_ouv_par,$pos_fer_par,''));
        */
        $chaine_tableau .= '[0,"' . $texte . '","i",-1,' . $constante_quotee . ',' . $premier . ',' . $dernier . ',0,0,0,0,' . $pos_ouv_par . ',0,""]';
        $type_precedent="i";
