...
if(isset($_SESSION[_CA_]['chi_id_projet']) && $_SESSION[_CA_]['chi_id_projet'] > 0){
   $les_menu1.='<li><div id="menu_2" data-id_menu="23" class="rev_bouton" data-rev_click="m1(n1(c_taches1),f1(liste_du_menu0(T0_chp_priorite_tache2(99))))" title="Liste des tâches">tâches</div></li>'.PHP_EOL;
}
$les_menu1.='<li><div id="menu_1" data-id_menu="24" class="rev_bouton" data-rev_click="m1(n1(c_projets1),f1(liste_du_menu0()))" title="liste des projets">projets</div></li>'.PHP_EOL;
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_projet']) && $_SESSION[_CA_]['chi_id_projet'] > 0){
...
if(isset($_SESSION[_CA_]['chi_id_projet']) && $_SESSION[_CA_]['chi_id_projet'] > 0 && isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_20"  class="rev_bouton" data-rev_click="m1(n1(ecran_generer_souches),f1(page_generer_les_souches1()))">souches</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_21"  class="rev_bouton" data-rev_click="m1(n1(ecran_source_vers_programme),f1(point_d_entree()))">source</div></li>'.PHP_EOL;
}
/* niveau 2 */
if($le_sous_menu1_2!==''){
...
if(isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_23"  class="rev_bouton" data-rev_click="m1(n1(ecran_rev_vers_matrice1),f1(ecran_matrice()))">matrice</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_24"  class="rev_bouton" data-rev_click="m1(n1(ecran_rev_vers_html1),f1(ecran_rev_html()))">html</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_25"  class="rev_bouton" data-rev_click="m1(n1(ecran_rev_vers_js1),f1(ecran_rev_js()))">js</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_26"  class="rev_bouton" data-rev_click="m1(n1(ecran_rev_vers_php1),f1(ecran_rev_php()))">php</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_27"  class="rev_bouton" data-rev_click="m1(n1(ecran_rev_vers_sql1),f1(ecran_rev_sql()))">sql</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_28"  class="rev_bouton" data-rev_click="m1(n1(ecran_rev_vers_css1),f1(ecran_rev_css()))">css</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_29"  class="rev_bouton" data-rev_click="m1(n1(ecran_rev_vers_txt1),f1(ecran_rev_txt()))">txt</div></li>'.PHP_EOL;
}
/* niveau 2 */
if($le_sous_menu1_2!==''){
    $le_sous_menu1_1.='<li><div data-libelle_noeud_menu1="2">convertions</div>';
    $le_sous_menu1_1.='<ul id="menu_22" data-id_menu="22">
';
    $le_sous_menu1_1.=$le_sous_menu1_2.PHP_EOL;
    $le_sous_menu1_1.='</ul>'.PHP_EOL;
    $le_sous_menu1_1.='</li>'.PHP_EOL;
