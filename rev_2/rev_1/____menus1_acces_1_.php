...
if(isset($_SESSION[_CA_]['chi_id_projet']) && $_SESSION[_CA_]['chi_id_projet'] > 0){
    $le_sous_menu1_1.='
    <li><div id="menu_12"  class="rev_bouton" data-rev_click="m1(n1(c_groupes1),f1(liste_du_menu0()))">groupes</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_projet']) && $_SESSION[_CA_]['chi_id_projet'] > 0){
    $le_sous_menu1_1.='
    <li><div id="menu_13"  class="rev_bouton" data-rev_click="m1(n1(c_metiers1),f1(liste_du_menu0()))">métiers</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_projet']) && $_SESSION[_CA_]['chi_id_projet'] > 0){
    $le_sous_menu1_1.='
    <li><div id="menu_14"  class="rev_bouton" data-rev_click="m1(n1(c_acces1),f1(liste_du_menu0()))">accès</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_projet']) && $_SESSION[_CA_]['chi_id_projet'] > 0){
    $le_sous_menu1_1.='
    <li><div id="menu_15"  class="rev_bouton" data-rev_click="m1(n1(c_autorisations1),f1(liste_du_menu0()))">autorisations</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_projet']) && $_SESSION[_CA_]['chi_id_projet'] === 1){
    $le_sous_menu1_1.='
    <li><div id="menu_16"  class="rev_bouton" data-rev_click="m1(n1(c_utilisateurs1),f1(liste_du_menu0()))">utilisateurs</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_projet']) && $_SESSION[_CA_]['chi_id_projet'] > 0){
    $le_sous_menu1_1.='
    <li><div id="menu_17"  class="rev_bouton" data-rev_click="m1(n1(c_menus1),f1(liste_du_menu0()))">menus</div></li>'.PHP_EOL;
}
/* niveau 1 */
if($le_sous_menu1_1!==''){
    $le_sous_menu1_0.='<li><div data-libelle_noeud_menu1="1">organisation</div>';
    $le_sous_menu1_0.='<ul id="menu_11" data-id_menu="11">
';
...
if(isset($_SESSION[_CA_]['chi_id_projet']) && $_SESSION[_CA_]['chi_id_projet'] > 0 && isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_20"  class="rev_bouton" data-rev_click="m1(n1(ecran_generer_programmes),f1(page_generer_le_programme1()))">générer</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_projet']) && $_SESSION[_CA_]['chi_id_projet'] > 0 && isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_21"  class="rev_bouton" data-rev_click="m1(n1(ecran_generer_souches),f1(page_generer_les_souches1()))">souches</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_22"  class="rev_bouton" data-rev_click="m1(n1(ecran_source_vers_programme),f1(point_d_entree()))">source</div></li>'.PHP_EOL;
}
/* niveau 2 */
if($le_sous_menu1_2!==''){
    $le_sous_menu1_1.='<li><div data-libelle_noeud_menu1="2">générations</div>';
    $le_sous_menu1_1.='<ul id="menu_19" data-id_menu="19">
';
...
if(isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_24"  class="rev_bouton" data-rev_click="m1(n1(ecran_rev_vers_matrice1),f1(ecran_matrice()))">matrice</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_25"  class="rev_bouton" data-rev_click="m1(n1(ecran_rev_vers_html1),f1(ecran_rev_html()))">html</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_26"  class="rev_bouton" data-rev_click="m1(n1(ecran_rev_vers_js1),f1(ecran_rev_js()))">js</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_27"  class="rev_bouton" data-rev_click="m1(n1(ecran_rev_vers_php1),f1(ecran_rev_php()))">php</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_28"  class="rev_bouton" data-rev_click="m1(n1(ecran_rev_vers_sql1),f1(ecran_rev_sql()))">sql</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_29"  class="rev_bouton" data-rev_click="m1(n1(ecran_rev_vers_css1),f1(ecran_rev_css()))">css</div></li>'.PHP_EOL;
}
/*
  ==================
*/
if(isset($_SESSION[_CA_]['chi_id_utilisateur']) && $_SESSION[_CA_]['chi_id_utilisateur'] > 0){
    $le_sous_menu1_2.='
    <li><div id="menu_30"  class="rev_bouton" data-rev_click="m1(n1(ecran_rev_vers_txt1),f1(ecran_rev_txt()))">txt</div></li>'.PHP_EOL;
}
/* niveau 2 */
if($le_sous_menu1_2!==''){
    $le_sous_menu1_1.='<li><div data-libelle_noeud_menu1="2">convertions</div>';
    $le_sous_menu1_1.='<ul id="menu_23" data-id_menu="23">
';
    $le_sous_menu1_1.=$le_sous_menu1_2.PHP_EOL;
    $le_sous_menu1_1.='</ul>'.PHP_EOL;
    $le_sous_menu1_1.='</li>'.PHP_EOL;
...
if($le_sous_menu1_1!==''){
    ...
    $le_sous_menu1_0.='<ul id="menu_18" data-id_menu="18">
';
    $le_sous_menu1_0.=$le_sous_menu1_1.PHP_EOL;
    $le_sous_menu1_0.='</ul>'.PHP_EOL;
    $le_sous_menu1_0.='</li>'.PHP_EOL;
