class v2_menu_pour_acces_2{
    ...
    */
    obtenir_le_html_des_menus( donnees_retournees ){
        ...
        les_menu1+=`<li><div id="menu_3" data-id_auto="47" data-id_menu="20" class="rev_bouton" data-rev_click="m1(n1(acteurs1),f1(entree_module()))" title="utilisateurs">acteurs</div></li>`;
        /* ================== */
        les_sous_menus[0]+=`<li><div  id="menu_5"   data-id_auto="25" data-id_menu="13" class="rev_bouton"  title="groupes" data-rev_click="m1(n1(groupes1),f1(entree_module()))">groupes</div></li>`;
        les_sous_menus[0]+=`<li><div  id="menu_6"   data-id_auto="27" data-id_menu="14" class="rev_bouton"  title="métier" data-rev_click="m1(n1(metiers1),f1(entree_module()))">métier</div></li>`;
        les_sous_menus[0]+=`<li><div  id="menu_7"   data-id_auto="29" data-id_menu="15" class="rev_bouton"  title="accès" data-rev_click="m1(n1(acces1),f1(entree_module()))">accès</div></li>`;
        les_sous_menus[0]+=`<li><div  id="menu_8"   data-id_auto="31" data-id_menu="16" class="rev_bouton"  title="autorisations" data-rev_click="m1(n1(autorisations1),f1(entree_module()))">autorisations</div></li>`;
        les_sous_menus[0]+=`<li><div  id="menu_9"   data-id_auto="33" data-id_menu="18" class="rev_bouton"  title="menus" data-rev_click="m1(n1(menus1),f1(entree_module()))">menus</div></li>`;
        les_sous_menus[0]+=`<li><div  id="menu_10"   data-id_auto="36" data-id_menu="19" class="rev_bouton"  title="utilisateurs" data-rev_click="m1(n1(utilisateurs1),f1(entree_module()))">utilisateurs</div></li>`;
        /* niveau 0 */
        if(les_sous_menus[0] !== ''){
