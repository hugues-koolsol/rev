...
class sql_1185{
    ...
    */
    async sql( par ){
        let sql0='';
        let obj1=await this.__ig1.tester_les_dependances1( {"table_parente" : 'tbl_parametres' ,"champ_parent" : 'chi_id_parametre' ,"id_enregistrement" : par['chi_id_parametre'] ,"__db1" : this.__db1} );
        if(obj1.__xst !== __xsu){
