...
class sql_1205{
    ...
    */
    async sql( par ){
        let sql0='';
        let obj1=await this.__ig1.tester_les_dependances1( {"table_parente" : 'tbl_grandeurs' ,"champ_parent" : 'chi_id_grandeur' ,"id_enregistrement" : par['chi_id_grandeur'] ,"__db1" : this.__db1} );
        if(obj1.__xst !== __xsu){
        ...
        try{
            ...
            return(this.__ig1.traite_erreur_sql( 1205 , e , sql0 , {} ));
        }
    }
    /*
      =============================================================================================================
