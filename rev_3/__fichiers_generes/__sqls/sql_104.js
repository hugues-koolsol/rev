      ...
      INSERT  INTO \`tbl_groupes\`(
        ...
        try{
            for(let i=0;i < par.donnees.length;i++){
                ...
                liste_des_valeurs+='(';
                liste_des_valeurs+='\r\n      ' + this.__gi1.__fnt1.sq1( par.donnees[i]['chi_id_groupe'] ) + ''+',';
                liste_des_valeurs+='\r\n      ' + this.__gi1.__fnt1.sq1( par.donnees[i]['chp_nom_groupe'] ) + ''+',';
                liste_des_valeurs+='\r\n      ' + this.__gi1.__fnt1.sq1( par.donnees[i]['chx_parent_groupe'] ) + '';
                liste_des_valeurs+=')';
            }
            let res=0;
            let nouvel_id=-1;
            if(liste_des_valeurs!==''){
                ...
                /* this.__gi1.ma_trace1('sql_104=',sql0); */
