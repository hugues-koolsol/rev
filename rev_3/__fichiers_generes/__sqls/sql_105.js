      ...
      INSERT  INTO \`tbl_metiers\`(
        ...
        try{
            for(let i=0;i < par.donnees.length;i++){
                ...
                liste_des_valeurs+='(';
                liste_des_valeurs+='\r\n      ' + this.__gi1.__fnt1.sq1( par.donnees[i]['chi_id_metier'] ) + ''+',';
                liste_des_valeurs+='\r\n      ' + this.__gi1.__fnt1.sq1( par.donnees[i]['chp_nom_metier'] ) + ''+',';
            ...
            if(liste_des_valeurs!==''){
                ...
                /* this.__gi1.ma_trace1('sql_105=',sql0); */
