    ...
    */
    async sql( par ){
        ...
        if(par['n_cht_parametres_acces'] === null || par['n_cht_parametres_acces'] === ''){
            this.__ig1.donnees_retournees.__xsi[__xer].push( 'la valeur pour "parametres" doit être renseignée [' + this.__ig1.nl2() + ']' );
            return({"__xst" : __xer});
        }
        ...
        try{
            ...
            return(this.__ig1.traite_erreur_sql( 154 , e , sql0 , {} ));
        }
    }
    /*
      =============================================================================================================
