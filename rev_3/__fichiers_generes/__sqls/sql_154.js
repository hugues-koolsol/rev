    ...
    async sql( par , donnees_retournees ){
        ...
        try{
            if(par['n_cht_parametres_acces'] === undefined || par['n_cht_parametres_acces'] === '' || par['n_cht_parametres_acces'] === null){
                ...
                tableau_champs.push( '`cht_parametres_acces` = \'' + this.__gi1.__fnt1.sq0( par['n_cht_parametres_acces'] ) + '\'' );
            }
            ...
            sql0+=where0;
            /* this.__gi1.ma_trace1(' sql_154= ' + sql0 ); */
            let res=await this.__db1.exec( sql0 );
            return({"__xst" : __xsu ,"changements" : res});
        }catch(e){
            return(this.__gi1.traite_erreur_sql( 154 , e , sql0 , donnees_retournees , {} ));
        }
    }
    /*
      =============================================================================================================
