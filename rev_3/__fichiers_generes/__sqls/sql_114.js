...
class sql_114{
    ...
    */
    async sql( par , donnees_retournees ){
        let obj1=await this.__gi1.tester_les_dependances1( {"table_parente" : 'tbl_taches' ,"champ_parent" : 'chi_id_tache' ,"id_enregistrement" : par['chi_id_tache'] ,"__db1" : this.__db1} , donnees_retournees );
        if(obj1.__xst !== __xsu){
        ...
        try{
            ...
            if(e.stack.indexOf( 'FOREIGN KEY' ) >= 0){
                await this.__gi1.afficher_les_dependances1( {"table_parente" : 'tbl_taches' ,"champ_parent" : 'chi_id_tache' ,"id_enregistrement" : par['chi_id_tache'] ,"__db1" : this.__db1} , donnees_retournees );
            }
            return(this.__gi1.traite_erreur_sql( 114 , e , sql0 , donnees_retournees , {} ));
        }
    }
    /*
      =============================================================================================================
