    ...
    page_creer1( mat , d , dupliquer=null ){
        ...
        */
        ...
        if(dupliquer && dupliquer.hasOwnProperty( 'T0.che_contient_version_source' )){
            o1+=this.__gi1.fi2( dupliquer['T0.che_contient_version_source'] );
        }else{
            o1+='0';
        }
        o1+='" />';
        ...
        */
        ...
        if(dupliquer && dupliquer.hasOwnProperty( 'T0.che_autorisation_globale_source' )){
            o1+=this.__gi1.fi2( dupliquer['T0.che_autorisation_globale_source'] );
        }else{
            o1+='0';
        }
        o1+='" />';
            ...
            for(let i in le_message_du_serveur.__xva[this.fonction_liste].__xva){
                ...
                */
                ...
                if(elem['T0.chp_nom_source'] !== null){
                    lst+=this.__gi1.fi2( elem['T0.chp_nom_source'].substr( 0 , 100 ) );
                }
                lst+='</td>';
                /*
                */
