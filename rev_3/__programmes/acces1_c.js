...
class acces1{
    ...
    */
    page_modification1( mat , d , le_message_du_serveur=null ){
        ...
        this.__ig1.afficher_le_titre_des_zones( 'vv_ecran_modification' , 'entree_module' , this.DUN_DUNE_ELEMENT_GERE , enreg['T0.chi_id_acces'] , this.moi );
        let o1='';
        /*
          =====================================================================================================
        */
        ...
        o1+='      <input  type="text" style="height: var(--t_hauteur_input1);" id="chp_nom_acces"  size="48"   maxlength="64"  value="' + this.__ig1.fi2( enreg['T0.chp_nom_acces'] ) + '"  autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" />';
    ...
    */
    page_confirmation_supprimer1( mat , d , le_message_du_serveur=null ){
        ...
        this.__ig1.afficher_le_titre_des_zones( 'vv_ecran_suppression' , 'entree_module' , this.DUN_DUNE_ELEMENT_GERE , enreg['T0.chi_id_acces'] , this.moi );
        let o1='';
        /*
          =====================================================================================================
        */
        ...
        */
        ...
        if(dupliquer && dupliquer.hasOwnProperty( 'T0.chx_metier_acces' )){
            if(dupliquer['T0.chx_metier_acces'] === null){
                ...
                o1+=this.__ig1.fi2( dupliquer['T2.chp_nom_metier'] );
            }
        }else{
            o1+='*indéfini';
        }
