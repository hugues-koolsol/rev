    ...
    */
    async page_modification1( mat , d , chi_id_menu=null , __db1=null ){
        ...
        */
        ...
        this.__ig1.donnees_retournees[__xva]['page_modification1']=tt1146;
        return({"__xst" : __xsu});
    }
    /*
      =============================================================================================================
    ...
    */
    async page_voir1( mat , d ){
        ...
        */
        ...
        this.__ig1.donnees_retournees[__xva]['page_voir1']=tt1146;
        return({"__xst" : __xsu});
    }
    /*
      =============================================================================================================
    ...
    */
    async filtre1( mat , d , __db1=null ){
        ...
        */
        ...
        if(tt1145.__xst === __xsu && tt1145.__xva.length === 0 && __debut > 0){
            /*
        ...
        this.__ig1.donnees_retournees[__xva][this.fonction_liste]=tt1145;
        return({"__xst" : __xsu});
    }
    /*
      =============================================================================================================
