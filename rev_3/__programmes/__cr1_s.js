...
class __cr1{
    ...
    */
    constructor( __ig1 ){
        this.__ig1=__ig1;
        /* this.__ig1.ma_trace1( 'constructeur de __cr1' ); */
    }
    /*
      =============================================================================================================
    */
    async executer_job_cron( donnees_recues , donnees_retournees , options_generales ){
        try{
            ...
            */
            ...
            let tt400=await this.__ig1.sql_iii( 400 , criteres_400 , donnees_retournees , __db1 );
            ...
            for( let i=0 ; i < tt400.__xva.length ; i++ ){
                ...
                if(ret.__xst !== __xsu){
                    let criteres_401={
                        ...
                        "n_cht_log_travail" : JSON.stringify( this.__ig1.__xsi , null , 2 )
                    };
                    let __db1=await this.__ig1.ouvrir_bdd( 1 , donnees_retournees , options_generales );
                    let tt401=await this.__ig1.sql_iii( 401 , criteres_401 , donnees_retournees , __db1 );
                    __db1.close();
                    if(tt401[__xst] !== __xsu){
                        if(tt397['__xme'] !== ''){
                            this.__ig1.__xsi[__xer].push( tt397['__xme'] + ' [' + this.__ig1.nl2() );
                        }else{
                ...
                if(tt401[__xst] !== __xsu){
                    if(tt401['__xme'] !== ''){
                        this.__ig1.__xsi[__xer].push( tt401['__xme'] + ' [' + this.__ig1.nl2() );
                    }else{
                        this.__ig1.__xsi[__xer].push( 'erreur de modification [' + this.__ig1.nl2() );
                    }
                    donnees_retournees.__xst=__xer;
