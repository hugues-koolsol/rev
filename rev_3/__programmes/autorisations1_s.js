...
class autorisations1{
    ...
    */
    async ecrire_fichier_des_autorisations( tableau_des_auto , chx_acces_autorisation , __db1 ){
        if(this.__ig1.donnees_retournees._CA_ > 2 && this.__ig1.donnees_retournees.chi_id_utilisateur >=2 && chx_acces_autorisation<=2){
            /*
    ...
    */
    async gererer_les_autorisation_serveur( mat , d , __db1=null ){
        ...
        */
        ...
        let tt151=await this.__ig1.sql_iii(
        /*sql_inclure_deb*/ /*#
        SELECT 
        `T0`.`chp_nom_source`
        ...
        */
        ...
        ;
        */
        /*sql_inclure_fin*/ 152 , criteres_select_152 , this.__ig1.donnees_retournees , __db1 );
    ...
    */
    async actions_et_tests_avant_modifier( mat , d , form , __xva_avant , __db1 ){
        if(this.__ig1.donnees_retournees._CA_ > 2 && this.__ig1.donnees_retournees.chi_id_utilisateur > 1 ){
            if( !( __xva_avant['T0.chx_acces_autorisation'] > 2 || __xva_avant['T0.chx_acces_autorisation'] === 0 ) ){
               this.__ig1.donnees_retournees.__xsi[__xer].push( ' vous ne pouvez pas modifier l\'autorisation pour cet accès  (' + __xva_avant['T0.chx_acces_autorisation'] + ')' );
               return({"__xst" : __xer});
            }
        }
        return({"__xst" : __xsu});
    ...
    */
    async test_avant_supprimer( mat , d , form , __xva_avant , __db1 ){
        ...
        this.__ig1.ma_trace1("this.__ig1.donnees_retournees.chi_id_utilisateur="+this.__ig1.donnees_retournees.chi_id_utilisateur);
        this.__ig1.ma_trace1("__xva_avant['T0.chx_acces_autorisation']"+__xva_avant['T0.chx_acces_autorisation']);
        if(this.__ig1.donnees_retournees._CA_ > 2 && this.__ig1.donnees_retournees.chi_id_utilisateur > 1 ){
            if( !( __xva_avant['T0.chx_acces_autorisation'] > 2 || __xva_avant['T0.chx_acces_autorisation'] === 0 ) ){
               this.__ig1.donnees_retournees.__xsi[__xer].push( ' vous ne pouvez pas supprimer l\'autorisation pour cet accès  (' + __xva_avant['T0.chx_acces_autorisation'] + ')' );
               return({"__xst" : __xer});
            }
        }
        return({"__xst" : __xsu});
    ...
    */
    async page_duplication1( mat , d , chi_id_autorisation=null ){
        ...
        */
        ...
        this.__ig1.donnees_retournees[__xva]['page_duplication1']=tt141;
        return({"__xst" : __xsu});
    }
    /*
      =============================================================================================================
    */
    async supprimer1( mat , d ){
        ...
        */
        ...
        let tt144=await this.__ig1.sql_iii(
        /*sql_inclure_deb*/ /*#
    ...
    */
    async page_confirmation_supprimer1( mat , d ){
        ...
        ;
        */
        /*sql_inclure_fin*/ 141 , critere_141 , this.__ig1.donnees_retournees , __db1 );
        this.__ig1.donnees_retournees[__xva]['page_confirmation_supprimer1']=tt141;
        return({"__xst" : __xsu});
    }
    /*
      =============================================================================================================
    */
    async creer1( mat , d ){
        ...
        /*  */
        await __db1.exec( 'BEGIN TRANSACTION' );
        let tt142=await this.__ig1.sql_iii(
        /*sql_inclure_deb*/ /*#
        ...
        */
        ...
        if(tt142[__xst] === __xsu){
            ...
            await __db1.exec( 'COMMIT' );
            let aacc=await this.action_apres_commit_creer( mat , d , tt142['nouvel_id'] , form , __db1 );
            if(retour_a_la_liste === true && form['__mat_liste_si_ok'] !== ''){
                let mat1=JSON.parse( form['__mat_liste_si_ok'] );
                await this.filtre1( mat1 , 1 , __db1 );
            }else{
                await this.page_modification1( mat , d , tt142['nouvel_id'] , __db1 );
            }
            return({"__xst" : __xsu});
        }else{
            this.__ig1.donnees_retournees.__xsi[__xer].push( tt142['__xme'] + '\nl\'insertion a échoué [' + this.__ig1.nl2() + ']' );
            return({"__xst" : __xer});
        }
    }
    /*
    ...
    */
    async filtre1( mat , d , __db1=null ){
        ...
        ;
        */
        /*sql_inclure_fin*/ 140 , criteres_140 , this.__ig1.donnees_retournees , __db1 );
        ...
        this.__ig1.donnees_retournees[__xva][this.fonction_liste]=tt140;
        return({"__xst" : __xsu});
    }
    /*
      =============================================================================================================
