    ...
    */
    async modifier_le_mot_de_passe( mat , d , donnees_recues , donnees_retournees , options_generales ){
        ...
        if(chi_id_utilisateur < 2){
            donnees_retournees.__xsi[__xer].push( 'vous ne pouvez pas modifier le mot de passe de cet utilisateur [' + this.__ig1.nl2() + ']' );
            return({"__xst" : __xer});
        }
        ...
        if(!(form['chp_mot_de_passe_utilisateur1'] === form['chp_mot_de_passe_utilisateur2']
            ...
            donnees_retournees.__xsi[__xer].push( 'les deux mots de passe doivent être identiques et faire au moins 7 caractères [' + this.__ig1.nl2() + ']' );
            return({"__xst" : __xer});
        }
        ...
        */
        ...
        if(tt150[__xst] !== __xsu){
            donnees_retournees.__xsi[__xer].push( 'erreur de maj du mot de passe [' + this.__ig1.nl2() + ']' );
            return({"__xst" : __xer});
        }
        return({"__xst" : __xsu});
    }
    ...
    */
    async actions_et_tests_avant_modifier( mat , d , donnees_recues , donnees_retournees , options_generales , form , __xva_avant , __db1 ){
        if(__xva_avant['T0.chi_id_utilisateur'] === 1 && form['che_actif_utilisateur'] !== 1){
            donnees_retournees.__xsi[__xer].push( ' l\'utilisateur 1 doit toujours être actif [' + this.__ig1.nl2() + ']' );
            return({"__xst" : __xer});
        }
        if(__xva_avant['T0.chi_id_utilisateur'] === 1 && form['chx_acces_utilisateur'] !== 1){
            donnees_retournees.__xsi[__xer].push( ' l\'utilisateur 1 doit toujours être sur le groupe 1 [' + this.__ig1.nl2() + ']' );
            return({"__xst" : __xer});
        }
        /*
        */
    ...
    */
    async tests_avant_creer( mat , d , donnees_recues , donnees_retournees , options_generales , form , __db1 ){
        if(form['chx_acces_utilisateur'] === 1){
            donnees_retournees.__xsi[__xer].push( ' seul l\'utilisateur 1 peut avoir l\'accès 1 [' + this.__ig1.nl2() + ']' );
            return({"__xst" : __xer});
        }
        /*
          donnees_retournees.__xsi[__xer].push( ' [' + this.__ig1.nl2() + ']' );
    ...
    */
    async modifier1( mat , d , donnees_recues , donnees_retournees , options_generales ){
        ...
        if(form['chp_nom_de_connexion_utilisateur'] === null || form['chp_nom_de_connexion_utilisateur'] === ''){
            donnees_retournees.__xsi[__xer].push( 'la valeur pour "nom de connexion" doit être renseigné [' + this.__ig1.nl2() + ']' );
            return({"__xst" : __xer});
        }
        ...
        if(tt121[__xst] === __xsu && tt121[__xva].length === 1){
            ...
            */
            ...
            if(tt122[__xst] !== __xsu){
                if(tt122['__xme'] !== ''){
                    donnees_retournees.__xsi[__xer].push( tt122['__xme'] + ' [' + this.__ig1.nl2() );
                }else{
    ...
    async creer1( mat , d , donnees_recues , donnees_retournees , options_generales ){
        ...
        */
        ...
        if(tt120[__xst] === __xsu){
            ...
            donnees_retournees.__xsi[__xer].push( tt120['__xme'] + '\nl\'insertion a échoué [' + this.__ig1.nl2() + ']' );
            return({"__xst" : __xer});
        }
    }
    /*
