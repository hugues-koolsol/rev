class v2_menu_pour_acces_2{
    ...
    */
    obtenir_le_html_des_menus( donnees_retournees ){
        ...
        les_menu1+=`<li><div id="menu_2" data-id_auto="82" data-id_menu="36" class="rev_bouton" data-rev_click="m1(n1(x_ecran_rev_vers_js1),f1(entree_module()))" title="convertion de javascript ">js</div></li>`;
