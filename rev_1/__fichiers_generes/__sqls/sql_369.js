...
class sql_369{
    ...
    */
    async sql( par , donnees_retournees ){
        ...
        sql0+=where0;
        /* this.__gi1.ma_trace1('sql_369 sql0=',sql0); */
        let lignes=[];
        try{
            ...
            return(this.__gi1.traite_erreur_sql( 369 , e , sql0 , donnees_retournees , {} ));
        }
        let donnees0=[];
        for(let col of lignes){
            donnees0.push( {
                    "T0.chi_id_dossier" : col[0] ,
                    "T0.chx_parent_dossier" : col[1]
                } );
        }
