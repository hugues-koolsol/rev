      ...
      INSERT  INTO \`tbl_metiers\`(
        ...
        try{
            for( let i=0 ; i < par.donnees.length ; i++ ){
                ...
                if(par.donnees[i]['chp_nom_metier'] === null || par.donnees[i]['chp_nom_metier']===''){
                ...
                */
                let __test_0_1=this.__ig1.__fnts_c_et_s.test_du_nom_technique1(par.donnees[i]['chp_nom_metier'],'nom du metier');
            ...
            if(liste_des_valeurs !== ''){
                ...
                /* this.__ig1.ma_trace1( 'sql_126=' + sql0 ); */
            ...
            return(this.__ig1.traite_erreur_sql( 126 , e , sql0 , {} ));
        }
    }
    /*
      =============================================================================================================
