      ...
      INSERT  INTO \`tbl_utilisateurs\`(
        ...
        try{
            for(let i=0;i < par.donnees.length;i++){
                ...
                liste_des_valeurs+='(';
                liste_des_valeurs+='\r\n      ' + this.__gi1.__fnt1.sq1( par.donnees[i]['chi_id_utilisateur'] ) + ''+',';
                liste_des_valeurs+='\r\n      ' + this.__gi1.__fnt1.sq1( par.donnees[i]['chp_nom_de_connexion_utilisateur'] ) + ''+',';
                liste_des_valeurs+='\r\n      ' + this.__gi1.__fnt1.sq1( par.donnees[i]['chp_mot_de_passe_utilisateur'] ) + ''+',';
            ...
            if(liste_des_valeurs!==''){
                ...
                /* this.__gi1.ma_trace1('sql_102=',sql0); */
