...
class sql_1333{
    ...
    */
    ...
    const plage0='';
    sql0+=plage0;
        /* this.__ig1.ma_trace1('sql_1333 sql0=',sql0); */
        let lignes=[];
        try{
            ...
            return(this.__ig1.traite_erreur_sql( 1333 , e , sql0 , {} ));
        }
        let donnees0=[];
        for(let col of lignes){
            donnees0.push( {
                    ...
                    "T0.che_est_positif_genre" : col[18] ,
                    "T0.cht_particularités_genre" : col[19]
                } );
        }
