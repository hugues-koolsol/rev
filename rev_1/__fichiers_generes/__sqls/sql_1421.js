...
class sql_1421{
    ...
    */
    async sql( par ){
        let sql0='';
        let obj1=await this.__ig1.tester_les_dependances1( {"table_parente" : 'tbl_sources' ,"champ_parent" : 'chi_id_source' ,"id_enregistrement" : par['chi_id_source'] ,"__db1" : this.__db1 ,"__ref_base" : 'b1' } );
        if(obj1.__xst !== __xsu){
