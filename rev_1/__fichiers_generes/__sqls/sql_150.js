    ...
    async sql( par , donnees_retournees ){
        ...
        try{
            if(par['n_chp_mot_de_passe_utilisateur'] === undefined || par['n_chp_mot_de_passe_utilisateur'] === '' || par['n_chp_mot_de_passe_utilisateur'] === null){
                ...
                tableau_champs.push( '`chp_mot_de_passe_utilisateur` = \'' + this.__gi1.__fnt1.sq0( par['n_chp_mot_de_passe_utilisateur'] ) + '\'' );
            }
            ...
            sql0+=where0;
            /* this.__gi1.ma_trace1(' sql_150= ' + sql0 ); */
            let res=await this.__db1.exec( sql0 );
            return({"__xst" : __xsu ,"changements" : res});
        }catch(e){
            return(this.__gi1.traite_erreur_sql( 150 , e , sql0 , donnees_retournees , {} ));
        }
    }
    /*
      =============================================================================================================
