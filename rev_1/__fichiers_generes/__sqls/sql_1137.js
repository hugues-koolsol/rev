      ...
      INSERT  INTO \`tbl_acces\`(
        ...
        try{
            for( let i=0 ; i < les_tups.donnees.length ; i++ ){
                ...
                liste_des_valeurs+='(';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq4( tup.chp_nom_acces , 'chp_nom_acces' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq1( tup.chx_groupe_acces , 'chx_groupe_acces' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq1( tup.chx_metier_acces , 'chx_metier_acces' ) + '';
                liste_des_valeurs+=')';
            }
            let res=0;
            let nouvel_id=-1;
            if(liste_des_valeurs !== ''){
                ...
                /* this.__ig1.ma_trace1( 'sql_1137=' + sql0 ); */
            ...
            return(this.__ig1.traite_erreur_sql( 1137 , e , sql0 , {} ));
        }
    }
    /*
      =============================================================================================================
