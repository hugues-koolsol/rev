    ...
    */
    async sql( par ){
        ...
        for(let col of lignes){
            donnees0.push( {
                    "T0_chi_id_menu" : col[0] ,
                    "T0_chp_titre_menu" : col[1] ,
                    "T0_chx_autorisation_menu" : col[2] ,
                    "T0_chp_methode_menu" : col[3] ,
                    "T0_cht_libelle_menu" : col[4] ,
                    "T0_cht_initialisation_menu" : col[5] ,
                    "T0_cht_condition_menu" : col[6] ,
                    "T1_chx_acces_autorisation" : col[7] ,
                    "T1_chx_source_autorisation" : col[8] ,
                    "T2_chp_nom_acces" : col[9] ,
                    "T3_chp_nom_source" : col[10] ,
                    "T3_che_binaire_source" : col[11] ,
