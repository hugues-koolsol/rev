...
class sql_1169{
    ...
    */
    async sql( tup ){
        ...
        let tableau_champs=[];
        try{
            if(tup.n_chi_id_televersement === undefined || tup.n_chi_id_televersement === '' || tup.n_chi_id_televersement === null){
                tableau_champs.push( '`chi_id_televersement` = NULL' );
            }else{
                if(isNaN(parseInt( tup.n_chi_id_televersement , 10 ))){
                    return({"__xst" : __xer ,"__xme" : 'le champ "id" doit être numérique'});
                }
                tableau_champs.push( '`chi_id_televersement` = ' + this.__ig1.__fnt1.sq0( tup.n_chi_id_televersement , 'n_chi_id_televersement' ) + '' );
            }
            if(tup.n_che_bdd_televersement === undefined || tup.n_che_bdd_televersement === '' || tup.n_che_bdd_televersement === null){
                tableau_champs.push( '`che_bdd_televersement` = NULL' );
            }else{
                if(isNaN(parseInt( tup.n_che_bdd_televersement , 10 ))){
                    return({"__xst" : __xer ,"__xme" : 'le champ "ref bdd" doit être numérique'});
                }
                tableau_champs.push( '`che_bdd_televersement` = ' + this.__ig1.__fnt1.sq0( tup.n_che_bdd_televersement , 'n_che_bdd_televersement' ) + '' );
            }
            if(tup.n_chp_nom_table_televersement === undefined || tup.n_chp_nom_table_televersement === '' || tup.n_chp_nom_table_televersement === null){
                tableau_champs.push( '`chp_nom_table_televersement` = NULL' );
            }else{
                tableau_champs.push( '`chp_nom_table_televersement` = \'' + this.__ig1.__fnt1.sq0( tup.n_chp_nom_table_televersement , 'n_chp_nom_table_televersement' ) + '\'' );
            }
            if(tup.n_che_id_element_televersement === undefined || tup.n_che_id_element_televersement === '' || tup.n_che_id_element_televersement === null){
                tableau_champs.push( '`che_id_element_televersement` = NULL' );
            }else{
                if(isNaN(parseInt( tup.n_che_id_element_televersement , 10 ))){
                    return({"__xst" : __xer ,"__xme" : 'le champ "id element" doit être numérique'});
                }
                tableau_champs.push( '`che_id_element_televersement` = ' + this.__ig1.__fnt1.sq0( tup.n_che_id_element_televersement , 'n_che_id_element_televersement' ) + '' );
            }
            if(tup.n_chx_utilisateur_televersement === undefined || tup.n_chx_utilisateur_televersement === '' || tup.n_chx_utilisateur_televersement === null){
                tableau_champs.push( '`chx_utilisateur_televersement` = NULL' );
            }else{
                if(isNaN(parseInt( tup.n_chx_utilisateur_televersement , 10 ))){
                    return({"__xst" : __xer ,"__xme" : 'le champ "utilisateur" doit être numérique'});
                }
                tableau_champs.push( '`chx_utilisateur_televersement` = ' + this.__ig1.__fnt1.sq0( tup.n_chx_utilisateur_televersement , 'n_chx_utilisateur_televersement' ) + '' );
            }
            if(tup.n_chp_champ_cle_televersement === undefined || tup.n_chp_champ_cle_televersement === '' || tup.n_chp_champ_cle_televersement === null){
                tableau_champs.push( '`chp_champ_cle_televersement` = NULL' );
            }else{
                tableau_champs.push( '`chp_champ_cle_televersement` = \'' + this.__ig1.__fnt1.sq0( tup.n_chp_champ_cle_televersement , 'n_chp_champ_cle_televersement' ) + '\'' );
            }
            if(tup.n_chp_nom_original_televersement === undefined || tup.n_chp_nom_original_televersement === '' || tup.n_chp_nom_original_televersement === null){
                tableau_champs.push( '`chp_nom_original_televersement` = NULL' );
            }else{
                tableau_champs.push( '`chp_nom_original_televersement` = \'' + this.__ig1.__fnt1.sq0( tup.n_chp_nom_original_televersement , 'n_chp_nom_original_televersement' ) + '\'' );
            }
            if(tup.n_che_poids_televersement === undefined || tup.n_che_poids_televersement === '' || tup.n_che_poids_televersement === null){
                tableau_champs.push( '`che_poids_televersement` = NULL' );
            }else{
                if(isNaN(parseInt( tup.n_che_poids_televersement , 10 ))){
                    return({"__xst" : __xer ,"__xme" : 'le champ "poids" doit être numérique'});
                }
                tableau_champs.push( '`che_poids_televersement` = ' + this.__ig1.__fnt1.sq0( tup.n_che_poids_televersement , 'n_che_poids_televersement' ) + '' );
            }
            ...
            if(tup.n_chp_nom_du_dossier_televersement === undefined || tup.n_chp_nom_du_dossier_televersement === '' || tup.n_chp_nom_du_dossier_televersement === null){
                tableau_champs.push( '`chp_nom_du_dossier_televersement` = NULL' );
            }else{
                tableau_champs.push( '`chp_nom_du_dossier_televersement` = \'' + this.__ig1.__fnt1.sq0( tup.n_chp_nom_du_dossier_televersement , 'n_chp_nom_du_dossier_televersement' ) + '\'' );
            }
            if(tup.n_cht_comm_glob_televersement === undefined || tup.n_cht_comm_glob_televersement === '' || tup.n_cht_comm_glob_televersement === null){
                tableau_champs.push( '`cht_comm_glob_televersement` = NULL' );
            }else{
                tableau_champs.push( '`cht_comm_glob_televersement` = \'' + this.__ig1.__fnt1.sq0( tup.n_cht_comm_glob_televersement , 'n_cht_comm_glob_televersement' ) + '\'' );
            }
            if(tup.n_chp_comm_fichier_televersement === undefined || tup.n_chp_comm_fichier_televersement === '' || tup.n_chp_comm_fichier_televersement === null){
                tableau_champs.push( '`chp_comm_fichier_televersement` = NULL' );
            }else{
                tableau_champs.push( '`chp_comm_fichier_televersement` = \'' + this.__ig1.__fnt1.sq0( tup.n_chp_comm_fichier_televersement , 'n_chp_comm_fichier_televersement' ) + '\'' );
            }
