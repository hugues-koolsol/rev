...
class sql_1405{
    ...
    */
    ...
    const plage0=`
        LIMIT 1000 OFFSET 0 `;
    sql0+=plage0;
        /* this.__ig1.ma_trace1('sql_1405 sql0=',sql0); */
        let lignes=[];
        try{
            ...
            return(this.__ig1.traite_erreur_sql( 1405 , e , sql0 , {} ));
        }
        let donnees0=[];
        for(let col of lignes){
            donnees0.push( {
                    ...
                    "T0_che_est_souche_requete" : col[3] ,
                    "T0_chp_table_reference_requete" : col[4]
                } );
        }
