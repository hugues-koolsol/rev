...
class sql_121{
    ...
    */
    async sql( par , donnees_retournees ){
        ...
        `;
        sql0+=from0;
        const where0=` WHERE \`T0\`.\`chi_id_utilisateur\` = ` + this.__gi1.__fnt1.sq1( par['T0_chi_id_utilisateur'] ) + ``;
        sql0+=where0;
        /* this.__gi1.ma_trace1('sql_121 sql0=',sql0); */
        let lignes=[];
        try{
            ...
            return(this.__gi1.traite_erreur_sql( 121 , e , sql0 , donnees_retournees , {} ));
        }
        let donnees0=[];
        for(let col of lignes){
            donnees0.push( {
                    ...
                    "T0.che__nur_utilisateur" : col[5] ,
                    "T0.chd__dtm_utilisateur" : col[6] ,
                    "T0.chd__dtc_utilisateur" : col[7] ,
                    "T0.chx_acces_utilisateur" : col[8] ,
                    "T1.chp_nom_acces" : col[9] ,
                    "T0.che_actif_utilisateur" : col[10]
                } );
        }
