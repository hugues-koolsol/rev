...
class sql_1375{
    ...
    */
    async sql( tup ){
        ...
        sql0+=where0;
        /* this.__ig1.ma_trace1('sql_1375 sql0=',sql0); */
        let lignes=[];
        try{
            ...
            return(this.__ig1.traite_erreur_sql( 1375 , e , sql0 , {} ));
        }
        let donnees0=[];
        for(let col of lignes){
            donnees0.push( {
                    "T0_chi_id_projet" : col[0] ,
                    "T0_chp_nom_projet" : col[1] ,
                    "T0_cht_commentaire_projet" : col[2]
                } );
        }
