      ...
      INSERT  INTO \`tbl_acces\`(
        ...
        try{
            for(let i=0;i < par.donnees.length;i++){
                ...
                liste_des_valeurs+='(';
                liste_des_valeurs+='\r\n      ' + this.__gi1.__fnt1.sq1( par.donnees[i]['chi_id_acces'] ) + ''+',';
                liste_des_valeurs+='\r\n      ' + this.__gi1.__fnt1.sq1( par.donnees[i]['chp_nom_acces'] ) + ''+',';
            ...
            if(liste_des_valeurs!==''){
                ...
                /* this.__gi1.ma_trace1('sql_106=',sql0); */
