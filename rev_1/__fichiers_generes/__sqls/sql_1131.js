    ...
    */
    async sql( tup ){
        ...
        try{
            ...
            return(this.__ig1.traite_erreur_sql( 1131 , e , sql0 , {} ));
        }
        let donnees0=[];
        for(let col of lignes){
            donnees0.push( {
                    "T0_chi_id_groupe" : col[0] ,
                    "T0_chp_nom_groupe" : col[1] ,
                    "T0_chx_parent_groupe" : col[2] ,
                    "T1_chp_nom_groupe" : col[3]
                } );
        }
