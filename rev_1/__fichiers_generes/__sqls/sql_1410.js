...
class sql_1410{
    ...
    */
    async sql( tup ){
        let sql0='';
        let obj1=await this.__ig1.tester_les_dependances1( {"table_parente" : 'tbl_dossiers' ,"champ_parent" : 'chi_id_dossier' ,"id_enregistrement" : tup.chi_id_dossier ,"__db1" : this.__db1 ,"__ref_base" : 'b1' } );
        if(obj1.__xst !== __xsu){
        ...
        try{
            ...
            if(e.stack.indexOf( 'FOREIGN KEY' ) >= 0){
                await this.__ig1.afficher_les_dependances1( {"table_parente" : 'tbl_dossiers' ,"champ_parent" : 'chi_id_dossier' ,"id_enregistrement" : tup.chi_id_dossier ,"__db1" : this.__db1} );
            }
