...
class sql_1354{
    ...
    */
    async sql( tup ){
        ...
        sql0+=where0;
        /* this.__ig1.ma_trace1('sql_1354 sql0=',sql0); */
        let lignes=[];
        try{
            ...
            return(this.__ig1.traite_erreur_sql( 1354 , e , sql0 , {} ));
        }
        let donnees0=[];
        for(let col of lignes){
            donnees0.push( {
                    "T0_chi_id_requete" : col[0] ,
                    "T0_chp_type_requete" : col[1] ,
                    "T0_cht_rev_requete" : col[2] ,
                    "T0_cht_sql_requete" : col[3] ,
                    "T0_cht_commentaire_requete" : col[4] ,
                    "T0_cht_matrice_requete" : col[5] ,
                    "T0_che_est_souche_requete" : col[6] ,
                    "T0_chp_table_reference_requete" : col[7] ,
                    "T0_che_base_reference_requete" : col[8]
                } );
        }
