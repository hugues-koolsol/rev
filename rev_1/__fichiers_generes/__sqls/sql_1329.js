    ...
    */
    verifier_parmis( tup ){
        ...
        if(!['cht','chi','che','chx','chp','chd','chc','chu','chn'].includes(tup.chp_prefixe_genre)){
            throw new Error( tete + '"' + tup.chp_prefixe_genre + '" pour "préfixe" '  + this.__ig1.nl2() );
        }
        if(!['TEXT','VARCHAR','INTEGER','FLOAT','DECIMAL'].includes(tup.chp_espece_genre)){
            throw new Error( tete + '"' + tup.chp_espece_genre + '" pour "espece" '  + this.__ig1.nl2() );
        }
        this.__ig1.options_generales.erreur_controlee=false;
        return({"__xst" : __xsu});
    }
      ...
      INSERT  INTO \`tbl_genres\`(
        ...
        try{
            for( let i=0 ; i < les_tups.donnees.length ; i++ ){
                ...
                */
                let __test_10_1=this.__ig1.__fnts_c_et_s.test_est_au_format_une_constante_rev(tup.cht_valeur_init_genre , 'valeur init');
                ...
                */
                let __test_12_1=this.__ig1.__fnts_c_et_s.test_est_au_format_constantes_rev(tup.cht_parmis_genre , 'parmis');
