...
class sql_1138{
    ...
    */
    async sql( tup ){
        ...
        /* test 0,1 sur le champ "che_actif_acces" */
        if(!( tup.n_che_actif_acces === 0 ||  tup.n_che_actif_acces === 1 ) ){
        ...
        */
        ...
        try{
            ...
            return(this.__ig1.traite_erreur_sql( 1138 , e , sql0 , {} ));
        }
    }
    /*
      =============================================================================================================
