      ...
      INSERT  INTO \`tbl_genres\`(
        ...
        try{
            for( let i=0 ; i < par.donnees.length ; i++ ){
                ...
                */
                let __test_21_1=this.__ig1.__fnts_c_et_s.test_est_au_format_rev(elem['cht_particularités_genre'],'particularités');
                ...
                */
                ...
                liste_des_valeurs+='(';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq1( par.chi_id_genre , 'chi_id_genre' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq4( par.chp_nom_genre , 'chp_nom_genre' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq1( par.che_ordre_genre , 'che_ordre_genre' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq4( par.chp_prefixe_genre , 'chp_prefixe_genre' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq4( par.chp_espece_genre , 'chp_espece_genre' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq4( par.che_longueur_genre , 'che_longueur_genre' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq1( par.che_est_primaire_genre , 'che_est_primaire_genre' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq1( par.che_est_incrément_genre , 'che_est_incrément_genre' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq1( par.che_est_obligatoire_genre , 'che_est_obligatoire_genre' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq1( par.che_a_init_genre , 'che_a_init_genre' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq1( par.che_init_est_mot_genre , 'che_init_est_mot_genre' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq4( par.cht_valeur_init_genre , 'cht_valeur_init_genre' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq1( par.che_est_parmis_genre , 'che_est_parmis_genre' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq4( par.cht_parmis_genre , 'cht_parmis_genre' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq4( par.cht_fonctions_genre , 'cht_fonctions_genre' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq1( par.che_est_nur_genre , 'che_est_nur_genre' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq1( par.che_est_tsm_genre , 'che_est_tsm_genre' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq1( par.che_est_tsc_genre , 'che_est_tsc_genre' ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq1( this.__ig1.donnees_retournees.date_heure_serveur ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq1( this.__ig1.donnees_retournees.date_heure_serveur ) + '' + ',';
                liste_des_valeurs+='\r\n      '+this.__ig1.__fnt1.sq1('0') + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq4( par.cht_particularités_genre , 'cht_particularités_genre' ) + '';
                liste_des_valeurs+=')';
            }
            let res=0;
            let nouvel_id=-1;
