      ...
      INSERT  INTO \`tbl_groupes\`(
        ...
        try{
            for( let i=0 ; i < par.donnees.length ; i++ ){
                ...
                if(par.donnees[i]['chp_nom_groupe'] === null || par.donnees[i]['chp_nom_groupe']===''){
                ...
                */
                let __test_0_1=this.__ig1.__fnts_c_et_s.test_du_nom_technique1(par.donnees[i]['chp_nom_groupe'],'nom du groupe');
