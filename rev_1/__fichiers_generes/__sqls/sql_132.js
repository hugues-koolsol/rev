      ...
      INSERT  INTO \`tbl_groupes\`(
        ...
        try{
            for( let i=0 ; i < par.donnees.length ; i++ ){
                ...
                liste_des_valeurs+='(';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq4( par.donnees[i]['chp_nom_groupe'] ) + '' + ',';
                liste_des_valeurs+='\r\n      ' + this.__ig1.__fnt1.sq1( par.donnees[i]['chx_parent_groupe'] ) + '';
                liste_des_valeurs+=')';
            }
            let res=0;
            let nouvel_id=-1;
            ...
            return(this.__ig1.traite_erreur_sql( 132 , e , sql0 , donnees_retournees , {} ));
        }
    }
    /*
      =============================================================================================================
