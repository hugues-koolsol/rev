...
class sql_1220{
    ...
    */
    async sql( tup ){
        ...
        sql0+=plage0;
        /* this.__ig1.ma_trace1('sql_1220 sql0=',sql0); */
        let lignes=[];
        try{
            ...
            return(this.__ig1.traite_erreur_sql( 1220 , e , sql0 , {} ));
        }
        /*  */
        for(let numero_de_ligne in lignes){
            donnees0.push( {
                    "T0_chi_id_autorisation" : lignes[numero_de_ligne][0] ,
                    "T0_chx_source_autorisation" : lignes[numero_de_ligne][1] ,
                    "T2_chp_nom_source" : lignes[numero_de_ligne][2] ,
                    "T0_chx_acces_autorisation" : lignes[numero_de_ligne][3] ,
                    "T1_chp_nom_acces" : lignes[numero_de_ligne][4] ,
                    "T0_che_pour_sous_liste_autorisation" : lignes[numero_de_ligne][5]
                } );
        }
        /* comptage */
