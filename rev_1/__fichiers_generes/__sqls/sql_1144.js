    ...
    async sql( par ){
        ...
        try{
            ...
            if(e.stack.indexOf( 'FOREIGN KEY' ) >= 0){
                await this.__ig1.afficher_les_dependances1( {"table_parente" : 'tbl_autorisations' ,"champ_parent" : 'chi_id_autorisation' ,"id_enregistrement" : par['chi_id_autorisation'] ,"__db1" : this.__db1} );
            }
