...
class sql_1123{
    ...
    */
    async sql( par ){
        let sql0='';
        let obj1=await this.__ig1.tester_les_dependances1( {"table_parente" : 'tbl_utilisateurs' ,"champ_parent" : 'chi_id_utilisateur' ,"id_enregistrement" : par['chi_id_utilisateur'] ,"__db1" : this.__db1 ,"__ref_base" : 'b1' } );
        if(obj1.__xst !== __xsu){
