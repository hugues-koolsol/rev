...
class dossiers1{
    ...
    */
    async modifier1( mat , d ){
        ...
        let __db1=await this.__ig1.ouvrir_bdd( this.__ig1.options_generales.base_de_travail );
        let criteres_select_1386={"T0_chi_id_dossier" : fo1.chi_id_dossier};
        let tt1386=await this.recup_chi_id_dossier( criteres_select_1386 , __db1 );
        if(tt1386.__xst !== __xsu || tt1386.__xva.length !== 1){
            return({"__xst" : __xer ,"__xme" : 'enregistrement non trouvé : aucune modification effectuée [1386 ' + this.__ig1.nl2() + ']'});
        }
        await __db1.exec( 'BEGIN TRANSACTION;' );
        let __aetavm=await this.actions_et_tests_avant_modifier( mat , d , fo1 , tt1386.__xva[0] , __db1 );
        ...
        let criteres_1407={
             /*  */
            "c_chi_id_dossier" : fo1.chi_id_dossier ,
            "n_chp_nom_dossier" : fo1.chp_nom_dossier === '' ? ( null ) : ( fo1.chp_nom_dossier ) ,
        ...
        */
        ...
        let __taam=await this.tests_et_actions_apres_modifier( mat , d , fo1 , tt1386.__xva[0] , __db1 );
        ...
        let tt1386_bis=await this.recup_chi_id_dossier( criteres_select_1386 , __db1 );
    ...
    */
    async page_modification1( mat , d , chi_id_dossier=null , __db1=null ){
        ...
        let tt1386=await this.recup_chi_id_dossier( {"T0_chi_id_dossier" : chi_id_dossier} , __db1 );
        if(tt1386.__xst !== __xsu || tt1386.__xva.length !== 1){
            return({"__xst" : __xer ,"__xme" : 'enregistrement non trouvé : modification impossible [1386 ' + this.__ig1.nl2() + ']'});
        }
    ...
    */
    async page_duplication1( mat , d , chi_id_dossier=null ){
        ...
        let tt1386=await this.recup_chi_id_dossier( {"T0_chi_id_dossier" : chi_id_dossier} , __db1 );
        if(tt1386.__xst !== __xsu || tt1386.__xva.length !== 1){
            return({"__xst" : __xer ,"__xme" : 'enregistrement non trouvé : duplication impossible [1386 ' + this.__ig1.nl2() + ']'});
        }
    ...
    */
    async supprimer1( mat , d ){
        ...
        /*  */
        let __db1=await this.__ig1.ouvrir_bdd( this.__ig1.options_generales.base_de_travail );
        let tt1386=await this.recup_chi_id_dossier( {"T0_chi_id_dossier" : fo1.chi_id_dossier} , __db1 );
        if(tt1386.__xst !== __xsu || tt1386.__xva.length !== 1){
            return({"__xst" : __xer ,"__xme" : 'enregistrement non trouvé : suppression impossible [1386 ' + this.__ig1.nl2() + ']'});
        }
        /*  */
        let tas=await this.test_avant_supprimer( mat , d , fo1 , tt1386.__xva[0] , __db1 );
        if(tas.__xst !== __xsu){
        ...
        */
        ...
        let __aavc=await this.actions_apres_supprimer( mat , d , fo1 , tt1386.__xva[0] , __db1 );
    ...
    */
    async creer1( mat , d ){
        ...
        let criteres_1378={
            "donnees" : [{"chp_nom_dossier" : fo1.chp_nom_dossier === '' ? ( null ) : ( fo1.chp_nom_dossier ) ,"chx_parent_dossier" : fo1.chx_parent_dossier}]
        };
        /*  */
        await __db1.exec( 'BEGIN TRANSACTION;' );
        let tt1378=await this.__ig1.sql_iii(
        ...
        */
        ...
        let __aapc=await this.action_apres_creer( mat , d , tt1378['nouvel_id'] , fo1 , __db1 );
