...
class __gi1{
    ...
    */
    constructor(){
        ...
        this.#liste_des_modules_dynamiques['__gi1']={"objet1" : this};
                ...
                */
                ...
                for( let i=d + 1 ; i < mat.length ; i=mat[i][12] ){
                    ...
                    try{
                        ...
                        this.ajoute_message( {
                                "__xst" : __xer ,
                                "__xme" : 'Impossible d\'appeler la fonction "' + mat[i][1] + '" du module "' + m1 + '" <br />Existe-t-elle ? est-elle publique ? <br />' + this.nl2( e )
                            } );
                        this.affiche_les_messages();
                        return({"__xst" : __xer});
                    }
                    if(obj){
                        if(obj.hasOwnProperty( '__xst' ) && obj.__xst !== __xsu){
                            ...
                            this.ajoute_message( {
                                    "__xst" : __xer ,
                                    "__xme" : 'Impossible d\'appeler la fonction "' + mat[i][1] + '" du module "' + m1 + '" <br />Existe-t-elle ? est-elle publique ? <br />' + this.nl2()
                                } );
                            this.affiche_les_messages();
                            return({"__xst" : __xer});
                        }else{
...
//                                        this.ajoute_message( {"__xst" : __xer ,"__xme" : this.nl2()} );
    ...
    */
    #apres_traite_message_recupere_du_worker( le_message_recu_du_worker ){
        ...
        if(le_message_recu_du_worker.data.hasOwnProperty( '__xac' ) && le_message_recu_du_worker.data.__xac !== ''){
            let obj1=this.__rev1.rev_tm( le_message_recu_du_worker.data.__xac );
            if(obj1.__xst === __xsu){
                        ...
                        if(lst[i]['hasAttribute']( 'data-rev_click' ) || lst[i]['hasAttribute']( 'data-action_option' )){
                            for( let j=0 ; j < tableau.length && trouve === -1 ; j++ ){
                                if(lst[i].getAttribute( 'data-rev_click' ) && lst[i].getAttribute( 'data-rev_click' ).indexOf( tableau[j].module ) >= 0){
                                    if(!(tableau[j].module === '__gi1' || tableau[j].module === '__fnt1')){
                                        trouve=i;
                                    }
    ...
    */
    html_principal(){
        ...
        t+='                        <div data-id_menu="-1" class="rev_bouton_carre" data-rev_click="m1(n1(__gi1),f1(affiche_page_d_accueil()))" title="page d\'accueil">' + this.les_svg.maison + '</div>';
        t+='                        <div id="vv_bouton_messages" class="rev_bouton_carre" data-rev_click="m1(n1(__gi1),f1(affiche_ou_masque_les_messages()))" title="affiche ou masque les messages">' + this.les_svg.message + '</div>';
        t+='                    </div>';
        ...
        t+='      <div data-id_menu="-4" class="rev_bouton_carre" style="" data-rev_click="m1(n1(__gi1),f1(defilement_bas()))">' + this.les_svg.deliler_vers_le_bas + '</div>';
        t+='      <div data-id_menu="-5" class="rev_bouton_carre" style="" data-rev_click="m1(n1(__gi1),f1(defilement_haut()))">' + this.les_svg.defiler_vers_le_haut + '</div>';
        t+='      <div data-id_menu="-6" class="rev_bouton_carre" style="" data-rev_click="m1(n1(__gi1),f1(page_haut()))">' + this.les_svg.haut_de_page + '</div>';
    ...
    */
    css1(){
        ...
        */
        ...
        t+='h1{font-size:1.6em;margin-bottom:0.6em;line-height:1.1em;}';
    ...
    */
    choisir_dans_sous_fenetre1( mat , d ){
        ...
        window.parent.__gi0.fermer_la_sous_fenetre();
        return({"__xst" : __xsu});
    }
    /*
      =============================================================================================================
    ...
    */
    lien_parent( module1 , champ_fils , id_span_libelle ){
        ...
        /* 📁 */
        o1+='<div class="rev_b_svg yy__2" data-rev_click="m1(n1(__gi1),f1(';
