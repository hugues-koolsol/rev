...
print('hella');`;
    ...
    */
    entree_module( mat , d ){
        ...
        /*  */
        t+='    <div class="rev_bouton" style="float:right;" data-rev_click="m1(n1(x_ecran_source_vers_programme1),f1(donnees_de_test1()))" title="charger les données de test" >pgm js</div>    ';
        t+='    <div class="rev_bouton" style="float:right;" data-rev_click="m1(n1(x_ecran_source_vers_programme1),f1(donnees_de_test2()))" title="charger les données de test2" >pgp php</div>';
        t+='  </div>';
        ...
        if(this.__gi1.stockage_local.hasOwnProperty( 'zones_sauvegardées' )
               && this.__gi1.stockage_local['zones_sauvegardées'].hasOwnProperty( 'x_ecran_source_vers_programme1' )
               && this.__gi1.stockage_local['zones_sauvegardées'].x_ecran_source_vers_programme1.hasOwnProperty( 'valeur' )
        ){
            t+=this.__gi1.stockage_local['zones_sauvegardées']['x_ecran_source_vers_programme1']['valeur'].replace( /</g , '&lt;' ).replace( />/g , '&gt;' ).replace( /"/g , '&quot;' );
        }
        t+='</textarea>';
        t+='</div>';
        t+='<div class="yy_conteneur_txtara">';
        ...
        t+='m1(n1(x_ecran_source_vers_programme1),f1(';
