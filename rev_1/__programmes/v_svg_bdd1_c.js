...
class v_svg_bdd1{
    ...
    */
    ...
    #liste_des_meta_table=[
        ...
        {
                "nom_du_meta_table" : 'contient_televersement' ,
                "exemple" : '"1 pour oui"' ,
                "zone_html2" : 'un_zero' ,
    ...
    requete_sur_base1( mat , d , le_colis1=null ){
        ...
        if('dictinct_count' === utilite){
            ...
            for(var i in le_colis1.__xva.lignes){
                ...
                t+=')))" >' + this.__ig1.les_svg.editer + '</div>';
                t+=t0;
                /*  */
                t+='</td>';
                /*  */
    ...
    */
    constructor( mat , d , __ig1 ){
        this.__ig1=__ig1;
        this.__m_rev_vers_sql1=new w_rev_vers_sql1( '__m_rev_vers_sql1' , this.__ig1 );
    ...
    */
    ...
    /*
      =============================================================================================================
    */
    init001( id_du_svg , nom_de_la_div_contenant_le_svg ){
        /* mat , d ]{ */
        /* console.log( 'init001' ); */
        this.#div_svg=document.getElementById( nom_de_la_div_contenant_le_svg );
        this.#taille_bordure=this.__ig1.css_dimensions.t_border;
        ...
        */
        ...
        this.#hauteur_de_boite=this.__ig1.css_dimensions.t_police + 2 * this.__ig1.css_dimensions.t_padding + 2 * this.#taille_bordure;
    ...
    */
    modale_ajouter_une_table(){
        ...
        this.__ig1.global_modale2.showModal();
    }
    /*
      =============================================================================================================
    */
    ...
    changer_le_nom_de_table_en_base_et_sur_le_svg( mat , d ){
        ...
        if(nouveau_nom !== nom_de_la_table){
            ...
            if(trouve === false){
                ...
                cmd+='))))';
                let obj={"__xac" : cmd ,"__xva" : {"source_sql" : source_sql ,"operation_table" : 'renommer_une_table'}};
                this.__ig1.envoyer_un_colis_au_worker( obj );
                return({"__xst" : __xsu});
            }
        }
                    ...
                    if(lst[i].getAttribute( 'donnees_rev_de_l_index' )){
                        ...
                        */
                        ...
                        if(obj1.__xst === __xsu){
                            ...
                            var obj2=this.__ig1.__rev1.matrice_vers_source_rev1( mat2 , 0 , false , 1 );
                            if(obj2.__xst === __xsu){
    ...
    */
    #recuperer_prochain_id_svg(){
        ...
        for( i=0 ; i < lst.length ; i++ ){
            if(lst[i].id && this.__ig1.est_num( lst[i].id )){
    ...
    */
    ajouter_un_champ_de_modale( mat ){
        ...
        let objxx=this.verifier_doublon_champ_index( nom_du_champ );
        ...
        if(trouve === true){
            return({"__xst" : __xer ,"__xme" : 'le champ existe déjà'});
        }
        document.getElementById( 'zone_message_ajouter_un_champ' ).innerHTML='';
        if(typologie === '' || nom_du_champ === '' || espece_du_champ === '' || genre === ''){
            return({
                    "__xst" : __xer ,
                    "__xme" : 'Vous devez choisir un type de champ et une typologie et renseigner le nom du champ [' + this.__ig1.nl2() + ']'
                });
        }
        if(document.getElementById( 'table_mère' ).value !== '' || document.getElementById( 'champ_père' ).value !== ''){
            if(document.getElementById( 'table_mère' ).value === '' || document.getElementById( 'champ_père' ).value === ''){
                return({"__xst" : __xer ,"__xme" : 'erreur sur la table mère ou le champ père'});
            }
            /*
            ...
            */
            ...
            if(trouve === false){
                return({"__xst" : __xer ,"__xme" : 'table mère ou champ père non trouvé'});
            }
        }
        var indice_courant=this.#recuperer_prochain_id_svg();
        var rev='';
        ...
        rev+='    libelle_du_champ(\'' + document.getElementById( 'meta_ajouter__libelle_du_champ' ).value.replace( /\\/g , '\\\\' ).replace( /\'/g , '\\\'' ) + '\')';
    ...
    */
    changer_le_nom_de_champ_de_modale( mat ){
        ...
        var nouveau_nom=document.getElementById( 'nouveau_nom' ).value;
        let objxx=this.verifier_doublon_champ_index( nouveau_nom );
        if(objxx.__xst !== __xsu){
            return objxx;
        }
        var ancien_nom=document.getElementById( 'ancien_nom' ).value;
        if(nouveau_nom !== ancien_nom){
            ...
            if(trouve === false){
                ...
                cmd+='    nouveau_nom(\'' + nouveau_nom.replace( /\\/g , '\\\\' ).replace( /\'/g , '\\\'' ) + '\')';
                cmd+='))))';
                let obj={"__xac" : cmd ,"__xva" : {"source_sql" : source_sql ,"operation_table" : 'renommer_un_champs'}};
                this.__ig1.envoyer_un_colis_au_worker( obj );
                return({"__xst" : __xsu});
            }
        }
    ...
    */
    ...
    /*
      =============================================================================================================
    */
    verifier_doublon_champ_index( nom_du_champ ){
        let doublon_champ_index_deja_affiche=[];
        let message_doublons_champs=[];
        for( let i=0 ; i < this.tableau_des_bases_tables_champs.length ; i++ ){
            if(this.#id_bdd_de_la_base_en_cours === this.tableau_des_bases_tables_champs[i][0]){
                for( let j=i + 1 ; j < this.tableau_des_bases_tables_champs.length ; j++ ){
                    if(this.#id_bdd_de_la_base_en_cours === this.tableau_des_bases_tables_champs[j][0]){
                        if(this.tableau_des_bases_tables_champs[i][2] === nom_du_champ){
                            if(!doublon_champ_index_deja_affiche.includes( this.tableau_des_bases_tables_champs[i][2] )){
                                message_doublons_champs.push( '<b>' + this.tableau_des_bases_tables_champs[i][2] + '</b> ' + this.tableau_des_bases_tables_champs[i][0] + ' ' + this.tableau_des_bases_tables_champs[i][1] );
                                doublon_champ_index_deja_affiche.push( this.tableau_des_bases_tables_champs[i][2] );
                            }
                        }
                    }
                }
        ...
        if(message_doublons_champs.length > 0){
            this.__ig1.affiche_les_messages( {"__xst" : __xal ,"__xme" : 'Attention, doublons<br />' + message_doublons_champs.join( '<br />' )} );
            return({"__xst" : __xer ,"__xme" : 'Attention, ce nom de champ est déjà utilisé comme index'});
        }
        return({"__xst" : __xsu});
    }
    /*
    ...
    */
    modifier_un_index_de_modale( mat , d ){
        ...
        if(document.getElementById( 'liste_des_champs_de_l_index' ).value.trim() === ''){
            return({"__xst" : __xer ,"__xme" : 'la liste des champs est vide ' + this.__ig1.nl2()});
        }
    ...
    */
    ...
    /*
      =============================================================================================================
      Quand un index ne fonctionne pas à cause de doublons, il faut les rechercher 
      
    */
    analyser_l_index( mat , d ){
        let id_svg_rectangle_de_l_index=0;
        let nom_de_l_index='';
        let nom_de_la_table='';
        let id_svg_conteneur_table=0;
        let id_svg_de_la_base_en_cours=0;
        for( let i=d + 1 ; i < mat.length ; i++ ){
            if(mat[i][1] === 'id_svg_rectangle_de_l_index' && mat[i][2] === 'f' && mat[i][8] === 1 && mat[i + 1][2] === 'c'){
                id_svg_rectangle_de_l_index=parseInt( mat[i + 1][1] , 10 );
            }else if(mat[i][1] === 'id_svg_de_la_base_en_cours' && mat[i][2] === 'f' && mat[i][8] === 1 && mat[i + 1][2] === 'c'){
                id_svg_de_la_base_en_cours=parseInt( mat[i + 1][1] , 10 );
            }else if(mat[i][1] === 'id_svg_conteneur_table' && mat[i][2] === 'f' && mat[i][8] === 1 && mat[i + 1][2] === 'c'){
                id_svg_conteneur_table=parseInt( mat[i + 1][1] , 10 );
            }else if(mat[i][1] === 'nom_de_l_index' && mat[i][2] === 'f' && mat[i][8] === 1 && mat[i + 1][2] === 'c'){
                nom_de_l_index=mat[i + 1][1];
        ...
        if(id_svg_rectangle_de_l_index > 0 && id_svg_conteneur_table > 0){
            let primary_key='';
            let lst=document.getElementById( id_svg_conteneur_table ).getElementsByTagName( 'rect' );
            for( let i=0 ; i < lst.length ; i++ ){
                if(lst[i].getAttribute( 'type_element' )
                       && 'rectangle_de_champ' === lst[i].getAttribute( 'type_element' )
                       && lst[i].getAttribute( 'primary_key' )
                       && '1' === lst[i].getAttribute( 'primary_key' )
                ){
                    primary_key=lst[i].getAttribute( 'nom_du_champ' );
                    break;
                }
            }
            if(primary_key === ''){
                return(this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : 'le champ clé primaire n\'a pas été trouvé pour cette table'} ));
            }
            let element_svg_rectangle_de_l_index=document.getElementById( id_svg_rectangle_de_l_index );
            let champs=element_svg_rectangle_de_l_index.getAttribute( 'champs' );
            let liste_des_champs=champs.split( ',' );
            ...
            for( let i=0 ; i < liste_des_champs.length ; i++ ){
                ...
                liste_des_champs[i]=liste_des_champs[i].replace( /\'/g , '' );
            }
            let liste_des_champs_avec_type={};
            for( let i=0 ; i < liste_des_champs.length ; i++ ){
                for( let j=0 ; j < lst.length ; j++ ){
                    if(lst[j].getAttribute( 'type_element' )
                           && 'rectangle_de_champ' === lst[j].getAttribute( 'type_element' )
                           && lst[j].getAttribute( 'nom_du_champ' ) === liste_des_champs[i]
                    ){
                        liste_des_champs_avec_type[lst[j].getAttribute( 'nom_du_champ' )]={"espece_du_champ" : lst[j].getAttribute( 'espece_du_champ' )};
                    }
                }
            }
            console.log( 'liste_des_champs_avec_type=' , liste_des_champs_avec_type );
            source_sql='SELECT ' + les_champs + '\r\n';
            source_sql+='FROM ' + nom_de_la_table + ' T0 , ' + nom_de_la_table + ' T1 \r\n';
            source_sql+='WHERE T0.' + primary_key + ' <> T1.' + primary_key + ' \r\n';
            les_champs='';
            for( let i=0 ; i < liste_des_champs.length ; i++ ){
                les_champs+='AND T0.' + liste_des_champs[i].replace( /\'/g , '' ) + ' =  T1.' + liste_des_champs[i].replace( /\'/g , '' ) + '\r\n';
            }
            source_sql+=les_champs + '\r\n';
            console.log( 'source_sql=' , source_sql );
            source_sql+=' LIMIT 100';
            let obj={
                 /*  */
                "__xac" : 'pm1(m1(n1(' + this.moi + '),f1(operation_table_dans_base(id_bdd_de_la_base(' + this.#id_bdd_de_la_base_en_cours + ')))))' ,
                "__xva" : {
                     /*  */
                    "source_sql" : source_sql ,
                    "operation_table" : 'analyser_l_index' ,
                    "liste_des_champs" : liste_des_champs ,
                    "primary_key" : primary_key ,
                    "id_svg_rectangle_de_l_index" : id_svg_rectangle_de_l_index ,
                    "id_svg_conteneur_table=" : id_svg_conteneur_table ,
                    "nom_de_la_table" : nom_de_la_table ,
                    "id_svg_de_la_base_en_cours" : id_svg_de_la_base_en_cours ,
    ...
    */
    ajouter_en_bdd_le_champ_de_modale( mat , d ){
        ...
        if(a.getAttribute( 'type_element' ) && a.getAttribute( 'type_element' ) === 'rectangle_de_champ'){
            ...
            var obj1=this.__ig1.__rev1.rev_tm( definition_du_champ );
            if(obj1.__xst === __xsu){
                var obj2=this.__m_rev_vers_sql1.c_tab_vers_sql( obj1.__xva , {} );
                if(obj2.__xst === __xsu){
        ...
        */
        ...
        for(i in this.#arbre[this.#id_bdd_de_la_base_en_cours].arbre_svg){
            ...
            if(elt.proprietes
                ...
                */
                var obj=this.__ig1.__rev1.rev_tm( elt.proprietes.donnees_rev_de_l_index );
                if(obj.__xst === __xsu){
                    var j=0;
                                    ...
                                    */
                                    if(obj.__xva[obj.__xva[k][7]][8] === 1){
                                        ...
                                        */
                                        ...
                                        var nouvelle_matrice=this.__ig1.__rev1.supprimer_un_element_de_la_matrice( obj.__xva , k , 0 );
    ...
    */
    modifier_un_champ_de_modale( mat , d ){
        ...
        if(base_mere !== '' && this.#id_bdd_de_la_base_en_cours !== base_mere){
            ...
            if(table_mere !== ''){
                ...
                if(document.getElementById( 'champ_père' ).value !== ''){
                    ...
                    for( j=0 ; j < lst2.length ; j++ ){
                        if(lst2[j].id && this.__ig1.est_num( lst2[j].id )){
                    ...
                    if(reference_amont_aval === -1){
                        ...
                        */
                        ...
                        max_id_svg++;
                        if(table_mere === 'tbl_grandeurs'){
                            couleur='stroke:gold;stroke-opacity:0.4';
                            if(nn !== '1'){
                                couleur='stroke:gold;stroke-opacity:0.2';
                            }
                        }
                        this.#arbre[this.#id_bdd_de_la_base_en_cours].arbre_svg[max_id_svg]={
                            "type" : 'path' ,
                        ...
                        this.#arbre[this.#id_bdd_de_la_base_en_cours].arbre_svg[id_du_path + 1].proprietes['style']=couleur + ';stroke-width:' + (this.#taille_bordure * 3) + ';fill:transparent;;stroke-linejoin:round;stroke-linecap:round;';
        ...
        let fonction_pour_liste1=document.getElementById( 'meta_modifier__fonction_pour_liste1' ).value.trim();
        if(fonction_pour_liste1 !== ''){
            /*
              s'il existe une fonction js pour le liste, il faut vérifier qu'on peur la convertir en rev
              hugues
            */
            let tableau_des_commentaires_js=[];
            let obj0=null;
            try{
                let le_parseur=window.acorn.Parser;
                obj0=le_parseur.parse( fonction_pour_liste1 , {"ecmaVersion" : 'latest' ,"sourceType" : 'module' ,"ranges" : false ,"onComment" : tableau_des_commentaires_js} );
            }catch(e){
                return({
                        "__xst" : __xer ,
                        "__xme" : 'le source javascript de la fonction pour liste n\'a pas pu interprétée correctement' + this.__ig1.nl2( e )
                    });
            }
            /* on transforme le ast du js en rev */
            let obj1=this.#objet_conversion_ast_js_vers_rev.traite_ast( obj0.body , tableau_des_commentaires_js , {} );
            if(obj1.__xst !== __xsu){
        ...
        */
        ...
        let obj={
            ...
            "libelle_du_champ" : document.getElementById( 'meta_modifier__libelle_du_champ' ).value ,
    ...
    */
    modale_modifier_l_index( mat , d ){
        ...
        var i=0;
        for( let i=0 ; i < lst.length && id_element_svg === 0 ; i++ ){
        ...
        for( let i=0 ; i < lst.length ; i++ ){
            if(lst[i].nodeName.toLowerCase() === 'rect' && 'rectangle_d_index' === lst[i].getAttribute( 'type_element' )){
                ...
                if(lst[i].getAttribute( 'donnees_rev_de_l_index' ) && lst[i].getAttribute( 'donnees_rev_de_l_index' ) !== ''){
                    var obj_matrice_de_l_index=this.__ig1.__rev1.rev_tm( lst[i].getAttribute( 'donnees_rev_de_l_index' ) );
                    if(obj_matrice_de_l_index.__xst === __xsu){
                        for( let k=1 ; k < obj_matrice_de_l_index.__xva.length ; k=obj_matrice_de_l_index.__xva[k][12] ){
        ...
        */
        cmd='';
        cmd+='m1(n1(\'' + this.moi + '\'),f1(analyser_l_index(';
        cmd+=' id_svg_rectangle_de_l_index(' + id_svg_rectangle_de_l_index + '),';
        cmd+=' nom_de_l_index(' + nom_de_l_index.replace( /\\/g , '\\\\' ).replace( /\'/g , '\\\'' ) + '),';
        cmd+=' nom_de_la_table(' + nom_de_la_table.replace( /\\/g , '\\\\' ).replace( /\'/g , '\\\'' ) + '),';
        cmd+=' id_svg_conteneur_table(' + id_svg_conteneur_table + ')';
    ...
    */
    supprimer_en_bdd_le_champ_de_modale( mat , d ){
        ...
        /*
          si le champ est le dernier de la table, il vaut mieux éviter à cause d'un bug sqlite
        */
    ...
    lister_les_champs_de_la_table( mat , d ){
        ...
        if(zone_liste_des_champs !== '' && zone_cible !== '' && zone_select !== ''){
            ...
            if(document.getElementById( zone_select ).value !== ''){
                ...
                let num_base_en_cours=parseInt( this.#id_bdd_de_la_base_en_cours , 10 );
                let num_base=parseInt( chi_id_base , 10 );
                if(num_base_en_cours === num_base){
                    document.getElementById( 'base_mère' ).value='';
                }else{
                    document.getElementById( 'base_mère' ).value=num_base;
                }
    ...
    */
    modale_modifier_le_champ( mat , d ){
        ...
        var l=0;
        /* on ne peut pas chercher un tagname #text */
        var lst=conteneur_de_champ.getElementsByTagName( '*' );
        let les_meta_rev='';
        for( let i=0 ; i < lst.length && id_element_texte_du_nom_de_champ_svg === 0 ; i++ ){
            ...
            }else if(lst[i].nodeName.toLowerCase() === 'rect' && 'rectangle_de_champ' === lst[i].getAttribute( 'type_element' )){
                les_meta_rev=lst[i].getAttribute( 'donnees_rev_du_champ' );
            }
        }
        ...
        */
        ...
        var table_mere='';
        var champ_pere='';
        if(les_meta_rev.indexOf( 'reference_externe(' ) >= 0){
            let o1=this.__ig1.__rev1.rev_tm( les_meta_rev );
            if(o1.__xst === __xsu){
                let tab1=o1.__xva;
                let l02=tab1.length;
                for( let i=0 ; i < l02 ; i++ ){
                    if(tab1[i][1] === 'reference_externe' && tab1[i][2] === 'f' && tab1[i][8] === 3){
        ...
        let libelle_du_champ=obj_donnees_rev_du_champ.libelle_du_champ;
        ...
        let description_du_champ=obj_donnees_rev_du_champ.description_du_champ;
        let fonction_pour_liste1=obj_donnees_rev_du_champ.fonction_pour_liste1;
        ...
        for(let i in this.__ig1.__liste_des_genres){
            ...
            l_option+=' value="' + this.__ig1.__liste_des_genres[i].chi_id_genre + '"';
            l_option+=' data-genre="' + this.__ig1.fi2( JSON.stringify( this.__ig1.__liste_des_genres[i] ) ) + '"';
            l_option+='>(' + this.__ig1.__liste_des_genres[i].chi_id_genre + ') ';
            l_option+=this.__ig1.__liste_des_genres[i].chp_nom_genre;
            l_option+='</option>';
            tableau_des_genres.push( [this.__ig1.__liste_des_genres[i].che_ordre_genre,l_option] );
        }
        ...
        */
        ...
        if(description_du_champ !== ''){
            if(description_du_champ.substr( 0 , 1 ) === "'"){
                ...
                description_du_champ=description_du_champ.replace( /\\\'/g , '\'' ).replace( /\\\\/g , '\\' );
            }else{
                return({"__xst" : __xer ,"__xme" : "erreur sur la description du champ"});
            }
        }
    ...
    recuperer_les_tableaux_des_bases( mat , d , le_message_serveur ){
        ...
        for(var a2 in par['tableau2']){
            if(tables.hasOwnProperty( a2 )){
                ...
                this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : ' la table ' + a2 + ' est absente de la base physique[tableau1] '} );
                differences_entre_les_tables=true;
            }
        }
        for(var a0 in tables){
            if(tables[a0].presente_dans_tableau_2 === false){
                this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : ' la table ' + a0 + ' est absente du schema svg[tableau2]'} );
                differences_entre_les_tables=true;
            }
        }
        if(differences_entre_les_tables === true){
            this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : ' des tables ne sont pas les mêmes'} );
        }else{
            this.__ig1.ajoute_message( {"__xst" : __xsu ,"__xme" : ' il y a les mêmes tables dans les deux tableaux'} );
        }
        ...
        */
                ...
                for(var ind_champ in par['tableau2'][a0]['liste_des_champs']){
                    if(champs.hasOwnProperty( ind_champ )){
                        ...
                        if(champs[ind_champ].champs2['type'].toLowerCase() !== champs[ind_champ].champs1['type'].toLowerCase()
                               ...
                               || champs[ind_champ].champs2['cle_etrangere'].hasOwnProperty( 'cid' ) !== champs[ind_champ].champs1['cle_etrangere'].hasOwnProperty( 'cid' )
                               || champs[ind_champ].champs2['cle_etrangere'].hasOwnProperty( 'cid' ) === champs[ind_champ].champs1['cle_etrangere'].hasOwnProperty( 'cid' )
                                   && champs[ind_champ].champs2['cle_etrangere'].hasOwnProperty( 'cid' ) === true
                                   && !(champs[ind_champ].champs2['cle_etrangere']['table'] === champs[ind_champ].champs1['cle_etrangere']['table']
                                           && champs[ind_champ].champs2['cle_etrangere']['from'] === champs[ind_champ].champs1['cle_etrangere']['from']
                                           && champs[ind_champ].champs2['cle_etrangere']['to'] === champs[ind_champ].champs1['cle_etrangere']['to'])
                        ){
                                ...
                                if( typeof champs[champ].champs1[typechamp] === 'object'){
                                    ...
                                    if(champs[champ].champs1[typechamp] === champs[champ].champs2[typechamp]){
                                        ...
                                        if('cid' === typechamp){
                                            ...
                                            this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : ' pour la table ' + a0 + ' , le champ ' + champ + ' , le type ' + typechamp + ' on a une différence'} );
                                        }
                                    }
                                }
                            }
        ...
        for(var ref in references){
            ...
            for(var nom_de_la_table in par[references[ref]]){
                ...
                t+='<th style="text-align:left;" title="clé étrangère">ce</th>';
                        ...
                        if(references[ref] === 'tableau1'){
                            ...
                            if(par['tableau2'].hasOwnProperty( nom_de_la_table ) && par['tableau2'][nom_de_la_table].liste_des_champs[nom_du_champ]){
                                if(par['tableau2'][nom_de_la_table].liste_des_champs[nom_du_champ][proprietes_a_tester[ind_prop]] !== par[references[ref]][nom_de_la_table].liste_des_champs[nom_du_champ][proprietes_a_tester[ind_prop]]
                                    ...
                                    if(proprietes_a_tester[ind_prop] === 'cle_etrangere'){
                                        if(par[references[ref]][nom_de_la_table].liste_des_champs[nom_du_champ][proprietes_a_tester[ind_prop]].hasOwnProperty( 'cid' )
                                        ){
                                            let tt1=par[references[ref]][nom_de_la_table].liste_des_champs[nom_du_champ][proprietes_a_tester[ind_prop]];
                                            t+='<td ' + le_style + ' title="reference(' + tt1.table + ',' + tt1.to + ')">1</td>';
                                        }else{
                                            t+='<td ' + le_style + ' > </td>';
                                        }
                                    }else{
                                    ...
                                    if(par[references[ref]][nom_de_la_table].liste_des_champs[nom_du_champ][proprietes_a_tester[ind_prop]] === null
                                        ...
                                        if(proprietes_a_tester[ind_prop] === 'cle_etrangere'){
                                            t+='<td ' + le_style + '  class="' + la_class_quoi + '">ce</td>';
                                        }else{
                            ...
                            if(proprietes_a_tester[ind_prop] === 'dflt_value'
                                ...
                                t+='<td ' + le_style + '  class="' + la_class_quoi + '"></td>';
                            }else if(proprietes_a_tester[ind_prop] === 'cle_etrangere'){
                                if(par[references[ref]][nom_de_la_table].liste_des_champs[nom_du_champ][proprietes_a_tester[ind_prop]].hasOwnProperty( 'cid' )
                                ){
                                    let tt1=par[references[ref]][nom_de_la_table].liste_des_champs[nom_du_champ][proprietes_a_tester[ind_prop]];
                                    t+='<td ' + le_style + ' title="reference(' + tt1.table + ',' + tt1.to + ')">1</td>';
    ...
    */
    comparer_la_base_physique_et_la_base_virtuelle( mat , d ){
        ...
        var obj2=this.__ig1.__rev1.rev_tm( obj1.__xva );
        if(obj2.__xst !== __xsu){
            return({"__xst" : __xer ,"__xme" : this.__ig1.nl2()});
        }
        ...
        let obj={
            ...
            "__xva" : {"source_base_sql" : obj3.__xva ,"id_bdd_de_la_base_en_cours" : id_bdd_de_la_base_en_cours}
        };
        this.__ig1.envoyer_un_colis_au_worker( obj );
        return({"__xst" : __xsu});
    }
    ...
    */
    creer_la_base_sur_disque_a_partir_du_shema( mat , d , le_colis1=null ){
        ...
        obj={
            ...
            "__xva" : {
                 /*  */
                "source_sql_de_la_base" : obj3.__xva ,
    ...
    */
    reecrire_la_base_a_partir_du_shema( mat ){
        ...
        let obj1={
             /*  */
            "__xac" : 'pm1(m1(n1(' + this.moi + '),f1(reconstruire_la_base_a_partir_du_shema_sur_disque())))' ,
            "__xva" : {
                 /*  */
                "id_bdd_de_la_base" : this.#id_bdd_de_la_base_en_cours ,
    ...
    */
    exécution_d_une_requete_sql_directement_sur_la_base( mat , d ){
        ...
        if(!(nom_de_zone !== '' && id_bdd_de_la_base_en_cours > 0 && document.getElementById( nom_de_zone ))){
            return({"__xst" : __xer ,"__xme" : 'la zone doit contenir une commande sql'});
        }
    ...
    */
    voir_la_définition_de_la_base_à_partir_de_ce_schema( mat , d ){
        ...
        let obj=this.#creer_rev_de_la_base_a_partir_de_svg( this.#id_bdd_de_la_base_en_cours );
        if(obj.__xst !== __xsu){
            return({"__xst" : __xer ,"__xme" : 'erreur de reconstruction du rev à partir du schema [' + this.__ig1.nl2() + ']'});
        }
        /*
        */
        var texte_rev=obj.__xva;
        var obj2=this.__ig1.__rev1.rev_tm( texte_rev );
        if(obj2.__xst !== __xsu){
            return({"__xst" : __xer ,"__xme" : 'erreur de construction de la matrice du rev [' + this.__ig1.nl2() + ']'});
        }
        /*
        */
        var obj3=this.__m_rev_vers_sql1.c_tab_vers_sql( obj2.__xva , {} );
        ...
        t+='<div class="yy_conteneur_txtara">';
        t+='    <div>\r\n';
        t+=this.__ig1.__fnt1.boutons_rev3( 'cht_rev_source' );
        t+='    </div>\r\n';
        t+='<textarea data-editeur1="rev"  id="cht_rev_source" rows="10" cols="50" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">' + this.__ig1.fi2( texte_rev ) + '</textarea>';
        t+='</div>\r\n';
        /*  */
        t+='<div class="yy_conteneur_txtara">';
        t+='    <div>\r\n';
        t+=this.__ig1.__fnt1.boutons_edition1( 'cht_genere_source' );
        t+='    </div>\r\n';
        t+='<textarea data-editeur1="source_editeur1"  id="cht_genere_source" rows="10" cols="50" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">' + this.__ig1.fi2( source_sql_de_la_base ) + '</textarea>';
        t+='</div>\r\n';
        /*  */
        this.__ig1.affiche_sous_fenetre1( t );
        document.getElementById( 'vv_sous_fenetre1' ).style.width='80%';
        return({"__xst" : __xsu});
    }
    /*
      =============================================================================================================
    */
    #modifier_une_table_en_bdd( nom_de_la_table , txt_ordre_original , txt_ordre_modifie , liste_ordre_modifie , mode_supression_de_champ , en_base_et_sur_schema ){
        ...
        */
        ...
        var obj1=this.__ig1.__rev1.rev_tm( nouveau_rev );
        if(obj1.__xst === __xsu){
            var obj2=this.__m_rev_vers_sql1.c_tab_vers_sql( obj1.__xva , {} );
            if(obj2.__xst === __xsu){
        ...
        for( let i=0 ; i < tab_des_index_rev.length ; i++ ){
            var obj1=this.__ig1.__rev1.rev_tm( tab_des_index_rev[i] );
            if(obj1.__xst === __xsu){
                var obj2=this.__m_rev_vers_sql1.c_tab_vers_sql( obj1.__xva , {} );
                if(obj2.__xst === __xsu){
    ...
    */
    bouton_ordonner_les_champs_en_base_et_sur_le_svg( mat , d ){
        ...
        */
        ...
        var obj1=this.__ig1.__rev1.rev_tm( t0 );
        if(obj1.__xst === __xsu){
            var obj2=this.__m_rev_vers_sql1.c_tab_vers_sql( obj1.__xva , {} );
            if(obj2.__xst === __xsu){
                chaine_create_table=obj2.__xva + '\n';
        ...
        */
        ...
        var obj1=this.__ig1.__rev1.rev_tm( ttt );
        if(obj1.__xst === __xsu){
            var obj2=this.__m_rev_vers_sql1.c_tab_vers_sql( obj1.__xva , {} );
            if(obj2.__xst === __xsu){
        ...
        if(chaine_des_index !== ''){
            var obj1=this.__ig1.__rev1.rev_tm( chaine_des_index );
            if(obj1.__xst === __xsu){
                var obj2=this.__m_rev_vers_sql1.c_tab_vers_sql( obj1.__xva , {} );
                if(obj2.__xst === __xsu){
        ...
        for( let j=d + 1 ; j < l01 ; j=mat[j][12] ){
            if(mat[j][1] === 'id_bdd_de_la_base' && mat[j][2] === 'f' && mat[j][8] === 1 && mat[j + 1][2] === 'c'){
                ...
                if(mat[j][8] === 0){
                    ...
                    let obj3=this.__ig1.__rev1.matrice_vers_source_rev1( mat , j , true , j + 1 );
                    if(obj3.__xst === __xsu){
    ...
    */
    ajouter_l_index_dans_modale( mat , d ){
        ...
        if(liste_des_champs_de_l_index.trim() === ''){
            return({"__xst" : __xer ,"__xme" : 'la liste des champs doit être renseignée ' + this.__ig1.nl2()});
        }
        var nom_de_l_index=document.getElementById( 'nom_de_l_index' ).value;
        if(nom_de_l_index.trim() === ''){
            return({"__xst" : __xer ,"__xme" : 'le nom de l\'index doit être renseigné ' + this.__ig1.nl2()});
        }
        let trouve=false;
        var lst=document.getElementById( id_svg_conteneur_table ).getElementsByTagName( 'rect' );
        for( let i=0 ; i < lst.length ; i++ ){
    ...
    */
    ...
    /*
      =============================================================================================================
    */
    recupere_les_champs_virtuels( mat1 , nom_de_la_table , nom_table_reelle ){
        let liste_des_champs_de_la_table_virtuelle={};
        let ordre=0;
        let l02=mat1.length;
        for( let i=1 ; i < l02 ; i=mat1[i][12] ){
            if(mat1[i][1] === 'créer_table' && mat1[i][2] === 'f'){
                for( let j=i + 1 ; j < l02 ; j=mat1[j][12] ){
                    if(mat1[j][1] === 'nom_de_la_table' && mat1[j][2] === 'f' && mat1[j][8] === 1 && mat1[j + 1][2] === 'c'){
                        if(mat1[j + 1][1] === nom_de_la_table){
                            for( let k=i + 1 ; k < l02 ; k=mat1[k][12] ){
                                if(mat1[k][1] === 'champs' && mat1[k][2] === 'f'){
                                    for( let l=k + 1 ; l < l02 ; l=mat1[l][12] ){
                                        if(mat1[l][1] === 'champ' && mat1[l][2] === 'f'){
                                            for( let m=l + 1 ; m < l02 ; m=mat1[m][12] ){
                                                if(mat1[m][1] === 'nom_du_champ' && mat1[m][2] === 'f' && mat1[m][8] === 1 && mat1[m + 1][2] === 'c'){
                                                    liste_des_champs_de_la_table_virtuelle[mat1[m + 1][1]]={"dans_table_reelle" : false ,"est_primaire" : false ,"ordre" : ordre++};
                                                }
                                            }
                                        }
                                    }
        ...
        let liste_des_champs_de_la_table_reelle={};
        for( let i=1 ; i < l02 ; i=mat1[i][12] ){
            if(mat1[i][1] === 'créer_table' && mat1[i][2] === 'f'){
                for( let j=i + 1 ; j < l02 ; j=mat1[j][12] ){
                    if(mat1[j][1] === 'nom_de_la_table' && mat1[j][2] === 'f' && mat1[j][8] === 1 && mat1[j + 1][2] === 'c'){
                        if(mat1[j + 1][1] === nom_table_reelle){
                            for( let k=i + 1 ; k < l02 ; k=mat1[k][12] ){
                                if(mat1[k][1] === 'champs' && mat1[k][2] === 'f'){
                                    for( let l=k + 1 ; l < l02 ; l=mat1[l][12] ){
                                        if(mat1[l][1] === 'champ' && mat1[l][2] === 'f'){
                                            for( let m=l + 1 ; m < l02 ; m=mat1[m][12] ){
                                                if(mat1[m][1] === 'nom_du_champ' && mat1[m][2] === 'f' && mat1[m][8] === 1 && mat1[m + 1][2] === 'c'){
                                                    if(liste_des_champs_de_la_table_virtuelle.hasOwnProperty( mat1[m + 1][1] )){
                                                        liste_des_champs_de_la_table_virtuelle[mat1[m + 1][1]].dans_table_reelle=true;
                                                        for( let o=l + 1 ; o < l02 ; o=mat1[o][12] ){
                                                            if(mat1[o][1] === 'primary_key' && mat1[o][2] === 'f' && mat1[o][8] === 1 && mat1[o + 1][2] === 'c'){
                                                                liste_des_champs_de_la_table_virtuelle[mat1[m + 1][1]].est_primaire=true;
                                                            }
                                                        }
                                                    }
                                                }
        ...
        return liste_des_champs_de_la_table_virtuelle;
    }
    /*
      =============================================================================================================
    */
    operation_trigger_update_de_la_table_virtuelle( mat , d ){
        var l01=mat.length;
        var id_svg_conteneur_table=0;
        var nom_de_la_table_virtuelle='';
        var id_bdd_de_la_base_en_cours=0;
        var operation='';
        for( let i=d + 1 ; i < l01 ; i=mat[i][12] ){
            if(mat[i][1] === 'nom_de_la_table_virtuelle' && mat[i][2] === 'f' && mat[i][8] === 1 && mat[i + 1][2] === 'c'){
                nom_de_la_table_virtuelle=mat[i + 1][1];
            }else if(mat[i][1] === 'operation' && mat[i][2] === 'f' && mat[i][8] === 1 && mat[i + 1][2] === 'c'){
                operation=mat[i + 1][1];
            }else if(mat[i][1] === 'id_svg_conteneur_table' && mat[i][2] === 'f' && mat[i][8] === 1 && mat[i + 1][2] === 'c'){
                id_svg_conteneur_table=parseInt( mat[i + 1][1] , 10 );
        ...
        if(id_bdd_de_la_base_en_cours > 0
               && nom_de_la_table_virtuelle !== ''
               && nom_de_la_table_virtuelle.substr( nom_de_la_table_virtuelle.length - 4 , 4 ) === '_fts'
        ){
            let obj=this.#creer_rev_de_la_base_a_partir_de_svg( id_bdd_de_la_base_en_cours );
            if(obj.__xst === __xsu){
                let objrev=this.__ig1.__rev1.rev_tm( obj.__xva );
                if(objrev.__xst === __xsu){
                    let mat1=objrev.__xva;
                    /*
                      afr _fts pour nom_de_la_table_virtuelle
                    */
                    ...
                    for(let i in liste_des_champs_de_la_table_virtuelle){
                        if(liste_des_champs_de_la_table_virtuelle[i].dans_table_reelle === false){
                            return(this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : 'le champ "' + i + '" n\'est pas dans la table réelle'} ));
                        }
                        if(liste_des_champs_de_la_table_virtuelle[i].est_primaire === true){
                            champ_primaire=i;
                        }
                    }
                    if(champ_primaire === ''){
                        return(this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : 'le champ primaire n\'a pas été trouvé !'} ));
                    }
                    console.log( 'champ_primaire=' + champ_primaire );
                    let source_sql='';
                    if(operation === 'creer_trigger_update'){
                        source_sql+='CREATE TRIGGER update_' + nom_de_la_table_virtuelle + ' AFTER UPDATE ON ' + nom_table_reelle + ' BEGIN  \n';
                        source_sql+='UPDATE ' + nom_de_la_table_virtuelle + ' SET \n';
                        for(let i in liste_des_champs_de_la_table_virtuelle){
                            if(liste_des_champs_de_la_table_virtuelle[i].est_primaire === false){
                                source_sql+='  ' + i + ' = NEW.' + i + ' ,\r\n';
                            }
                        }
                        source_sql=source_sql.substr( source_sql , source_sql.length - 3 ) + '\r\n';
                        source_sql+='WHERE    ' + champ_primaire + ' = NEW.' + champ_primaire + ' ;\n';
                        source_sql+='END;\n';
                    }else if(operation === 'supprimer_trigger_update'){
                        source_sql+='DROP TRIGGER update_' + nom_de_la_table_virtuelle + ' ;\n';
                    }else{
                        return(this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : 'l\'opération ' + operation + ' n\'est pas prise en compte'} ));
                    }
                    console.log( 'source_sql=' + source_sql );
                    let obj={
    ...
    /*
      =============================================================================================================
    */
    operation_trigger_insert_de_la_table_virtuelle( mat , d ){
        var l01=mat.length;
        var id_svg_conteneur_table=0;
        var nom_de_la_table_virtuelle='';
        var id_bdd_de_la_base_en_cours=0;
            ...
            if(obj.__xst === __xsu){
                ...
                if(objrev.__xst === __xsu){
                    ...
                    */
                    ...
                    console.log( 'champ_primaire=' + champ_primaire );
                    let source_sql='';
                    if(operation === 'creer_trigger_insert'){
                        source_sql+='CREATE TRIGGER insert_' + nom_de_la_table_virtuelle + ' AFTER INSERT ON ' + nom_table_reelle + ' BEGIN  \n';
                        source_sql+='INSERT INTO ' + nom_de_la_table_virtuelle + ' ( \n';
                        for(let i in liste_des_champs_de_la_table_virtuelle){
                            source_sql+='  ' + i + ' ,\r\n';
                        }
                        source_sql=source_sql.substr( source_sql , source_sql.length - 3 ) + '\r\n';
                        ...
                        source_sql+=');\n';
                        source_sql+='END;\n';
                    }else if(operation === 'supprimer_trigger_insert'){
                        source_sql+='DROP TRIGGER insert_' + nom_de_la_table_virtuelle + ' ;\n';
                    }else{
                        return(this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : 'l\'opération ' + operation + ' n\'est pas prise en compte'} ));
                    }
                    console.log( 'source_sql=' + source_sql );
    ...
    /*
      =============================================================================================================
    */
    operation_trigger_delete_de_la_table_virtuelle( mat , d ){
        var l01=mat.length;
        var id_svg_conteneur_table=0;
        var nom_de_la_table_virtuelle='';
        var id_bdd_de_la_base_en_cours=0;
            ...
            if(obj.__xst === __xsu){
                ...
                if(objrev.__xst === __xsu){
                    ...
                    */
                    ...
                    console.log( 'champ_primaire=' + champ_primaire );
                    let source_sql='';
                    if(operation === 'creer_trigger_delete'){
                        source_sql+='CREATE TRIGGER delete_' + nom_de_la_table_virtuelle + ' AFTER DELETE ON ' + nom_table_reelle + ' BEGIN  \n';
                        source_sql+='DELETE FROM ' + nom_de_la_table_virtuelle + '\n';
                        source_sql+='WHERE    ' + champ_primaire + ' = OLD.' + champ_primaire + ' ;\n';
                        source_sql+='END;\n';
                    }else if(operation === 'supprimer_trigger_delete'){
                        source_sql+='DROP TRIGGER delete_' + nom_de_la_table_virtuelle + ' ;\n';
                    }else{
                        return(this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : 'l\'opération ' + operation + ' n\'est pas prise en compte'} ));
                    }
                    console.log( 'source_sql=' + source_sql );
    ...
    /*
      =============================================================================================================
    */
    insérer_les_donnees_dans_la_table_virtuelle( mat , d ){
        var l01=mat.length;
        var id_svg_conteneur_table=0;
        var nom_de_la_table_virtuelle='';
        var id_bdd_de_la_base_en_cours=0;
            ...
            if(obj.__xst === __xsu){
                ...
                if(objrev.__xst === __xsu){
                    ...
                    */
                    ...
                    source_sql=source_sql.substr( source_sql , source_sql.length - 3 ) + '\r\n';
                    source_sql+=' FROM  ' + nom_table_reelle + ';';
                    console.log( 'source_sql=' + source_sql );
                    let obj={
                        "__xac" : 'pm1(m1(n1(' + this.moi + '),f1(operation_table_dans_base(id_bdd_de_la_base(' + id_bdd_de_la_base_en_cours + ')))))' ,
    ...
    /*
      =============================================================================================================
    */
    voir_la_definition_de_la_table( mat , d ){
        this.__ig1.fermer_la_sous_fenetre();
        let id_svg_rectangle_de_la_table=0;
        let nom_de_la_table='';
        for( let i=0 ; i < mat.length ; i++ ){
        ...
        let t='';
        t+='<h1>définition de la table</h1>';
        /*  */
        t+='<div class="yy_conteneur_txtara">';
        t+='    <div>\r\n';
        t+=this.__ig1.__fnt1.boutons_rev3( 'cht_rev_source_rev' );
        t+='    </div>\r\n';
        t+='<textarea data-editeur1="rev"  id="cht_rev_source_rev" rows="10" cols="50" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">';
        /* t+=this.__ig1.fi2( texte_rev ); */
        t+='</textarea>';
        t+='</div>\r\n';
        /*  */
        t+='<div class="yy_conteneur_txtara">';
        ...
        t+=this.__ig1.__fnt1.boutons_edition1( 'cht_genere_source' );
        t+='    </div>\r\n';
        t+='<textarea data-editeur1="source_editeur1"  id="cht_genere_source" rows="10" cols="50" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">';
        /* t+=this.__ig1.fi2( source_sql_de_la_base ); */
        t+='</textarea>';
        t+='</div>\r\n';
        /*  */
        this.__ig1.affiche_sous_fenetre1( t );
    ...
    */
    modale_gerer_la_table( mat , d ){
        ...
        if(id_svg_conteneur_table < 0){
            debugger;
            return({"__xst" : __xer ,"__xme" : 'id_svg_conteneur_table non trouvé ' + this.__ig1.nl2()});
        }
        ...
        if(id_svg_du_texte === 0){
            return({"__xst" : __xer ,"__xme" : 'id_svg_du_texte non trouve' + id_svg_du_texte + this.__ig1.nl2()});
        }
        var t='';
        ...
        cmd+='m1(n1(x_ecran_generer_programmes1),f1(entree_module(';
        cmd+=' nom_de_la_table(\'' + nom_de_la_table.replace( /\\/g , '\\\\' ).replace( /\'/g , '\\\'' ) + '\'),';
        ...
        var cmd='';
        cmd+='m1(n1(__ig1),f1(fermer_la_sous_fenetre()))';
        cmd+='m1(n1(ecran_generer_souches),f1(entree_module(';
        cmd+=' nom_de_la_table(\'' + nom_de_la_table.replace( /\\/g , '\\\\' ).replace( /\'/g , '\\\'' ) + '\'),';
        cmd+=' chi_id_basedd(' + id_bdd_de_la_base_en_cours + '),';
        cmd+=')))';
        ...
        t+='<input id="nouveau_nom" type="text" class="yy_input1" value="' + nom_de_la_table + '" autocapitalize="off" />';
        ...
        for(let i in this.#liste_des_meta_table){
            ...
            if(this.#liste_des_meta_table[i].zone_html2 === 'text'){
                t+=' : <input class="yy_input1" id="vv_' + this.#liste_des_meta_table[i].nom_du_meta_table + '" type="text" autocapitalize="off" ';
                if(this.#liste_des_meta_table[i].nom_du_meta_table === 'rang_de_la_table'){
                ...
                if(nouveau_meta.hasOwnProperty( this.#liste_des_meta_table[i].nom_du_meta_table )){
                    contenu=nouveau_meta[this.#liste_des_meta_table[i].nom_du_meta_table];
                }
                if(contenu.trim() !== '' && this.#liste_des_meta_table[i].nom_du_meta_table === 'fonctions_coherence1'){
                    let obj1=this.#objet_conversion_rev_vers_js.c_rev_vers_js( contenu.replace( /¶CRLF¶/g , '\r\n' ).replace( /¶LF¶/g , '\n' ).replace( /¶CR¶/g , '\r' ) , {} );
                    if(obj1.__xst === __xsu){
                        contenu=obj1.__xva;
                    }else{
                        return({"__xst" : __xer ,"__xme" : this.__ig1.nl2()});
            ...
            if(this.#liste_des_meta_table[i].hasOwnProperty( 'exemple' )){
                if(this.#liste_des_meta_table[i].nom_du_meta_table === 'fonctions_coherence1'){
                    t+='<pre>' + this.#liste_des_meta_table[i].exemple + '</pre>';
                }else{
                    t+=this.#liste_des_meta_table[i].exemple;
                }
            }
        ...
        */
        ...
        for(let i in this.__ig1.__liste_des_genres){
            ...
            */
            l_option='';
            l_option+='<option';
            if(1 == this.__ig1.__liste_des_genres[i].chi_id_genre){
                l_option+=' selected="true"';
            }
            l_option+=' value="' + this.__ig1.__liste_des_genres[i].chi_id_genre + '"';
            l_option+=' data-genre="' + this.__ig1.fi2( JSON.stringify( this.__ig1.__liste_des_genres[i] ) ) + '"';
            l_option+='>';
            l_option+='(' + this.__ig1.__liste_des_genres[i].chi_id_genre + ')' + this.__ig1.__liste_des_genres[i].chp_nom_genre;
            l_option+='</option>';
            tableau_des_genres.push( [this.__ig1.__liste_des_genres[i].che_ordre_genre,l_option] );
        }
        tableau_des_genres.sort( function( a , b ){
        ...
        */
        var cmd='';
        cmd+='m1(n1(' + this.moi + '),f1(maj_typologie(';
        ...
        */
        ...
        t+='<br />description_du_champ : <textarea rows="3" cols="50" id="meta_ajouter__description_du_champ" autocapitalize="off"></textarea>';
        t+='<br />';
        var cmd='';
        ...
        */
        ...
        t+=' )';
        t+='))';
        t+='" >supprimer cette table du schéma</div>';
        t+='<hr />';
        /*
          =====================================================================================================
        */
        ...
        if(est_table_virtuelle === 1){
            ...
            t+=' id_bdd_de_la_base_en_cours(' + id_bdd_de_la_base_en_cours + ' ),';
            t+=')))';
            t+='" >insérer les donnees dans la table virtuelle</div>';
            t+='<table border="1">';
            /*
            */
            t+='<tr>';
            ...
            */
            ...
            t+=' id_svg_conteneur_table(' + id_svg_conteneur_table + ' ),';
            t+=' id_bdd_de_la_base_en_cours(' + id_bdd_de_la_base_en_cours + ' ),';
            t+=' operation(creer_trigger_delete),';
            t+=')))';
            t+='" >creer le trigger delete</div>';
            t+='</td>';
            /*  */
            /*  */
            t+='<td>';
            ...
            t+=' id_svg_conteneur_table(' + id_svg_conteneur_table + ' ),';
            t+=' id_bdd_de_la_base_en_cours(' + id_bdd_de_la_base_en_cours + ' ),';
            t+=' operation(supprimer_trigger_delete),';
            t+=')))';
            t+='" >supprimer le trigger delete</div>';
            t+='</td>';
            /*  */
            t+='</tr>';
            /*
            ...
            */
            ...
            t+=' id_svg_conteneur_table(' + id_svg_conteneur_table + ' ),';
            t+=' id_bdd_de_la_base_en_cours(' + id_bdd_de_la_base_en_cours + ' ),';
            t+=' operation(creer_trigger_update),';
            t+=')))';
            t+='" >creer le trigger update</div>';
            t+='</td>';
            /*  */
            /*  */
            t+='<td>';
            ...
            t+=' id_svg_conteneur_table(' + id_svg_conteneur_table + ' ),';
            t+=' id_bdd_de_la_base_en_cours(' + id_bdd_de_la_base_en_cours + ' ),';
            t+=' operation(supprimer_trigger_update),';
            t+=')))';
            t+='" >supprimer le trigger update</div>';
            t+='</td>';
            /*  */
            t+='</tr>';
            /*
            ...
            */
            ...
            t+=' id_svg_conteneur_table(' + id_svg_conteneur_table + ' ),';
            t+=' id_bdd_de_la_base_en_cours(' + id_bdd_de_la_base_en_cours + ' ),';
            t+=' operation(creer_trigger_insert),';
            t+=')))';
            t+='" >creer le trigger insert</div>';
            t+='</td>';
            /*  */
            /*  */
            t+='<td>';
            ...
            t+=' id_svg_conteneur_table(' + id_svg_conteneur_table + ' ),';
            t+=' id_bdd_de_la_base_en_cours(' + id_bdd_de_la_base_en_cours + ' ),';
            t+=' operation(supprimer_trigger_insert),';
            t+=')))';
            t+='" >supprimer le trigger insert</div>';
            t+='</td>';
            /*  */
            t+='</tr>';
            /*
        ...
        */
        ...
        let options1={
            ...
            "largeur_max" : /* entre 20 et 80 */'400px' ,
    ...
    */
    modifier_la_table_de_modale( mat , d ){
        ...
        for(let i in this.#liste_des_meta_table){
            if(this.#liste_des_meta_table[i].nom_du_meta_table === 'fonctions_coherence1'){
                let source_js=document.getElementById( 'vv_' + this.#liste_des_meta_table[i].nom_du_meta_table ).value;
                if(source_js.trim !== ''){
                    let le_parseur=window.acorn.Parser;
                    let tableau_des_commentaires_js=[];
                    let obj0=null;
                    try{
                        obj0=le_parseur.parse( source_js , {"ecmaVersion" : 'latest' ,"sourceType" : 'module' ,"ranges" : false ,"onComment" : tableau_des_commentaires_js} );
                    }catch(e){
                        return({"__xst" : __xer ,"__xme" : this.__ig1.nl2( e )});
                    }
                    /* on transforme le ast du js en rev */
                    let obj1=this.#objet_conversion_ast_js_vers_rev.traite_ast( obj0.body , tableau_des_commentaires_js , {} );
                    if(obj1.__xst === __xsu){
                        /* afr vérifier que les champs utilisés appartiennent bien à la table ( par.xxxx ) */
                        obj[this.#liste_des_meta_table[i].nom_du_meta_table]=obj1.__xva.replace( /\\/g , '\\\\' ).replace( /\'/g , '\\\'' );
                    }
                }else{
                    obj[this.#liste_des_meta_table[i].nom_du_meta_table]='';
                }
            }else{
    ...
    */
    ...
    /*
      =============================================================================================================
    */
    ajouter_indicateur_pour_correction_index( mat , d ){
        let nom_de_la_table='';
        let k0='';
        ...
        for( let i=d ; i < mat.length ; i++ ){
            if(mat[i][1] === 'nom_de_la_table' && mat[i][2] === 'f' && mat[i][8] === 1 && mat[i + 1][2] === 'c'){
                nom_de_la_table=mat[i + 1][1];
            }else if(mat[i][1] === 'k0' && mat[i][2] === 'f' && mat[i][8] === 1 && mat[i + 1][2] === 'c'){
                k0=mat[i + 1][1];
            }else if(mat[i][1] === 'nom_du_champ_a_modifier' && mat[i][2] === 'f' && mat[i][8] === 1 && mat[i + 1][2] === 'c'){
                nom_du_champ_a_modifier=mat[i + 1][1];
            }else if(mat[i][1] === 'nom_du_champ_cle' && mat[i][2] === 'f' && mat[i][8] === 1 && mat[i + 1][2] === 'c'){
                nom_du_champ_cle=mat[i + 1][1];
            }
        }
        if(nom_du_champ_cle !== '' && nom_du_champ_a_modifier !== '' && nom_de_la_table !== '' && k0 !== ''){
            ...
            this.__ig1.ma_trace1( 'source_sql=' + source_sql );
            let obj={
    ...
    */
    affiche_resultat_analyse_index( le_colis1 ){
        ...
        */
        ...
        t+='' + lmds.primary_key;
        t+='</th>';
        for( let i=0 ; i < lmds.liste_des_champs.length ; i++ ){
            t+='<th colspan="2">';
            t+='' + lmds.liste_des_champs[i];
            t+='</th>';
        }
        t+='</tr>';
        /*
        ...
        */
        let k='';
        t+='</tr>';
        for( let i=0 ; i < lmds.donnees0.length ; i++ ){
            let k0=0;
            t+='<tr>';
            /*
            ...
            */
            ...
            for( let j=0 ; j < lmds.liste_des_champs.length ; j++ ){
                ...
                if(lmds.liste_des_champs_avec_type[lmds.liste_des_champs[j]].espece_du_champ.toLowerCase().indexOf( 'char' ) >= 0){
                    var cmd='';
                    cmd+='m1(n1(' + this.moi + '),f1(ajouter_indicateur_pour_correction_index(';
                    cmd+=' k0(' + k0 + '),';
                    cmd+=' nom_du_champ_cle(\'' + lmds.primary_key + '\'),';
    ...
    */
    ajouter_la_table_en_base_de_modale( mat , d ){
        ...
        var obj1=this.__ig1.__rev1.rev_tm( t );
        if(obj1.__xst === __xsu){
        ...
        */
        ...
        for(i in this.#arbre[this.#id_bdd_de_la_base_en_cours].arbre_svg){
            if(this.#arbre[this.#id_bdd_de_la_base_en_cours].arbre_svg[i] !== null
                ...
                */
                var obj=this.__ig1.__rev1.rev_tm( this.#arbre[this.#id_bdd_de_la_base_en_cours].arbre_svg[i].proprietes.donnees_rev_du_champ );
                if(obj.__xst === __xsu){
                    var j=0;
                    for( j=0 ; j < obj.__xva.length ; j++ ){
    ...
    */
    #maj_meta( type_element , id_bdd , id_svg_element , nom_propriete ){
        if(type_element === 'base'){
            ...
            var obj1=this.__ig1.__rev1.rev_tm( texte_rev );
            var nouveau_rev='';
            if(obj1.__xst === __xsu){
                var i=0;
                for( i=0 ; i < obj1.__xva.length ; i++ ){
                    if(obj1.__xva[i][3] === 1 && obj1.__xva[i][1] === 'transform_base_sur_svg'){
                        var tab=this.__ig1.__rev1.supprimer_un_element_de_la_matrice( obj1.__xva , i - 1 , 0 );
                        var obj2=this.__ig1.__rev1.matrice_vers_source_rev1( tab , 0 , false , 1 );
                        if(obj2.__xst === __xsu){
                            if(obj2.__xva !== ''){
                                obj2.__xva+=',';
                            }
    ...
    */
    #corrige_meta_champ( texte_meta_rev , nouvelles_valeurs={} , nom_du_champ , table_permet_la_gestion_de='' ){
        ...
        */
                ...
                if(mat2[l][1] === 'meta' && mat2[l][2] === 'f'){
                    for( let k=l + 1 ; k < l01 ; k=mat2[k][12] ){
                        if(mat2[k][1] === 'genre_meta' && mat2[k][2] === 'f'){
                            ...
                            }else if(mat2[k][8] === 2 && mat2[k + 1][2] === 'c' && mat2[k + 2][2] === 'c'){
                                longueur_du_champ='' + mat2[k + 1][1] + ',' + mat2[k + 2][1] + '';
                            }
                        ...
                        }else if(mat2[k][1] === 'libelle_du_champ' && mat2[k][2] === 'f' && mat2[k][8] === 1 && mat2[k + 1][2] === 'c'){
                            if(nouvelles_valeurs.hasOwnProperty( 'libelle_du_champ' )){
                                mat2[k + 1][1]=nouvelles_valeurs.libelle_du_champ;
                            }
                            libelle_du_champ=mat2[k + 1][1];
                        ...
                        }else if(mat2[k][1] === 'suggestion_du_champ' && mat2[k][2] === 'f'){
                            /*
                              il peut y avoir plusieurs valeurs
                            */
                            if(mat2[k][8] === 0 || nouvelles_valeurs.hasOwnProperty( 'suggestion_du_champ' )){
                                /* on verra plus bas */
                                suggestion_du_champ='';
                            }else{
                                let obj3=this.__ig1.__rev1.matrice_vers_source_rev1( mat2 , k , true , k + 1 );
                                if(obj3.__xst !== __xsu){
                                    return({"__xst" : __xer ,"__xme" : "erreur de convertion du suggestion_du_champ pour le champ " + nom_du_champ + " "});
                                }
                                suggestion_du_champ=obj3.__xva;
                            }
                        }else if(mat2[k][1] === 'description_du_champ' && mat2[k][2] === 'f' && mat2[k][8] === 1 && mat2[k + 1][2] === 'c'){
                            /*#
                              if(nom_du_champ === 'fld_bob_four_bobine'){
                                  debugger;
                              }
                            */
                            if(mat2[k][8] === 0 || nouvelles_valeurs.hasOwnProperty( 'description_du_champ' )){
                                /* on verra plus bas */
                                description_du_champ='';
                            }else{
                                let obj3=this.__ig1.__rev1.matrice_vers_source_rev1( mat2 , k , true , k + 1 );
                                if(obj3.__xst !== __xsu){
                                    return({"__xst" : __xer ,"__xme" : "erreur de convertion du description_du_champ pour le champ " + nom_du_champ + " "});
                                }
                                description_du_champ=obj3.__xva;
                            }
                        }else if(mat2[k][1] === 'fonction_pour_liste1' && mat2[k][2] === 'f' && mat2[k][8] === 1 && mat2[k + 1][2] === 'c'){
                            if(nouvelles_valeurs.hasOwnProperty( 'fonction_pour_liste1' )){
                                mat2[k + 1][1]=nouvelles_valeurs.fonction_pour_liste1;
                            }
                            fonction_pour_liste1=mat2[k + 1][1];
                        }else if(mat2[k][1] === 'libelle_grandeur' && mat2[k][2] === 'f' && mat2[k][8] === 1 && mat2[k + 1][2] === 'c'){
                            if(nouvelles_valeurs.hasOwnProperty( 'libelle_grandeur' )){
                        ...
                        }else if(mat2[k][1] === 'reference_externe' && mat2[k][2] === 'f' && mat2[k][8] === 3){
                            reference_externe='(' + mat2[k + 1][1] + ',\'' + mat2[k + 2][1] + '\',\'' + mat2[k + 3][1] + '\')';
                            if(nouvelles_valeurs.hasOwnProperty( 'reference_externe' )){
                                debugger;
                                mat2[k + 1][1]=nouvelles_valeurs.reference_externe;
                            }
        ...
        if(nouvelles_valeurs.hasOwnProperty( 'description_du_champ' ) && nouvelles_valeurs.description_du_champ !== ''){
            if(nouvelles_valeurs.description_du_champ !== ''){
                description_du_champ='\'' + nouvelles_valeurs.description_du_champ.replace( /\\/g , '\\\\' ).replace( /\'/g , '\\\'' ) + '\'';
            }else{
                description_du_champ='';
            }
        }
        if(nouvelles_valeurs.hasOwnProperty( 'fonction_pour_liste1' ) && nouvelles_valeurs.fonction_pour_liste1 !== ''){
            fonction_pour_liste1=nouvelles_valeurs.fonction_pour_liste1;
        }
        ...
        if(espece_du_champ === '' && genre !== ''){
            for(let i in this.__ig1.__liste_des_genres){
                if(genre == this.__ig1.__liste_des_genres[i].chi_id_genre){
                    espece_du_champ=this.__ig1.__liste_des_genres[i].chp_espece_genre.toUpperCase();
                    if(this.__ig1.__liste_des_genres[i].che_longueur_genre !== null
                           && this.__ig1.__liste_des_genres[i].che_longueur_genre !== 0
                    ){
                        longueur_du_champ=this.__ig1.__liste_des_genres[i].che_longueur_genre;
                    }
                    break;
                }
            }
        ...
        if(libelle_du_champ === '' || libelle_du_champ.indexOf( 'à faire' ) >= 0 || libelle_du_champ.indexOf( 'A faire' ) >= 0){
            let tab=nom_du_champ.split( '_' );
            if(libelle_du_champ === ''){
                if(nom_du_champ.substr( 0 , 2 ) === 'ch' && tab.length === 3){
                    tab.splice( 0 , 1 );
                    ...
                    libelle_du_champ=tab.join( ' ' );
                }else{
                    libelle_du_champ=nom_du_champ.replace( /_d_/g , ' d\'' ).replace( /_/g , ' ' );
                }
            }else{
                if(tab.length >= 2){
                    tab.splice( 0 , 1 );
        ...
        */
        ...
        /* o1+='    champ(\'' + champ + '\'),'; */
        if(nom_bref_du_champ.indexOf( '\\\'' ) >= 0){
            o1+='    nom_bref_du_champ(\'' + nom_bref_du_champ + '\'),';
        }else{
            o1+='    nom_bref_du_champ(\'' + nom_bref_du_champ.replace( /\'/g , '\\\'' ) + '\'),';
        }
        if(libelle_du_champ.indexOf( '\\\'' ) >= 0){
            o1+='    libelle_du_champ(\'' + libelle_du_champ + '\'),';
        }else{
            o1+='    libelle_du_champ(\'' + libelle_du_champ.replace( /\'/g , '\\\'' ) + '\'),';
        }
        ...
        */
        if(description_du_champ !== ''){
            o1+='    description_du_champ(' + description_du_champ + '),';
        }
        if(fonction_pour_liste1 !== ''){
            if(fonction_pour_liste1.indexOf( '\\\'' ) >= 0){
                o1+='    fonction_pour_liste1(\'' + fonction_pour_liste1 + '\'),';
            }else{
                o1+='    fonction_pour_liste1(\'' + fonction_pour_liste1.replace( /\'/g , '\\\'' ) + '\'),';
            }
        }
        if(libelle_grandeur !== ''){
            if(libelle_grandeur.indexOf( '\\\'' ) >= 0){
                o1+='    libelle_grandeur(\'' + libelle_grandeur + '\'),';
            }else{
        ...
        if(espece_du_champ === 'TEXT'){
            if(longueur_du_champ === ''){
                debugger;
                console.log( '%c 01 longueur corrigee pour champ=' + champ , 'background:yellow;color:red;' );
                longueur_du_champ='10.200';
            }else{
                let tab1=longueur_du_champ.split( '.' );
                if(tab1.length === 2 && this.__ig1.est_entier( tab1[0] ) && this.__ig1.est_entier( tab1[1] )){
                    /* console.log('%c 04 longueur OK pour champ='+champ , 'background:lime;color:red;') */
                }else{
                    if(tab1.length === 1 && this.__ig1.est_entier( tab1[0] )){
                        longueur_du_champ=tab1[0] + '.200';
                        console.log( '%c 02 longueur corrigee pour champ=' + champ , 'background:yellow;color:red;' );
                    }else{
                        console.log( '%c 03 longueur à corriger pour champ=' + champ , 'background:yellow;color:red;' );
                    }
                }
            }
        }
        if(nouvelles_valeurs.hasOwnProperty( 'longueur_du_champ' )){
            if(nouvelles_valeurs.longueur_du_champ !== ''){
                o1+='    longueur_du_champ(' + nouvelles_valeurs.longueur_du_champ + ')';
                longueur_du_champ=nouvelles_valeurs.longueur_du_champ;
            }
        ...
        if(obj2.__xst === __xsu){
            let obj3=this.__ig1.__rev1.matrice_vers_source_rev1( obj2.__xva , 0 , true , 1 );
            if(obj3.__xst === __xsu){
                o1=obj3.__xva;
            }else{
                debugger;
    ...
    */
    #corrige_meta_table( texte_meta_rev , nouvelles_valeurs={} , nom_de_la_table_en_parametre_pour_debug=null ){
                ...
                if(mat2[l][1] === 'meta' && mat2[l][2] === 'f'){
                    for( let k=l + 1 ; k < l01 ; k=mat2[k][12] ){
                        if(mat2[k][1] === 'genre_meta' && mat2[k][2] === 'f'){
                            ...
                            if(mat2.length === k + 1){
                                debugger;
                                transform_table_sur_svg='transform_base_sur_svg(translate(10,10))';
                            }else{
                                var obj=this.__ig1.__rev1.matrice_vers_source_rev1( mat2 , k , false , k + 1 );
                                if(obj.__xst === __xsu){
                            ...
                            let trouve=false;
                            if(mat2[k][2] === 'f' && mat2[k][1] === 'transform_base_sur_svg'){
                                if(mat2[k + 1][1] === 'translate' && mat2[k + 1][2] === 'f' && mat2[k + 1][8] === 2){
                                    transform_table_sur_svg='translate(' + mat2[k + 2][1] + ' , ' + mat2[k + 3][1] + ')';
                                    decallage_x=parseInt( mat2[k + 2][1] , 10 );
                                    decallage_y=parseInt( mat2[k + 3][1] , 10 );
                                }
                                trouve=true;
                            }else if(mat2[k][2] === 'f'){
                                for(let l in this.#liste_des_meta_table){
                                    if(this.#liste_des_meta_table[l].nom_du_meta_table === mat2[k][1]){
                                        if(mat2[k][8] === 1 && mat2[k + 1][2] === 'c'){
                                            ...
                                            this.#liste_des_meta_table[l].valeur_normale_pour_meta=this.__ig1.__rev1.ma_constante( mat2[k + 1] );
                                            this.#liste_des_meta_table[l].valeur_brut_pour_meta=this.__ig1.__rev1.ma_constante_inverse( mat2[k + 1] );
                                        }else{
        ...
        */
            ...
            if('rang_de_la_table' === le_meta_table.nom_du_meta_table){
                ...
                if(le_meta_table.zone_html2 === 'un_zero' ){
                    ...
                    if(le_meta_table.valeur_brut_pour_meta !== ''){
                        ...
                        if(le_meta_table.doit_etre_dans_meta === true){
                            o1+=' ' + le_meta_table.nom_du_meta_table + '(\'\'),';
                        }
                    }
                }
            }else{
                if(le_meta_table.valeur_normale_pour_meta === '\'\''
                       || le_meta_table.valeur_normale_pour_meta === ''
                       || le_meta_table.valeur_normale_pour_meta === null
                ){
                    if(le_meta_table.doit_etre_dans_meta === true){
                        o1+=' ' + le_meta_table.nom_du_meta_table + '(\'\'),';
                    }
        ...
        if(nouvelles_valeurs.hasOwnProperty( 'decallage_x' )
               && nouvelles_valeurs.hasOwnProperty( 'decallage_y' )
               && this.__ig1.est_num( nouvelles_valeurs.decallage_x )
               && this.__ig1.est_num( nouvelles_valeurs.decallage_y )
        ){
            o1+=' transform_base_sur_svg(translate(' + nouvelles_valeurs.decallage_x + ' , ' + nouvelles_valeurs.decallage_y + '))';
        }else{
                        ...
                        if(mat2[k][1] === 'genre_meta' && mat2[k][2] === 'f'){
                            ...
                            */
                            ...
                            if(mat2[k + 1][1] === 'default_charset' && mat2[k + 1][2] === 'c' && mat2[k + 2][2] === 'c'){
                                ...
                                var obj=this.__ig1.__rev1.matrice_vers_source_rev1( mat2 , k + 2 , false , k + 3 );
                                if(obj.__xst === __xsu){
                                    transform_base_sur_svg=obj.__xva;
                                }else{
                                    debugger;
    ...
    */
    #creer_rev_de_la_base_a_partir_de_svg( id_bdd_de_la_base ){
        ...
        if(racine_du_svg === null){
            return(this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : this.__ig1.nl2() + 'il y a eu un problème lors de la récupération de l\'arbre svg'} ));
        }
        ...
        if(id_bdd_de_la_base > 0){
            ...
            if(obj.__xst === __xsu){
                ...
                if(objrev.__xst === __xsu){
                    ...
                    var obj2=this.__ig1.__rev1.matrice_vers_source_rev1( objrev.__xva , 0 , true , 1 );
                    if(obj2.__xst === __xsu){
                        let a_envoyer={
                             /*  */
    ...
    */
    #ajouter_nom_de_table_au_svg( nom_de_la_table , indice_courant , id_svg_conteneur_table , largeur_de_la_boite , la_table_est_virtuelle=false , contient_televersement=false ){
        ...
        */
        ...
        this.#arbre[this.#id_bdd_de_la_base_en_cours].arbre_svg[indice_courant]={
            ...
            "proprietes" : {
                ...
                "style" : "stroke:white;stroke-width:" + this.#taille_bordure + ";fill:" + (la_table_est_virtuelle ? ( 'darkorange' ) : ( 'red' )) + ";fill-opacity:1;"
            }
        };
        indice_courant++;
        /* carré rouge 🟥 */
        ...
        */
        this.#arbre[this.#id_bdd_de_la_base_en_cours].arbre_svg[indice_courant]={
            ...
            "proprietes" : {
                ...
                "y" : this.#hauteur_de_boite - 0.3 * this.__ig1.css_dimensions.t_police - this.#taille_bordure ,
    ...
    #ajouter_champ_a_arbre( nom_du_champ , indice_courant , id_svg_conteneur_table , nom_de_la_table , id_bdd_de_la_base , donnees_rev_du_champ , primary_key , non_nulle , auto_increment , references , a_une_valeur_par_defaut , espece_du_champ , longueur_du_champ , valeur_par_defaut , la_valeur_par_defaut_est_caractere , cht_fonction_init ){
        ...
        */
        ...
        if(donnees_rev_du_champ.indexOf( 'genre(1)' ) < 0){
            var obj1=this.__ig1.__rev1.rev_tm( donnees_rev_du_champ );
            if(obj1.__xst === __xsu){
                let mat=obj1.__xva;
        ...
        */
        ...
        this.#arbre[id_bdd_de_la_base].arbre_svg[indice_courant]={
            ...
            "proprietes" : {
                ...
                "nom_de_la_table" : nom_de_la_table ,
                "nom_du_champ" : nom_du_champ ,
                "x" : this.#hauteur_de_boite + 2 * this.#taille_bordure + this.__ig1.css_dimensions.t_police * 1.8 ,
                "y" : this.#hauteur_de_boite - 0.3 * this.__ig1.css_dimensions.t_police - this.#taille_bordure ,
        ...
        this.#arbre[id_bdd_de_la_base].arbre_svg[indice_courant]={
            ...
            "id" : indice_courant ,
            "id_parent" : id_svg_champ_en_cours ,
            "contenu" : /* carré jaune */genre_du_champ ,
            "proprietes" : {
                "id" : indice_courant ,
    ...
    */
    #ajouter_table_et_index_a_arbre( tab , id_tab_table_en_cours , indice_courant , id_bdd_de_la_base , nom_de_la_table_a_utiliser=null ){
            ...
            if(tab[i][7] === id_tab_table_en_cours){
                if('nom_de_la_table' === tab[i][1]){
                    ...
                    */
                    ...
                    var tt=[0,0];
                    let est_table_virtuelle=false;
                    let contient_televersement=false;
                    /*#
                      if(nom_de_la_table==='rpps_fts'){
                          debugger
                      }
                    */
        ...
        */
        for( let k=this.tableau_des_bases_tables_champs.length - 1 ; k >= 0 ; k-- ){
            if(this.tableau_des_bases_tables_champs[k][0] === id_bdd_de_la_base
                   && this.tableau_des_bases_tables_champs[k][1] === nom_de_la_table
            ){
                this.tableau_des_bases_tables_champs.splice( k , 1 );
            }
        }
        for( let k=id_tab_table_en_cours + 1 ; k < l01 ; k=tab[k][12] ){
                    ...
                    if(tab[l][1] === 'champ' && tab[l][2] === 'f'){
                        for( var m=l + 1 ; m < l01 ; m=tab[m][12] ){
                            if(tab[m][1] === 'nom_du_champ'){
                                ...
                                for( let n=l + 1 ; n < l01 ; n=tab[n][12] ){
                                    if(tab[n][2] === 'f' && tab[n][1] === 'nom_du_champ' && tab[n][8] === 1){
                                        ...
                                        */
                                        ...
                                        console.log( '%c ' + tab[n][1] + ' non pris en compte ' , 'background:red;color:yellow;' );
                                    }
                                }
                                if(espece_du_champ === ''){
                                    if(type !== ''){
                                ...
                                if(indice_meta > 0){
                                    var obj1=this.__ig1.__rev1.matrice_vers_source_rev1( tab , tab[indice_meta][7] , false , indice_meta , 0 , [] , null , true );
                                    if(obj1.__xst === __xsu){
                                        donnees_rev_du_champ=obj1.__xva;
                                        donnees_rev_du_champ=donnees_rev_du_champ.substr( 0 , donnees_rev_du_champ.length - 1 ) + ',espece_du_champ(' + espece_du_champ + '))';
                                    }else{
                                        return({"__xst" : __xer ,"__xme" : 'problème sur les données du champ "' + nom_du_champ + '"'});
                                    }
                                    for( let n=indice_meta + 1 ; n < l01 ; n=tab[n][12] ){
                                        if(tab[n][1] === 'genre' && tab[n][2] === 'f' && tab[n][8] === 1 && tab[n + 1][2] === 'c'){
                                            let genre=parseInt( tab[n + 1][1] , 10 );
                                            if(genre === 2){
                                                this.tableau_des_bases_tables_champs.push( [id_bdd_de_la_base,nom_de_la_table,nom_du_champ] );
                                            }
                                        }
                                    }
                                }
                        ...
                        */
                        ...
                        if(indice_meta > 0){
                            ...
                            if(obj1.__xst === __xsu){
                                ...
                                return({"__xst" : __xer ,"__xme" : 'problème sur les données de l\'index "' + nom_de_l_index + '"'});
                            }
                        }
                        id_svg_champ_en_cours=indice_courant;
                        ...
                        for(let j in this.#arbre[id_bdd_de_la_base].arbre_svg){
                            if(this.#arbre[id_bdd_de_la_base].arbre_svg[j]
                                ...
                                if(this.#arbre[id_bdd_de_la_base].arbre_svg[j].proprietes.nom_de_la_table === nom_table_mere
                                    ...
                                    var couleur_du_lien='stroke:brown;stroke-opacity:0.6;';
                                    if(nom_parent_table === 'tbl_grandeurs'){
                                        if(non_nulle === 0){
                                            couleur_du_lien='stroke:gold;stroke-opacity:0.3;';
                                        }else{
                                            couleur_du_lien='stroke:orange;stroke-opacity:0.6;';
                                        }
                                    }else{
                                        if(non_nulle === 0){
                                            couleur_du_lien='stroke:coral;stroke-opacity:0.6;';
                                        }
                                    }
                                    /*
                                    ...
                                    */
                                    ...
                                    this.#arbre[id_bdd_de_la_base].arbre_svg[indice_courant]={
                                        ...
                                        "proprietes" : {
                                            ...
                                            "nom_parent_table" : nom_parent_table ,
                                            "nom_parent_champ" : nom_parent_champ ,
                                            "style" : '' + couleur_du_lien + ';stroke-width:' + (this.#taille_bordure * 3) + ';fill:transparent;stroke-linejoin:round;stroke-linecap:round;'
                                        }
                                    };
                                    indice_courant++;
                                    this.#arbre[id_bdd_de_la_base].arbre_svg[indice_courant]={
    ...
    */
    selectionner_une_base( mat , d ){
        ...
        let arbre_charge=false;
        for(let i in this.#arbre){
            arbre_charge=true;
        }
        /*#
          if(arbre_charge === false){
              console.log( "%cl'arbre n'est pas chargé" , "background:red;" );
          }else{
              console.log( "%cl'arbre est chargé" , "background:lightgreen;" );
          }
        */
        if(arbre_charge === false){
            return({"__xst" : __xsu});
        ...
        this.#arbre[id_bdd_de_la_base].arbre_svg[indice_svg_courant]={
            ...
            "proprietes" : {
                ...
                "y" : this.#taille_bordure + this.__ig1.css_dimensions.t_police ,
                "style" : "fill:blue;"
            }
        };
        indice_svg_courant++;
        ...
        */
        ...
        for( let indice_matr=1 ; indice_matr < l01 ; indice_matr=tab[indice_matr][12] ){
            if(tab[indice_matr][3] === 0 && tab[indice_matr][1] === 'meta' && tab[indice_matr][2] === 'f'){
                var objxx=this.__ig1.__rev1.matrice_vers_source_rev1( tab , tab[indice_matr][7] , false , indice_matr , 0 , [] , null , true );
                if(objxx.__xst === __xsu){
        ...
        */
        ...
        for( let i=0 ; i < this.tableau_des_bases_tables_champs.length ; i++ ){
            for( let j=i + 1 ; j < this.tableau_des_bases_tables_champs.length ; j++ ){
                if(this.tableau_des_bases_tables_champs[i][2] === this.tableau_des_bases_tables_champs[j][2]
                       && this.tableau_des_bases_tables_champs[i][0] === this.tableau_des_bases_tables_champs[j][0]
                ){
                    if(!doublon_champ_index_deja_affiche.includes( this.tableau_des_bases_tables_champs[i][2] )){
                        message_doublons_champs.push( '<b>' + this.tableau_des_bases_tables_champs[i][2] + '</b> ' + this.tableau_des_bases_tables_champs[i][0] + ' ' + this.tableau_des_bases_tables_champs[i][1] + ' / ' + this.tableau_des_bases_tables_champs[j][0] + ' ' + this.tableau_des_bases_tables_champs[j][1] + '' );
                        doublon_champ_index_deja_affiche.push( this.tableau_des_bases_tables_champs[i][2] );
                    }
                }
            }
    ...
    */
    editer_les_schemas2( mat , d , le_colis1=null ){
        ...
        if(le_colis1 !== null){
            ...
            this.__ig1.ajoute_les_evenements_aux_boutons();
            this.editer_le_schema( null , null , tab_les_bases_a_editer[0] );
            window.location.hash='#pm1(m1(n1(' + this.moi + '),f1(editer_les_schemas2(les_bases_a_editer(\'' + les_bases_a_editer + '\')))))';
            return({"__xst" : __xsu});
        }
        return({"__xst" : __xer ,"__xme" : this.__ig1.nl2()});
    }
    ...
    plus_n_x( nb_pix , axe ){
        if(this.#id_bdd_de_la_base_en_cours > 0){
            ...
            for( let i=0 ; i < tab1.length ; i++ ){
                ...
                if(elem){
                    if(elem.type === 'g'
                           && elem.hasOwnProperty( 'proprietes' )
                           && elem.proprietes.hasOwnProperty( 'type_element' )
                        ...
                        if(t){
                            ...
                            if(p1.__xst === __xsu){
                                if(p1.__xva.length === 4
                                       && p1.__xva[1][1] === 'translate'
                                       && p1.__xva[1][2] === 'f'
                                       && p1.__xva[1][8] === 2
                                       && p1.__xva[2][2] === 'c'
                                       && p1.__xva[3][2] === 'c'
                           ...
                           && elem.hasOwnProperty( 'proprietes' )
                           && elem.proprietes.hasOwnProperty( 'type_element' )
                           && elem.proprietes.type_element === 'rectangle_de_table'
                    ){
                        ...
                        if(t){
                           ...
                           && elem.hasOwnProperty( 'proprietes' )
                           && elem.proprietes.hasOwnProperty( 'type_element' )
                           && elem.proprietes.type_element === 'reference_croisée'
                    ){
