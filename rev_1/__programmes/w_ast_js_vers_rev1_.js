...
class w_ast_js_vers_rev1{
    ...
    #traite_CallExpression( element , niveau , parent , tab_comm ){
        ...
        if(element.body){
            ...
            if(obj.__xst === __xsu){
                ...
                return(this.#astjs_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + 'body' ,"element" : element} ));
            }
        }
    ...
    */
    #traite_ArrowFunctionExpression( element , niveau , parent , tab_comm ){
        ...
        if(element.generator !== false){
            return(this.#astjs_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + ' generator' ,"element" : element} ));
        }
        if(element.id){
            obj=this.#traite_element( element.id , niveau + 1 , element , tab_comm , false );
            if(obj.__xst === __xsu){
    ...
    */
    #traite_BinaryExpression( element , niveau , parent , tab_comm ){
        ...
        if(element.right.type === 'Literal'
                   && (element.right.hasOwnProperty( 'raw' )
                           && element.right.raw.substr( 0 , 1 ) === "'"
                       || element.right.raw.substr( 0 , 1 ) === '"')
                   && nomDuTest === 'plus'
               || element.left.type === 'Literal'
                   && (element.left.hasOwnProperty( 'raw' )
                           && element.left.raw.substr( 0 , 1 ) === "'"
                       || element.left.raw.substr( 0 , 1 ) === '"')
                   && nomDuTest === 'plus'
               || element.left.type === 'TemplateLiteral'
                   && element.left.quasis.length === 1
                   && element.left.quasis[0].value.hasOwnProperty( 'raw' )
                   && nomDuTest === 'plus'
        ){
        ...
        if(t.substr( 0 , 14 ) === 'concat(concat(' || t.substr( 0 , 15 ) === 'concat( concat('){
            obj=this.__rev1.rev_tm( t );
            if(obj.__xst === __xsu){
                nouveauTableau=this.__rev1.baisser_le_niveau_et_supprimer( obj.__xva , 2 , 0 );
                obj=this.__rev1.matrice_vers_source_rev1( nouveauTableau , 0 , false , 1 );
                if(obj.__xst === __xsu){
                    t=obj.__xva;
                }else{
                    return(this.#astjs_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() ,"element" : element} ));
        ...
        for(let i in element.properties){
            ...
            if(val.computed === true){
                if(val.key.type === 'Identifier'){
                    ...
                    return(this.#astjs_le( {"__xst" : __xer ,"__xme" : (this.__rev1.nl2() + val.key.type) + '"' ,"element" : element} ));
                }
            }else{
                if(val.type === 'RestElement'){
                    ...
                    if(val.argument.type === 'Identifier' && raccourcie === true){
                        ...
                        return(this.#astjs_le( {"__xst" : __xer ,"__xme" : (this.__rev1.nl2() + val.argument.type) + '"' ,"element" : element} ));
                    }
                }else{
                    if(val.key.type === 'Identifier'){
                        t+='(' + val.key.name + ',';
            ...
            if(raccourcie === true){
                ...
                if(obj.__xst === __xsu){
                    ...
                    return(this.#astjs_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2()} ));
                }
            }
        }
        t='obj(' + t + ')';
            ...
            if(val.key === undefined){
                ...
                if(val.key.type === 'Identifier'){
                    if(methode === true){
                        ...
                        if(obj.__xst === __xsu){
                            /* repasse en matrice */
                            obj=this.__rev1.rev_tm( obj.__xva );
                            if(obj.__xst === __xsu){
                                if(obj.__xva[1][1] === 'appelf' && obj.__xva[2][1] === 'nomf' && obj.__xva[3][1] === 'function'){
                                    ...
                                    obj=this.__rev1.matrice_vers_source_rev1( obj.__xva , 0 , false , 1 );
                                    if(obj.__xst === __xsu){
                                        t+='(' + obj.__xva + ')';
                                    }else{
                                        return(this.#astjs_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() ,"element" : element} ));
        ...
        for(let i in element.elements){
            ...
            if(element.elements[i] === null){
                ...
                /*#
                  this.#astjs_le( {
                          "__xst" : __xal ,
                          "__xme" : this.__rev1.nl2() + '<br /> ATTENTION, CE N\'EST PAS UNE ERREUR MAIS... élément vide dans un tableau' ,
                          "element" : element
                      } );
                */
                lesPar+=',p()';
    ...
    */
    #traite_FunctionDeclaration( element , niveau , parent , tab_comm ){
        ...
        if(element.expression !== false){
            return(this.#astjs_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + 'expression' ,"element" : element} ));
        }
        if(element.generator !== false){
    ...
    */
    #recupProp( element , niveau , parent , tab_comm ){
        ...
        if(element.type === 'BinaryExpression'){
            ...
            return(this.#astjs_le( {"__xst" : __xer ,"__xme" : (this.__rev1.nl2() + element.type) + '"' ,"element" : element} ));
        }
        return({"__xst" : __xsu ,"__xva" : t});
    }
    /*
        ...
        if(element.computed === false){
                        ...
                        if(obj.__xst === __xsu){
                            ...
                            for( var i=nouveauTableau.length - 1 ; i >= 1 ; i-- ){
                                if(nouveauTableau[i][2] === 'f' && nouveauTableau[i][1] === '#' && nouveauTableau[i][3] === 0){
                                    ...
                                    nouveauTableau=this.__rev1.supprimer_un_element_de_la_matrice( nouveauTableau , i , 0 );
                                }
                            }
                            if(nouveauTableau.length > 0 && nouveauTableau[1][1] === 'appelf' && nouveauTableau[1][2] === 'f'){
                                var nouvelle_fonction=this.__rev1.matrice_vers_source_rev1( nouveauTableau , 0 , false , 1 );
            ...
            if(type_parent === 'CallExpression'){
                ...
                if(type_propriete === 'Identifier' && type_objet === 'Identifier'){
                    ...
                    if(objet.endsWith( ']' ) && this.est_num( propriete )){
                        t=objet + '[' + propriete + ']';
                    }else{
                        if((type_objet === 'Identifier' || type_objet === null) && this.est_num( propriete )){
                            t=objet + '[' + propriete + ']';
                        }else{
                            t='tableau(nomt(' + objet + '),p(' + propriete + '))';
                        }
        ...
        if(obj.__xst === __xsu){
            if(obj.__xva.length > 3
                ...
                if(onContinue === true){
                    ...
                    */
                    nouveau_tableau=this.__rev1.baisser_le_niveau_et_supprimer( o.__xva , 2 , 0 );
                    obj=this.__rev1.matrice_vers_source_rev1( nouveau_tableau , 0 , false , 1 );
                    if(obj.__xst === __xsu){
                        t=obj.__xva;
                    }
                }
    ...
    */
    #traite_LogicalExpression( element , niveau , parent , tab_comm ){
        ...
        if(t.substr( 0 , 6 ) === 'ou(ou('
            ...
            obj=this.__rev1.rev_tm( t );
            if(obj.__xst === __xsu){
                nouveau_tableau=this.__rev1.baisser_le_niveau_et_supprimer( obj.__xva , 2 , 0 );
                obj=this.__rev1.matrice_vers_source_rev1( nouveau_tableau , 0 , false , 1 );
                if(obj.__xst === __xsu){
                    t=obj.__xva;
                }else{
    ...
    */
    #recup_nom_operateur( s ){
        switch (s){
            ...
            default:
                this.#astjs_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + ' "' + s + '"'} );
        ...
        if(element.expression.type === 'CallExpression'){
            ...
            if(obj.__xst === __xsu){
                ...
                if(gauche.substr( 0 , 7 ) === 'chainé('){
                    obj=this.__rev1.rev_tcm( gauche );
                    if(obj.__xst === __xsu){
                        var nouveauTableau=obj.__xva;
                        /* le nom de l'élément */
                        var t1=this.__rev1.matrice_vers_source_rev1( nouveauTableau , 1 , true , 2 , 0 , [] , null , true );
                        if(t1.__xst === __xsu){
                        }else{
                            return(this.#astjs_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() ,"element" : element} ));
                        }
                        /* le reste */
                        var t2=this.__rev1.matrice_vers_source_rev1( nouveauTableau , 1 , true , nouveauTableau[2][12] , 0 , [] , null , false );
                        if(t2.__xst === __xsu){
                        }else{
                            return(this.#astjs_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() ,"element" : element} ));
                        }
            ...
            return(this.#astjs_le( {"__xst" : __xer ,"__xme" : (this.__rev1.nl2() + element.expression.type) + '"' ,"element" : element} ));
        }
        return({"__xst" : __xsu ,"__xva" : t});
    }
    /*
    ...
    */
    #traite_UnaryExpression( element , niveau , parent , tab_comm ){
        ...
        obj=this.#traite_element( element.argument , niveau + 1 , element , tab_comm , false );
        if(obj.__xst === __xsu){
            if((nomDuTestUnary === 'moins' || nomDuTestUnary === 'plus') && this.est_num( obj.__xva )){
            ...
            if(element.value.params && element.value.params.length > 0){
                ...
                for( j=0 ; j < element.value.params.length ; j++ ){
                    ...
                    if(element.value.params[j].type === "Identifier"){
                        ...
                        return(this.#astjs_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + '"' + element.value.params[j].type + '"' ,"element" : element} ));
                    }
    ...
    */
    #traite_SequenceExpression( element , niveau , parent , tab_comm ){
        ...
        if(element.expressions.length > 1 && parent.computed && parent.computed === true){
            ...
            */
            this.#astjs_le( {"__xst" : __xal ,"__xme" : this.__rev1.nl2() + '<br />l\'opérateur virgule est dangereux dans un tableau !' ,"element" : element} );
        }
        for( let i=0 ; i < element.expressions.length ; i++ ){
    ...
    */
    #traite_element( element , niveau , parent , tab_comm , ignorer_commentaires_avant ){
        ...
        switch (element.type){
                ...
                if(element.regex){
                    ...
                    if(parent && parent.type === 'BlockStatement' && element.value === 'use strict'){
                        ...
                        if(element.raw.indexOf( '\\\n' ) >= 0){
                            return(this.#astjs_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + 'veuillez réécrire ces lignes JS qui terminent par un \\' ,"element" : element} ));
                        }else{
                            valeur=element.raw;
                        }
                        if(niveau === 0){
            ...
            default:
                debugger;
                return(this.#astjs_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + ' non prévu "' + element.type + '" ' ,"element" : element} ));
                break;
    ...
    */
                ...
                switch (element[i].type){
                    case 'ExpressionStatement' :
                        ...
                        if(obj.__xst === __xsu){
                            ...
                            return(this.#astjs_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + 'ExpressionStatement' ,"element" : element} ));
                        }
                        break;
    ...
    /*
      =============================================================================================================
    */
    traite_ast( ast_de_js_body , tab_comm , options_traitement ){
        let t='';
        let obj=null;
        if(options_traitement !== undefined){
            this.#options_traitement=options_traitement;
        }
        if(Array.isArray( ast_de_js_body )){
            let niveau=0;
            obj=this.#traite_ast0( ast_de_js_body , niveau , null , tab_comm );
            if(obj.__xst === __xsu){
                t+=obj.__xva;
            ...
            return(this.#astjs_le( {"__xst" : __xer ,"__xme" : 'le paramètre à passer est le "body" de l\'ast du js qui DOIT être un tableau ' + this.__rev1.nl2()} ));
        }
        return({"__xst" : __xsu ,"__xva" : t});
    }
    /*
...
export{w_ast_js_vers_rev1 as w_ast_js_vers_rev1};