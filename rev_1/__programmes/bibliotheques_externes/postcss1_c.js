/*
  browserify de https://www.npmjs.com/package/postcss
  Utilisation :
  var a=postcss.parse('body{color:red;}',{});
  console.log(a.nodes)
  Pour les modifications sur des regex, chercher "hugues" çi dessous
*/
(function(){
        function r( e , n , t ){
            function o( i , f ){
                    ...
                    (function( Buffer ){
                            (function(){
                                    ...
                                    */
                                    ...
                                    /* ================ */
                                    /*
                                      hugues l'original n'avait pas de \ devant le /
        ...
        10 : [function( require , module , exports ){
                    ...
                    /* c8 ignore stop */
                },{"./comment" : 9 ,"./declaration" : 12 ,"./node" : 20 ,"./symbols" : 31}] ,
        11 : [function( require , module , exports ){
                ...
                },{"./terminal-highlight" : 2 ,"picocolors" : 7}] ,
                        ...
                        if(ownInputs){
                            ...
                            for(let input of ownInputs){
                                ...
                                if(inputHydrated.map){
                                    inputHydrated.map={ ...inputHydrated.map  ,"__proto__" : PreviousMap.prototype};
                                }
                                inputs.push( inputHydrated );
                            }
                        }
                        if(defaults.nodes){
                            defaults.nodes=json.nodes.map( ( n ) => {
        ...
        15 : [function( require , module , exports ){
                    ...
                    class Input{
                        ...
                        error( message , line , column , opts={} ){
                            ...
                            if(origin){
                                result=new CssSyntaxError( message , origin.endLine === undefined ? ( origin.line ) : ( {"column" : origin.column ,"line" : origin.line} ) , origin.endLine === undefined ?
                                  ( 
                                    origin.column
                                  ) : ( 
                                                        ...
                                                        try{
                                                            if(root.type === 'document'){
                                                                let roots=root.nodes.map( ( subRoot ) => {
                                                                    return(visitor( subRoot , this.helpers ));} );
                                                ...
                                                if( typeof plugin === 'object' && plugin.Once){
                                                    if(this.result.root.type === 'document'){
                                                        let roots=this.result.root.nodes.map( ( root ) => {
                                                            return(plugin.Once( root , this.helpers ));} );
        ...
        18 : [function( require , module , exports ){
                ...
                },{"./input" : 15 ,"buffer" : 3 ,"path" : 2 ,"source-map-js" : 2 ,"url" : 2}] ,
        ...
        20 : [function( require , module , exports ){
                    ...
                    class Node{
                        ...
                        /* function rangeBy */
                        rangeBy( opts ){
                            let start={"column" : this.source.start.column ,"line" : this.source.start.line};
                        ...
                        toJSON( _ , inputs ){
                            ...
                            if(emitInputs){
                                fixed.inputs=[...inputs.keys()].map( ( input ) => {
                                    return(input.toJSON());} );
                            }
                            return fixed;
                        }
                    ...
                    module.exports=Node;
                    Node.default=Node;
                },{"./css-syntax-error" : 11 ,"./stringifier" : 29 ,"./stringify" : 30 ,"./symbols" : 31}] ,
        21 : [function( require , module , exports ){
                ...
                },{"./container" : 10 ,"./input" : 15 ,"./parser" : 22 ,"_process" : 5}] ,
        22 : [function( require , module , exports ){
                    ...
                    class Parser{
                        ...
                        decl( tokens , customProperty ){
                            ...
                            let hasWord=tokens.some( ( i ) => {
                                return(i[0] !== 'space' && i[0] !== 'comment');} );
                            if(hasWord){
                                node.raws.between+=firstSpaces.map( ( i ) => {
                                    return i[1];} ).join( '' );
                                firstSpaces=[];
                            }
                        ...
                        parse(){
                            ...
                            while(!this.tokenizer.endOfFile()){
                                token=this.tokenizer.nextToken();
                                switch (token[0]){
                                    case 'space' : this.spaces+=token[1];
                                        break;
                        ...
                        /* function precheckMissedSemicolon */
                        ...
                        /* function spacesAndCommentsFromEnd */
        ...
        24 : [function( require , module , exports ){
                ...
                },{"buffer" : 3 ,"fs" : 2 ,"path" : 2 ,"source-map-js" : 2}] ,
        25 : [function( require , module , exports ){
                ...
                },{"./document" : 13 ,"./lazy-result" : 16 ,"./no-work-result" : 19 ,"./root" : 27 ,"_process" : 5}] ,
