                ...
                */
                ...
                var __webpack_modules__={
                    ...
                    9108 : ( module , __unused_webpack_exports , __webpack_require__ ) => {
                        ...
                        */
                        Lexer.prototype.lex=function(){
                            ...
                            if(!this.all_tokens){
                                while(token === this.tok.T_WHITESPACE
                                       || !this.comment_tokens
                                           && (token === this.tok.T_COMMENT
                                               || token === this.tok.T_DOC_COMMENT)
                                       || token === this.tok.T_OPEN_TAG
                                ){
                                    token=this.next() || this.lex();
                                    /* ignore white space */
                                    /* ignore single lines comments */
                                    /* ignore doc comments */
                                    /* ignore open tags */
                                }
                    ...
                    2429 : ( module ) => {
                        module.exports={
                            ...
                            "T_DOC_COMMENT" : function T_DOC_COMMENT(){
                                ...
                                if(ch === "*"){
                                    /* started with '/_*' , check is next is '*' */
                                    ch=this.input();
                                    if(this.is_WHITESPACE()){
                    ...
                    6545 : ( module ) => {
                        ...
                        /* hugues pas de process ici */
                        if(true || process.arch == "x64"){
                    ...
                    7259 : ( module , __unused_webpack_exports , __webpack_require__ ) => {
                        ...
                        */
                        var Parser=function Parser( lexer , ast ){
                            ...
                            this.entries={
                                "IDENTIFIER" : /* reserved_non_modifiers */new Map( [
                                    this.tok.T_ABSTRACT,
                                    this.tok.T_ARRAY,
                                    this.tok.T_AS,
                                    this.tok.T_BREAK,
                        ...
                        Parser.prototype.lex=function(){
                            ...
                            if(this.extractTokens){
                                do{
                                    ...
                                    /* ignore doc comments */
                                    /* ignore open tags */
                                }while(this.token === this.tok.T_WHITESPACE
                                       || !this.extractDoc
                        ...
                        module.exports={
                            ...
                            "read_use_declarations" : function read_use_declarations( typed ){
                                ...
                                while(this.token === ","){
                                    this.next();
                                    if(typed){
                                        if(this.token !== this.tok.T_NAME_RELATIVE
                                               && this.token !== this.tok.T_NAME_QUALIFIED
                                               && this.token !== this.tok.T_NAME_FULLY_QUALIFIED
