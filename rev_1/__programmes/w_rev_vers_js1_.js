...
class w_rev_vers_js1{
    ...
    */
    #macst_pour_javascript( elt ){
        let r=this.__rev1.ma_constante( elt );
        if(elt[4] === 1 || elt[4] === 3){
    ...
    */
    #rev_js1( id , niveau , opt ){
        ...
        const un_espace_p0=this.__rev1.resps( niveau );
        const un_espace_p1=this.__rev1.resps( niveau + 1 );
                ...
                switch (this.#tb[i][1]){
                    case "directive" :
                        if(this.#tb[i][8] === 1 && this.#tb[i + 1][2] === 'c'){
                            ...
                            return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' un seul argument'} ));
                        }
                        break;
                    ...
                    case 'identifiant' :
                        if(this.#tb[i][8] === 1 && this.#tb[i + 1][2] === 'c'){
                            ...
                            return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + ' "' + this.#tb[i][1] + '" doit avoir un seul paramètre '} ));
                        }
                        break;
                    ...
                    case 'debugger' :
                        if('useStrict' === this.#tb[i][1]){
                            ...
                            if(this.#tb[i][8] === 0){
                                ...
                                return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' doit être sous le format ' + this.tb[i][1] + '() strictement'} ));
                            }
                        }
                        break;
                    ...
                    case 'revenir' :
                        if(this.#tb[i][8] === 0){
                            ...
                            return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' ne doit pas avoir de paramètre'} ));
                        }
                        break;
                            ...
                            for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                                if(this.#tb[j][2] === 'c'){
                                    ...
                                    if(obj.__xst === __xsu){
                                        ...
                                        return(this.#rev_js_le( {"__xst" : __xer ,"id" : j ,"__xme" : this.__rev1.nl2() + 'retourner '} ));
                                    }
                    ...
                    case 'appelf' :
                        ...
                        if(obj.__xst === __xsu){
                            ...
                            return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + 'il faut un nom de fonction à appeler n(xxxx)'} ));
                        }
                        break;
                    ...
                    case 'cascade' :
                        ...
                        if(obj.__xst === __xsu){
                            ...
                            return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + 'cascade'} ));
                        }
                        break;
                    ...
                    case 'boucle_sur_objet_dans' :
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if(this.#tb[j][1] === 'pourChaque'){
                                ...
                                return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' syntaxe : pourChaque(dans(a , b)),faire()'} ));
                            }
                        }
                        var pourChaque='';
                        var faire='';
                        for( j=0 ; j < les_cas.length ; j=j + 1 ){
                            if(les_cas[j][1] === 'pourChaque'){
                                ...
                                if(obj.__xst === __xsu){
                                    ...
                                    return(this.#rev_js_le( {"__xst" : __xer ,"id" : les_cas[j][0] ,"__xme" : this.__rev1.nl2() + this.#tb[i][1]} ));
                                }
                    ...
                    case 'boucle_sur_objet_de' :
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if(this.#tb[j][1] === 'pourChaque'){
                                ...
                                return(this.#rev_js_le( {"__xst" : __xer ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + 'syntaxe = boucle_sur_objet_dans(pourChaque(dans(a , b)),faire())'} ));
                            }
                        }
                        for( j=0 ; j < les_cas.length ; j=j + 1 ){
                            if(les_cas[j][1] === 'pourChaque'){
                                ...
                                if(this.#tb[les_cas[j][0]][8] === 0){
                                    ...
                                    if(obj.__xst === __xsu){
                                        ...
                                        return(this.#rev_js_le( {"__xst" : __xer ,"id" : les_cas[j][0] ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + 'faire'} ));
                                    }
                                }
                            }
                        }
                                ...
                                if(this.#tb[j][1] === 'quand' && this.#tb[j][2] === 'f'){
                                    if(this.#tb[j][8] === 1 && this.#tb[j + 1][2] === 'c'){
                                        ...
                                        if(obj.__xst === __xsu){
                                            ...
                                            return(this.#rev_js_le( {"__xst" : __xer ,"id" : ind ,"__xme" : this.__rev1.nl2() + this.#tb[i][1]} ));
                                        }
                                    }
                                    ...
                                    for( k=j + 1 ; k < this.#l02 ; k=this.#tb[k][12] ){
                                        if(this.#tb[k][1] === 'valeurNonPrevue' && this.#tb[k][2] === 'f' && this.#tb[k][8] === 0){
                                            ...
                                            if(this.#tb[k][8] >= 1){
                                                ...
                                                niveau-=2;
                                                if(obj.__xst === __xsu){
                                                    InstructionsCas=this.__rev1.resps( niveau + 2 ) + obj.__xva;
                                                }else{
                                                    return(this.#rev_js_le( {"__xst" : __xer ,"id" : k ,"__xme" : this.__rev1.nl2() + this.#tb[i][1]} ));
                                                }
                                            }else{
                                                InstructionsCas='';
                                            }
                                        }else{
                                            return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + this.#tb[i][1]} ));
                                        }
                                    }
                                    valeursCase+=this.__rev1.resps( niveau + 1 );
                                    if(valeurCas === null){
                                        valeursCase+='default:';
                                    }else{
                                    ...
                                    if(InstructionsCas.length < 120){
                                        ...
                                        valeursCase+=InstructionsCas;
                                        valeursCase+=this.__rev1.resps( niveau + 2 );
                                    }
                                }else{
                                    return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + this.#tb[i][1]} ));
                                }
                    ...
                    case 'faire_tant_que' :
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if(this.#tb[j][1] === 'condition'){
                                ...
                                return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + 'syntaxe=faire_tant_que(instructions(),conditions())'} ));
                            }
                        }
                        var condition='';
                        var instructions='';
                    ...
                    case 'boucle' :
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if(this.#tb[j][1] === 'condition'){
                                ...
                                return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ',syntaxe = condition(),initialisation(),increment(),faire()'} ));
                            }
                        }
                        var initialisation='';
                        var condition='';
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if(this.#tb[j][1] === 'faire' && this.#tb[j][2] === 'f'){
                                        ...
                                        if(this.#tb[j + 2][1] === 'faire' && this.#tb[j + 2][2] === 'f'){
                                            if(this.#tb[j + 2][8] === 0){
                                                ...
                                                if(obj.__xst === __xsu){
                                                    ...
                                                    return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + 'sierreur'} ));
                                                }
                                            }
                                        }else{
                                            return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + 'sierreur le deuxième argument doit être "faire"'} ));
                                        }
                                    }else{
                                        return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + 'sierreur le premier argument doit être une variable'} ));
                                    }
                                }else{
                                    return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + 'sierreur doit contenir 2 arguments sierreur(e,faire())'} ));
                                }
                                ...
                                if(obj.__xst === __xsu){
                                    ...
                                    return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + 'finalement'} ));
                                }
                            }else{
                                return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + this.#tb[i][1]} ));
                            }
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if(this.#tb[j][1] === 'si'){
                                ...
                                return(this.#rev_js_le( {
                                        "__xst" : __xer ,
                                        "id" : id ,
                                        "__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ',syntaxe = si(condition(),alors()),sinonsi(condition(),alors()),sinon(alors())'
                                    } ));
                            }
                        }
                        for( j=0 ; j < les_cas.length ; j=j + 1 ){
                            if(les_cas[j][1] === '#'){
                                ...
                                if(this.#tb[les_cas[j][0]][13].indexOf( '\n' ) >= 0){
                                    t+=this.__rev1.resps( niveauSi );
                                }
                                var commt=this.__rev1.tr_co_src( this.#tb[les_cas[j][0]][13] , niveauSi , les_cas[j][0] );
                                t+='/*' + commt + '*/';
                                ...
                                if(debutCondition === 0){
                                    return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' condition est manquante dans un si'} ));
                                }
                                for( k=0 ; k < les_comts.length ; k=k + 1 ){
                                    if(les_comts[k].indexOf( '\n' ) >= 0){
                                        t+=this.__rev1.resps( niveau + 1 );
                                    }
                                    var commt=this.__rev1.tr_co_src( les_comts[k] , niveau + 1 , les_cas[j][0] );
                                    t+='/*' + commt + '*/';
                                    if(les_comts[k].indexOf( '\n' ) >= 0){
                                        t+=this.__rev1.resps( niveau + 1 );
                                    }
                                ...
                                if(this.#tb[debutCondition + 1][8] >= 5){
                                    ...
                                    if(obj.__xst === __xsu){
                                        ...
                                        return(this.#rev_js_le( {"__xst" : __xer ,"id" : les_cas[j][0] ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' condition '} ));
                                    }
                                }else{
                                ...
                                if(debutCondition === 0){
                                    return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + 'condition manquante dans le sinon'} ));
                                }
                                for( k=0 ; k < les_comts.length ; k=k + 1 ){
                                    if(les_comts[k].indexOf( '\n' ) >= 0){
                                        t+=this.__rev1.resps( niveau + 1 );
                                ...
                                if(this.#tb[debutCondition + 1][8] >= 5){
                                    ...
                                    if(obj.__xst === __xsu){
                                        ...
                                        return(this.#rev_js_le( {"__xst" : __xer ,"id" : les_cas[j][0] ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + 'sinonsi '} ));
                                    }
                                }else{
                                    obj=this.#TraiteOperations2( debutCondition , niveau + 1 , 0 , false );
                                    if(obj.__xst === __xsu){
                    ...
                    case 'variable_publique' :
                        ...
                        for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if(this.#tb[j][1] === '#' && this.#tb[j][2] === 'f'){
                                le_commentaire='/*' + this.__rev1.tr_co_src( this.#tb[j][13] , niveau , j ) + '*/' + this.__rev1.resps( niveau );
                            }else if(this.#tb[j][1] === 'prop' && this.#tb[j][2] === 'f'){
                                obj=this.#js_traiteInstruction1( niveau , j + 1 , {} );
                                if(obj.__xst === __xsu){
                                    la_propriété=obj.__xva;
                                }else{
                                    this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2() + this.#tb[i][1]} );
                                }
                            }else{
                        ...
                        if(les_declarations.length === 2){
                            ...
                            if("declare" === this.#tb[i][1]){
                                ...
                                return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' prefixe  inconnu'} ));
                            }
                            var debut='';
                            var debut2='';
                            obj1=this.#js_traiteInstruction1( niveau , les_declarations[0][0] , {} );
                            if(obj1.__xst === __xsu){
                                debut=le_commentaire + prefixe_declaration + obj1.__xva;
                                debut2=le_commentaire + obj1.__xva;
                            }else{
                                this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2() + this.#tb[i][1]} );
                            }
                                ...
                                if(dans_initialisation === true && t !== ''){
                                    ...
                                    if(obj.__xva === ''){
                                        ...
                                        if(la_propriété !== ''){
                                            ...
                                            if(le_commentaire.trim().indexOf( '\n' ) < 0
                                                   && (this.#tb[i][1] === 'declare_constante'
                                                       || this.#tb[i][1] === 'variable_publique'
                                                       || this.#tb[i][1] === 'variable_privée')
                                            ){
                                                t+=(prefixe_declaration + obj1.__xva) + '=' + le_commentaire.trim() + obj.__xva;
                                            }else{
                                                t+=debut + '=' + obj.__xva;
                                            }
                                        }
                            ...
                            return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : (this.__rev1.nl2() + this.#tb[i][1]) + ' declare  doit avoir 2 paramètres'} ));
                        }
                        break;
                        
                    case '#' :
                        var commt=this.__rev1.tr_co_src( this.#tb[i][13] , niveau , i );
                        t+='/*' + commt + '*/';
                        ne_pas_mettre_de_terminateur=true;
                        break;
                    ...
                    case 'throw' :
                        ...
                        if(this.#tb[i + 1][1] === 'new'){
                            ...
                            if(obj.__xst === __xsu){
                                ...
                                return(this.#rev_js_le( {"__xst" : __xer ,"id" : i + 1 ,"__xme" : this.__rev1.nl2() + this.#tb[i][1]} ));
                            }
    ...
    */
    #js_traiteInstruction1( niveau , id , opt ){
        ...
        if(this.#tb[id][2] === 'c'){
            ...
            switch (this.#tb[id][1]){
                case '#' :
                    t+='/*' + this.__rev1.tr_co_src( this.#tb[id][13] , niveau + 1 , id ) + '*/';
                    break;
                    ...
                    for( j=id + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                        if(this.#tb[j][1] === 'condition'){
                            ...
                            if(objCondition.__xst === __xsu){
                                ...
                                return(this.#rev_js_le( {"__xst" : __xer ,"id" : j ,"__xme" : this.__rev1.nl2() + this.#tb[id][1]} ));
                            }
                            ...
                            return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : (this.__rev1.nl2() + this.#tb[id][1]) + 'la syntaxe =testEnLigne(condition(),siVrai(),siFaux())'} ));
                        }
                    }
                    if(un_trop_long === true){
                        t=testlignecondition + ' ?' + this.__rev1.resps( niveau ) + '  ( ' + this.__rev1.resps( niveau + 1 ) + si_vrai + this.__rev1.resps( niveau ) + '  ) : ( ' + this.__rev1.resps( niveau + 1 ) + si_faux + this.__rev1.resps( niveau ) + '  )';
                    }else{
                        ...
                        for( var j=id + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if(this.#tb[j][2] === 'c'){
                                ...
                                if(objOperation.__xst === __xsu){
                                    ...
                                    return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + this.#tb[id][1]} ));
                                }
                                break;
                            }
                        }
                ...
                case '' :
                    ...
                    if(obj.__xst === __xsu){
                        ...
                        return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : (this.__rev1.nl2() + this.#tb[id][1]) + ' bloc'} ));
                    }
                    break;
                ...
                case 'virgule' :
                    ...
                    for( j=id + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                        if(this.#tb[j][1] === '#' && this.#tb[j][2] === 'f'){
                            virgule+='/*' + this.__rev1.tr_co_src( this.#tb[j][13] , niveau , j ) + '*/';
                    ...
                    /*
                      ...
                      if(obj.__xst === __xsu){
                      if(virgule !== '' && precedent_est_commentaire === false){
                      virgule+=',' + this.__rev1.resps( niveau - 1 );
                      }
                      virgule+=obj.__xva;
                      precedent_est_commentaire=false;
                      }else{
                    ...
                    if(positionDeclarationFonction >= 0 && positionContenu >= 0){
                        for( j=positionDeclarationFonction + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if(this.#tb[j][1] === 'nom'){
                                ...
                                if(this.#tb[j][8] === 1 && this.#tb[j + 1][1] === 'lire'){
                                    ...
                                    return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : (this.__rev1.nl2() + this.#tb[id][1]) + 'type méthode doit être écrire ou lire '} ));
                                }
                            }
                        }
                        argumentsFonction='';
                        ...
                        for( j=positionDeclarationFonction + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                            if(this.#tb[j][1] === 'argument'){
                                if(this.#tb[j + 1][2] === 'f' && this.#tb[j][1] === '#'){
                                    le_commentaire=' /*' + this.__rev1.tr_co_src( this.#tb[j][13] , niveau , j ) + '*/ ';
                                    ...
                                    for( var k=j + 1 ; k < this.#l02 ; k=this.#tb[k][12] ){
                                        if(this.#tb[k][2] === 'c'){
                                            ...
                                            if(obj.__xst === __xsu){
                                                ...
                                                return(this.#rev_js_le( {"__xst" : __xer ,"id" : j ,"__xme" : (this.__rev1.nl2() + this.#tb[id][1]) + 'argument(xxx,[defaut(yyy)]) '} ));
                                            }
                                            ...
                                            return(this.#rev_js_le( {"__xst" : __xer ,"id" : j ,"__xme" : this.#tb[k][1] + ' non prévu ' + this.__rev1.nl2()} ));
                                        }
                                    }
                        ...
                        if(nomFonction !== ''){
                            if('méthode' === this.#tb[id][1] && !(this.#tb[id - 1][1] === '#' && this.#tb[id - 1][2] === 'f')){
                                ...
                                */
                                t+=this.__rev1.resps( niveau ) + '/* function' + generateur + ' ' + nomFonction + ' */' + this.__rev1.resps( niveau );
                            }
                            if('méthode' === this.#tb[id][1]){
                                if(format_tableau === true){
                                    if(typeFonction === 'get '){
                                        ...
                                        return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : (this.__rev1.nl2() + this.#tb[id][1]) + ' ' + typeFonction} ));
                                    }
                                }else{
                            ...
                            if(this.#tb[positionContenu][8] === 0){
                                ...
                                if(obj.__xst === __xsu){
                                    ...
                                    return(this.#rev_js_le( {"__xst" : __xer ,"id" : positionContenu ,"__xme" : (this.__rev1.nl2() + this.#tb[id][1]) + ' contenu de "' + nomFonction + '"'} ));
                                }
                            }
                        }else{
                            return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2() + this.#tb[id][1]} ));
                ...
                default:
                    ...
                    if(this.#tbleau_precedences_js.hasOwnProperty( this.#tb[id][1] )){
                        ...
                        return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2() + ' non traité "' + this.#tb[id][1] + '"'} ));
                    }
        ...
        for( j=id + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
            if(this.#tb[j][1] === '#' && this.#tb[j][2] === 'f'){
                ...
                if(this.#tb[j][8] === 1 && this.#tb[j + 1][2] === 'c'){
                    ...
                    return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2()} ));
                }
    ...
    */
    #js_traite_affecte( id , niveau , opt ){
        ...
        for( j=id + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
            if(this.#tb[j][1] === '#' && this.#tb[j][2] === 'f'){
                commt+=this.__rev1.tr_co_src( this.#tb[j][13] , niveau , j );
            }else{
            ...
            if(objInstructionDroite.__xst === __xsu){
                ...
                */
                if(signe === '='
                    ...
                    t+=objInstructionGauche.__xva + signe + (commt === '' ? ( '' ) : ( '/* ' + commt.trim() + ' */' )) + droite;
                }
                    ...
                    if(l_objet_affecte['par2'][1] === 'prop'){
                        if(l_objet_affecte['par2'][2] === 'f'){
                            if(this.#tb[l_objet_affecte['par2'][0] + 1][2] === 'c'){
                                ...
                                return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2()} ));
                            }
                        }else{
                            return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2()} ));
                        }
        ...
        for( j=id + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
            ...
            if(this.#tb[j][1] === 'p' && this.#tb[j][2] === 'f'){
                if(this.#tb[j][8] === 0){
                    ...
                    textObj+='';
                    /*
                      this.#rev_js_le( {"__xst" : __xal ,"id" : j ,"__xme" : this.__rev1.nl2() + '<br />attention CE N\'EST PAS UNE ERREUR MAIS... paramètre vide dans un tableau'} );
                    */
                }else{
                    for( var k=j + 1 ; k < this.#l02 ; k=this.#tb[k][12] ){
                        if(this.#tb[k][1] === '#' && this.#tb[k][2] === 'f'){
                            ...
                            mettre_des_sauts=true;
                            textObj+=this.__rev1.resps( niveau + 1 );
                            valeur=this.__rev1.resps( niveau + 1 );
                            var commt=this.__rev1.tr_co_src( this.#tb[k][13] , niveau , j );
                            textObj+='/*' + commt + '*/';
                            valeur+='/*' + commt + '*/';
                            precedent_est_commentaire=true;
                        }else{
                ...
                textObj+=this.__rev1.resps( niveau + 1 );
                var commt=this.__rev1.tr_co_src( this.#tb[j][13] , niveau , j );
                textObj+='/*' + commt + '*/';
                precedent_est_commentaire=true;
                comptage=0;
            }
    ...
    */
    #js_traitetableau1( id , niveau , opt ){
            ...
            if(this.#tb[j][1] === 'nomt' && this.#tb[j][2] === 'f'){
                ...
                if(this.#tb[j][8] === 0){
                    ...
                    if(obj1.__xst === __xsu){
                        ...
                        return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2() + 'nomt'} ));
                    }
                }
                break;
            }
        ...
        if(position_de_l_appel > 0){
            for( j=id + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                if(this.#tb[j][2] === 'f'){
                    if(this.#tb[j][1] === 'nomt' || this.#tb[j][1] === 'p' || this.#tb[j][1] === '#' || this.#tb[j][1] === 'prop'){
                        ...
                        this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2() + 'nomt,p,prop mai pas "' + this.#tb[j][1] + '"'} );
                    }
                }
            }
            argumentsFonction='';
                    ...
                    if(this.#tb[j][8] === 0 && this.#tb[j + 1][2] === 'f'){
                        ...
                        if(this.#tb[j][8] === 1 && this.#tb[j + 1][1] === 'obj'){
                            ...
                            if(obj.__xst === __xsu){
                                ...
                                return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2() + 'obj'} ));
                            }
                        ...
                        if(this.#tb[j][8] === 1 && this.#tb[j + 1][2] === 'f'){
                            if(this.#tb[j + 1][1] === 'appelf'){
                                ...
                                if(obj.__xst === __xsu){
                                    ...
                                    return(this.#rev_js_le( {"__xst" : __xer ,"id" : j ,"__xme" : this.__rev1.nl2() + 'prop'} ));
                                }
                            }else{
                                return(this.#rev_js_le( {"__xst" : __xer ,"id" : j ,"__xme" : this.__rev1.nl2() + 'fonction inconnue ' + this.#tb[j][1]} ));
                            }
                        }
                    }
                }
            ...
            return(this.#rev_js_le( {"__xst" : __xer ,"id" : i ,"__xme" : this.__rev1.nl2() + 'nomt(xxxx)'} ));
        }
                ...
                for( j=i + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
                    if(this.#tb[j][2] === 'c'){
                        ...
                        if(this.#tb[j][1] === 'étend' && this.#tb[j][8] === 1 && this.#tb[j + 1][2] === 'c'){
                            ...
                            return(this.#rev_js_le( {"__xst" : __xer ,"id" : j ,"__xme" : this.__rev1.nl2() + ' "' + this.#tb[j][1] + '" inconnu'} ));
                        }
                    }
                }
    ...
    */
    #js_traiteDefinitionObjet( id , niveau , opt ){
        ...
        for( j=id + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
            est_methode=false;
            if(this.#tb[j][1] === '#' && this.#tb[j][2] === 'f'){
                commt=this.__rev1.tr_co_src( this.#tb[j][13] , niveau + 1 , j );
                if(commt.indexOf( '\n' ) >= 0){
                    valeur=' /*' + commt + ' ' + '*/';
                ...
                for( var k=j + 1 ; k < this.#l02 ; k=this.#tb[k][12] ){
                    if(this.#tb[k][2] === 'c'){
                        ...
                        if(this.#tb[k][1] === '#'){
                            commt=this.__rev1.tr_co_src( this.#tb[k][13] , niveau + 1 , j );
                            if(commt.indexOf( '\n' ) >= 0){
                                valeur='/*' + commt + ' ' + '*/';
                            }else{
                                valeur='/*' + commt + '*/';
                            ...
                            return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2() + 'dans js_traiteDefinitionObjet il y a un problème'} ));
                        }
                    }
                }
        ...
        let le_commentaire_en_ligne='';
        let l02=tableau_prop_objet.length;
        for( var i=0 ; i < l02 ; i++ ){
            if(i === 0 && a_des_commentaires){
                tt+=this.__rev1.resps( niveau + 1 );
            }
            if(tableau_prop_objet[i].type === 'comm'){
                if(tableau_prop_objet[i].valeur.length < 50
                       && tableau_prop_objet[i].valeur.indexOf( '\n' ) < 0
                       && i <= l02 - 2
                       && tableau_prop_objet[i + 1].type !== 'comm'
                       && tableau_prop_objet[i].valeur.indexOf( 'tbel' ) < 0
                       && tableau_prop_objet[i].valeur.replace( /\/\*/ , '' ).replace( /\*\// , '' ).trim() !== ''
                ){
                    le_commentaire_en_ligne=tableau_prop_objet[i].valeur;
                }else{
    ...
    */
    #js_traiteAppelFonction( id , dansConditionOuDansFonction , niveau , recursif , nom_de_la_fonction_parente ){
        ...
        var generateur='';
        let premier_argument_de_la_fonction_pour_sqliii=null;
        for( j=id + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
            if(this.#tb[j][1] === 'nomf' && this.#tb[j][2] === 'f'){
                ...
                if(this.#tb[j][8] === 0){
                    ...
                    */
                    ...
                    if(obj1.__xst === __xsu){
                        ...
                        return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2() + '"' + this.#tb[j][1] + '"'} ));
                    }
                ...
                if(this.#tb[j][8] === 0){
                    ...
                    obj=this.#rev_js1( j , niveau + 1 , {} );
                    if(obj.__xst === __xsu){
                        contenu_obj+='{' + this.__rev1.resps( niveau + 1 );
                        contenu_obj+=obj.__xva;
                        contenu_obj+=this.__rev1.resps( niveau ) + '}';
                    }else{
                        return(this.#rev_js_le( {"__xst" : __xer ,"id" : j ,"__xme" : this.__rev1.nl2()} ));
                    }
                }
                    ...
                    if(this.#tb[k][2] === 'c'){
                        ...
                        if(this.#tb[k][1] === '#'){
                            ...
                            if(obj_tableau.__xst === __xsu){
                                ...
                                return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2() + 'element'} ));
                            }
                            ...
                            if(objinst.__xst === __xsu){
                                ...
                                return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2() + 'element incorrecte dans appelf '} ));
                            }
                        }
                    }
                }
        ...
        if(!(positionAppelFonction > 0) && nomFonction !== ''){
            return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2() + ' il faut un nom de fonction à appeler nomf(xxxx)'} ));
        }
        for( j=id + 1 ; j < this.#l02 ; j=this.#tb[j][12] ){
            if(this.#tb[j][2] === 'f'){
                if(this.#tb[j][1] === 'element'
                    ...
                    return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2() + ' l\'argument de appelf "' + this.#tb[j][1] + '" n\'est pas pris en compte'} ));
                }
            }
        }
        argumentsFonction='';
                ...
                if(this.#tb[j][1] === 'obj'){
                    ...
                    if(obj.__xst === __xsu){
                        ...
                        if(nomFonction === 'Array' && nbEnfants >= 4){
                            forcerNvelleLigneEnfant=true;
                            argumentsFonction+=this.__rev1.resps( niveau + 1 );
                        }
                        argumentsFonction+=obj.__xva + ' ';
                    }else{
                        return(this.#rev_js_le( {"__xst" : __xer ,"id" : j ,"__xme" : this.__rev1.nl2()} ));
                    ...
                    if(this.#tb[j][8] === 0){
                        ...
                        argumentsFonction+=', ' + this.#macst_pour_javascript( this.#tb[j + 1] ) + ' ';
                        if(premier_argument_de_la_fonction_pour_sqliii === null){
                            premier_argument_de_la_fonction_pour_sqliii=this.#macst_pour_javascript( this.#tb[j + 1] );
                        }
                    }else if(this.#tb[j][8] > 1 && this.#tb[j + 1][2] === 'c'){
                        argumentsFonction+=', ';
                                ...
                                if(this.#tb[k][2] === 'c'){
                                    ...
                                    if(this.#tb[k][8] === 1 && this.#tb[k + 1][2] === 'c'){
                                        ...
                                        if(objJs.__xst === __xsu){
                                            ...
                                            return(this.#rev_js_le( {"__xst" : __xer ,"id" : this.#tb[k][0] ,"__xme" : this.__rev1.nl2()} ));
                                        }
                                    }
                                }else{
                                    return(this.#rev_js_le( {"__xst" : __xer ,"id" : j ,"__xme" : this.__rev1.nl2()} ));
                            ...
                            for( k=j + 1 ; k < this.#l02 ; k=this.#tb[k][12] ){
                                ...
                                if(this.#tb[k][1] === '#' && this.#tb[k][2] === 'f'){
                                    ...
                                    if(objOperation.__xst === __xsu){
                                        ...
                                        return(this.#rev_js_le( {"__xst" : __xer ,"id" : k ,"__xme" : this.__rev1.nl2()} ));
                                    }
                                }else if(this.#tb[k][2] === 'c'){
                                    argumentsFonction+=this.#macst_pour_javascript( this.#tb[k] ) + ' ';
                                    if(premier_argument_de_la_fonction_pour_sqliii === null){
                                        premier_argument_de_la_fonction_pour_sqliii=this.#macst_pour_javascript( this.#tb[k] );
                                    }
        ...
        if(recursif === true && nomRetour === '' && !dansConditionOuDansFonction){
            t+=this.__rev1.resps( niveau + 1 ) + (nomElement === '' ? ( '' ) : ( nomElement + '.' ));
        }else{
            if(nomElement !== ''){
        ...
        */
        ...
        if(nomFonction === 'function' || nomFonction === '' && flechee === true){
            var espaces_avant_contenu=this.__rev1.resps( niveau );
                ...
                */
                if(nom_de_la_fonction_parente === 'forEach'
                    ...
                    if(temp.substr( 0 , 8 ) === 'function'){
                        t+='{' + contenu + this.__rev1.resps( niveau ) + '}';
                    }else{
    ...
    */
    #TraiteOperations2( id , niveau , niveauOp , ajouter_des_sauts_de_lignes ){
        ...
        let propriete='';
        if(!this.#tbleau_precedences_js.hasOwnProperty( this.#tb[id][1] )){
            return(this.#rev_js_le( {"__xst" : __xer ,"id" : id ,"__xme" : this.__rev1.nl2() + ' pour "' + this.#tb[id][1] + '"'} ));
        }
        ...
        if(operandes.length === 0){
            ...
            if(ajouter_des_sauts_de_lignes !== undefined && ajouter_des_sauts_de_lignes === true){
                sauts=true;
                un_espace=this.__rev1.resps( niveau );
                un_espacem1=this.__rev1.resps( niveau - 1 );
                un_espacem2=this.__rev1.resps( niveau - 2 );
            }
    ...
    */
    c_tab_vers_js( tab , les_options ){
        ...
        if(obj.__xst === __xsu){
            ...
            return(this.#rev_js_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + 'erreur de conversion en js'} ));
        }
    }
    /*
      =============================================================================================================
    ...
    */
    c_rev_vers_js( source_rev , les_options ){
        ...
        let obj=null;
        /*
          obj=this.__rev1.txt_en_tableau(source_rev);
        ...
        */
        ...
        if(obj.__xst === __xsu){
            ...
            return(this.#rev_js_le( {"__xst" : __xer ,"__xme" : this.__rev1.nl2() + 'erreur dans un rev'} ));
        }
    }
}
export{w_rev_vers_js1 as w_rev_vers_js1};