...
class x_ecran_generer_programmes1{
    ...
    */
    recupere_elements_pour_générer_les_programmes1_clic( mat , d ){
        let obj_clic={
            "masquer_le_bouton_ajouter_et_retour" : document.getElementById( 'masquer_le_bouton_ajouter_et_retour' ).checked ? ( 1 ) : ( 0 ) ,
            "masquer_le_bouton_ajouter_seulement" : document.getElementById( 'masquer_le_bouton_ajouter_seulement' ).checked ? ( 1 ) : ( 0 ) ,
            ...
            "ref_liste_ecran" : document.getElementById( 'reference_requete_liste_ecran' ).value === '' ?
              ( 
                ...
                parseInt( document.getElementById( 'reference_requete_liste_ecran' ).value , 10 )
              ) ,
    ...
    */
            ...
            */
            ...
            if(le_colis.__xva.rev_fragment !== null){
                for(let j in le_colis.__xva.rev_fragment){
                    if(le_colis.__xva.rev_fragment[j] !== null){
            ...
            if(le_colis.__xva.le_source_n_existe_pas === false){
                if(le_colis.__xva.tab_ref !== null){
                    for(let i in le_colis.__xva.tab_ref){
                        if(i.substr( 0 , 4 ) === 'ref_'){
                        ...
                        }else if(i === 'masquer_le_bouton_ajouter_et_retour'){
                            if(le_colis.__xva.tab_ref[i] === 0){
                                document.getElementById( 'masquer_le_bouton_ajouter_et_retour' ).checked=false;
                            }else{
                                document.getElementById( 'masquer_le_bouton_ajouter_et_retour' ).checked=true;
                            }
                        }else if(i === 'masquer_le_bouton_ajouter_seulement'){
                            if(le_colis.__xva.tab_ref[i] === 0){
                                document.getElementById( 'masquer_le_bouton_ajouter_seulement' ).checked=false;
                            }else{
                                document.getElementById( 'masquer_le_bouton_ajouter_seulement' ).checked=true;
                            }
                        }else if(i === 'masquer_le_bouton_modifier_et_retour'){
                            if(le_colis.__xva.tab_ref[i] === 0){
                                document.getElementById( 'masquer_le_bouton_modifier_et_retour' ).checked=false;
                            }else{
                                document.getElementById( 'masquer_le_bouton_modifier_et_retour' ).checked=true;
                            }
                        }else if(i === 'est_une_grandeur'){
                            if(le_colis.__xva.tab_ref[i] === 0){
                                document.getElementById( 'est_une_grandeur' ).checked=false;
                            }else{
                            ...
                            */
                        ...
                        }else if(i === 'avec_creer_et_dupliquer1'){
                            if(le_colis.__xva.tab_ref[i] === 0){
                            ...
                            if(le_colis.__xva.tab_ref[i] === 0){
                                ...
                                document.getElementById( 'puiser_avec' ).value=parseInt( le_colis.__xva.tab_ref[i] , 10 );
                            }
                        }
                    }
                }
                this.#liste_des_liens_dejà_definis={};
                this.#liste_des_liens_dejà_definis_pour_affichage={};
                if(le_colis.__xva.tab_liens_parents.length > 0){
                    console.log( le_colis.__xva.tab_liens_parents );
                    let liens_trouves=false;
                    let a_convertir=le_colis.__xva.tab_liens_parents.join( ' ' );
                    /*
                      on supprime les commentaires
                    */
                    a_convertir=a_convertir.replace( /\/\*[\s\S]*?\*\//g , '' );
                    let obj1=this.__ig1.__rev1.rev_tm( a_convertir );
                    ...
                    if(obj1.__xst === __xsu){
                        ...
                        for( let i=1 ; i < l01 ; i=mat1[i][12] ){
                            if(mat1[i][1] === 'lien_parent2'
                                ...
                                if(this.#liste_des_liens_dejà_definis_pour_affichage.hasOwnProperty( mat1[i + 1][1] )){
                                    if(this.#liste_des_liens_dejà_definis_pour_affichage[mat1[i + 1][1]].hasOwnProperty( mat1[i + 2][1] )){
                                        this.#liste_des_liens_dejà_definis_pour_affichage[mat1[i + 1][1]][mat1[i + 2][1]]++;
                                    }else{
                                        this.#liste_des_liens_dejà_definis_pour_affichage[mat1[i + 1][1]][mat1[i + 2][1]]=1;
                                    }
                                }else{
                                    this.#liste_des_liens_dejà_definis_pour_affichage[mat1[i + 1][1]]={};
                                    this.#liste_des_liens_dejà_definis_pour_affichage[mat1[i + 1][1]][mat1[i + 2][1]]=1;
                                }
                                liens_trouves=true;
                            }else if(mat1[i][1] === 'lien_dans_objet1' && mat1[i][2] === 'f' && mat1[i][8] === 2){
                                this.#liste_des_liens_dejà_definis[mat1[i + 2][1]]=mat1[i + 1][1];
                                if(this.#liste_des_liens_dejà_definis_pour_affichage.hasOwnProperty( mat1[i + 1][1] )){
                                    if(this.#liste_des_liens_dejà_definis_pour_affichage[mat1[i + 1][1]].hasOwnProperty( mat1[i + 2][1] )){
                                        this.#liste_des_liens_dejà_definis_pour_affichage[mat1[i + 1][1]][mat1[i + 2][1]]++;
                        ...
                        console.log( '%cconvertion KO pour ' + a_convertir , 'background:red;color:yellow;' );
                    }
                    if(liens_trouves === true){
                        let o2='<table>';
                        for(let i in this.#liste_des_liens_dejà_definis_pour_affichage){
                            o2+='<tr>';
                            o2+='<td>';
                            o2+=i;
                            o2+='</td>';
                            o2+='<td>';
                            for(let j in this.#liste_des_liens_dejà_definis_pour_affichage[i]){
                                o2+=j + ' , ';
                            }
                            o2+='</td>';
                            o2+='</tr>';
    ...
    /*
      =============================================================================================================
    */
    liste_des_liens_parmis1( obj_champ ){
        let o2='';
        ...
        if(obj1.__xst !== __xsu){
            return({
                    "__xst" : __xer ,
                    "__xme" : "erreur de convertion de champ parmis pour le champ \"" + obj_champ.nom_du_champ + "\"" + this.__ig1.nl2()
                });
        }
        o2+='        /* Liste des Liens Parmis Du Genre */\r\n';
        o2+='        let llpdg_' + obj_champ.nom_du_champ + '=[\r\n';
        o2+='            /*  */\r\n';
        let mat1=obj1.__xva;
        let l01=mat1.length;
        for( let i=1 ; i < l01 ; i=mat1[i][12] ){
            if(mat1[i][2] === 'c' && mat1[i][8] === 0){
                ...
                if(mat1[i][4] === 1 || mat1[i][4] === 0){
                    ...
                    o2+='            `';
                    o2+='<div class="rev_bouton" data-rev_click="m1(n1(__ig1),f1(maj_contenu(type_cible(valeur_constante),';
                    o2+='id(' + obj_champ.nom_du_champ + '),';
                    o2+='valeur(valeur_constante(' + val2 + '))';
                    o2+=')))">' + libelle2 + '</div>';
                    o2+='` ,\r\n';
                }else if(mat1[i][4] === 3){
                    /* guillemet */
                    ...
                    o2+='            /* guillemets */\r\n';
                    o2+='            `';
                    o2+='<div class="rev_bouton" data-rev_click="m1(n1(__ig1),f1(maj_contenu(\r\n';
                    o2+='               type_cible(valeur_constante),\r\n';
                    o2+='               id(' + obj_champ.nom_du_champ + '),\r\n';
                    o2+='               valeur(\r\n';
                    o2+='               valeur_constante(' + val2 + ')\r\n';
                    o2+='               )';
                    o2+='';
                    o2+=')))">';
                    o2+=libelle2;
    ...
    */
    générer_les_programmes( mat , d ){
        ...
        */
        ...
        let puiser_avec=parseInt( document.getElementById( 'puiser_avec' ).value , 10 );
                                ...
                                if(mati[k][1] === 'affecte' && mati[k][2] === 'f'){
                                    for( let l=k + 1 ; l < mati.length ; l=mati[l][12] ){
                                        if(mati[l][1] === 'champ' && mati[l][2] === 'f' && mati[l][8] === 1 && mati[l + 1][2] === 'c'){
                                            liste_des_champs_insert.push( {
                                                     /*  */
                                                    "nom_du_champ" : mati[l + 1][1] ,
                                                    "nom_variable_session" : ''
                                                } );
                                        }else if(mati[l][1] === 'session' && mati[l][2] === 'f' && mati[l][8] === 1 && mati[l + 1][2] === 'c'){
                                            liste_des_champs_insert[liste_des_champs_insert.length - 1].nom_variable_session=mati[l + 1][1];
                                        }
                                    }
                                }
                            }
                                    ...
                                    if(mats[k][8] === 2){
                                        if(mats[k + 1][1] === 'T0'){
                                            ...
                                            liste_des_champs_select.push( {
                                                    ...
                                                    "alias_table_mere" : '' ,
                                                    "table_mere" : table_mere ,
                                                    "champ_pere" : champ_pere ,
                                                    "nom_variable_session" : ''
                                                } );
                                        }else{
                                            liste_des_champs_select.push( {
                            ...
                            for( let k=j + 1 ; k < mats.length ; k++ ){
                                if(mats[k][1] === 'champ' && mats[k][2] === 'f'){
                                    if(mats[k][8] === 1 && mats[k + 1][2] === 'c'){
                                        liste_des_champs_condition_select.push( {"nom_du_champ" : mats[k + 1][1] ,"champ_dans_la_base" : null ,"nom_variable_session" : ''} );
                                    }else if(mats[k][8] === 2 && mats[k + 1][2] === 'c'){
                                        liste_des_champs_condition_select.push( {"nom_du_champ" : mats[k + 2][1] ,"champ_dans_la_base" : null ,"nom_variable_session" : ''} );
                                    }
                                }else if(mats[k][1] === 'session' && mats[k][2] === 'f' && mats[k][8] === 1 && mats[k + 1][2] === 'c'){
                                    liste_des_champs_condition_select[liste_des_champs_condition_select.length - 1].nom_variable_session=mats[k + 1][1];
                                }
                            }
                        }
                    }
        ...
        let liste_des_champs_visualisation_delete=[];
        let matd=null;
        if(ref_delete !== ''){
            ...
            for( let i=1 ; i < matd.length ; i=matd[i][12] ){
                if(matd[i][1] === 'supprimer' && matd[i][2] === 'f'){
                    for( let j=i + 1 ; j < matd.length ; j=matd[j][12] ){
                        ...
                        }else if(matd[j][1] === 'valeurs' && matd[j][2] === 'f'){
                            for( let k=j + 1 ; k < matd.length ; k++ ){
                                if(matd[k][1] === 'champ' && matd[k][2] === 'f' && matd[k][8] === 2 && matd[k + 1][2] === 'c'){
                                    liste_des_champs_visualisation_delete.push( {"nom_du_champ" : matd[k + 2][1] ,"champ_dans_la_base" : null} );
                                }
                            }
                        }
                    }
        ...
        for(let i in liste_des_champs_visualisation_delete){
            let champ_dans_la_base=this.#obj_table.champs[liste_des_champs_visualisation_delete[i].nom_du_champ];
            liste_des_champs_visualisation_delete[i].champ_dans_la_base=champ_dans_la_base;
        }
        ...
        if(ref_update !== ''){
                            ...
                            for( let k=j + 1 ; k < lngumat ; k=matu[k][12] ){
                                if(matu[k][1] === 'affecte' && matu[k][2] === 'f'){
                                    for( let l=k + 1 ; l < lngumat ; l=matu[l][12] ){
                                        ...
                                        }else if(matu[l][1] === 'session' && matu[l][2] === 'f' && matu[l][8] === 1 && matu[l + 1][2] === 'c'){
                                            liste_des_champs_update[liste_des_champs_update.length - 1].nom_variable_session=matu[l + 1][1];
                                        }
                                    }
                                }
                            }
                            ...
                            for( let k=j + 1 ; k < lngumat ; k++ ){
                                if(matu[k][1] === 'champ' && matu[k][2] === 'f' && matu[k + 1][2] === 'c'){
                                    if(matu[k][8] === 1){
                                        ...
                                        liste_des_champs_condition_update.push( {"nom_du_champ" : nom_du_champ ,"champ_dans_la_base" : null ,"champ_session" : champ_session ,"nom_variable_session" : ''} );
                                    }else{
                                ...
                                }else if(matu[k][1] === 'session' && matu[k][2] === 'f' && matu[k][8] === 1 && matu[k + 1][2] === 'c'){
                                    liste_des_champs_condition_update[liste_des_champs_condition_update.length - 1].nom_variable_session=matu[k + 1][1];
                                }
                            }
                        }else if(matu[j][1] === 'champs_visualisation_update' && matu[j][2] === 'f'){
                            let lngumat=matu.length;
                            for( let k=j + 1 ; k < lngumat ; k=matu[k][12] ){
                                if(matu[k][1] === 'champ' && matu[k][2] === 'f' && matu[k][8] === 2 && matu[k + 1][2] === 'c'){
                                                                                        ...
                                                                                        for( let r=p + 1 ; r < lngbmat && !trouve ; r=matb[r][12] ){
                                                                                            if(matb[r][1] === 'meta' && matb[r][2] === 'f'){
                                                                                                for( let s=r + 1 ; s < lngbmat ; s=matb[s][12] ){
                                                                                                    ...
                                                                                                    }else if(matb[s][1] === 'libelle_du_champ' && matb[s][2] === 'f'){
                                                                                                        champ_dans_la_base.libelle_du_champ=matb[s + 1][1];
                                                                                                    }else if(matb[s][1] === 'genre' && matb[s][2] === 'f'){
                                                                                                        champ_dans_la_base.genre=matb[s + 1][1];
                                                                                                    }else if(matb[s][1] === 'longueur_du_champ' && matb[s][2] === 'f'){
                                                                                                        if(matb[s][8] === 2){
                                                                                                            longueur_du_champ=matb[s + 1][1] + ',' + matb[s + 2][1];
                                                                                                        }
                                                                                                    }
                                                                                                }
                                                                                                liste_des_champs_visualisation_update.push( {
                                                                                                        ...
                                                                                                        "champ_dans_la_base" : champ_dans_la_base ,
                                    ...
                                    if(trouve === false){
                                        console.log( '%c le champ visualisation ' + matu[k + 1][1] + '.' + matu[k + 2][1] + 'non trouvé dans la requete select ' , 'color:red;background:yellow;' );
                                    }
                                }
                            }
                        }
            ...
            const le01=matu.length;
            for( let i=1 ; i < le01 ; i=matu[i][12] ){
                if(matu[i][1] === 'modifier' && matu[i][2] === 'f'){
                    for( let j=i + 1 ; j < le01 ; j=matu[j][12] ){
                        if(matu[j][1] === 'champs_combinaison_update' && matu[j][2] === 'f'){
                            /* champs_combinaison_update */
                            for( let k=j + 1 ; k < le01 ; k=matu[k][12] ){
                                if(matu[k][1] === '' && matu[k][2] === 'f'){
                                    let champs=[];
                                    let entete_liste='';
                                    let format_colonne='';
                                    let format_entete='';
                                    for( let l=k + 1 ; l < le01 ; l=matu[l][12] ){
                                        if(matu[l][1] === 'utiliser' && matu[l][2] === 'f'){
                                            let le_champ={"prefix" : '' ,"nom_du_champ" : '' ,"nom_complet_du_champ" : ''};
                                            for( let m=l + 1 ; m < le01 ; m=matu[m][12] ){
                                                if(matu[m][1] === 'champ' && matu[m][2] === 'f' && matu[m][8] === 2){
                                                    le_champ['prefix']=matu[m + 1][1];
                                                    le_champ['nom_du_champ']=matu[m + 2][1];
                                                    le_champ['nom_complet_du_champ']=matu[m + 1][1] + '_' + matu[m + 2][1];
                                                }
                                            }
                                            champs.push( le_champ );
                                        }
                                    }
                                    champs_combinaison_update.push( {"combinaison" : champs} );
                                }
                            }
                        }
                    }
        ...
        if(ref_liste_ecran !== ''){
                        ...
                        if(matle[j][1] === 'champs_combinaison_liste' && matle[j][2] === 'f'){
                            ...
                            for( let k=j + 1 ; k < le01 ; k=matle[k][12] ){
                                if(matle[k][1] === '' && matle[k][2] === 'f'){
                                    ...
                                    let format_entete='';
                                    for( let l=k + 1 ; l < le01 ; l=matle[l][12] ){
                                        if(matle[l][1] === 'utiliser' && matle[l][2] === 'f'){
                                            let le_champ={
                                                "prefix" : '' ,
                                                "nom_du_champ" : '' ,
                                                "nom_complet_du_champ" : '' ,
                                                "htm_pref" : '' ,
                                                "htm_clas" : '' ,
                                                "htm_prop" : '' ,
                                                "htm_post" : '' ,
                                                "le_champ_dans_la_base" : null
                                            };
                                            for( let m=l + 1 ; m < le01 ; m=matle[m][12] ){
                                                if(matle[m][1] === 'champ' && matle[m][2] === 'f' && matle[m][8] === 2){
                                                    le_champ['prefix']=matle[m + 1][1];
                                                    le_champ['nom_du_champ']=matle[m + 2][1];
                                                    le_champ['nom_complet_du_champ']=matle[m + 1][1] + '_' + matle[m + 2][1];
                                                }else if(matle[m][1] === 'htm_pref' && matle[m][2] === 'f' && matle[m][8] === 1){
                                                    le_champ['htm_pref']=matle[m + 1][1];
                                                }else if(matle[m][1] === 'htm_post' && matle[m][2] === 'f' && matle[m][8] === 1){
                                                    le_champ['htm_post']=matle[m + 1][1];
                                                }else if(matle[m][1] === 'htm_clas' && matle[m][2] === 'f' && matle[m][8] === 1){
                                                    le_champ['htm_clas']=matle[m + 1][1];
                                                }else if(matle[m][1] === 'htm_prop' && matle[m][2] === 'f' && matle[m][8] === 1){
                                                    le_champ['htm_prop']=matle[m + 1][1];
                                                }
                                            }
                                            champs.push( le_champ );
                                        }else if(matle[l][1] === 'entete_liste' && matle[l][2] === 'f' && matle[l][8] === 1){
                                            entete_liste=matle[l + 1][1];
                                        }else if(matle[l][1] === 'format_colonne' && matle[l][2] === 'f' && matle[l][8] === 1){
                                            format_colonne=matle[l + 1][1];
                                        }else if(matle[l][1] === 'format_entete' && matle[l][2] === 'f' && matle[l][8] === 1){
                                            format_entete=matle[l + 1][1];
                                        }
                                    }
                                    champs_combinaison_liste.push( {"combinaison" : champs ,"entete_liste" : entete_liste ,"format_colonne" : format_colonne ,"format_entete" : format_entete} );
                                }
                            }
                        }
                    }
            ...
            for(let i in liste_des_champs_condition_liste_ecran){
                ...
                if(liste_des_champs_condition_liste_ecran[i].préfixe_du_champ === 'T0'){
                    ...
                    let ref_table=liste_de_tables_liste_ecran[liste_des_champs_condition_liste_ecran[i].préfixe_du_champ];
                    let nt=ref_table.nom_de_la_table;
                    let aa=this.#obj_bdd[nt];
                    if(aa === undefined){
                        let numero_de_base=liste_de_tables_liste_ecran[liste_des_champs_condition_liste_ecran[i].préfixe_du_champ].base_numerique;
                        let mat2=this.#les_bases[numero_de_base].matrice;
                        let l02=mat2.length;
                        let obj_oout=null;
                        for( let j=1 ; j < l02 ; j=mat2[j][12] ){
                            if(mat2[j][2] === 'f' && mat2[j][1] === 'créer_table'){
                                ...
                                if(nom_de_la_table === nt){
                                    obj_oout=this.enrichir_table_de_base( mat2 , j , numero_de_base , nom_de_la_table );
                                }
                            }
                        }
                        this.#obj_bdd[nt]=obj_oout.oout;
                        liste_des_champs_condition_liste_ecran[i].champ_dans_la_base=obj_oout.oout.champs[liste_des_champs_condition_liste_ecran[i].nom_du_champ];
            ...
            */
            for(let i in liste_des_champs_liste_ecran){
                if(liste_des_champs_liste_ecran[i].préfixe_du_champ === 'T0'){
                    ...
                    if(champ_dans_la_base.espece_du_champ === "DECIMAL"){
            ...
            /*
              recherche des types de champs pour les combinaisons
            */
            for(let i in champs_combinaison_liste){
                let tt=champs_combinaison_liste[i];
                for(j in tt.combinaison){
                    let champ=tt.combinaison[j];
                    if(champ.nom_complet_du_champ.substr( 0 , 3 ) === 'T0_'){
                        let le_champ_dans_la_base=this.#obj_table.champs[champ.nom_du_champ];
                        champs_combinaison_liste[i].combinaison[j].le_champ_dans_la_base=le_champ_dans_la_base;
                        champs_combinaison_liste[i].combinaison[j]['espece_du_champ']=le_champ_dans_la_base.espece_du_champ;
                        if(le_champ_dans_la_base.espece_du_champ === "DECIMAL"){
                            let lng_size=21;
                            let lng_maxlength=21;
                            if(le_champ_dans_la_base.longueur_du_champ.indexOf( ',' ) >= 0){
                                let tabt=le_champ_dans_la_base.longueur_du_champ.split( ',' );
                                ...
                                champs_combinaison_liste[i].combinaison[j]['nombre_de_decimales']=tabt[1];
                            }
                        }
                    }else{
                        let nt=liste_de_tables_liste_ecran[champs_combinaison_liste[i].combinaison[j].prefix].nom_de_la_table;
                        let aa=this.#obj_bdd[nt];
                        if(aa === undefined){
                            /*
                              le champ fait référence à une table dans une autre base
                            ...
                            */
                            ...
                            let le_champ_dans_la_base=aa['champs'][champ.nom_du_champ];
                            champs_combinaison_liste[i].combinaison[j].le_champ_dans_la_base=le_champ_dans_la_base;
                            if(le_champ_dans_la_base.espece_du_champ === "DECIMAL"){
                                let lng_size=21;
                                let lng_maxlength=21;
        ...
        */
        ...
        if(ref_update !== ''){
            ...
            for( let i=0 ; i < tableau_des_fragments_serveur.length ; i++ ){
                if(tableau_des_fragments_serveur[i].nom_methode_serveur === 'actions_et_tests_apres_page_modifications'){
                    fragment_trouve=i;
                    break;
                }
            }
            ...
            */
            ...
            if(fragment_trouve >= 0){
                ...
                src_serveur_js2+='      =============================================================================================================\r\n';
                src_serveur_js2+='    */\r\n';
                src_serveur_js2+='    async tests_et_actions_apres_modifier(mat , d , fo1 , __xva_avant , __db1){\r\n';
                src_serveur_js2+='        return{__xst:__xsu};\r\n';
                src_serveur_js2+='    }\r\n';
            }
            /*
            */
            ...
            if(fragment_trouve >= 0){
                ...
                src_serveur_js2+='      =============================================================================================================\r\n';
                src_serveur_js2+='    */\r\n';
                src_serveur_js2+='    async actions_et_tests_avant_modifier( mat , d , fo1 , __xva_avant , __db1 ){\r\n';
                src_serveur_js2+='        return{__xst:__xsu};\r\n';
                src_serveur_js2+='    }\r\n';
            }
        }
        ...
        */
        if(ref_delete !== ''){
            fragment_trouve=-1;
            for( let i=0 ; i < tableau_des_fragments_serveur.length ; i++ ){
                if(tableau_des_fragments_serveur[i].nom_methode_serveur === 'test_avant_supprimer'){
                    fragment_trouve=i;
                    break;
                }
            }
            ...
            */
            ...
            if(fragment_trouve >= 0){
                ...
                src_serveur_js2+='      =============================================================================================================\r\n';
                src_serveur_js2+='    */\r\n';
                src_serveur_js2+='    async actions_apres_supprimer( mat , d , fo1 , __xva_avant , __db1 ){\r\n';
                src_serveur_js2+='        return{__xst:__xsu};\r\n';
                src_serveur_js2+='    }\r\n';
            }
        }
        ...
        */
        if(ref_insert !== ''){
            fragment_trouve=-1;
            for( let i=0 ; i < tableau_des_fragments_serveur.length ; i++ ){
                if(tableau_des_fragments_serveur[i].nom_methode_serveur === 'tests_avant_creer'){
                    fragment_trouve=i;
                    break;
                }
            }
            if(fragment_trouve >= 0){
                ...
                src_serveur_js2+='      =============================================================================================================\r\n';
                src_serveur_js2+='    */\r\n';
                src_serveur_js2+='    async tests_avant_creer( mat , d , fo1 , __db1 ){\r\n';
                src_serveur_js2+='        return{__xst:__xsu};\r\n';
                src_serveur_js2+='    }\r\n';
            }
            /*
            ...
            */
            ...
            if(fragment_trouve >= 0){
                ...
                src_serveur_js2+='      =============================================================================================================\r\n';
                src_serveur_js2+='    */\r\n';
                src_serveur_js2+='    async action_apres_creer( mat , d , nouvel_id , fo1 , __db1 ){\r\n';
                src_serveur_js2+='        return{__xst:__xsu};\r\n';
                src_serveur_js2+='    }\r\n';
            }
        }
        ...
        */
        ...
        if(masquer_le_bouton_modifier_et_retour !== 0){
            src_client2+='      masquer_le_bouton_modifier_et_retour=' + masquer_le_bouton_modifier_et_retour + ';\n';
        }
        if(masquer_le_bouton_ajouter_et_retour !== 0){
            src_client2+='      masquer_le_bouton_ajouter_et_retour=' + masquer_le_bouton_ajouter_et_retour + ';\n';
        }
        if(masquer_le_bouton_ajouter_seulement !== 0){
            src_client2+='      masquer_le_bouton_ajouter_seulement=' + masquer_le_bouton_ajouter_seulement + ';\n';
        }
        ...
        */
        ...
        let les_conversions_update1='';
        let les_conversions_create1='';
        let les_tests_standarts_modifier_update_client1='';
        let les_tests_particuliers_modifier_update_client1='';
        let les_tests_particuliers_modifier_update_serveur1='';
        let les_tests_standarts_creer1='';
        let les_tests_particuliers_client_creer2='';
        let les_tests_particuliers_serveur_creer2='';
        fragment_trouve=-1;
        ...
        if(est_une_grandeur === 1){
            ...
            src_client2+='      =============================================================================================================\r\n';
            src_client2+='    */\r\n';
            src_client2+='    selectionner_une_grandeur_sous_liste2( mat , d ){\r\n';
            src_client2+='        return(this.__ig1.__fnt1.generique_selectionner_une_grandeur_sous_liste2( mat , d ));\r\n';
            src_client2+='    }\r\n';
            src_client2+='    /*\r\n';
            src_client2+='      =============================================================================================================\r\n';
            src_client2+='    */\r\n';
            src_client2+='    obtenir_les_grandeurs_pour_sous_liste2( mat , d , le_colis ){\r\n';
            src_client2+='        return(this.__ig1.__fnt1.generique_obtenir_les_grandeurs_pour_sous_liste2( mat , d , le_colis , this ));\r\n';
            src_client2+='    }\r\n';
            src_client2+='    /*\r\n';
            src_client2+='      =============================================================================================================\r\n';
            src_client2+='    */\r\n';
            src_client2+='    selectionner_des_grandeur_de_la_liste_pour_le_filtre( mat , d ){\r\n';
            src_client2+='        return(this.__ig1.__fnt1.generique_selectionner_des_grandeur_de_la_liste_pour_le_filtre( mat , d ));\r\n';
            src_client2+='    }\r\n';
            src_client2+='    /*\r\n';
            src_client2+='      =============================================================================================================\r\n';
            src_client2+='      UNE grandeurs quand on est sur une zone filtre\r\n';
            src_client2+='    */\r\n';
            src_client2+='    selectionner_une_grandeur_de_la_liste_pour_le_filtre( mat , d ){\r\n';
            src_client2+='        return(this.__ig1.__fnt1.generique_selectionner_une_grandeur_de_la_liste_pour_le_filtre( mat , d ));\r\n';
            src_client2+='    }\r\n';
            src_client2+='    /*\r\n';
            src_client2+='      =============================================================================================================\r\n';
            src_client2+='      PLUSIEURS grandeurs quand on est sur une zone filtre\r\n';
            src_client2+='    *' + '/\r\n';
            src_client2+='    obtenir_les_grandeurs_pour_filtre_liste2( mat , d , le_colis1=null ){\r\n';
            src_client2+='        return(this.__ig1.__fnt1.generique_obtenir_les_grandeurs_pour_filtre_liste2( mat , d , le_colis1 , this ));\r\n';
            src_client2+='    }\r\n';
        }
        if(fragment_trouve >= 0){
        ...
        let liste_des_grandeurs_initialisees=null;
        for(let i in this.#obj_bdd[table_de_reference].champs){
            let elem=this.#obj_bdd[table_de_reference].champs[i];
            if(elem.table_mere === 'tbl_grandeurs' && elem.valeur_par_defaut !== ''){
                if(liste_des_grandeurs_initialisees === null){
                    liste_des_grandeurs_initialisees={};
                }
                liste_des_grandeurs_initialisees[i]=elem;
            }
        }
        fragment_trouve=-1;
        for( let i=0 ; i < tableau_des_fragments_client.length ; i++ ){
        ...
        if(fragment_trouve >= 0){
            ...
            if(pour_sous_liste_uniquement === 1 && est_une_grandeur === 1){
                ...
                src_client2+='\'<div class="yy_svg1 yy__xif" data-rev_click="';
        ...
        if(ref_update !== '' && ref_select !== ''){
            ...
            fragment_trouve=-1;
            for( let i=0 ; i < tableau_des_fragments_client.length ; i++ ){
                if(tableau_des_fragments_client[i].nom_methode_client === 'afficher_le_contenu_sous_pg_modif1'){
                    fragment_trouve=i;
                    break;
                }
            }
            if(fragment_trouve >= 0){
                ...
                src_client2+='        }\r\n';
                src_client2+='        document.getElementById( \'vv_ecran_modification_zone_complement\' ).innerHTML=o1;\r\n';
                src_client2+='    }\r\n';
            }
            /*  */
            src_client2+='    /*\r\n';
            ...
            src_client2+='        if(this.__ig1.stockage_local.aspect[\'--supprimer_les_messages_affiches_lors_d_un_envoi_de_colis\'].valeur === 1){\r\n';
            src_client2+='            this.__ig1.supprimer_les_messages();\r\n';
            src_client2+='        }\r\n';
            src_client2+='        let retour_a_la_liste=\'\';\r\n';
            src_client2+='        const l01=mat.length;\r\n';
            ...
            les_conversions_update1+='            {nc : "id1" , nz : \'' + champ_primaire + '\' , m : \'une erreur système est survenue sur le champ "identifiant"\'},\r\n';
            if(liste_des_conversions_modification.length > 0){
                /*
                  les_conversions_update1+='        fo1.' + champ_primaire + '=fo1.' + champ_primaire + ' === \'\'?null:parseInt( fo1.' + champ_primaire + ' , 10 );\r\n';
                */
                for( let i=0 ; i < liste_des_conversions_modification.length ; i++ ){
                    ...
                    if(liste_des_conversions_modification[i].hasOwnProperty( 'valeur_par_defaut' )){
                        if(liste_des_conversions_modification[i].valeur_par_defaut.toUpperCase() === 'NULL'){
                            ...
                            vpd=liste_des_conversions_modification[i].valeur_par_defaut;
                        }
                    }else{
                        vpd=undefined;
                    }
                    let nom_du_champ=liste_des_conversions_modification[i].nom_du_champ;
                    if(liste_des_conversions_modification[i].espece_du_champ === 'INTEGER'){
                        les_conversions_update1+='    {';
                        les_conversions_update1+='"nc" : "entier1" ,';
                        les_conversions_update1+='"nz" : \'' + liste_des_conversions_modification[i].nom_du_champ + '\' ,';
                        les_conversions_update1+='"vpd" : ' + vpd + ' ,';
                        les_conversions_update1+='"lib" : \'' + liste_des_conversions_modification[i].meta.libelle_du_champ.replace( /"/g , '&quot;' ).replace( /\'/g , '&apos;' ) + '\'';
                        les_conversions_update1+='},\r\n';
                    }else if(liste_des_conversions_modification[i].espece_du_champ === 'FLOAT'){
                        les_conversions_update1+='    {';
                        les_conversions_update1+='"nc" : "float1" ,';
                        les_conversions_update1+='"nz" : \'' + liste_des_conversions_modification[i].nom_du_champ + '\' ,';
                        les_conversions_update1+='"vpd" : ' + vpd + ' , ';
                        les_conversions_update1+='"lib" : \'' + liste_des_conversions_modification[i].meta.libelle_du_champ.replace( /"/g , '&quot;' ).replace( /\'/g , '&apos;' ) + '\'';
                        les_conversions_update1+='},\r\n';
                    }else if(liste_des_conversions_modification[i].espece_du_champ === 'DECIMAL'){
                        les_conversions_update1+='    {';
                        les_conversions_update1+='"nc" : "decim1" ,';
                        les_conversions_update1+='"nz" : \'' + liste_des_conversions_modification[i].nom_du_champ + '\' ,';
                        les_conversions_update1+='"vpd" : ' + vpd + ' ,';
                        les_conversions_update1+='"ldc" : \'' + liste_des_conversions_modification[i].longueur_du_champ + '\' ,';
                        les_conversions_update1+='"lib" : \'' + liste_des_conversions_modification[i].meta.libelle_du_champ.replace( /"/g , '&quot;' ).replace( /\'/g , '&apos;' ) + '\'';
                        les_conversions_update1+='},\r\n';
                    }
                }
            }
            if(les_conversions_update1 !== ''){
                src_client2+='        let __les_convertions=[\r\n';
                src_client2+='            /*  */';
                src_client2+=les_conversions_update1;
                src_client2+='        ];\r\n';
            ...
            if(les_tests_standarts_modifier_update_client1 !== ''){
                src_client2+='        let __les_tests=[\r\n';
                src_client2+='            /*  */\r\n';
                src_client2+=les_tests_standarts_modifier_update_client1;
                src_client2+='        ];\r\n';
            ...
            for( let i=0 ; i < liste_des_champs_update.length ; i++ ){
                ...
                if(obj_champ.genre_objet_du_champ.che_est_tsm_genre === 1
                    ...
                    if(obj_champ.cht_particularités_genre.source_au_format_rev === 1){
                        ...
                        les_tests_particuliers_modifier_update_client1+='            if(obj1.__xst!==__xsu){\r\n';
                        les_tests_particuliers_modifier_update_client1+='                this.__ig1.ajoute_message({ __xst : __xer, __xme : \'le contenu de "' + obj_champ.meta.libelle_du_champ.replace( /"/g , '&quot;' ).replace( /\'/g , '&apos;' ) + '" n\\\'est pas dans un format rev valide\'  });\r\n';
                        les_tests_particuliers_modifier_update_client1+='                this.__ig1.affiche_les_messages();\r\n';
                        les_tests_particuliers_modifier_update_client1+='                this.__ig1.retablir_les_boutons_masques();\r\n';
                        les_tests_particuliers_modifier_update_client1+='                try{\r\n';
                        les_tests_particuliers_modifier_update_client1+='                    document.getElementById(\'' + nom_du_champ + '\').focus();\r\n';
                        les_tests_particuliers_modifier_update_client1+='                }catch{}\r\n';
                        les_tests_particuliers_modifier_update_client1+='                return({__xst:__xsu})\r\n';
                        ...
                        les_tests_particuliers_modifier_update_serveur1+='            if(obj1.__xst!==__xsu){\r\n';
                        les_tests_particuliers_modifier_update_serveur1+='                return({"__xst" : __xer , "__xme" : \'le contenu de "' + obj_champ.meta.libelle_du_champ.replace( /"/g , '&quot;' ).replace( /\'/g , '&apos;' ) + '" n\\\'est pas dans un format rev valide\'  });\r\n';
                        les_tests_particuliers_modifier_update_serveur1+='            }\r\n';
                        les_tests_particuliers_modifier_update_serveur1+='        }\r\n';
                    }
                    if(obj_champ.genre_objet_du_champ.cht_fonctions_genre !== null){
                        ...
                        for( let j=1 ; j < l01 ; j=mat1[j][12] ){
                            if(mat1[j][2] === 'f'){
                                les_tests_particuliers_modifier_update_client1+='        let __test_' + i + '_' + j + '=this.__ig1.__fnts_c_et_s.' + mat1[j][1] + '(';
                                les_tests_particuliers_modifier_update_serveur1+='        let __test_' + i + '_' + j + '=this.__ig1.__fnts_c_et_s.' + mat1[j][1] + '(';
                                if(mat1[j][8] === 0){
                                }else{
                                    for( let k=j + 1 ; k < l01 ; k=mat1[k][12] ){
                                        if(mat1[k][2] === 'c'){
                                            if(mat1[k][4] === 0){
                                                les_tests_particuliers_modifier_update_client1+=mat1[k][1] + ',';
                                                les_tests_particuliers_modifier_update_serveur1+=mat1[k][1] + ',';
                                            }else if(mat1[k][4] === 1){
                                                /* entre quotes */
                                                les_tests_particuliers_modifier_update_client1+='\'' + mat1[k][1] + '\',';
                                                les_tests_particuliers_modifier_update_serveur1+='\'' + mat1[k][1] + '\',';
                                ...
                                les_tests_particuliers_modifier_update_client1+='fo1.' + nom_du_champ + ' , \'' + obj_champ.meta.libelle_du_champ.replace( /"/g , '&quot;' ).replace( /\'/g , '&apos;' ) + '\');\r\n';
                                les_tests_particuliers_modifier_update_client1+='        if(__test_' + i + '_' + j + '.__xst!==__xsu){\r\n';
                                les_tests_particuliers_modifier_update_client1+='            this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : __test_' + i + '_' + j + '.__xme} );\r\n';
                                les_tests_particuliers_modifier_update_client1+='            this.__ig1.affiche_les_messages();\r\n';
                                les_tests_particuliers_modifier_update_client1+='            this.__ig1.retablir_les_boutons_masques();\r\n';
                                les_tests_particuliers_modifier_update_client1+='            try{\r\n';
                                les_tests_particuliers_modifier_update_client1+='              document.getElementById(\'' + nom_du_champ + '\').focus();\r\n';
                                ...
                                les_tests_particuliers_modifier_update_client1+='        }\r\n';
                                /*  */
                                les_tests_particuliers_modifier_update_serveur1+='fo1.' + nom_du_champ + ' , \'' + obj_champ.meta.libelle_du_champ.replace( /"/g , '&quot;' ).replace( /\'/g , '&apos;' ) + '\');\r\n';
                                les_tests_particuliers_modifier_update_serveur1+='        if(__test_' + i + '_' + j + '.__xst!==__xsu){\r\n';
                                les_tests_particuliers_modifier_update_serveur1+='            return( {"__xst" : __xer ,"__xme" : __test_' + i + '_' + j + '.__xme} );\r\n';
                                les_tests_particuliers_modifier_update_serveur1+='        }\r\n';
                            }else{
                                return({"__xst" : __xer ,"__xme" : this.__ig1.nl2()});
                            }
            ...
            src_client2+=les_tests_particuliers_modifier_update_client1;
        ...
        if(ref_update !== '' && ref_select !== ''){
            ...
            src_serveur_js2+='        let fo1=this.__ig1.donnees_recues.__xva.__fo1[nom_formulaire];\r\n';
            src_serveur_js2+='         /**/\r\n';
            if(les_conversions_update1 !== ''){
                src_serveur_js2+='        let __les_convertions=[\r\n';
                src_serveur_js2+='            /*  */';
                src_serveur_js2+=les_conversions_update1;
                src_serveur_js2+='        ];\r\n';
            ...
            if(les_tests_standarts_modifier_update_client1 !== ''){
                src_serveur_js2+='        let __les_tests=[\r\n';
                src_serveur_js2+='            /*  */\r\n';
                src_serveur_js2+=les_tests_standarts_modifier_update_client1;
                src_serveur_js2+='        ];\r\n';
            ...
            src_serveur_js2+='        let criteres_select_' + ref_select + '={"T0_' + champ_primaire + '" : fo1.' + champ_primaire + '};\r\n';
            src_serveur_js2+='        let tt' + ref_select + '=await this.recup_' + champ_primaire + '( criteres_select_' + ref_select + ' , __db1 );\r\n';
            ...
            src_serveur_js2+='        let __aetavm=await this.actions_et_tests_avant_modifier( mat , d , fo1 , tt' + ref_select + '.__xva[0] , __db1 );\r\n';
            ...
            for( let i=0 ; i < liste_des_champs_condition_update.length ; i++ ){
                if(liste_des_champs_condition_update[i].nom_variable_session !== ''){
                    /*
                      rien ici
                    */
                }else if(champ_primaire === liste_des_champs_condition_update[i].nom_du_champ){
                    src_serveur_js2+='                    \'c_' + liste_des_champs_condition_update[i].nom_du_champ + '\' : fo1.' + liste_des_champs_condition_update[i].nom_du_champ + ',\n';
                }else if(liste_des_champs_condition_update[i].champ_dans_la_base.genre_objet_du_champ.che_est_nur_genre === 1){
                    src_serveur_js2+='                    \'c_' + liste_des_champs_condition_update[i].nom_du_champ + '\' : fo1.' + liste_des_champs_condition_update[i].nom_du_champ + ',\n';
                }else{
                    if(liste_des_champs_condition_update[i].nom_variable_session !== ''){
                        src_serveur_js2+='                    \'c_' + liste_des_champs_condition_update[i].nom_du_champ + '\' : ';
                        src_serveur_js2+=' this.__ig1.donnees_retournees.' + liste_des_champs_condition_update[i].nom_variable_session + ' ,\n';
                    }else{
                        src_serveur_js2+='                    \'c_' + liste_des_champs_condition_update[i].nom_du_champ + '\' : tt' + ref_select + '.__xva[0][\'T0_' + liste_des_champs_condition_update[i].nom_du_champ + '\'] ,\n';
                    }
                }
            }
            for( let i=0 ; i < liste_des_champs_update.length ; i++ ){
                let nom_du_champ=liste_des_champs_update[i].nom_du_champ;
                let obj_champ=this.#obj_table.champs[nom_du_champ];
                if(obj_champ.genre_objet_du_champ.che_est_nur_genre === 1){
                    l_update_gere_un_nur=nom_du_champ;
                }
                if(liste_des_champs_update[i].nom_variable_session !== ''){
                    continue;
                }
                ...
                if(obj_champ.genre_objet_du_champ.che_est_tsm_genre === 1
                    ...
                    if(liste_des_champs_update[i].on_affecte_une_constante !== ''){
                        ...
                        if(obj_champ.non_nulle === false){
                            src_serveur_js2+='                \'n_' + nom_du_champ + '\' : fo1.' + nom_du_champ + ' === \'\'? ( null ) : ( fo1.' + nom_du_champ + ' ) ,\n';
                        }else{
                            src_serveur_js2+='                \'n_' + nom_du_champ + '\' : fo1.' + nom_du_champ + ' ,\n';
                        }
                    }
                }
            }
            ...
            if(l_update_gere_un_nur !== ''){
                src_serveur_js2+='            if(tt' + ref_select + '.__xva[0].T0_' + l_update_gere_un_nur + ' !== parseInt( fo1.' + l_update_gere_un_nur + ' , 10 )){\r\n';
                src_serveur_js2+='                return({"__xst" : __xer ,"__xme" : \'__nur_ko1_\'});\r\n';
                src_serveur_js2+='            }\r\n';
            }
            src_serveur_js2+='            return({"__xst" : __xer , "__xme" : tt' + ref_update + '.__xme  });\r\n';
            src_serveur_js2+='        }\r\n';
            src_serveur_js2+='        let __taam=await this.tests_et_actions_apres_modifier(mat , d , fo1 , tt' + ref_select + '.__xva[0] , __db1);\r\n';
            ...
            if(l_update_gere_un_nur !== ''){
                src_serveur_js2+='        this.__ig1.donnees_retournees.__xva[\'__nouveau_nur\']=parseInt( fo1.' + l_update_gere_un_nur + ' , 10 )+1;\r\n';
            }
            src_serveur_js2+='        if(retour_a_la_liste === true){\r\n';
            src_serveur_js2+='            if(fo1.__mat_liste_si_ok){\r\n';
            src_serveur_js2+='                let mat1=JSON.parse( fo1.__mat_liste_si_ok );\r\n';
            src_serveur_js2+='                await this.filtre1( mat1 , 1 , __db1 );\r\n';
            src_serveur_js2+='            }\r\n';
            src_serveur_js2+='            return({"__xst" : __xsu});\r\n';
            src_serveur_js2+='        }\r\n';
            src_serveur_js2+='        let tt' + ref_select + '_bis=await this.recup_' + champ_primaire + '( criteres_select_' + ref_select + ' , __db1 );\r\n';
        ...
        if(ref_select !== '' && ref_update !== ''){
            ...
            src_serveur_js2+='        }\r\n';
            src_serveur_js2+='        let tt' + ref_select + '=await this.recup_' + champ_primaire + '( {"T0_' + champ_primaire + '" : ' + champ_primaire + '} , __db1 );\r\n';
            src_serveur_js2+='        if(tt' + ref_select + '.__xst !== __xsu || tt' + ref_select + '.__xva.length !== 1){\r\n';
            src_serveur_js2+='            return({"__xst" : __xer ,"__xme" : \'enregistrement non trouvé : modification impossible [' + ref_select + ' \' + this.__ig1.nl2() + \']\'});\r\n';
            src_serveur_js2+='        }\r\n';
        ...
        if(ref_select !== '' && ref_update !== ''){
            ...
            src_client2+='        }\r\n';
            src_client2+='        let tup=le_colis1.__xva.page_modification1.__xva[0];\r\n';
            src_client2+='        this.__ig1.afficher_le_titre_des_zones( \'vv_ecran_modification\' , \'entree_module\' , this.DUN_DUNE_ELEMENT_GERE , tup.T0_' + champ_primaire + ' , this.moi , \'' + champ_primaire + '\' );\r\n';
            src_client2+='        let o1=\'\';\r\n';
            let tab_champs_sortie=[];
            for( let i=0 ; i < liste_des_champs_visualisation_update.length ; i++ ){
                if(liste_des_champs_visualisation_update[i].prefixe_du_champ === 'T0'){
                    src_client2+='        /*\r\n';
                    src_client2+='          =====================================================================================================\r\n';
                    src_client2+='        */\r\n';
                ...
                src_client2+='        o1+=\'      <span>' + liste_des_champs_visualisation_update[i].champ_dans_la_base.libelle_du_champ + '</span>\';\r\n';
                src_client2+='        o1+=\'    </div>\';\r\n';
                src_client2+='        o1+=\'    <div class="yy_edition_valeur1">\';\r\n';
                src_client2+='        if(tup.' + liste_des_champs_visualisation_update[i].prefixe_du_champ + '_' + liste_des_champs_visualisation_update[i].nom_du_champ + ' === undefined){\r\n';
                src_client2+='            o1+=\'        <div class="yy__0">ATTENTION, ERREUR DE SQL :  LE CHAMP n\\\'est pas inclus dans le SELECT</div>\';\r\n';
                src_client2+='        }\r\n';
                src_client2+='        o1+=\'        <span>\';\r\n';
                src_client2+='        o1+=tup.' + liste_des_champs_visualisation_update[i].prefixe_du_champ + '_' + liste_des_champs_visualisation_update[i].nom_du_champ + ';\r\n';
                for( let j=0 ; j < this.#dependances[chi_id_basedd_de_reference].length ; j++ ){
                    if(this.#dependances[chi_id_basedd_de_reference][j].table_fille === table_de_reference
                           && this.#dependances[chi_id_basedd_de_reference][j].champ_fils === liste_des_champs_visualisation_update[i].nom_du_champ
                    ){
                        let dependance=this.#dependances[chi_id_basedd_de_reference][j];
                        let base_mere=dependance.base_mere;
                        let table_mere=dependance.table_mere;
                        let champ_pere=dependance.champ_pere;
                        /*
                          on va chercher dans la requête select une référence à ce champ
                        */
                        for( let k=0 ; k < les_jointures.length ; k++ ){
                            if(les_jointures[k].aa_provenance === 'jointure_gauche'
                                   && les_jointures[k].nom_de_la_table === table_mere
                                   && les_jointures[k].alias2 === 'T0'
                                   && les_jointures[k].champ2 === liste_des_champs_visualisation_update[i].nom_du_champ
                            ){
                                let la_jointure=les_jointures[k];
                                if( typeof ( typeof la_jointure.libelles_lien) === 'string'){
                                    if(la_jointure.nom_de_la_table === 'tbl_grandeurs'){
                                        src_client2+='        o1 +=  this.__ig1.fi2(tup.' + la_jointure.alias1 + '_chp_cle_grandeur) ;\r\n';
                                        un_champ_libelle_trouve=true;
                                    }else{
                                        for( let l=0 ; l < la_jointure.libelles_lien.length ; l++ ){
                                            src_client2+='        o1+=\' \' + this.__ig1.fi2(tup.' + la_jointure.alias1 + '_' + la_jointure.libelles_lien[l] + ') ;\r\n';
                                        }
                                    }
                                }else{
                                    if(Array.isArray( la_jointure.libelles_lien ) === true){
                                        for( let j=0 ; l < la_jointure.libelles_lien.length ; l++ ){
                                            debugger;
                                            src_client2+='        o1+=\' \' + this.__ig1.fi2(tup.' + la_jointure.alias1 + '_' + la_jointure.libelles_lien[l] + ') ;\r\n';
                                        }
                                    }else{
            ...
            for( let i=0 ; i < liste_des_champs_update.length ; i++ ){
                ...
                for(let j in champs_combinaison_update){
                    /* champs_combinaison_update */
                    if(champs_combinaison_update[j].combinaison[0].hasOwnProperty( 'nom_complet_du_champ' )){
                        if(champs_combinaison_update[j].combinaison[0].nom_du_champ === nom_du_champ){
                        ...
                        return({
                                "__xst" : __xer ,
                                "__xme" : "attention, les champs de champs_combinaison_update de la requete " + ref_liste_ecran + " sont mal définis "
                            });
                    }
                }
                let c_est_un_nieme_champ_de_combinaison=null;
                for(let j in champs_combinaison_update){
                    for( let k=1 ; k < champs_combinaison_update[j].combinaison.length ; k++ ){
                        if(nom_du_champ === champs_combinaison_update[j].combinaison[k].nom_du_champ){
                ...
                if(c_est_un_premier_champ_de_combinaison !== null){
                    ...
                    for( let j=0 ; j < champs_combinaison_update[c_est_un_premier_champ_de_combinaison].combinaison.length ; j++ ){
                        let combi=champs_combinaison_update[c_est_un_premier_champ_de_combinaison].combinaison[j];
                ...
                let contient_description=false;
                let contenu_champ_description='';
                ...
                */
                if(obj_champ.genre_objet_du_champ.che_est_tsm_genre === 1 || obj_champ.genre_objet_du_champ.che_est_tsc_genre === 1){
                    ...
                    src_client2+='          =====================================================================================\r\n';
                    src_client2+='        */\r\n';
                    src_client2+='        o1 += \'     <input type="hidden" id="' + obj_champ.nom_du_champ + '" value="\' + this.__ig1.fi2( tup.T0_' + obj_champ.nom_du_champ + ' ) + \'" />\' ;\r\n';
                    continue;
                    ...
                    */
                    ...
                    if(obj_champ.table_mere === 'tbl_grandeurs'){
                        let a_transmettre={
                        ...
                        for( let j=0 ; j < les_jointures.length ; j++ ){
                            if(les_jointures[j].alias2 === 'T0'
                                ...
                                if( typeof ( typeof les_jointures[j].libelles_lien) === 'string'){
                                    for( let k=0 ; k < les_jointures[j].libelles_lien.length ; k++ ){
                                        liste_des_champs_libelles.push( les_jointures[j].alias1 + '_' + les_jointures[j].libelles_lien[k] );
                                    }
                                }else{
                                    if(Array.isArray( les_jointures[j].libelles_lien ) === true){
                                        for( let k=0 ; k < les_jointures[j].libelles_lien.length ; k++ ){
                                            liste_des_champs_libelles.push( les_jointures[j].alias1 + '_' + les_jointures[j].libelles_lien[k] );
                                        }
                                    }else{
                                ...
                                for( let k=0 ; k < les_jointures[j].libelles_lien.length ; k++ ){
                                    liste_des_champs_libelles.push( les_jointures[j].alias2 + '_' + les_jointures[j].libelles_lien[k] );
                                }
                            }
                        }
                        if(liste_des_champs_libelles.length === 0){
                                        ...
                                        if(liste_des_champs_select[j].nom_du_champ === trouve && liste_des_champs_select[j].prefixe_du_champ !== 'T0'){
                                            if(trouve === 'chp_cle_grandeur'){
                                                ...
                                                */
                                                ...
                                                liste_des_champs_libelles.push( liste_des_champs_select[j].prefixe_du_champ + '_' + trouve );
                                            }
                                        }
                                    }
                                }else{
                                            ...
                                            if(trouve2 !== null){
                                                for(let k in liste_des_champs_select){
                                                    if(liste_des_champs_select[k].nom_du_champ === trouve2 && liste_des_champs_select[k].prefixe_du_champ !== 'T0'){
                                                        liste_des_champs_libelles.push( liste_des_champs_select[k].prefixe_du_champ + '_' + trouve2 );
                                                    }
                                                }
                                            }
                                        }
                    ...
                    if(obj_champ.genre_objet_du_champ.chi_id_genre === 22){
                        ...
                        src_client2+='          =====================================================================================\r\n';
                        src_client2+='        */\r\n';
                        src_client2+='        o1+=this.__ig1.__fnt1.html_edition_de_date2( tup , {\r\n';
                        ...
                        */
                        ...
                        src_client2+='          =====================================================================================\r\n';
                        src_client2+='        */\r\n';
                        src_client2+='        o1+=this.__ig1.__fnt1.html_edition_de_heure2( tup , {\r\n';
                        src_client2+='            "nom_du_champ" : "' + obj_champ.nom_du_champ.replace( /"/g , '\\"' ) + '" ,\r\n';
                        src_client2+='            "__contexte" : "modification1" ,\r\n';
                        src_client2+='            "libelle_du_champ" : "' + obj_champ.meta.libelle_du_champ.replace( /"/g , '\\"' ) + '" ,';
                        if(obj_champ.meta.description_du_champ){
                        ...
                        if(obj_champ.genre_objet_du_champ.cht_parmis_genre && obj_champ.genre_objet_du_champ.cht_parmis_genre !== ''){
                            ...
                            src_client2+=obj_liens1.__xva;
                        }
                        let les_suggestions=this.ajoute_suggestion_du_champ( obj_champ ).les_suggestions;
                        if(les_suggestions.length > 0 && contient_des_liens_parmis_du_genre === true){
                            return({
                                    "__xst" : __xer ,
                        ...
                        if(contient_des_liens_parmis_du_genre === true){
                            src_client2+='            "liste_des_liens_parmis_du_genre" : llpdg_' + obj_champ.nom_du_champ + ' ,\r\n';
                        }
                        src_client2+='            "libelle_du_champ" : "' + obj_champ.meta.libelle_du_champ.replace( /"/g , '\\"' ) + '" ,';
                        if(obj_champ.meta.description_du_champ){
                            src_client2+='            "description_du_champ" : "' + obj_champ.meta.description_du_champ.replace( /"/g , '\\"' ) + '" ,';
                        ...
                        if(obj_champ.hasOwnProperty( 'longueur_du_champ' )
                            ...
                            let tab=obj_champ.longueur_du_champ.split( '.' );
                        ...
                        if(obj_champ.genre_numerique_du_champ === 95
                               ...
                               || obj_champ.genre_numerique_du_champ === 97
            ...
            src_client2+='              =============================================================================================\r\n';
            src_client2+='            */\r\n';
            src_client2+='            o1+=\'      <input type="hidden" id="' + champ_primaire + '" value="\' + tup.T0_' + champ_primaire + ' + \'">\';\r\n';
            src_client2+='            /*\r\n';
            src_client2+='              =============================================================================================\r\n';
            src_client2+='            */\r\n';
            src_client2+='        let cmd=\'\';\r\n';
            ...
            if(masquer_le_bouton_modifier_et_retour === 1){
            ...
            src_client2+='        if(this.__ig1.decallage_page_avant_envoi > 0){\r\n';
            src_client2+='            window.scrollTo( {"top" : this.__ig1.decallage_page_avant_envoi ,"left" : 0} );\r\n';
            src_client2+='            this.__ig1.decallage_page_avant_envoi=0;\r\n';
            src_client2+='        }\r\n';
            src_client2+='        return({"__xst" : __xsu});\r\n';
            src_client2+='    }\r\n';
            fragment_trouve=-1;
            for( let i=0 ; i < tableau_des_fragments_client.length ; i++ ){
                if(tableau_des_fragments_client[i].nom_methode_client === 'modifier1'){
                    fragment_trouve=i;
                    break;
                }
            }
            if(fragment_trouve >= 0){
                ...
                if(l_update_gere_un_nur !== ''){
                    src_client2+='        if(le_colis1.__xva.hasOwnProperty( \'__nouveau_nur\' )){\r\n';
                    src_client2+='            document.getElementById(\'' + l_update_gere_un_nur + '\').value=le_colis1.__xva.__nouveau_nur;\r\n';
                    src_client2+='        }\r\n';
                }
                src_client2+='        /*\r\n';
                src_client2+='          on recharge la page après modification au besoin\r\n';
                src_client2+='        */\r\n';
                src_client2+='        /*\r\n';
                src_client2+='          let tt=\'pm1(m1(n1(\' + this.moi + \'),f1(page_modification1(' + champ_primaire + '(\' + le_colis1.__xva.page_modification1.__xva[0].T0_' + champ_primaire + ' + \')))))\';\r\n';
                src_client2+='          this.__ig1.executer1(tt , null , null);\r\n';
                src_client2+='        */\r\n';
                src_client2+='        return({__xst:__xsu});\r\n';
                src_client2+='    }\r\n';
            }
        ...
        */
        if(ref_delete !== ''){
            ...
            src_client2+='            return( this.__ig1.affiche_les_messages({"__xst" : __xer ,"__xme" : \'cet élément n\\\'a pas été trouvé\'}) );\r\n';
            src_client2+='        }\r\n';
            src_client2+='        let tup=le_colis1.__xva.page_confirmation_supprimer1.__xva[0];\r\n';
            src_client2+='        if(tup.T0_' + champ_primaire + ' === undefined){\r\n';
            src_client2+='            return({"__xst" : __xer ,"__xme" : "Attention, le champ T0_' + champ_primaire + ' n\'est pas en sortie dans la requête select "});\r\n';
            src_client2+='        }\r\n';
            src_client2+='        this.__ig1.afficher_le_titre_des_zones( \'vv_ecran_suppression\' , \'entree_module\' , this.DUN_DUNE_ELEMENT_GERE , tup.T0_' + champ_primaire + ' , this.moi , \'' + champ_primaire + '\' );\r\n';
            src_client2+='        let o1=\'\';\r\n';
            let liste_des_champs_a_visualiser_pour_delete=[];
            if(liste_des_champs_visualisation_delete.length === 0){
                /*
                  on prend les champs update si aucun champ visualisation_delete 
                */
                /*
                  liste_des_champs_a_visualiser_pour_delete=liste_des_champs_update
                */
                liste_des_champs_a_visualiser_pour_delete=liste_des_champs_liste_ecran;
            }else{
                liste_des_champs_a_visualiser_pour_delete=liste_des_champs_visualisation_delete;
            }
            for( let i=0 ; i < liste_des_champs_a_visualiser_pour_delete.length ; i++ ){
                if(liste_des_champs_a_visualiser_pour_delete[i].hasOwnProperty( 'nom_variable_session' )
                       && liste_des_champs_a_visualiser_pour_delete[i].nom_variable_session !== ''
                ){
                    continue;
                }
                let nom_du_champ=liste_des_champs_a_visualiser_pour_delete[i].nom_du_champ;
                let obj_champ=this.#obj_table.champs[nom_du_champ];
                if(liste_des_champs_a_visualiser_pour_delete[i].hasOwnProperty( 'préfixe_du_champ' )
                       && liste_des_champs_a_visualiser_pour_delete[i].préfixe_du_champ !== 'T0'
                ){
                    continue;
                }
                if(obj_champ.hasOwnProperty( 'champ_pere' )
                       && obj_champ.champ_pere === 'chi_id_utilisateur'
                       && obj_champ.table_mere === 'tbl_utilisateurs'
                ){
                    continue;
                }
                if(obj_champ.genre_numerique_du_champ === 2){
                    continue;
                }
                let entete_bloc_supprimer1='';
                entete_bloc_supprimer1+='        /*\n';
                entete_bloc_supprimer1+='          =====================================================================================\n';
                entete_bloc_supprimer1+='        */\n';
                entete_bloc_supprimer1+='        o1 += \'<div class="yy_edition_champ1">\' ;\r\n';
                entete_bloc_supprimer1+='        o1 += \'    <div class="yy_edition_libelle1">\' ;\r\n';
                entete_bloc_supprimer1+='        o1 += \'        <div>' + obj_champ.meta.libelle_du_champ + '</div>\' ;\r\n';
                entete_bloc_supprimer1+='        o1 += \'    </div>\' ;\r\n';
                entete_bloc_supprimer1+='        o1 += \'    <div class="yy_edition_valeur1">\' ;\r\n';
                let pied_bloc_supprimer1='';
                pied_bloc_supprimer1+='        o1 += \'    </div>\' ;\r\n';
                pied_bloc_supprimer1+='        o1 += \'  </div>\' ;\r\n';
                /*#
                  if(nom_du_champ === 'che_ordre_genre'){
                      debugger;
                  }
                */
                let reference_externe_base='';
                ...
                if(obj_champ.hasOwnProperty( 'table_mere' )
                    ...
                    if(obj_champ.genre_objet_du_champ.chp_espece_genre === 'VARCHAR'){
                        ...
                        if(obj_champ.genre_numerique_du_champ === 25){
                            src_client2+=entete_bloc_supprimer1;
                            src_client2+='        o1+=this.__ig1.__fnt1.html_de_zones_nulle_zero_un_pour_ecran( \'' + obj_champ.nom_du_champ + '\' , tup , \'supprimer11\' );\r\n';
                            src_client2+=pied_bloc_supprimer1;
                        }else if(obj_champ.genre_numerique_du_champ === 5){
                            let a_transmettre={"nom_du_champ" : obj_champ.nom_du_champ ,"__contexte" : 'supprimer1' ,"libelle_du_champ" : obj_champ.meta.libelle_du_champ};
                            src_client2+='            /*\r\n';
                            src_client2+='              =============================================================================================\r\n';
                            src_client2+='            */\r\n';
                            src_client2+='            o1+=this.__ig1.__fnt1.html_edition_zero_un2(  tup , ' + JSON.stringify( a_transmettre ) + ');\r\n';
            ...
            src_client2+='        }\r\n';
            src_client2+='        this.__ig1.ajoute_les_evenements_aux_boutons();\r\n';
            src_client2+='        this.__ig1.repositionner_les_boutons_action( \'vv_ecran_suppression_zone_boutons\' );\r\n';
            src_client2+='        return({"__xst" : __xsu});\r\n';
            src_client2+='    }\r\n';
        }
        /*
        ...
        */
        if(ref_select !== '' && avec_page_voir1 === 1){
            ...
            for( let i=0 ; i < liste_des_champs_select.length ; i++ ){
                ...
                let obj_champ=this.#obj_table.champs[nom_du_champ];
                if(liste_des_champs_select[i].prefixe_du_champ === 'T0' && obj_champ.genre_numerique_du_champ === 2){
        ...
        */
        if(ref_insert !== '' && ref_select !== ''){
            ...
            */
            ...
            src_serveur_js2+='        let tt' + ref_select + '=await this.recup_' + champ_primaire + '( {"T0_' + champ_primaire + '" : ' + champ_primaire + '} , __db1 );\r\n';
            src_serveur_js2+='        if(tt' + ref_select + '.__xst !== __xsu || tt' + ref_select + '.__xva.length !== 1){\r\n';
            src_serveur_js2+='            return({"__xst" : __xer ,"__xme" : \'enregistrement non trouvé : duplication impossible [' + ref_select + ' \' + this.__ig1.nl2() + \']\'});\r\n';
            src_serveur_js2+='        }\r\n';
        ...
        if(ref_select !== '' && avec_page_voir1 === 1){
            ...
            src_serveur_js2+='            return({"__xst" : __xer ,"__xme" : __aetapv.__xme});\r\n';
            src_serveur_js2+='        }\r\n';
            src_serveur_js2+='        return({"__xst" : __xsu});\r\n';
            src_serveur_js2+='    }\r\n';
            src_serveur_js2+='\r\n';
        ...
        if(ref_delete !== '' && ref_select !== ''){
            ...
            src_serveur_js2+='        let tt' + ref_select + '=await this.recup_' + champ_primaire + '( {"T0_' + champ_primaire + '" : fo1.' + champ_primaire + '} , __db1 );\r\n';
            src_serveur_js2+='        if(tt' + ref_select + '.__xst !== __xsu || tt' + ref_select + '.__xva.length !== 1){\r\n';
            src_serveur_js2+='            return({"__xst" : __xer ,"__xme" : \'enregistrement non trouvé : suppression impossible [' + ref_select + ' \' + this.__ig1.nl2() + \']\'});\r\n';
            src_serveur_js2+='        }\r\n';
            src_serveur_js2+='        /*  */\r\n';
            src_serveur_js2+='        let tas=await this.test_avant_supprimer( mat , d , fo1 , tt' + ref_select + '.__xva[0] , __db1 );\r\n';
            ...
            src_serveur_js2+='        }\r\n';
            src_serveur_js2+='        let __aavc=await this.actions_apres_supprimer( mat , d , fo1 , tt' + ref_select + '.__xva[0] , __db1 );\r\n';
            src_serveur_js2+='        if(__aavc.__xst === __xer){\r\n';
            src_serveur_js2+='            return({"__xst" : __xer ,"__xme" : __aavc.__xme});\r\n';
            src_serveur_js2+='        }\r\n';
            src_serveur_js2+='        /**/\r\n';
            src_serveur_js2+='        if(fo1.__mat_liste_si_ok !== \'\'){\r\n';
            src_serveur_js2+='            let mat1=JSON.parse( fo1.__mat_liste_si_ok );\r\n';
            ...
            */
            ...
            src_serveur_js2+='        const l01=mat.length;\r\n';
            src_serveur_js2+='        for( let i=d + 1 ; i < l01 ; i=mat[i][12] ){\r\n';
            src_serveur_js2+='            if(mat[i][1] === \'' + champ_primaire + '\' && mat[i][2] === \'f\' && mat[i][8] === 1 && mat[i + 1][2] === \'c\'){\r\n';
            src_serveur_js2+='                ' + champ_primaire + '=parseInt( mat[i + 1][1] , 10 );\r\n';
            src_serveur_js2+='            }\r\n';
            src_serveur_js2+='        }\r\n';
            src_serveur_js2+='        if(' + champ_primaire + ' === 0){\r\n';
        ...
        */
        ...
        if(ref_insert !== '' && ref_select !== ''){
            ...
            src_client2+='        let retour_a_la_liste=\'\';\r\n';
            if(avec_creer_et_dupliquer1 === 1){
                src_client2+='        let __creer_et_dupliquer1=0;\r\n';
            }
            src_client2+='        const l01=mat.length;\r\n';
            src_client2+='        for(let i=d+1;i<l01;i=mat[i][12]){\r\n';
            src_client2+='            if(mat[i][1]===\'retour_a_la_liste\' && mat[i][2]===\'f\' ){\r\n';
            src_client2+='                retour_a_la_liste=\'retour_a_la_liste()\';\r\n';
            if(avec_creer_et_dupliquer1 === 1){
                src_client2+='            }else if(mat[i][1] === \'__creer_et_dupliquer1\' && mat[i][2] === \'f\' && mat[i][8] === 1 && mat[i+1][2] === \'c\'){\r\n';
                src_client2+='                __creer_et_dupliquer1=parseInt(mat[i+1][1] , 10);\r\n';
            }
            src_client2+='            }\r\n';
            src_client2+='        }\r\n';
            src_client2+='        let co1=données.__co1;\r\n';
            ...
            if(liste_des_conversions.length > 0){
                for( let i=0 ; i < liste_des_conversions.length ; i++ ){
                    let vpd=null;
                    if(liste_des_conversions[i].hasOwnProperty( 'valeur_par_defaut' )){
                        if(liste_des_conversions[i].valeur_par_defaut.toUpperCase() === 'NULL'){
                            vpd=null;
                        }else{
                            vpd=liste_des_conversions[i].valeur_par_defaut;
                        }
                    }else{
                        vpd=undefined;
                    }
                    ...
                    if(liste_des_conversions[i].espece_du_champ === 'INTEGER'){
                        les_conversions_create1+='    {';
                        les_conversions_create1+='"nc" : "entier1" ,';
                        les_conversions_create1+='"nz" : \'' + liste_des_conversions[i].nom_du_champ + '\' ,';
                        les_conversions_create1+='"vpd" : ' + vpd + ' ,';
                        les_conversions_create1+='"lib" : \'' + liste_des_conversions[i].meta.libelle_du_champ.replace( /"/g , '&quot;' ).replace( /\'/g , '&apos;' ) + '\'';
                        les_conversions_create1+='},\r\n';
                    }else if(liste_des_conversions[i].espece_du_champ === 'FLOAT'){
                        les_conversions_create1+='    {';
                        les_conversions_create1+='"nc" : "float1" ,';
                        les_conversions_create1+='"nz" : \'' + liste_des_conversions[i].nom_du_champ + '\' ,';
                        les_conversions_create1+='"vpd" : ' + vpd + ' , ';
                        les_conversions_create1+='"lib" : \'' + liste_des_conversions[i].meta.libelle_du_champ.replace( /"/g , '&quot;' ).replace( /\'/g , '&apos;' ) + '\'';
                        les_conversions_create1+='},\r\n';
                    }else if(liste_des_conversions[i].espece_du_champ === 'DECIMAL'){
                        les_conversions_create1+='    {';
                        les_conversions_create1+='"nc" : "decim1" ,';
                        les_conversions_create1+='"nz" : \'' + liste_des_conversions[i].nom_du_champ + '\' ,';
                        les_conversions_create1+='"vpd" : ' + vpd + ' ,';
                        les_conversions_create1+='"ldc" : \'' + liste_des_conversions[i].longueur_du_champ + '\' ,';
                        les_conversions_create1+='"lib" : \'' + liste_des_conversions[i].meta.libelle_du_champ.replace( /"/g , '&quot;' ).replace( /\'/g , '&apos;' ) + '\'';
                        les_conversions_create1+='},\r\n';
                    }
                }
            }
            if(les_conversions_create1 !== ''){
                src_client2+='        /* conversion des données numériques verifier_creer début */\r\n';
                src_client2+='        let __les_convertions=[\r\n';
                src_client2+='            /*  */';
                src_client2+=les_conversions_create1;
                src_client2+='        ];\r\n';
                src_client2+='        let __obj_convertions=this.__ig1.__fnt1.convertir_les_zonnes_saisies( __les_convertions , fo1 );\r\n';
                src_client2+='        if(__obj_convertions.__xst !== __xsu){\r\n';
                src_client2+='            return({"__xst" : __xsu});\r\n';
            ...
            for( let i=0 ; i < liste_des_champs_insert.length ; i++ ){
                ...
                if(obj_champ.genre_objet_du_champ.che_est_tsm_genre === 1
                    ...
                    if(obj_champ.genre_objet_du_champ.che_est_parmis_genre === 1){
                        ...
                        let tab0=[];
                        let l01=mat0.length;
                        les_tests_standarts_creer1+='        {';
                        les_tests_standarts_creer1+='"nt" : \'parmis1\' ,';
                        les_tests_standarts_creer1+='"nz" : "' + nom_du_champ + '" ,';
                        les_tests_standarts_creer1+='"lib" : \'' + obj_champ.meta.libelle_du_champ.replace( /"/g , '&quot;' ).replace( /\'/g , '&apos;' ) + '\' ,';
                        let les_tests_creer_tab='';
                        let nb_tab=0;
                        for( let j=1 ; j < l01 ; j=mat0[j][12] ){
                            if(mat0[j][2] === 'c' && mat0[j][8] === 0){
                                nb_tab++;
                        ...
                        if(nb_tab > 4){
                            les_tests_standarts_creer1+='"p" : [ /* tbel */';
                        }else{
                            les_tests_standarts_creer1+='"p" : [';
                        }
                        les_tests_standarts_creer1+=les_tests_creer_tab + '] },\r\n';
                    }
                }
            }
            if(les_tests_standarts_creer1 !== ''){
                src_client2+='        let __les_tests=[\r\n';
                src_client2+='            /*  */\r\n';
                src_client2+=les_tests_standarts_creer1;
                src_client2+='        ];\r\n';
                src_client2+='        let __obj_tests=this.__ig1.__fnt1.tester_les_zonnes_saisies(__les_tests , fo1);\r\n';
                src_client2+='        if(__obj_tests.__xst !== __xsu){\r\n';
                src_client2+='            return({"__xst" : __xsu});\r\n';
                ...
                if(obj_champ.genre_objet_du_champ
                    ...
                    */
                    ...
                    if(obj_champ.genre_objet_du_champ && obj_champ.genre_objet_du_champ.cht_fonctions_genre !== null){
                        ...
                        for( let j=1 ; j < l01 ; j=mat1[j][12] ){
                            if(mat1[j][2] === 'f'){
                                les_tests_particuliers_client_creer2+='        let __test_' + i + '_' + j + '=this.__ig1.__fnts_c_et_s.' + mat1[j][1] + '(';
                                les_tests_particuliers_serveur_creer2+='        let __test_' + i + '_' + j + '=this.__ig1.__fnts_c_et_s.' + mat1[j][1] + '(';
                                if(mat1[j][8] === 0){
                                }else{
                                    for( let k=j + 1 ; k < l01 ; k=mat1[k][12] ){
                                        if(mat1[k][2] === 'c'){
                                            if(mat1[k][4] === 0){
                                                les_tests_particuliers_client_creer2+=mat1[k][1] + ',';
                                                les_tests_particuliers_serveur_creer2+=mat1[k][1] + ',';
                                            }else if(mat1[k][4] === 1){
                                                les_tests_particuliers_client_creer2+='\'' + mat1[k][1].replace( /\\/g , '\\\\' ).replace( /\'/g , '\\\'' ) + '\',';
                                                les_tests_particuliers_serveur_creer2+='\'' + mat1[k][1].replace( /\\/g , '\\\\' ).replace( /\'/g , '\\\'' ) + '\',';
                                            }else{
                                                /* afr */
                                                debugger;
                                                return({"__xst" : __xer ,"__xme" : this.__ig1.nl2()});
                                ...
                                les_tests_particuliers_client_creer2+='fo1.' + nom_du_champ + ' , \'' + obj_champ.meta.libelle_du_champ.replace( /"/g , '&quot;' ).replace( /\'/g , '&apos;' ) + '\');\r\n';
                                les_tests_particuliers_client_creer2+='        if(__test_' + i + '_' + j + '.__xst!==__xsu){\r\n';
                                les_tests_particuliers_client_creer2+='            this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : __test_' + i + '_' + j + '.__xme} );\r\n';
                                les_tests_particuliers_client_creer2+='            this.__ig1.affiche_les_messages();\r\n';
                                les_tests_particuliers_client_creer2+='            this.__ig1.retablir_les_boutons_masques();\r\n';
                                les_tests_particuliers_client_creer2+='            try{\r\n';
                                les_tests_particuliers_client_creer2+='              document.getElementById(\'' + nom_du_champ + '\').focus();\r\n';
                                les_tests_particuliers_client_creer2+='            }catch{}\r\n';
                                les_tests_particuliers_client_creer2+='            return({__xst:__xsu})\r\n';
                                les_tests_particuliers_client_creer2+='        }\r\n';
                                les_tests_particuliers_serveur_creer2+='fo1.' + nom_du_champ + ' , \'' + obj_champ.meta.libelle_du_champ.replace( /"/g , '&quot;' ).replace( /\'/g , '&apos;' ) + '\');\r\n';
                                les_tests_particuliers_serveur_creer2+='        if(__test_' + i + '_' + j + '.__xst!==__xsu){\r\n';
                                les_tests_particuliers_serveur_creer2+='            return( {"__xst" : __xer ,"__xme" : __test_' + i + '_' + j + '.__xme} );\r\n';
                                les_tests_particuliers_serveur_creer2+='        }\r\n';
                            }else{
                                return({"__xst" : __xer ,"__xme" : this.__ig1.nl2()});
                            }
                        }
            ...
            src_client2+=les_tests_particuliers_client_creer2;
            src_client2+='        let __fo1={};\r\n';
            src_client2+='        __fo1[co1]=fo1;\r\n';
            src_client2+='        this.__ig1.envoyer_un_colis_au_worker( {/**/\r\n';
            if(avec_creer_et_dupliquer1 === 1){
                src_client2+='            "__xac" : \'pm1(m1(n1(\'+this.moi+\'),f1(creer1(__creer_et_dupliquer1(\' + __creer_et_dupliquer1 + \'),\'+retour_a_la_liste+\'))))\',\r\n';
            }else{
        ...
        */
        if(ref_select !== '' && ref_insert !== ''){
            ...
            */
            ...
            src_serveur_js2+='        let retour_a_la_liste=false;\r\n';
            if(avec_creer_et_dupliquer1 === 1){
                src_serveur_js2+='        let __creer_et_dupliquer1=0;\r\n';
            }
            src_serveur_js2+='        const l01=mat.length;\r\n';
            src_serveur_js2+='        for( let i=d + 1 ; i < l01 ; i=mat[i][12] ){\r\n';
            src_serveur_js2+='            if(mat[i][1] === \'retour_a_la_liste\' && mat[i][2] === \'f\'){\r\n';
            src_serveur_js2+='                retour_a_la_liste=true;\r\n';
            if(avec_creer_et_dupliquer1 === 1){
                src_serveur_js2+='            }else if(mat[i][1] === \'__creer_et_dupliquer1\' && mat[i][2] === \'f\' && mat[i][8] === 1 && mat[i + 1][2] === \'c\'){\r\n';
                src_serveur_js2+='                __creer_et_dupliquer1=parseInt( mat[i + 1][1] , 10 );\r\n';
            }
            src_serveur_js2+='            }\r\n';
            src_serveur_js2+='        }\r\n';
            src_serveur_js2+='        let nom_formulaire=this.__ig1.donnees_recues.__xva[\'__co1\'];\r\n';
            src_serveur_js2+='        let fo1=this.__ig1.donnees_recues.__xva[\'__fo1\'][nom_formulaire];\r\n';
            if(les_conversions_create1 !== ''){
                src_serveur_js2+='        /* convertion des données verifier_creer début */\r\n';
                src_serveur_js2+='        let __les_convertions=[\r\n';
                src_serveur_js2+='            /*  */';
                src_serveur_js2+=les_conversions_create1;
                src_serveur_js2+='        ];\r\n';
                src_serveur_js2+='        let __obj_convertions=this.__ig1.__fnt1.convertir_les_zonnes_saisies( __les_convertions , fo1 );\r\n';
                src_serveur_js2+='        if(__obj_convertions.__xst !== __xsu){\r\n';
                src_serveur_js2+='            return({"__xst" : __xsu});\r\n';
                src_serveur_js2+='        }\r\n';
                src_serveur_js2+='        /* convertion des données verifier_creer fin */\r\n';
            }
            if(les_tests_standarts_creer1 !== ''){
                src_serveur_js2+='        let __les_tests=[\r\n';
                src_serveur_js2+='            /*  */\r\n';
                src_serveur_js2+=les_tests_standarts_creer1;
                src_serveur_js2+='        ];\r\n';
                src_serveur_js2+='        let __obj_tests=this.__ig1.__fnt1.tester_les_zonnes_saisies(__les_tests , fo1);\r\n';
                src_serveur_js2+='        if(__obj_tests.__xst !== __xsu){\r\n';
            ...
            src_serveur_js2+='        let __tac=await this.tests_avant_creer( mat , d , fo1 , __db1 );\r\n';
                ...
                */
                ...
                if(obj_champ.genre_objet_du_champ
                    ...
                    */
                    ...
                    if(liste_des_champs_insert[i].nom_variable_session !== ''){
                        src_serveur_js2+='                    \'' + nom_du_champ + '\' : this.__ig1.donnees_retournees.' + liste_des_champs_insert[i].nom_variable_session + ',\n';
                    }else{
                        if(obj_champ.non_nulle === false){
                            src_serveur_js2+='                    \'' + nom_du_champ + '\' : fo1.' + nom_du_champ + ' === \'\' ? ( null ) : ( fo1.' + nom_du_champ + ' ),\n';
                        }else{
                            src_serveur_js2+='                    \'' + nom_du_champ + '\' : fo1.' + nom_du_champ + ' ,\n';
                        }
                    }
                }
            }
            ...
            src_serveur_js2+='        }\r\n';
            src_serveur_js2+='        let __aapc=await this.action_apres_creer( mat , d , tt' + ref_insert + '[\'nouvel_id\'] , fo1 , __db1 );\r\n';
            src_serveur_js2+='        if(__aapc.__xst === __xer){\r\n';
            src_serveur_js2+='            await __db1.exec( \'ROLLBACK;\' );\r\n';
            src_serveur_js2+='            return({"__xst" : __xer ,"__xme" : __aapc.__xme});\r\n';
            src_serveur_js2+='        }\r\n';
            src_serveur_js2+='        await __db1.exec(\'COMMIT;\');\r\n';
            src_serveur_js2+='        if(retour_a_la_liste===true && fo1.__mat_liste_si_ok !== \'\'){\r\n';
            src_serveur_js2+='            let mat1=JSON.parse( fo1.__mat_liste_si_ok );\r\n';
            src_serveur_js2+='            await this.filtre1( mat1 , 1 , __db1 );\r\n';
            src_serveur_js2+='        }else{\r\n';
            if(avec_creer_et_dupliquer1 === 1){
                src_serveur_js2+='            if(__creer_et_dupliquer1 !== 0){\r\n';
                src_serveur_js2+='                let cmd=\'\';\r\n';
                src_serveur_js2+='                cmd+=\'m1(n1(\' + this.moi + \'),f1(page_creer1(\';\r\n';
                src_serveur_js2+='                cmd+=\'__creer_et_dupliquer1(\' + __creer_et_dupliquer1 + \')\';\r\n';
                for( let i=0 ; i < liste_des_champs_insert.length ; i++ ){
                    let le_champ=liste_des_champs_insert[i];
                    if(le_champ.nom_variable_session !== ''){
                        continue;
                    }
                    let genu=le_champ.champ_dans_la_base.genre_numerique_du_champ;
                    if(genu === 14 || genu === 16 || genu === 15){
                        /* dtc, dtm, nur */
                        continue;
                    }
                    if(le_champ.champ_dans_la_base.espece_du_champ === 'VARCHAR' || le_champ.champ_dans_la_base.espece_du_champ === 'TEXT'){
                        src_serveur_js2+='                cmd+=\',' + le_champ.nom_du_champ + '(\\\'\' + fo1.' + le_champ.nom_du_champ + '.replace(/\\\\/g,\'\\\\\\\\\').replace(/\\\'/g,\'\\\\\\\'\') + \'\\\')\';\r\n';
                    }else{
                        src_serveur_js2+='                cmd+=\',' + le_champ.nom_du_champ + '(\' + fo1.' + le_champ.nom_du_champ + ' + \')\';\r\n';
                    }
                }
                src_serveur_js2+='                cmd+=\',fld_indice_ds_lot(\' + (fo1.fld_indice_ds_lot + 1) + \')\';\r\n';
                src_serveur_js2+='                cmd+=\',fld_fil_id(\' + fo1.fld_fil_id + \')\';\r\n';
                src_serveur_js2+='                cmd+=\')))\';\r\n';
                src_serveur_js2+='                this.__ig1.donnees_retournees.__xac=cmd;\r\n';
                src_serveur_js2+='                let obj1=this.__ig1.__rev1.t2m( cmd );\r\n';
                src_serveur_js2+='                if(obj1.__xst !== __xsu){\r\n';
                src_serveur_js2+='                    return({"__xst" : __xer ,"__xme" : \' la __creer_et_dupliquer1 a echoué [\' + this.__ig1.nl2() + \']\'});\r\n';
                src_serveur_js2+='                }\r\n';
                src_serveur_js2+='                await this.page_creer1( obj1.__xva , 5 , __db1 );\r\n';
                src_serveur_js2+='            }else{\r\n';
                src_serveur_js2+='                await this.page_modification1( mat , d , tt2332[\'nouvel_id\'] , __db1 );\r\n';
                src_serveur_js2+='            }\r\n';
            }else{
        ...
        if(ref_select !== '' && ref_insert !== ''){
            ...
            if(fragment_trouve >= 0){
                ...
                src_serveur_js2+='      =============================================================================================================\r\n';
                src_serveur_js2+='    */\r\n';
                src_serveur_js2+='    async page_creer1( mat , d , __db1=null ){\r\n';
                src_serveur_js2+='        /*#\r\n';
                ...
                if(avec_creer_et_dupliquer1 === 1){
                    ...
                    for( let i=0 ; i < liste_des_champs_insert.length ; i++ ){
                        ...
                        if(le_champ.champ_dans_la_base.espece_du_champ === 'VARCHAR' || le_champ.champ_dans_la_base.espece_du_champ === 'TEXT'){
                            src_serveur_js2+='        let ' + le_champ.nom_du_champ + '=\'\';\r\n';
                        }else{
                            src_serveur_js2+='        let ' + le_champ.nom_du_champ + '=0;\r\n';
                        }
                    }
                    src_serveur_js2+='        const l01=mat.length;\r\n';
                    src_serveur_js2+='        for( let i=d + 1 ; i < l01 ; i=mat[i][12] ){\r\n';
                    src_serveur_js2+='            if(mat[i][1] === \'__creer_et_dupliquer1\' && mat[i][2] === \'f\' && mat[i][8] === 1 && mat[i + 1][2] === \'c\'){\r\n';
                    src_serveur_js2+='                __creer_et_dupliquer1=parseInt( mat[i + 1][1] , 10 );\r\n';
                    for( let i=0 ; i < liste_des_champs_insert.length ; i++ ){
                        let le_champ=liste_des_champs_insert[i];
                        if(le_champ.nom_variable_session !== ''){
                        ...
                        if(le_champ.champ_dans_la_base.espece_du_champ === 'VARCHAR' || le_champ.champ_dans_la_base.espece_du_champ === 'TEXT'){
                            src_serveur_js2+='            }else if(mat[i][1] === \'' + le_champ.nom_du_champ + '\' && mat[i][2] === \'f\' && mat[i][8] === 1 && mat[i + 1][2] === \'c\'){\r\n';
                            src_serveur_js2+='                ' + le_champ.nom_du_champ + '=mat[i + 1][1];\r\n';
                        }else{
                            if(le_champ.champ_dans_la_base.espece_du_champ === 'FLOAT' || le_champ.champ_dans_la_base.espece_du_champ === 'DECIMAL'){
                                src_serveur_js2+='            }else if(mat[i][1] === \'' + le_champ.nom_du_champ + '\' && mat[i][2] === \'f\' && mat[i][8] === 1 && mat[i + 1][2] === \'c\'){\r\n';
                                src_serveur_js2+='                ' + le_champ.nom_du_champ + '=parseFloat( mat[i + 1][1] );\r\n';
                            }else{
                                src_serveur_js2+='            }else if(mat[i][1] === \'' + le_champ.nom_du_champ + '\' && mat[i][2] === \'f\' && mat[i][8] === 1 && mat[i + 1][2] === \'c\'){\r\n';
                                src_serveur_js2+='                ' + le_champ.nom_du_champ + '=parseInt( mat[i + 1][1] , 10 );\r\n';
                            }
                        }
                    }
                    src_serveur_js2+='            }\r\n';
                ...
                src_serveur_js2+='        /* on peut initialiser une valeur ici, par exemple : */\r\n';
                src_serveur_js2+='        /* this.__ig1.donnees_retournees.__xva[\'xxxxx\']=\'xxxxx\'; */\r\n';
                src_serveur_js2+='        return({"__xst" : __xsu});\r\n';
                src_serveur_js2+='    }\r\n';
            }
        }
        if(ref_liste_ecran !== '' && pour_sous_liste_uniquement === 0){
            ...
            if(table_reference_est_table_virtuelle.length === 2){
                ...
                src_serveur_js2+='                criteres_' + ref_liste_ecran + '[i]=this.__ig1.donnees_recues.__xva.__complements_sous_liste[i];\r\n';
                src_serveur_js2+='            }\r\n';
                src_serveur_js2+='        }\r\n';
        ...
        if(est_une_grandeur === 1){
            ...
            */
            ...
            src_serveur_js2+='            }else if(mat[i][1] === \'id_zone\' && mat[i][2] === \'f\' && mat[i][8] === 1 && mat[i + 1][2] === \'c\'){\r\n';
            src_serveur_js2+='                id_zone=mat[i + 1][1];\r\n';
            src_serveur_js2+='            }else if(mat[i][1] === \'origine_de_l_appel_liste\' && mat[i][2] === \'f\' && mat[i][8] === 1 && mat[i + 1][2] === \'c\'){\r\n';
            src_serveur_js2+='                origine_de_l_appel_liste=mat[i + 1][1];\r\n';
            src_serveur_js2+='            }else if(mat[i][1] === \'champ_texte_associé\' && mat[i][2] === \'f\' && mat[i][8] === 1 && mat[i + 1][2] === \'c\'){\r\n';
            src_serveur_js2+='                champ_texte_associé=mat[i + 1][1];\r\n';
            src_serveur_js2+='            }else if(mat[i][1] === \'champ_libelle_associé\' && mat[i][2] === \'f\' && mat[i][8] === 1 && mat[i + 1][2] === \'c\'){\r\n';
        ...
        if(pour_sous_liste_uniquement === 1){
            ...
            if(est_une_grandeur === 1){
                ...
                */
                ...
                src_serveur_js2+='        let l01=mat.length;\r\n';
                src_serveur_js2+='        for(let i=d+1 ; i < l01 ; i=mat[i][12]){\r\n';
                src_serveur_js2+='            if(mat[i][1]===\'methode_sur_click2\' && mat[i][2]===\'f\'){\r\n';
                src_serveur_js2+='                for(let j=i+1 ; j < l01 ; j=mat[j][12]){\r\n';
                src_serveur_js2+='                    if(mat[j][1]===\'f1\' && mat[j][2]===\'f\'){\r\n';
                src_serveur_js2+='                        for(let k=j+1 ; k < l01 ; k=mat[k][12]){\r\n';
                src_serveur_js2+='                            if(mat[k][1]===\'nom_du_contexte\' && mat[k][2]===\'f\'){\r\n';
                src_serveur_js2+='                                contexte=\'nom_du_contexte\';\r\n';
                src_serveur_js2+='                                for(let l=k+1 ; l < l01 ; l=mat[l][12]){\r\n';
                src_serveur_js2+='                                    if(mat[l][1]===\'nom_de_variable\' && mat[l][2]===\'f\' && mat[l][8]===1 && mat[l+1][2]===\'c\'){\r\n';
                src_serveur_js2+='                                        nom_de_variable=parseInt( mat[l+1][1] , 10 );\r\n';
                src_serveur_js2+='                                    }\r\n';
                src_serveur_js2+='                                }\r\n';
                src_serveur_js2+='                            }\r\n';
                src_serveur_js2+='                        }\r\n';
        ...
        if(ref_select !== '' && ref_insert !== ''){
            ...
            if(avec_creer_et_dupliquer1 === 1){
                ...
                for( let i=0 ; i < liste_des_champs_insert.length ; i++ ){
                    ...
                    if(le_champ.champ_dans_la_base.espece_du_champ === 'VARCHAR' || le_champ.champ_dans_la_base.espece_du_champ === 'TEXT'){
                        src_client2+='        let ' + le_champ.nom_du_champ + '=\'\';\r\n';
                    }else{
                        src_client2+='        let ' + le_champ.nom_du_champ + '=0;\r\n';
                    }
                }
                src_client2+='        const l01=mat.length;\r\n';
                src_client2+='        for( let i=d + 1 ; i < l01 ; i=mat[i][12] ){\r\n';
                src_client2+='            if(mat[i][1] === \'__creer_et_dupliquer1\' && mat[i][2] === \'f\' && mat[i][8] === 1 && mat[i + 1][2] === \'c\'){\r\n';
                src_client2+='                __creer_et_dupliquer1=parseInt( mat[i + 1][1] , 10 );\r\n';
                for( let i=0 ; i < liste_des_champs_insert.length ; i++ ){
                    let le_champ=liste_des_champs_insert[i];
                    if(le_champ.nom_variable_session !== ''){
                    ...
                    if(le_champ.champ_dans_la_base.espece_du_champ === 'VARCHAR' || le_champ.champ_dans_la_base.espece_du_champ === 'TEXT'){
                        src_client2+='            }else if(mat[i][1] === \'' + le_champ.nom_du_champ + '\' && mat[i][2] === \'f\' && mat[i][8] === 1 && mat[i + 1][2] === \'c\'){\r\n';
                        src_client2+='                ' + le_champ.nom_du_champ + '=mat[i + 1][1];\r\n';
                    }else{
                        if(le_champ.champ_dans_la_base.espece_du_champ === 'FLOAT' || le_champ.champ_dans_la_base.espece_du_champ === 'DECIMAL'){
                            src_client2+='            }else if(mat[i][1] === \'' + le_champ.nom_du_champ + '\' && mat[i][2] === \'f\' && mat[i][8] === 1 && mat[i + 1][2] === \'c\'){\r\n';
                            src_client2+='                ' + le_champ.nom_du_champ + '=parseFloat( mat[i + 1][1] );\r\n';
                        }else{
                            src_client2+='            }else if(mat[i][1] === \'' + le_champ.nom_du_champ + '\' && mat[i][2] === \'f\' && mat[i][8] === 1 && mat[i + 1][2] === \'c\'){\r\n';
                            src_client2+='                ' + le_champ.nom_du_champ + '=parseInt( mat[i + 1][1] , 10 );\r\n';
                        }
                    }
                }
                src_client2+='            }\r\n';
            ...
            if(ref_insert !== ''){
                for( let i=0 ; i < liste_des_champs_insert.length ; i++ ){
                    ...
                    if(obj_champ.valeur_par_defaut
                           ...
                           && obj_champ.valeur_par_defaut.toLowerCase() !== 'null'
                    ){
            ...
            src_client2+='        this.__ig1.ajoute_les_evenements_aux_boutons();\r\n';
            if(masquer_le_bouton_ajouter_seulement === 1){
                src_client2+='        document.getElementById( \'vv_ajouter_un_element_\' + this.moi ).style.visibility=\'hidden\';\r\n';
            }
        ...
        */
        ...
        if(pour_sous_liste_uniquement === 0){
            ...
            src_client2+='      =============================================================================================================\r\n';
            src_client2+='    */\r\n';
            src_client2+='    raz_champ_filtre_grandeurs0( mat , d ){\r\n';
            src_client2+='        let l01=mat.length;\r\n';
            src_client2+='        for( let i=d + 1 ; i < l01 ; i=mat[i][12] ){\r\n';
            src_client2+='            this.filtres[\'liste1\'][mat[i][1]]=\'\';\r\n';
            src_client2+='        }\r\n';
            src_client2+='        return({"__xst" : __xsu});\r\n';
            src_client2+='    }\r\n';
            src_client2+='    /*\r\n';
            ...
            src_client2+='        if(a.innerHTML === this.LISTE_DES_ELEMENTS_GERES && a.getAttribute(\'data-contexte\') === this.moi){\r\n';
            src_client2+='        }else{\r\n';
        ...
        */
        if(des_champs_sont_references_dans_une_autre_table === true){
            ...
            if(est_une_grandeur === 1 && pour_sous_liste_uniquement === 1){
                src_client2+='    /*\r\n';
                src_client2+='      =============================================================================================================\r\n';
                src_client2+='    */\r\n';
                ...
                if(pour_sous_liste_uniquement === 1){
                    ...
                    src_client2+='        let o1=\'\';\r\n';
                    if(est_une_grandeur === 1 && pour_sous_liste_uniquement === 1){
                        src_client2+='        let __sous_titre_a_afficher=le_colis1.__xva.criteres2.__sous_titre_a_afficher??\'\';\r\n';
                        src_client2+='        let obj2=this.__ig1.construire_les_zones_filtres2( mat , d , le_colis1 , this , __sous_titre_a_afficher );\r\n';
                    }else{
                        src_client2+='        let obj2=this.__ig1.construire_les_zones_filtres2( mat , d , le_colis1 , this , \'grandeurs' + puiser_avec + '\' );\r\n';
                    }
                    src_client2+='        o1+=obj2.html2;\r\n';
                    src_client2+='        if(le_colis1 !== null && le_colis1.__xva.hasOwnProperty(\'sous_liste2\')){\r\n';
                    src_client2+='            let la_methode=\'\'\r\n';
                    src_client2+='            let contient_une_methode=false;\r\n';
                    src_client2+='            if(le_colis1.__xva.hasOwnProperty(\'methode_sur_click2\') && le_colis1.__xva.methode_sur_click2.trim() !== \'\'){\r\n';
                    src_client2+='                let methode_sur_click2=le_colis1.__xva.methode_sur_click2.trim();\r\n';
                    src_client2+='                methode_sur_click2=\'m1(\'+methode_sur_click2.substr(methode_sur_click2 , methode_sur_click2.length-2);\r\n';
                    src_client2+='                la_methode=\'\'+methode_sur_click2;\r\n';
                    src_client2+='                contient_une_methode=true;\r\n';
                    src_client2+='            }else{\r\n';
                    ...
                    src_client2+='                parametres+=la_methode;\r\n';
                    ...
                    src_client2+='                parametres+=\' id2(\' + tup.T0_' + champ_primaire + ' + \')\';\r\n';
                    src_client2+='                let libelle2=\'\';\r\n';
                    src_client2+='                libelle2+=\'(\' + tup.T0_' + champ_primaire + ' + \') \';\r\n';
                    /*
                    ...
                    */
                    ...
                    for(let i in this.#obj_table.champs){
                        if(this.#obj_table.champs[i].meta.est_libelle_lien === 1){
                            src_client2+='                libelle2+=tup.T0_' + i + ' ? ( \' , \' + this.__ig1.fi2( tup.T0_' + i + ' ) ) : ( \'\' );\r\n';
                            libelle_trouve=true;
                        }
                    }
                            ...
                            */
                            for(let j in liste_des_champs_liste_ecran){
                                if(liste_des_champs_liste_ecran[j].nom_du_champ === trouve && liste_des_champs_liste_ecran[j].prefixe_du_champ !== 'T0'){
                                    src_client2+='        libelle2+=\'       / \' + this.__ig1.fi2( tup.' + liste_des_champs_liste_ecran[j].prefixe_du_champ + '_' + trouve + ' ) ;\r\n';
                                }
                            }
                        }else{
                            /*
                              on essaie de trouver un champ varchar dans la table mère et on prend le premier
                            */
                            let position=9999;
                            ...
                            if(le_champ_trouve !== null){
                                let tt='%cAttention, pour le sous_liste2, la table ne contient pas d\'entete_distant_du_champ en conséquence le champ "' + le_champ_trouve.nom_du_champ + '" a été sélectionné.';
                                            ...
                                            if(les_champs_de_la_table_mere_de_la_table_mere[k].meta.hasOwnProperty( 'est_libelle_lien' )
                                                ...
                                                for(let l in liste_des_champs_liste_ecran){
                                                    if(liste_des_champs_liste_ecran[l].nom_du_champ === k && liste_des_champs_liste_ecran[l].préfixe_du_champ !== 'T0'){
                                                        src_client2+='        libelle2+=\'       / \' + this.__ig1.fi2( tup.' + liste_des_champs_liste_ecran[l].préfixe_du_champ + '_' + k + ' ) ;\r\n';
                                                    }
                                                }
                                            }
                                        }
                    ...
                    */
                    ...
                    for(let i in liste_des_champs_liste_ecran){
                        ...
                        for(let j in champs_combinaison_liste){
                            if(champs_combinaison_liste[j].combinaison[0].hasOwnProperty( 'nom_complet_du_champ' )){
                                ...
                                return({
                                        "__xst" : __xer ,
                                        "__xme" : "attention, les champs de champs_combinaison_liste de la requete " + ref_liste_ecran + " sont mal définis "
                                    });
                            }
                        }
                        let c_est_un_nieme_champ_de_combinaison=null;
                        ...
                        if(tab_champs_sortie.includes( cle )){
                            ...
                            if(chp_ds_lb === null){
                                ...
                                */
                                ...
                                if(chp_ds_lb.genre_objet_du_champ
                                       && (chp_ds_lb.genre_objet_du_champ.che_est_tsm_genre === 1
                                           || chp_ds_lb.genre_objet_du_champ.che_est_tsc_genre === 1
                                           || chp_ds_lb.genre_objet_du_champ.che_est_nur_genre === 1)
                                ){
                                    continue;
                                }
                                ...
                                src_client2+='            /' + '*\n';
                                src_client2+='            *' + '/\n';
                                if(chp_ds_lb.espece_du_champ === 'TEXT'){
                                    if(c_est_un_premier_champ_de_combinaison !== null){
                                        debugger;
                                        src_client2+='            /* combinaison */;\r\n';
                                    }
                                    src_client2+='            lst += \'<td style="max-width:24em;overflow:hidden;">\';\r\n';
                                    src_client2+='            lst+=this.__ig1.fi2( tup.' + cle + ').substr(0,200);\r\n';
                                    if(c_est_un_premier_champ_de_combinaison !== null){
                                        for( let j=1 ; j < champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].combinaison.length ; j++ ){
                                            let combi=champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].combinaison[j];
                                            if(combi.nom_complet_du_champ.indexOf( 'chp_cle_grandeur' ) >= 0){
                                                src_client2+='            /* cas liste2 1.0 */\r\n';
                                                ...
                                                src_client2+='            /* cas liste2 1.1 */\r\n';
                                                src_client2+='            lst+=\'' + combi.htm_pref + '<span class="' + combi.htm_clas + '" style="' + combi.htm_prop + '">\' + this.__ig1.fi2( tup.' + combi.nom_complet_du_champ + ' ) + \'</span>' + combi.htm_post + '\';\r\n';
                                            }
                                        }
                                    }
                                }else if(chp_ds_lb.espece_du_champ === 'VARCHAR'){
                                    if(c_est_un_premier_champ_de_combinaison !== null){
                                        debugger;
                                        src_client2+='            /* combinaison */;\r\n';
                                    ...
                                    if(c_est_un_premier_champ_de_combinaison !== null){
                                        for( let j=1 ; j < champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].combinaison.length ; j++ ){
                                            let combi=champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].combinaison[j];
                                            if(this.#obj_table.champs.hasOwnProperty( combi.nom_du_champ )
                                                   && this.#obj_table.champs[combi.nom_du_champ].table_mere === 'tbl_grandeurs'
                                            ){
                                                src_client2+='            /* cas liste2 2.0 */\r\n';
                                                src_client2+='                lst+=\'' + combi.htm_pref + '\' + this.__ig1.rendu_lst_grandeur1( ' + this.#obj_table.champs[combi.nom_du_champ].base_mere + ' , tup.' + combi.nom_complet_du_champ + ' ) + \'' + combi.htm_post + '\';\r\n';
                                            }else{
                                                if(combi.nom_complet_du_champ.indexOf( 'chp_cle_grandeur' ) >= 0){
                                                    src_client2+='                /* cas liste2 2.1 */\r\n';
                                                    src_client2+='                lst+=\'' + combi.htm_pref + '<span class="' + combi.htm_clas + '" style="' + combi.htm_prop + '">\' + this.__ig1.fi2( tup.' + combi.nom_complet_du_champ + ' ) + \'</span>' + combi.htm_post + '\';\r\n';
                                                }else{
                                                    src_client2+='                /* cas liste2 2.2 */\r\n';
                                                    src_client2+='                lst+=\'' + combi.htm_pref + '<span class="' + combi.htm_clas + '" style="' + combi.htm_prop + '">\' + this.__ig1.fi2( tup.' + combi.nom_complet_du_champ + ') + \'</span>' + combi.htm_post + '\';\r\n';
                                                }
                                            }
                                        }
                                    ...
                                    if(chp_ds_lb.genre_objet_du_champ.cht_parmis_genre === '0,1'
                                           && chp_ds_lb.genre_objet_du_champ.cht_valeur_init_genre === '0'
                                           && chp_ds_lb.genre_objet_du_champ.chp_espece_genre === 'INTEGER'
                                    ){
                                        if(c_est_un_premier_champ_de_combinaison !== null){
                                            debugger;
                                            src_client2+='            /* combinaison */;\r\n';
                                        }
                                        src_client2+='                /* cas liste2 3.0 */\r\n';
                                        src_client2+='            lst += \'<td style="text-align:center;">\';\r\n';
                                        src_client2+='            if(tup.' + cle + '===0){\r\n';
                                        src_client2+='                lst+=\'<div style="height:var(--t_police);width:var(--t_police);margin:0 auto;display:inline-block;">\'+this.__ig1.les_svg.rond_rouge1+\'</div>\';\r\n';
                                        src_client2+='            }else{\r\n';
                                        src_client2+='                lst+=\'<div style="height:var(--t_police);width:var(--t_police);margin:0 auto;display:inline-block;">\'+this.__ig1.les_svg.rond_vert1+\'</div>\';\r\n';
                                        src_client2+='            }\r\n';
                                        /*#
                                          if('T0_che_actif_acces' === cle){
                                              debugger
                                          }
                                        */
                                        if(c_est_un_premier_champ_de_combinaison !== null){
                                            for( let j=1 ; j < champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].combinaison.length ; j++ ){
                                                let combi=champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].combinaison[j];
                                                if(combi.nom_complet_du_champ.indexOf( 'chp_cle_grandeur' ) >= 0){
                                                    src_client2+='                /* cas liste2 3.1 */\r\n';
                                                    src_client2+='                lst+=\'' + combi.htm_pref + '<span class="' + combi.htm_clas + '" style="' + combi.htm_prop + '">\' + this.__ig1.fi2( tup.' + combi.nom_complet_du_champ + ' ) + \'</span>' + combi.htm_post + '\';\r\n';
                                                }else{
                                                    src_client2+='                /* cas liste2 3.2 */\r\n';
                                                    src_client2+='                lst+=\'' + combi.htm_pref + '<span class="' + combi.htm_clas + '" style="' + combi.htm_prop + '">\' + this.__ig1.fi2( tup.' + combi.nom_complet_du_champ + ' ) + \'</span>' + combi.htm_post + '\';\r\n';
                                                }
                                            }
                                        }
                                        ...
                                        if(chp_ds_lb.hasOwnProperty( 'table_mere' ) && chp_ds_lb.table_mere !== ''){
                                            if(chp_ds_lb.table_mere === 'tbl_grandeurs'){
                                                src_client2+='                /* cas liste2 4.0 */\r\n';
                                                src_client2+='                if(tup.' + cle + ' !== null){\r\n';
                                                src_client2+='                    lst+=this.__ig1.rendu_lst_grandeur1( ' + chi_id_basedd_de_reference + ' , tup.' + cle + ' );\r\n';
                                                src_client2+='                }\r\n';
                                            }else{
                                                src_client2+='                /* cas liste2 4.1 */\r\n';
                                                src_client2+='                lst+=\'(\' + this.__ig1.fi2( tup.' + cle + ' ) + \') \';\r\n';
                                            }
                                        }else{
                                            if(el.champ_dans_la_base.genre_numerique_du_champ === 25){
                                                src_client2+='                /* cas liste2 4.2 */\r\n';
                                                src_client2+='                if(tup.' + cle + ' === 0){\r\n';
                                                src_client2+='                    lst+=\'<div style="height:var(--t_police);width:var(--t_police);margin:0 auto;display:inline-block;">\' + this.__ig1.les_svg.rond_rouge1 + \'</div>\';\r\n';
                                                src_client2+='                }else{\r\n';
                                                src_client2+='                    lst+=\'<div style="height:var(--t_police);width:var(--t_police);margin:0 auto;display:inline-block;">\' + this.__ig1.les_svg.rond_vert1 + \'</div>\';\r\n';
                                        ...
                                        if(c_est_un_premier_champ_de_combinaison !== null){
                                            for( let j=1 ; j < champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].combinaison.length ; j++ ){
                                                let combi=champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].combinaison[j];
                                                if(combi.nom_complet_du_champ.indexOf( 'chp_cle_grandeur' ) >= 0){
                                                    src_client2+='                /* cas liste2 5.0 */\r\n';
                                                    src_client2+='                lst+=\'' + combi.htm_pref + '<span class="' + combi.htm_clas + '" style="' + combi.htm_prop + '">\' + this.__ig1.fi2( tup.' + combi.nom_complet_du_champ + ' ) + \'</span>' + combi.htm_post + '\';\r\n';
                                                }else{
                                                    src_client2+='                /* cas liste2 5.1 */\r\n';
                                                    src_client2+='                lst+=\'' + combi.htm_pref + '<span class="' + combi.htm_clas + '" style="' + combi.htm_prop + '">\' + this.__ig1.fi2( tup.' + combi.nom_complet_du_champ + ' ) + \'</span>' + combi.htm_post + '\';\r\n';
                                                }
                                            }
                                        }
                    ...
                    for(let i in liste_des_champs_liste_ecran){
                        ...
                        let cle=cle_Tn + '_' + liste_des_champs_liste_ecran[i].nom_du_champ;
                        let c_est_un_premier_champ_de_combinaison=null;
                        for(let j in champs_combinaison_liste){
                            if(champs_combinaison_liste[j].combinaison[0].nom_complet_du_champ === cle){
                                c_est_un_premier_champ_de_combinaison=j;
                    ...
                    src_client2+='        }\r\n';
                    if(est_une_grandeur === 1 && pour_sous_liste_uniquement === 1){
                        src_client2+='        this.__ig1.initialisation_filtre_sous_fenetre2( \'sous_liste2\' , o1 , this.DUN_DUNE_ELEMENT_GERE , __sous_titre_a_afficher );\r\n';
                    }else{
        ...
        fragment_trouve=-1;
        for( let i=0 ; i < tableau_des_fragments_client.length ; i++ ){
            if(tableau_des_fragments_client[i].nom_methode_client === 'liste_des_boutons_action1'){
                fragment_trouve=i;
                break;
            }
        }
            ...
            if(pour_sous_liste_uniquement === 0){
                ...
                */
                ...
                for(let i in liste_des_champs_liste_ecran){
                    ...
                    */
                    if(this.#obj_table.champs.hasOwnProperty( el.nom_du_champ )
                        ...
                        fonction_pour_liste1=this.#obj_table.champs[el.nom_du_champ].meta.fonction_pour_liste1.replace( /¶CRLF¶/g , '\r\n' ).replace( /¶LF¶/g , '\n' ).replace( /¶CR¶/g , '\r' ).trim();
                        fonction_pour_liste1=fonction_pour_liste1.replace( /\\\\/g , '\\' ).replace( /\\\'/g , '\'' );
                        /* hugues */
                        let obj1=this.#objet_conversion_rev_vers_js.c_rev_vers_js( fonction_pour_liste1 , {} );
                        if(obj1.__xst !== __xsu){
                            return({"__xst" : __xsu ,"__xme" : "erreur de conversion de la fonction_pour_liste1 pour " + cle + " " + this.__ig1.nl2()});
                        }
                        fonction_pour_liste1=obj1.__xva;
                    }
                    if(el.champ_dans_la_base.espece_du_champ === 'TEXT'){
                        ...
                        if(c_est_un_premier_champ_de_combinaison !== null){
                            src_client2+='                /*\r\n';
                            src_client2+='                  =====================================================================================\r\n';
                            src_client2+='                  combinaison ' + champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].entete_liste + '\r\n';
                            src_client2+='                */;\r\n';
                            if(champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].format_colonne !== ''){
                                src_client2+='            lst += \'<td style="' + champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].format_colonne + '">\';\r\n';
                            }else{
                        ...
                        if(fonction_pour_liste1 !== ''){
                            src_client2+='            ' + fonction_pour_liste1 + '\r\n';
                        }else{
                            src_client2+='            lst+=this.__ig1.fi2( tup.' + cle + ').substr( 0 , ' + lng_txt + ' );\r\n';
                        }
                        if(c_est_un_premier_champ_de_combinaison !== null){
                            for( let j=1 ; j < champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].combinaison.length ; j++ ){
                                let combi=champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].combinaison[j];
                        ...
                        if(c_est_un_premier_champ_de_combinaison !== null){
                            ...
                            if(champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].format_colonne !== ''){
                                ...
                                src_client2+='            lst += \'<td style="text-align:left;">\';\r\n';
                            }
                        }else{
                            src_client2+='            lst += \'<td style="text-align:left;">\';\r\n';
                        }
                        if(el.champ_dans_la_base.table_mere === 'tbl_grandeurs'){
                            src_client2+='            /* cas 3.1 */\r\n';
                            src_client2+='            /* lst+=this.__ig1.fi2( tup.' + cle + '); */\r\n';
                        }else{
                            if(c_est_un_premier_champ_de_combinaison !== null){
                                let combi=champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].combinaison[0];
                                src_client2+='            /* cas 3.2 */\r\n';
                                src_client2+='            lst+=\'' + combi.htm_pref + '<span class="' + combi.htm_clas + '" style="' + combi.htm_prop + '">\' + this.__ig1.fi2( tup.' + combi.nom_complet_du_champ + ' ) + \'</span>' + combi.htm_post + '\';\r\n';
                            }else{
                                if(fonction_pour_liste1 !== ''){
                        ...
                        if(c_est_un_premier_champ_de_combinaison !== null){
                            for( let j=1 ; j < champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].combinaison.length ; j++ ){
                                ...
                                if(combi.nom_complet_du_champ.indexOf( 'chp_cle_grandeur' ) >= 0){
                                    ...
                                    src_client2+='<span class="' + combi.htm_clas + '" style="' + combi.htm_prop + '">';
                                    src_client2+='\' + this.__ig1.fi2( tup.' + combi.nom_complet_du_champ + ' ) + \'</span>' + combi.htm_post + '\';\r\n';
                                }else{
                                    let nom_complet_du_champ=combi.nom_complet_du_champ;
                                    let est_une_reference_a_grandeur=false;
                                    if(nom_complet_du_champ.substr( 0 , 3 ) === 'T0_'){
                                        let nom_reduit_du_champ=nom_complet_du_champ.substr( 3 );
                                        if(this.#obj_table.champs[nom_reduit_du_champ].hasOwnProperty( 'table_mere' )
                                               && this.#obj_table.champs[nom_reduit_du_champ].table_mere === 'tbl_grandeurs'
                                        ){
                                            est_une_reference_a_grandeur=true;
                                        }
                                    }
                                    if(est_une_reference_a_grandeur === true){
                                        src_client2+='                /* cas 4.2 */\r\n';
                                        /* src_client2+='                /'+'* lst+=\' \' + this.__ig1.fi2( tup.' + combi.nom_complet_du_champ + ' ); *'+'/\r\n'; */
                                        src_client2+='                if(tup.' + combi.nom_complet_du_champ + ' !== null){\r\n';
                                        src_client2+='                    lst+=\'' + combi.htm_pref + '\';\r\n';
                                        src_client2+='                    lst+=this.__ig1.rendu_lst_grandeur1( ' + chi_id_basedd_de_reference + ' , tup.' + combi.nom_complet_du_champ + ' );\r\n';
                                        src_client2+='                    lst+=\'' + combi.htm_post + '\';\r\n';
                                        src_client2+='                }\r\n';
                                    }else{
                                        if(combi.prefix === 'T0'){
                                            src_client2+='                /* cas 4.3 */\r\n';
                                            if(this.#obj_table.champs[combi.nom_du_champ].genre_numerique_du_champ === 5){
                                                src_client2+='                lst+=\'' + combi.htm_pref + '\';\r\n';
                                                src_client2+='                if(tup.' + combi.nom_complet_du_champ + ' === 0){\r\n';
                                                src_client2+='                    lst+=\'<div style="height:var(--t_police);width:var(--t_police);margin:0 auto;display:inline-block;">\' + this.__ig1.les_svg.rond_rouge1 + \'</div>\';\r\n';
                                                src_client2+='                }else{\r\n';
                                                src_client2+='                    lst+=\'<div style="height:var(--t_police);width:var(--t_police);margin:0 auto;display:inline-block;">\' + this.__ig1.les_svg.rond_vert1 + \'</div>\';\r\n';
                                                src_client2+='                }\r\n';
                                            }else if(this.#obj_table.champs[combi.nom_du_champ].genre_numerique_du_champ === 25){
                                                src_client2+='                lst+=\'' + combi.htm_pref + '\';\r\n';
                                                src_client2+='                if(tup.' + combi.nom_complet_du_champ + ' === 1){\r\n';
                                                src_client2+='                    lst+=\'<div style="height:var(--t_police);width:var(--t_police);margin:0 auto;display:inline-block;">\' + this.__ig1.les_svg.rond_rouge1 + \'</div>\';\r\n';
                                                src_client2+='                }else if(tup.' + combi.nom_complet_du_champ + ' === 0){\r\n';
                                                src_client2+='                    lst+=\'<div style="height:var(--t_police);width:var(--t_police);margin:0 auto;display:inline-block;">\' + this.__ig1.les_svg.rond_vert1 + \'</div>\';\r\n';
                                                src_client2+='                }\r\n';
                                            }else{
                                                src_client2+='                lst+=\'' + combi.htm_pref;
                                                src_client2+='<span class="' + combi.htm_clas + '" style="' + combi.htm_prop + '">';
                                                if(this.#obj_table.champs[combi.nom_du_champ].hasOwnProperty( 'table_mere' )
                                                       && this.#obj_table.champs[combi.nom_du_champ].table_mere !== ''
                                                ){
                                                    src_client2+='(\' + this.__ig1.fi2( tup.' + combi.nom_complet_du_champ + ' ) + \') </span>\';\r\n';
                                                }else{
                                                    src_client2+='\' + this.__ig1.fi2( tup.' + combi.nom_complet_du_champ + ' ) + \'</span>' + combi.htm_post + '\';\r\n';
                                                }
                                            }
                        ...
                        if(liste_des_champs_liste_ecran[i].champ_dans_la_base.genre_objet_du_champ.cht_parmis_genre === '0,1'
                            ...
                            if(c_est_un_premier_champ_de_combinaison !== null
                                   && champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].format_colonne !== ''
                            ){
                                src_client2+='            lst += \'<td style="' + champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].format_colonne + '">\';\r\n';
                            }else{
                                src_client2+='            lst += \'<td style="text-align:center;">\';\r\n';
                            ...
                            src_client2+='                /* cas 5 */\r\n';
                            src_client2+='                if(tup.' + cle + ' === 1){\r\n';
                            src_client2+='                    lst+=\'<div style="display:inline-block;height:var(--t_police);width:var(--t_police);margin:0 auto;">\'+this.__ig1.les_svg.rond_vert1+\'</div>\';\r\n';
                            src_client2+='                }else{\r\n';
                            src_client2+='                    lst+=\'<div style="display:inline-block;height:var(--t_police);width:var(--t_police);margin:0 auto;">\'+this.__ig1.les_svg.rond_rouge1+\'</div>\';\r\n';
                            src_client2+='                }\r\n';
                            if(c_est_un_premier_champ_de_combinaison !== null){
                                for( let j=1 ; j < champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].combinaison.length ; j++ ){
                                    let combi=champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].combinaison[j];
                                    if(combi.prefix === 'T0'){
                                        if(this.#obj_table.champs[combi.nom_du_champ].genre_numerique_du_champ === 5
                                               || this.#obj_table.champs[combi.nom_du_champ].genre_numerique_du_champ === 25
                                        ){
                                            src_client2+='        /* cas 6.0 */\r\n';
                                            if(combi.htm_pref !== ''){
                                                src_client2+='        lst+=\'' + combi.htm_pref + '\'\r\n';
                            ...
                            if(liste_des_champs_liste_ecran[i].champ_dans_la_base.hasOwnProperty( 'table_mere' )
                                   && liste_des_champs_liste_ecran[i].champ_dans_la_base.table_mere !== ''
                            ){
                                if(c_est_un_premier_champ_de_combinaison !== null){
                                    if(liste_des_champs_liste_ecran[i].champ_dans_la_base.table_mere === 'tbl_grandeurs'){
                                        ...
                                        src_client2+='                    lst+=this.__ig1.rendu_lst_grandeur1( ' + chi_id_basedd_de_reference + ' , tup.' + cle + ' )\r\n';
                                        src_client2+='                }\r\n';
                                        /* src_client2+='                /_* lst+=\'(\' + this.__ig1.fi2( tup.' + cle + ' ) + \')\' *_/;\r\n'; */
                                    }else{
                                        src_client2+='                /* cas 7.2 */\r\n';
                                        src_client2+='                lst+=\'(\' + this.__ig1.fi2( tup.' + cle + ' ) + \')\';\r\n';
                                    }
                                ...
                                if(c_est_un_premier_champ_de_combinaison !== null){
                                    let combi=champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].combinaison[0];
                                    if(combi.nom_complet_du_champ === cle){
                                        src_client2+='                /* cas 9.0.1 */\r\n';
                                        src_client2+='                lst+=\'' + combi.htm_pref + '<span';
                                        src_client2+=' class="' + combi.htm_clas + '"';
                                        src_client2+=' style="' + combi.htm_prop + '">';
                                        src_client2+='\' +';
                                        if(combi.espece_du_champ === 'DECIMAL'){
                                            src_client2+='this.__ig1.__fnts_c_et_s.fmt_dec1(tup.' + combi.nom_complet_du_champ + ' , ' + combi.nombre_de_decimales + ' )';
                                            /* src_client2+='tup.' + combi.nom_complet_du_champ + '.toLocaleString( undefined , {"minimumFractionDigits" : '+combi.nombre_de_decimales +'} )'; */
                                        }else{
                                            src_client2+='this.__ig1.fi2( tup.' + combi.nom_complet_du_champ + ')';
                                        }
                                        src_client2+=' + \'</span>' + combi.htm_post + '\';\r\n';
                                    }else{
                                        src_client2+='                /* cas 9.0.2 */\r\n';
                                        src_client2+='                lst+=this.__ig1.fi2( tup.' + cle + ' );\r\n';
                                    }
                                }else{
                                    if(champ_primaire === el.nom_du_champ && el.préfixe_du_champ === 'T0'){
                                        src_client2+='                /* cas 9.1.0 */\r\n';
                                        src_client2+='                lst+=\'<span data-' + champ_primaire + '="\' + this.__ig1.fi2( tup.' + cle + ' ) + \'">\' + this.__ig1.fi2( tup.' + cle + ' ) + \'</span>\';\r\n';
                                    }else{
                                        if(el.champ_dans_la_base.genre_numerique_du_champ === 5){
                                            src_client2+='                /* cas 9.1.1 */\r\n';
                                            src_client2+='                if(tup.' + cle + ' === 0){\r\n';
                                            src_client2+='                    lst+=\'<div style="height:var(--t_police);width:var(--t_police);margin:0 auto;display:inline-block;">\' + this.__ig1.les_svg.rond_rouge1 + \'</div>\';\r\n';
                                            src_client2+='                }else{\r\n';
                                            src_client2+='                    lst+=\'<div style="height:var(--t_police);width:var(--t_police);margin:0 auto;display:inline-block;">\' + this.__ig1.les_svg.rond_vert1 + \'</div>\';\r\n';
                                            src_client2+='                }\r\n';
                                        }else if(el.champ_dans_la_base.genre_numerique_du_champ === 25){
                                            src_client2+='                /* cas 9.1.2 */\r\n';
                                            src_client2+='                if(tup.' + cle + ' === 0){\r\n';
                                            src_client2+='                    lst+=\'<div style="height:var(--t_police);width:var(--t_police);margin:0 auto;display:inline-block;">\' + this.__ig1.les_svg.rond_rouge1 + \'</div>\';\r\n';
                                            src_client2+='                }else if(tup.' + cle + ' === 1){\r\n';
                                            src_client2+='                    lst+=\'<div style="height:var(--t_police);width:var(--t_police);margin:0 auto;display:inline-block;">\' + this.__ig1.les_svg.rond_vert1 + \'</div>\';\r\n';
                                            src_client2+='                }\r\n';
                                        }else{
                            ...
                            if(c_est_un_premier_champ_de_combinaison !== null){
                                for( let j=1 ; j < champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].combinaison.length ; j++ ){
                                    let combi=champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].combinaison[j];
                                    let nom_complet_du_champ=combi.nom_complet_du_champ;
                                    let est_une_reference_a_grandeur=0;
                                    if(nom_complet_du_champ.substr( 0 , 3 ) === 'T0_'){
                                        let nom_reduit_du_champ=nom_complet_du_champ.substr( 3 );
                                        if(this.#obj_table.champs[nom_reduit_du_champ].hasOwnProperty( 'table_mere' )
                                               && this.#obj_table.champs[nom_reduit_du_champ].table_mere === 'tbl_grandeurs'
                                        ){
                                            est_une_reference_a_grandeur=this.#obj_table.champs[nom_reduit_du_champ].meta.chi_id_parametre;
                                        }
                                    }
                                    if(est_une_reference_a_grandeur > 0){
                                        src_client2+='                /* cas 10.1 */\r\n';
                                        src_client2+='                if(tup.T0_' + nom_complet_du_champ.substr( 3 ) + '){\r\n';
                                        src_client2+='                    lst+=\'' + combi.htm_pref + '<span class="' + combi.htm_clas + '" style="' + combi.htm_prop + '">\' + this.__ig1.rendu_lst_grandeur1( ' + chi_id_basedd_de_reference + ' , tup.T0_' + nom_complet_du_champ.substr( 3 ) + ' ) + \'</span>' + combi.htm_post + '\';\r\n';
                                        src_client2+='                }\r\n';
                                    }else{
                                        if(combi.nom_complet_du_champ.substr( 0 , 3 ) === 'T0_'){
                                            let le_champ=this.#obj_bdd[this.#nom_de_la_table].champs[combi.nom_complet_du_champ.substr( 3 )];
                                            if(le_champ.espece_du_champ === 'TEXT'){
                                                let longueur_du_champ=this.#obj_bdd[this.#nom_de_la_table].champs[combi.nom_complet_du_champ.substr( 3 )].longueur_du_champ;
                                                let sub_a_prendre=longueur_du_champ.substr( longueur_du_champ.indexOf( '.' ) + 1 );
                                                /* src_client2+='                // cas 10.2.1\r\n'; */
                                                src_client2+='                lst+=\'' + combi.htm_pref + '';
                                                src_client2+='<span class="' + combi.htm_clas + '" style="' + combi.htm_prop + '">\' + this.__ig1.fi2( tup.' + combi.nom_complet_du_champ + ').substr( 0 , ' + sub_a_prendre + ' ) + \'</span>' + combi.htm_post + '\';\r\n';
                                            }else{
                                                src_client2+='                /* cas 10.2.1 */\r\n';
                                                src_client2+='                lst+=\'' + combi.htm_pref + '';
                                                src_client2+='<span class="' + combi.htm_clas + '"';
                                                src_client2+=' style="' + combi.htm_prop + '"';
                                                src_client2+='>\' + ';
                                                if(combi.espece_du_champ === 'DECIMAL'){
                                                    /* src_client2+='tup.' + combi.nom_complet_du_champ + '.toLocaleString( undefined , {"minimumFractionDigits" : '+combi.nombre_de_decimales +'} )'; */
                                            ...
                                            src_client2+='                /* cas 10.2.2 */\r\n';
                                            src_client2+='                lst+=\'' + combi.htm_pref + '';
                                            src_client2+='<span class="' + combi.htm_clas + '" style="' + combi.htm_prop + '">\' + this.__ig1.fi2( tup.' + combi.nom_complet_du_champ + ' ) + \'</span>' + combi.htm_post + '\';\r\n';
                                        }
                                    }
                                }
                            }
                ...
                for(let i in liste_des_champs_liste_ecran){
                    let el=liste_des_champs_liste_ecran[i];
                    let cle_Tn=liste_des_champs_liste_ecran[i].préfixe_du_champ;
                    let nom_du_champ=liste_des_champs_liste_ecran[i].nom_du_champ;
                    let cle=liste_des_champs_liste_ecran[i].préfixe_du_champ + '_' + nom_du_champ;
                    if(tab_champs_sortie.includes( cle )){
                    }else{
                        let el=liste_des_champs_liste_ecran[i];
                        let cle=el.préfixe_du_champ + '_' + el.nom_du_champ;
                        ...
                        if(c_est_un_premier_champ_de_combinaison !== null){
                            if(champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].hasOwnProperty( 'format_entete' )
                                   && champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].format_entete !== ''
                            ){
                                src_client2+='                o1+=/* combinaison */\'<th style="' + champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].format_entete + '">' + champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].entete_liste + '</th>\';\r\n';
                            }else{
                                src_client2+='                o1+=/* combinaison */\'<th>' + champs_combinaison_liste[c_est_un_premier_champ_de_combinaison].entete_liste + '</th>\';\r\n';
                            }
                            continue;
    ...
    */
    ajoute_suggestion_du_champ( obj_champ ){
        ...
        if(obj_champ.meta.hasOwnProperty( 'suggestion_du_champ' ) && obj_champ.meta.suggestion_du_champ !== ''){
            ...
            /*#
              if(obj_champ.nom_du_champ === 'fld_nom_modele'){
                   debugger
              }
            */
            for( let isuggestion_du_champ=1 ; isuggestion_du_champ < obj_mat_rev.__xva.length ; isuggestion_du_champ=obj_mat_rev.__xva[isuggestion_du_champ][12] ){
                let le_chtm_du_lien='';
                let la_suggestion='';
                la_suggestion+='<div class="rev_bouton" data-rev_click="m1(n1(__ig1),f1(maj_contenu(';
                la_suggestion+='type_cible(valeur_constante),';
                la_suggestion+='id(' + obj_champ.nom_du_champ + '),';
                la_suggestion+='valeur(valeur_constante(';
                if(obj_mat_rev.__xva[isuggestion_du_champ][4] === 0){
                    /* constante */
                    la_suggestion+=obj_mat_rev.__xva[isuggestion_du_champ][1];
                }else if(obj_mat_rev.__xva[isuggestion_du_champ][4] === 1){
                    la_suggestion+='\'' + obj_mat_rev.__xva[isuggestion_du_champ][1].replace( /"/g , '&quot;' ) + '\'';
                }else if(obj_mat_rev.__xva[isuggestion_du_champ][4] === 3){
                    /* double quote */
                    la_suggestion+='\'' + obj_mat_rev.__xva[isuggestion_du_champ][1].replace( /\'/g , '\\\'' ).replace( /\\"/g , '&quot;' ) + '\'';
                }else{
                    debugger;
                }
                /* .replace( /\\/g , '\\\\' ).replace( /\'/g , '\\\'' ) */
                ...
                la_suggestion+='</div>';
                les_suggestions.push( la_suggestion );
                le_chtm_du_lien+='        o1+=\'          <div';
                le_chtm_du_lien+=' class="rev_bouton yy_btn_large"';
                le_chtm_du_lien+=' data-rev_click="';
                le_chtm_du_lien+='m1(n1(__ig1),f1(maj_contenu(';
                le_chtm_du_lien+='type_cible(valeur_constante),';
                le_chtm_du_lien+='id(' + obj_champ.nom_du_champ + '),';
                le_chtm_du_lien+='valeur(valeur_constante(';
                if(obj_mat_rev.__xva[isuggestion_du_champ][4] === 0){
                    le_chtm_du_lien+=obj_mat_rev.__xva[isuggestion_du_champ][1];
                }else if(obj_mat_rev.__xva[isuggestion_du_champ][4] === 1){
                    le_chtm_du_lien+='\\\'' + obj_mat_rev.__xva[isuggestion_du_champ][1].replace( /\\/g , '\\\\\\\\' ).replace( /\'/g , '\\\\\\\'' ) + '\\\'';
                }else if(obj_mat_rev.__xva[isuggestion_du_champ][4] === 3){
                    le_chtm_du_lien+='\\\'' + obj_mat_rev.__xva[isuggestion_du_champ][1].replace( /\\/g , '\\\\\\\\' ).replace( /\'/g , '\\\\\\\'' ) + '\\\'';
                }else{
                    debugger;
                ...
                le_chtm_du_lien+=obj_mat_rev.__xva[isuggestion_du_champ][1];
                le_chtm_du_lien+='</div>\';\r\n';
                src_client2+=le_chtm_du_lien;
            }
            src_client2+='        o1+=\'      </div>\';\r\n';
        }
        return({"src_client2" : src_client2 ,"les_suggestions" : les_suggestions});
    }
    /*
      =============================================================================================================
    */
    ...
    */
    selectionner_une_requete( mat , d ){
        ...
        if(this.#liste_des_types_de_requetes.liste_ecran === true){
            ...
            if(document.getElementById( 'pour_sous_liste_uniquement' ).checked === true
                   && document.getElementById( 'est_une_grandeur' ).checked === true
            ){
                document.getElementById( 'gererer_le_js_bdd1' ).style.visibility='visible';
            }else{
    ...
    /*
      =============================================================================================================
    */
    enrichir_table_de_base( mat2 , j , chi_id_basedd , nom_de_la_table ){
        let l02=mat2.length;
        let oout={"champs" : {} ,"ordre_des_champs" : [] ,"meta" : {}};
        let les_dependances=[];
        for( let k=j + 1 ; k < l02 ; k=mat2[k][12] ){
            if(mat2[k][2] === 'f' && mat2[k][1] === 'meta'){
                for( let l=k + 1 ; l < l02 ; l=mat2[l][12] ){
                    if(mat2[l][2] === 'f' && mat2[l][8] === 1 && mat2[l + 1][2] === 'c'){
                        oout.meta[mat2[l][1]]=mat2[l + 1][1];
                    }
                }
            }
        }
        for( let l=j + 1 ; l < l02 ; l=mat2[l][12] ){
            if(mat2[l][1] === 'champs'){
                let position_du_champ_dans_la_table=0;
                for( let m=l + 1 ; m < l02 ; m=mat2[m][12] ){
                    if(mat2[m][1] === 'champ'){
                        var nom_du_champ='';
                        ...
                        for( let n=m + 1 ; n < l02 ; n=mat2[n][12] ){
                            if(mat2[n][1] === 'nom_du_champ' && mat2[n][2] === 'f' && mat2[n][8] === 1){
                                ...
                                position_du_champ_dans_la_table++;
                                oout.champs[nom_du_champ]={"nom_du_champ" : nom_du_champ ,"meta" : {} ,"position_du_champ_dans_la_table" : position_du_champ_dans_la_table};
                        ...
                        if(nom_du_champ !== ''){
                            oout.ordre_des_champs.push( nom_du_champ );
                            oout.champs[nom_du_champ]['non_nulle']=false;
                            for( let n=m + 1 ; n < l02 ; n=mat2[n][12] ){
                                if(mat2[n][1] === 'type'){
                                    oout.champs[nom_du_champ]['type_du_champ']=mat2[n + 1][1];
                                }else if(mat2[n][1] === 'primary_key'){
                                    oout.champs[nom_du_champ]['primary_key']=true;
                                }else if(mat2[n][1] === 'non_nulle'){
                                    oout.champs[nom_du_champ]['non_nulle']=true;
                                }else if(mat2[n][1] === 'espece_du_champ'){
                                    oout.champs[nom_du_champ]['espece_du_champ']=mat2[n + 1][1];
                                    oout.champs[nom_du_champ]['type_du_champ']=mat2[n + 1][1];
                                }else if(mat2[n][1] === 'references'){
                                    if(mat2[n][8] === 2){
                                        oout.champs[nom_du_champ]['table_mere']=mat2[n + 1][1];
                                        oout.champs[nom_du_champ]['champ_pere']=mat2[n + 2][1];
                                        oout.champs[nom_du_champ]['base_mere']=chi_id_basedd;
                                        let trouve=false;
                                    ...
                                    if(this.__ig1.est_entier_positif( mat2[n + 1][1] )){
                                        oout.champs[nom_du_champ]['longueur_du_champ']=parseInt( mat2[n + 1][1] , 10 );
                                    }else{
                                        oout.champs[nom_du_champ]['longueur_du_champ']=mat2[n + 1][1];
                                    }
                                }else if(mat2[n][1] === 'longueur_du_champ' && mat2[n][8] === 2 && mat2[n + 1][2] === 'c' && mat2[n + 2][2] === 'c'){
                                    oout.champs[nom_du_champ]['longueur_du_champ']=mat2[n + 1][1] + ',' + mat2[n + 2][1];
                                }else if(mat2[n][1] === 'a_une_valeur_par_defaut' && mat2[n][8] === 1 && mat2[n + 1][2] === 'c'){
                                    oout.champs[nom_du_champ]['a_une_valeur_par_defaut']=parseInt( mat2[n + 1][1] , 10 );
                                }else if(mat2[n][1] === 'valeur_par_defaut' && mat2[n][8] === 1 && mat2[n + 1][2] === 'c'){
                                    oout.champs[nom_du_champ]['valeur_par_defaut']=mat2[n + 1][1];
                                }else if(mat2[n][1] === 'la_valeur_par_defaut_est_caractere' && mat2[n][8] === 1 && mat2[n + 1][2] === 'c'){
                                    oout.champs[nom_du_champ]['la_valeur_par_defaut_est_caractere']=parseInt( mat2[n + 1][1] , 10 );
                                    ...
                                    */
                                    ...
                                    for( let o=n + 1 ; o < l02 ; o=mat2[o][12] ){
                                        if(mat2[o][1] === 'genre' && mat2[o][2] === 'f' && mat2[o][8] === 1 && mat2[o + 1][2] === 'c'){
                                            oout.champs[nom_du_champ]['genre_numerique_du_champ']=parseInt( mat2[o + 1][1] , 10 );
                                            ...
                                            oout.champs[nom_du_champ]['cht_particularités_genre']=cht_particularités_genre;
                                            oout.champs[nom_du_champ]['genre_objet_du_champ']=this.__ig1.__liste_des_genres[mat2[o + 1][1]];
                                        }else if(mat2[o][1] === 'reference_externe' && mat2[o][2] === 'f' && mat2[o][8] === 3){
                                            oout.champs[nom_du_champ].meta[mat2[o][1] + '_base']=mat2[o + 1][1];
                                            oout.champs[nom_du_champ].meta[mat2[o][1] + '_table']=mat2[o + 2][1];
                                            oout.champs[nom_du_champ].meta[mat2[o][1] + '_champ']=mat2[o + 3][1];
                                            ...
                                            if(this.__ig1.est_entier_positif( mat2[o + 1][1] )){
                                                oout.champs[nom_du_champ]['longueur_du_champ']=parseInt( mat2[o + 1][1] , 10 );
                                            }else{
                                                oout.champs[nom_du_champ]['longueur_du_champ']=mat2[o + 1][1];
                                            }
                                        }else if(mat2[o][1] === 'longueur_du_champ' && mat2[o][8] === 2 && mat2[o + 1][2] === 'c' && mat2[o + 2][2] === 'c'){
                                            oout.champs[nom_du_champ]['longueur_du_champ']=mat2[o + 1][1] + ',' + mat2[o + 2][1];
                                        }else if(mat2[o][1] === 'cht_fonction_init' && mat2[o][2] === 'f'){
                                            let objfi=this.__ig1.__rev1.m2t( mat2 , o );
                                            if(objfi.__xst === __xsu){
                                                oout.champs[nom_du_champ]['cht_fonction_init']=objfi.__xva;
                                            }else{
                                                return({"__xst" : __xer ,"__xme" : ' erreur cht_fonction_init ' + this.__ig1.nl2()});
                                            }
                                        }else if(mat2[o][1] === 'suggestion_du_champ' && mat2[o][2] === 'f'){
                                            let objfi=this.__ig1.__rev1.m2t( mat2 , o );
                                            if(objfi.__xst === __xsu){
                                                oout.champs[nom_du_champ].meta['suggestion_du_champ']=objfi.__xva;
                                            }else{
                                                return({"__xst" : __xer ,"__xme" : ' erreur suggestion_du_champ ' + this.__ig1.nl2()});
                                            }
                                        }else if(mat2[o][1] === 'description_du_champ' && mat2[o][2] === 'f' && mat2[o][8] === 1 && mat2[o + 1][2] === 'c'){
                                            if(mat2[o + 1][4] === 1){
                                                /* simples quotes */
                                                oout.champs[nom_du_champ].meta[mat2[o][1]]=mat2[o + 1][1].replace( /\\\'/g , '\'' ).replace( /\\\\/g , '\\' ).replace( /¶CR¶/g , '' ).replace( /¶CRLF¶/g , '<br />' ).replace( /¶LF¶/g , '<br />' );
                                            }else{
                                                debugger;
                                                oout.champs[nom_du_champ].meta[mat2[o][1]]=mat2[o + 1][1];
                                            }
                                        }else if(mat2[o][1] === 'libelle_du_champ' && mat2[o][2] === 'f' && mat2[o][8] === 1 && mat2[o + 1][2] === 'c'){
                                            /*
                                              if('chx_autorisation_menu' === nom_du_champ){
                                              debugger
                                              }
                                            */
                                            if(mat2[o + 1][4] === 1){
                                    ...
                                    console.log( '%ctab2[n][1]=' + mat2[n][1] , 'background:red;' );
                                }
                            }
                        }
                    }
        ...
        return({"oout" : oout ,"les_dependances" : les_dependances});
    }
    /*
      =============================================================================================================
    */
    ...
    */
    charger_base1( chi_id_basedd , nom_de_la_table , indice_de_la_classe ){
        ...
        */
        ...
        o1+='</label>';
        /*  */
        o1+='<label for="avec_creer_et_dupliquer1" style="border:1px black solid;padding:1px;" title="avec creer et dupliquer1">';
        o1+=' ? aced1 : ';
            ...
            if(nom_de_la_table !== ''){
                ...
                if(indice_de_la_classe !== ''){
                    ...
                    /*
                      on annule le 
                    */
                    this.__ig1.date_derniere_navigation=performance.now();
    ...
    */
    recuperer_zone_travail_pour_les_bases2( mat , d , le_colis1=null ){
        ...
        for(let i in le_colis1.__xva.les_bases_du_projet){
            if(le_colis1.__xva.les_bases_du_projet[i]['T0_chp_rev_travail_basedd'] === null){
            }else{
                o1+='<option ';
                o1+=' value="' + le_colis1.__xva.les_bases_du_projet[i]['T0_chi_id_basedd'] + '" ';
                o1+=' id="option_base_"';
                o1+=le_colis1.__xva.les_bases_du_projet[i]['T0_chi_id_basedd'];
                o1+='"';
                if(le_colis1.__xva.les_bases_du_projet[i]['T0_chi_id_basedd'] === chi_id_basedd){
                    o1+=' selected ';
                }
                o1+='>' + le_colis1.__xva.les_bases_du_projet[i]['T0_chi_id_basedd'] + '</option>';
                this.#les_bases[le_colis1.__xva.les_bases_du_projet[i]['T0_chi_id_basedd']]={"matrice" : null ,"tables" : []};
                var obj1=this.__ig1.__rev1.rev_tm( le_colis1.__xva.les_bases_du_projet[i]['T0_chp_rev_travail_basedd'] );
                if(obj1.__xst === __xsu){
                    this.#les_bases[le_colis1.__xva.les_bases_du_projet[i]['T0_chi_id_basedd']].matrice=obj1.__xva;
                    let mat2=obj1.__xva;
                    let l02=mat2.length;
                    for( let j=1 ; j < l02 ; j=mat2[j][12] ){
                        if(mat2[j][1] === 'créer_table'){
                            for( let k=j + 1 ; k < l02 ; k=mat2[k][12] ){
                                if(mat2[k][1] === 'nom_de_la_table' && mat2[k][2] === 'f' && mat2[k][8] === 1 && mat2[k + 1][2] === 'c'){
                                    this.#les_bases[le_colis1.__xva.les_bases_du_projet[i]['T0_chi_id_basedd']].tables.push( mat2[k + 1][1] );
                                }
                            }
                        }
                    }
