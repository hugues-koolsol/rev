        ...
        */
                        ...
                        if(el.préfixe_du_champ === 'T0'){
                            ...
                            if(el.champ_dans_la_base === null){
                                ...
                                */
                                ...
                                if(cle_Tn !== 'T0'){
                                    /*
                                      inutile 02 maintenant qu'on a un JSON grandeurs
                                    */
                                    debugger
                                    /*#
            ...
            for( let i=0 ; i < liste_des_champs_update.length ; i++ ){
                ...
                if(obj_champ.genre_objet_du_champ.che_est_tsm_genre === 1
                    ...
                    if(obj_champ.non_nulle === true){
                        ...
                        src_client2+='            this.__ig1.ajoute_message({ __xst : __xer, __xme : \'la valeur pour "' + obj_champ.meta.libelle_du_champ + '" doit être renseignée\'  });\r\n';
                    ...
                    if(obj_champ.cht_particularités_genre.source_au_format_rev === 1){
                        ...
                        src_client2+='                this.__ig1.ajoute_message({ __xst : __xer, __xme : \'le contenu de "' + obj_champ.meta.libelle_du_champ + '" n\\\'est pas dans un format rev valide\'  });\r\n';
                        src_client2+='                this.__ig1.affiche_les_messages();\r\n';
                        src_client2+='                this.__ig1.retablir_les_boutons_masques();\r\n';
                        src_client2+='                try{\r\n';
                        src_client2+='                    document.getElementById(\'' + nom_du_champ + '\').focus();\r\n';
                    ...
                    if(obj_champ.genre_objet_du_champ.cht_fonctions_genre !== null){
                        ...
                        for( let j=1 ; j < l01 ; j=mat1[j][12] ){
                            if(mat1[j][2] === 'f'){
                                ...
                                src_client2+='fo1.' + nom_du_champ + ' , \'' + obj_champ.meta.libelle_du_champ + '\');\r\n';
                ...
                for( let i=0 ; i < liste_des_conversions_modification.length ; i++ ){
                    ...
                    if(c_est_un_champ_numerique === true){
                        if(liste_des_conversions_modification[i].hasOwnProperty( 'valeur_par_defaut' )
                            ...
                            src_client2+='            this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : \'la valeur pour "' + liste_des_conversions_modification[i].meta.libelle_du_champ + '" doit être numérique\'} );\r\n';
                            src_client2+='            this.__ig1.affiche_les_messages();\r\n';
                            src_client2+='            this.__ig1.retablir_les_boutons_masques();\r\n';
                            src_client2+='            try{\r\n';
            ...
            if(liste_des_conversions_modification.length > 0){
                ...
                for( let i=0 ; i < liste_des_conversions_modification.length ; i++ ){
                    if(liste_des_conversions_modification[i].espece_du_champ === 'INTEGER'
                        ...
                        src_serveur_js2+='"__xme" : \'la valeur pour "' + liste_des_conversions_modification[i].meta.libelle_du_champ + '" doit être numérique\'});\r\n';
                        src_serveur_js2+='        }\r\n';
                    }
                }
                src_serveur_js2+='        /*\r\n';
        ...
        if(ref_select !== '' && ref_update !== ''){
            ...
            for( let i=0 ; i < liste_des_champs_update.length ; i++ ){
                ...
                for(let j in champs_combinaison_update){ // champs_combinaison_update
                ...
                if(c_est_un_premier_champ_de_combinaison !== null){
                    ...
                    src_client2+='        */\r\n';
                    src_client2+='        o1+=\'<div class="yy_edition_champ1" style="border: var(--t_border) #669900 solid;">\';\r\n';
                        ...
                        for( let k =0 ; k<liste_des_champs_update.length;k++){
                            ...
                            if(elem.nom_du_champ === combi.nom_du_champ){
                                ...
                                if(elem.table_mere === 'tbl_grandeurs'){
                                    ...
                                    src_client2+=' \''+obj_champ.meta.nom_bref_du_champ +'\' ,'; // .replace(/\\/g,'\\\\').replace(/\'/g,'\\\'')
                                    ...
                                    debugger
                                    return({"__xst" : __xer ,"__xme" : 'seuls les champs ayant comme table mere tbl_grandeurs peuvent être utilisés dans le update (' + ref_update + ') '+this.__ig1.nl2()});
                                }
                            }
                        }
                    }
                ...
                /*
                if('fld_certificationen_modele' === nom_du_champ){
                    debugger;
                }
                */
                let obj_champ=this.#obj_table.champs[nom_du_champ];
        ...
        */
        if(ref_delete !== ''){
            ...
            for( let i=0 ; i < liste_des_champs_a_visualiser_pour_delete.length ; i++ ){
                if(liste_des_champs_a_visualiser_pour_delete[i].hasOwnProperty('nom_variable_session') && liste_des_champs_a_visualiser_pour_delete[i].nom_variable_session !== ''){
                    continue;
                }
                let nom_du_champ=liste_des_champs_a_visualiser_pour_delete[i].nom_du_champ;
                let obj_champ=this.#obj_table.champs[nom_du_champ];
                if(liste_des_champs_a_visualiser_pour_delete[i].hasOwnProperty('préfixe_du_champ') && liste_des_champs_a_visualiser_pour_delete[i].préfixe_du_champ !== 'T0'){
                   continue;
                }
                if(obj_champ.hasOwnProperty('champ_pere') && obj_champ.champ_pere==='chi_id_utilisateur' && obj_champ.table_mere==='tbl_utilisateurs'){
                    continue;
                }
                        ...
                        if('che_priorite_tache' ===  obj_champ.nom_du_champ ){
                            ...
                            if(obj_champ.genre_numerique_du_champ === 25){
                                ...
                                /*
                                  le champ référence
                                */
                                src_client2+='        o1+=\'        <span id="' + obj_champ.nom_du_champ + '" >(\' + this.__ig1.fi2( tup.T0_' + obj_champ.nom_du_champ + ' )+\')</span>\' ;\r\n';
                                /*
                                  le champ référence
                                */
                                /* il faut aller chercher les libelles parents */
            ...
            for( let i=0 ; i < liste_des_champs_select.length ; i++ ){
                ...
                */
                ...
                if(obj_champ.hasOwnProperty( 'table_mere' )
                    ...
                    src_client2+='        o1+=\'  <div class="yy_edition_champ1">\' ;\r\n';
                    src_client2+='        o1+=\'    <div class="yy_edition_libelle1">\' ;\r\n';
                    src_client2+='        o1+=\'      <span>' + obj_champ.meta.libelle_du_champ + '</span>\' ;\r\n';
                    src_client2+='        o1+=\'    </div>\' ;\r\n';
                    src_client2+='        o1+=\'    <div class="yy_edition_valeur1">\' ;\r\n';
                    src_client2+='        o1+=\'        <input type="hidden" value="\' ;\r\n';
                    src_client2+='        o1+=tup.T0_' + obj_champ.nom_du_champ + ' ;\r\n';
...
*/                                    
                              ...
                              if(true || obj_champ.nom_du_champ === 'fld_sequence_modele'){
                                ...
                                src_client2+='cols="50" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">\';\r\n';
                                src_client2+='        if(tup && tup.T0_' + obj_champ.nom_du_champ + '){\r\n';
                                src_client2+='            o1+=this.__ig1.fi2( tup.T0_' + obj_champ.nom_du_champ + ' );\r\n';
                                src_client2+='        }else{\n';
                                if(obj_champ.non_nulle === false){
                                    if(obj_champ.hasOwnProperty( 'cht_fonction_init' ) && obj_champ.cht_fonction_init !== ''){
                                        ...
                                        if(obj_champ.a_une_valeur_par_defaut === 1){
                                            if(obj_champ.valeur_par_defaut.toUpperCase() === 'NULL' && obj_champ.la_valeur_par_defaut_est_caractere === 0){
                                                src_client2+='            o1 +=\'\';\r\n';
                                            }else{
                                                src_client2+='            o1 +=`' + obj_champ.valeur_par_defaut.replace( /`/g , '\\`' ) + '`;\r\n';
                                            }
                                        }else{
                                            src_client2+='            o1 += \'\';\r\n';
                                        }
                                    ...
                                    */
                                    ...
                                    for( let o=n + 1 ; o < l02 ; o=mat2[o][12] ){
                                        if(mat2[o][1] === 'genre' && mat2[o][2] === 'f' && mat2[o][8] === 1 && mat2[o + 1][2] === 'c'){
                                            ...
                                            /*#
                                              if('fld_sequence_modele' === nom_du_champ){
                                                  debugger
                                              }
                                            */
                                            if(mat2[o+1][4] === 1){
