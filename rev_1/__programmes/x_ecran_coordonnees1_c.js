class x_ecran_coordonnees1{
    ...
    */
    entree_module( mat , d ){
        ...
        t+='      <td>nouveau nom</td>';
        t+='      <td>';
        t+='        <input type="hidden" id="chp_nom_de_connexion_utilisateur_ancien" value="" autocapitalize="off" class="yy_input1" />';
        t+='        <input type="text" id="chp_nom_de_connexion_utilisateur" value="" autocapitalize="off" class="yy_input1" />';
        t+='      </td>';
        t+='    </tr>';
        t+='    <tr>';
        t+='      <td>nouveau mot de passe</td>';
        t+='      <td>';
        t+='        <input type="password" id="chp_mot_de_passe_utilisateur" value="" autocomplete="new-password" class="yy_input1" />';
        t+='      </td>';
        t+='    </tr>';
        t+='    <tr>';
        t+='    <tr>';
        ...
        t+='      <td>';
        t+='        <input type="password" id="chp_mot_de_passe_utilisateur2" value="" autocomplete="off" class="yy_input1" />';
        t+='      </td>';
        t+='    </tr>';
        t+='    <tr>';
        t+='      <td>ancien mot de passe</td>';
        t+='      <td>';
        t+='        <input type="password" id="chp_mot_de_passe_utilisateur3" value="" autocomplete="off" class="yy_input1" />';
        t+='      </td>';
        t+='    </tr>';
        t+='    <tr>';
