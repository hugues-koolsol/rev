    ...
    async modifier1( mat , d ){
        ...
        */
        ...
        if(isNaN( form.chx_parametre_grandeur )){
            return({"__xst" : __xer ,"__xme" : 'la valeur pour "id paramètre" doit être numérique'});
        }
        ...
        */
        ...
        let criteres_1204={
            ...
            "n_cht_rev_grandeur" : form.cht_rev_grandeur === '' ? ( null ) : ( form.cht_rev_grandeur ) ,
    ...
    async creer1( mat , d ){
        ...
        let criteres_1203={
            "donnees" : [{
                        ...
                        "cht_rev_grandeur" : form.cht_rev_grandeur === '' ? ( null ) : ( form.cht_rev_grandeur ) ,
