        ...
        */
        try{
            ...
            */
            ...
            let continuer=true;
            /* this.__ig1.ma_trace1( 'tt1316.__xva=' , tt1316.__xva ); */
            do{
                for(let i in tt1316.__xva){
                    try{
                        ...
                        */
                        ...
                        /* this.__ig1.ma_trace1( 'tt1400.__xva.length=' + tt1400.__xva.length ); */
                        ...
                        if(delta < 55000){
                            ...
                            */
                            if(tt1400.__xva.length === 0 && delta < 100){
                                /*
    ...
    */
    async page_modification1( mat , d , chi_id_travail=null , __db1=null ){
        ...
        */
        ...
        this.__ig1.donnees_retournees[__xva]['page_modification1']=tt1396;
        return({"__xst" : __xsu});
    }
    /*
      =============================================================================================================
    ...
    async filtre1( mat , d , __db1=null ){
        ...
        if(this.__ig1.donnees_recues.__xva.hasOwnProperty( '__complements_sous_liste' )){
            for(let i in this.__ig1.donnees_recues.__xva.__complements_sous_liste){
                criteres_1395[i]=this.__ig1.donnees_recues.__xva.__complements_sous_liste[i];
            }
        }
        if(__db1 === null){
            __db1=await this.__ig1.ouvrir_bdd( this.__ig1.options_generales.base_de_travail );
        ...
        */
        ...
        if(tt1395.__xst === __xsu && tt1395.__xva.length === 0 && __debut > 0){
            /*
