    ...
    async sauvegarder_une_matrice_de_requete( mat , d , donnees_recues , donnees_retournees , options_generales , chi_id_requete , __db1 ){
        ...
        */
        ...
        if(tt353[__xst] !== __xsu){
            donnees_retournees.__xsi[__xer].push( '[' + tt353['__xme'] + ' ' + this.__ig1.nl2() + ']' );
            return({"__xst" : __xer});
        }
    ...
    async construire_le_js_contenant_la_liste_des_requetes( mat , d , donnees_recues , donnees_retournees , options_generales , __db1 ){
        ...
        */
        ...
        try{
            ...
            donnees_retournees.__xsi[__xer].push( 'erreur lors de l\'écriture de __liste_des_sql[' + this.__ig1.nl2( e ) + ']' );
            return({"__xst" : __xer});
        }
    ...
    async enregistrer_la_requete_en_base( mat , d , donnees_recues , donnees_retournees , options_generales ){
        ...
        */
        ...
        try{
            ...
            this.__ig1.ma_trace1( 'chemin_fichier=' + chemin_fichier );
            donnees_retournees.__xsi[__xer].push( 'ecriture du fichier sql_' + donnees_recues[__xva]['chi_id_requete'] + ' [' + this.__ig1.nl2() );
            return({"__xst" : __xer});
        }
    ...
    */
    async modifier_la_requete_en_base( mat , d , donnees_recues , donnees_retournees , options_generales ){
        ...
        */
        ...
        if(tt355[__xst] === __xsu){
            let chemin_fichier='';
            /* this.__ig1.ma_trace1( 'donnees_retournees._CA_=' + donnees_retournees._CA_ ); */
            if(donnees_retournees._CA_ === 2){
            ...
            try{
                ...
                donnees_retournees.__xsi[__xer].push( 'erreur modifier_la_requete_en_base [' + this.__ig1.nl2() );
                return({"__xst" : __xer});
            }
        }else{
            donnees_retournees.__xsi[__xer].push( '  [' + this.__ig1.nl2() );
