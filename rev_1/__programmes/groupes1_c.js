class groupes1{
    ...
    */
    page_modification1( mat , d , le_colis1=null ){
        ...
        this.__ig1.afficher_le_titre_des_zones( 'vv_ecran_modification' , 'entree_module' , this.DUN_DUNE_ELEMENT_GERE , tup.T0_chi_id_groupe , this.moi , 'chi_id_groupe' );
        let o1='';
        /*
          =====================================================================================================
        */
        ...
        if(tup.T0_chp_nom_groupe === undefined){
            o1+='        <div class="yy__0">ATTENTION, ERREUR DE SQL :  LE CHAMP n\'est pas inclus dans le SELECT</div>';
        }
        o1+='      <input  type="text" style="height: var(--t_hauteur_input1);" id="chp_nom_groupe"  size="48"  maxlength="128" value="' + this.__ig1.fi2( tup.T0_chp_nom_groupe ) + '" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" />';
        ...
        */
        ...
        if(tup.T0_chx_parent_groupe === undefined){
            o1+='        <div class="yy__0">ATTENTION, ERREUR DE SQL :  LE CHAMP n\'est pas inclus dans le SELECT</div>';
        }
        o1+='        <input type="hidden" value="' + tup.T0_chx_parent_groupe + '" id="chx_parent_groupe" />';
        ...
        /*
          =====================================================================================================
        */
        o1+='      <input type="hidden" id="chi_id_groupe" value="' + tup.T0_chi_id_groupe + '">';
        /*
          =====================================================================================================
        */
        let cmd='';
    ...
    */
    page_confirmation_supprimer1( mat , d , le_colis1=null ){
        ...
        if(tup.T0_chi_id_groupe === undefined){
            return({"__xst" : __xer ,"__xme" : "Attention, le champ T0_chi_id_groupe n'est pas en sortie dans la requête select "});
        }
        this.__ig1.afficher_le_titre_des_zones( 'vv_ecran_suppression' , 'entree_module' , this.DUN_DUNE_ELEMENT_GERE , tup.T0_chi_id_groupe , this.moi , 'chi_id_groupe' );
        let o1='';
        /*
          =====================================================================================================
        */
        ...
        o1+='    </div>';
        o1+='    <div class="yy_edition_valeur1">';
        o1+='      <input disabled  type="text" id="chp_nom_groupe"   maxlength="128"  value="' + this.__ig1.fi2( tup.T0_chp_nom_groupe ) + '"   />';
    ...
    */
    page_voir1( mat , d , le_colis1=null ){
        ...
        this.__ig1.afficher_le_titre_des_zones( 'vv_ecran_visualisation' , 'entree_module' , this.DUN_DUNE_ELEMENT_GERE , tup.T0_chi_id_groupe , this.moi , 'chi_id_groupe' );
        let o1='';
        /*
          =====================================================================================================
        */
        ...
        o1+='    </div>';
        o1+='    <div class="yy_edition_valeur1">';
        o1+='      <input type="text" id="chp_nom_groupe"  maxlength="128"  value="' + this.__ig1.fi2( tup.T0_chp_nom_groupe ) + '" />';
        o1+=this.__ig1.__fnt1.boutons_suppression2( 'chp_nom_groupe' );
        o1+='    </div>';
        o1+='  </div>';
        /*
    ...
    */
    page_creer1( mat , d , tup=null ){
        ...
        */
        ...
        if(tup){
            o1+=this.__ig1.fi2( tup.T0_chp_nom_groupe );
        }else{
            o1+='';
        }
        o1+='" />';
        ...
        */
        ...
        if(tup){
            o1+=this.__ig1.fi2( tup.T0_chx_parent_groupe );
        }else{
            o1+='';
        }
        o1+='" />';
        o1+='        <span id="chx_parent_groupe_libelle">';
        if(tup){
            if(tup.T0_chx_parent_groupe === null){
                o1+='*indéfini';
            }else{
                o1+='(' + tup.T0_chx_parent_groupe + ') ';
