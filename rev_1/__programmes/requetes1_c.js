...
class requetes1{
    ...
    */
    verifier_modifier1( mat , d , données ){
        ...
        if(fo1['che_est_souche_requete'] === ''){
            this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : 'la valeur pour "requête souche ?" doit être renseigné'} );
        ...
        if(fo1['chp_type_requete'] === ''){
            this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : 'la valeur pour "type de requête" doit être renseigné'} );
            this.__ig1.affiche_les_messages();
            this.__ig1.retablir_les_boutons_masques();
            try{
    ...
    */
    page_modification1( mat , d , le_message_du_serveur=null ){
        ...
        this.__ig1.afficher_le_titre_des_zones( 'vv_ecran_modification' , 'entree_module' , this.DUN_DUNE_ELEMENT_GERE , enreg['T0.chi_id_requete'] , this.moi );
        let o1='';
        /*
          =====================================================================================================
        */
    ...
    */
    page_confirmation_supprimer1( mat , d , le_message_du_serveur=null ){
        ...
        this.__ig1.afficher_le_titre_des_zones( 'vv_ecran_suppression' , 'entree_module' , this.DUN_DUNE_ELEMENT_GERE , enreg['T0.chi_id_requete'] , this.moi );
        let o1='';
        /*
          =====================================================================================================
        */
