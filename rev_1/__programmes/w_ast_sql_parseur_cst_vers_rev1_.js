...
//        this.__rev1.empiler_erreur( o );
    ...
    /*
      =============================================================================================================
    */
    #traite_constraint_primary_key( element , niveau , parent , options , vient_de ){
        let t='';
        let obj1=null;
        let behaviorKw='';
        let column='';
    ...
    */
    ...
    /*
      =============================================================================================================
    */
    #drop_table_stmt( element , niveau , parent , options , vient_de ){
        let t='';
        let obj1=null;
        let actions='';
        let table='';
        ...
        for(let i in element.items){
            ...
            switch (element.items[i].type){
                    ...
                    if(element.items[i].name){
                        ...
                        switch (name.toLowerCase()){
                            ...
                            case 'min' : name='min';
                                break;
                            default:
                                return(this.#astsql_le( {"__xst" : __xer ,"__xme" : this.__ig1.nl2() + ' ' + name.toLowerCase()} ));
                ...
                case 'number_literal' : t+=element.items[i].value;
                    break;
                default:
                    return(this.#astsql_le( {"__xst" : __xer ,"__xme" : this.__ig1.nl2() + ' ' + element.items[i].type} ));
                    break;
    ...
    */
    #traite_binary_expr( element , niveau , parent , options , vient_de ){
        ...
        if(obj1.__xst === __xsu){
            ...
            return(this.#astsql_le( {"__xst" : __xsu ,"__xme" : this.__ig1.nl2()} ));
        }
        ...
        switch (operator.toUpperCase()){
            ...
            case 'IN' : t+='dans(' + t1 + ',' + t2 + ')';
                break;
            default:
                return(this.#astsql_le( {"__xst" : __xsu ,"__xme" : operator + ' ' + this.__ig1.nl2()} ));
                break;
        ...
        if(t.substr( 0 , 6 ) === 'et(et('){
            ...
            if(obj.__xst === __xsu){
                ...
                if(obj.__xst === __xsu){
                    ...
                    return(this.#astsql_le( {"__xst" : __xer ,"__xme" : this.__ig1.nl2() ,"element" : element} ));
                }
            }
        }
        return({"__xst" : __xsu ,"__xva" : t});
    ...
    */
    #traite_specification( element , niveau , parent , options , vient_de ){
        ...
        switch (element.type){
            ...
            default: return(this.#astsql_le( {"__xst" : __xsu ,"__xme" : this.__ig1.nl2()} ));
                break;
        }
        return({"__xst" : __xsu ,"__xva" : t});
    }
    ...
    #traite_func_args( element , niveau , parent , options , vient_de ){
        ...
        */
        if(element.distinctKw
            ...
            return(this.#astsql_le( {"__xst" : __xsu ,"__xme" : this.__ig1.nl2() + ' a traiter'} ));
        }
        if(element.args){
...
//                dataType=element.dataType.name.name + '(' + element.dataType.params.expr.items[0].value + ')';
            ...
            return(this.#astsql_le( {"__xst" : __xer ,"__xme" : this.__ig1.nl2() + ' type de donnée non précisé pour le champ ' + name + ' '} ));
        }
...
//        t+='type(' + dataType + ')';
        ...
        switch (element.type){
            ...
            case 'join_expr' :
                ...
                if(obj1.__xst === __xsu){
                    ...
                    return(this.#astsql_le( {"__xst" : __xsu ,"__xme" : this.__ig1.nl2() + ' ' + element.type} ));
                }
                obj2=this.#traite_expr( element.right , niveau , element , options , vient_de );
                if(obj2.__xst === __xsu){
                    t2=obj2.__xva;
                ...
                switch (parent.type){
                    ...
                    default: return(this.#astsql_le( {"__xst" : __xer ,"__xme" : this.__ig1.nl2() + ' '} ));
                }
                break;
    ...
    */
    #traite_ast_sql_parseur_cst( element , niveau , parent , options={} , vient_de ){
        ...
        if(element === null){
            return(this.#astsql_le( {"__xst" : __xer ,"__xme" : this.__ig1.nl2() + 'null'} ));
        }
        ...
        switch (element.type){
            ...
            case 'select_stmt' :
                ...
                if(obj.__xst === __xsu){
                    ...
                    return(this.#astsql_le( {"__xst" : __xer ,"__xme" : this.__ig1.nl2() + 'select'} ));
                }
                vient_de.pop();
                break;
