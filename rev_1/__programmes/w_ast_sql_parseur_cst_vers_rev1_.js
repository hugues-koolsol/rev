...
/*
  ...
  =====================================================================================================================
*/
class w_ast_sql_parseur_cst_vers_rev1{
    __m_rev1=null;
    ...
    */
    #astsql_le( o ){
        ...
        */
        this.__gi1.ajoute_message( o ); //{"__xst" : numero ,"__xme" : 'exemple de message ' + numero + ' ' + parseInt( performance.now(),10 ) } );
    ...
    */
    #traite_alter_action_drop_column( element , niveau , parent , options , vient_de ){
        ...
        if(element.behaviorKw){
            return(this.#astsql_le( {"__xst" : __xer ,"__xme" : this.__gi1.nl2() + ' '} ));
        }
        ...
        for(let i in element.items){
            ...
            switch (element.items[i].type){
                    ...
                    if(element.items[i].name){
                        ...
                        switch (name.toLowerCase()){
                            ...
                            case 'min' : name='min';
                                break;
                            default:
                                return(this.#astsql_le( {"__xst" : __xer ,"__xme" : this.__gi1.nl2() + ' ' + name.toLowerCase()} ));
                ...
                case 'number_literal' : t+=element.items[i].value;
                    break;
                default:
                    return(this.#astsql_le( {"__xst" : __xer ,"__xme" : this.__gi1.nl2() + ' ' + element.items[i].type} ));
                    break;
    ...
    */
    #traite_binary_expr( element , niveau , parent , options , vient_de ){
        ...
        if(obj1.__xst === __xsu){
            ...
            return(this.#astsql_le( {"__xst" : __xsu ,"__xme" : this.__gi1.nl2()} ));
        }
        ...
        switch (operator.toUpperCase()){
            ...
            case 'IN' : t+='dans(' + t1 + ',' + t2 + ')';
                break;
            default:
                return(this.#astsql_le( {"__xst" : __xsu ,"__xme" : operator + ' ' + this.__gi1.nl2()} ));
                break;
                
        }
        if(t.substr( 0 , 6 ) === 'et(et('){
            var obj=this.__rev1.rev_tm( t );
            if(obj.__xst === __xsu){
                var nouveau_tableau=this.__rev1.baisser_le_niveau_et_supprimer( obj.__xva , 2 , 0 );
                obj=this.__rev1.matrice_vers_source_rev1( nouveau_tableau , 0 , false , 1 );
                if(obj.__xst === __xsu){
                    t=obj.__xva;
                }else{
                    return(this.#astsql_le( {"__xst" : __xer ,"__xme" : this.__gi1.nl2() ,"element" : element} ));
                }
            }
        }
        return({"__xst" : __xsu ,"__xva" : t});
    ...
    */
    #traite_specification( element , niveau , parent , options , vient_de ){
        ...
        switch (element.type){
            ...
            default: return(this.#astsql_le( {"__xst" : __xsu ,"__xme" : this.__gi1.nl2()} ));
                break;
        }
        return({"__xst" : __xsu ,"__xva" : t});
    }
    ...
    #traite_func_args( element , niveau , parent , options , vient_de ){
        ...
        */
        if(element.distinctKw
            ...
            return(this.#astsql_le( {"__xst" : __xsu ,"__xme" : this.__gi1.nl2() + ' a traiter'} ));
        }
        if(element.args){
...
//                dataType=element.dataType.name.name + '(' + element.dataType.params.expr.items[0].value + ')';
            ...
            return(this.#astsql_le( {"__xst" : __xer ,"__xme" : this.__gi1.nl2() + ' type de donnée non précisé pour le champ ' + name + ' '} ));
        }
...
//        t+='type(' + dataType + ')';
        ...
        switch (element.type){
            ...
            case 'join_expr' :
                ...
                if(obj1.__xst === __xsu){
                    ...
                    return(this.#astsql_le( {"__xst" : __xsu ,"__xme" : this.__gi1.nl2() + ' ' + element.type} ));
                }
                obj2=this.#traite_expr( element.right , niveau , element , options , vient_de );
                if(obj2.__xst === __xsu){
                    t2=obj2.__xva;
                ...
                switch (parent.type){
                    ...
                    default: return(this.#astsql_le( {"__xst" : __xer ,"__xme" : this.__gi1.nl2() + ' '} ));
                }
                break;
    ...
    */
    #traite_create_table_stmt( element , niveau , parent , options , vient_de ){
        ...
        if(Array.isArray( element.clauses ) && element.clauses.length > 0){
            debugger
            return(this.#astsql_le( {"__xst" : __xer ,"__xme" : '<b style="font-size:1.2em;">clauses non prévu</b>' + this.__gi1.nl2() + ' '} ));
        }
        if(element.ifNotExistsKw){
            return(this.#astsql_le( {"__xst" : __xer ,"__xme" : this.__gi1.nl2() + ' '} ));
        }
        ...
        if(this.#meta_table===''){
            ...
            t+='      table(\'' + name + '\'),\r\n';
            t+='      genre_meta(table_de_base),\r\n';
            t+='      permet_la_gestion_de(\'' + name + '\'),\r\n';
    ...
    */
    #traite_ast_sql_parseur_cst( element , niveau , parent , options={} , vient_de ){
        ...
        if(element === null){
            return(this.#astsql_le( {"__xst" : __xer ,"__xme" : this.__gi1.nl2() + 'null'} ));
        }
        ...
        switch (element.type){
            ...
            case 'select_stmt' :
                ...
                if(obj.__xst === __xsu){
                    ...
                    return(this.#astsql_le( {"__xst" : __xer ,"__xme" : this.__gi1.nl2() + 'select'} ));
                }
                vient_de.pop();
                break;
...
export{w_ast_sql_parseur_cst_vers_rev1 as w_ast_sql_parseur_cst_vers_rev1};