...
class groupes1{
    ...
    */
    async modifier1( mat , d , donnees_recues , donnees_retournees , options_generales ){
        ...
        let __test_0_1=this.__gi1.__fnt1.test_du_nom_technique1( form['chp_nom_groupe'] , 'nom' );
        ...
        let tt131=await this.__gi1.sql_iii(
        /*sql_inclure_deb*/ /*#
        SELECT 
        ...
        */
        ...
        if(tt131[__xst] === __xsu && tt131[__xva].length === 1){
            ...
            let tt133=await this.__gi1.sql_iii(
            /*sql_inclure_deb*/ /*#
            ...
            */
            ...
            if(tt133[__xst] !== __xsu){
                if(tt133['__xme'] !== ''){
                    this.__gi1.__xsi[__xer].push( tt133['__xme'] + ' [' + this.__gi1.nl2() );
                }else{
            ...
            let tt131_bis=await this.__gi1.sql_iii(
            /*sql_inclure_deb*/ /*#
            SELECT 
            `T0`.`chi_id_groupe` , `T0`.`chp_nom_groupe` , `T0`.`chx_parent_groupe` , `T1`.`chp_nom_groupe`
             FROM b1.tbl_groupes T0
    ...
    */
    async supprimer1( mat , d , donnees_recues , donnees_retournees , options_generales ){
        ...
        */
        ...
        let tt134=await this.__gi1.sql_iii(
        /*sql_inclure_deb*/ /*#
    ...
    */
    async creer1( mat , d , donnees_recues , donnees_retournees , options_generales ){
        ...
        /*  */
        await __db1.exec( 'BEGIN TRANSACTION;' );
        let tt132=await this.__gi1.sql_iii(
        /*sql_inclure_deb*/ /*#
        ...
        */
        ...
        if(tt132[__xst] === __xsu){
            ...
            this.__gi1.__xsi[__xer].push( tt132['__xme'] + '\nl\'insertion a échoué [' + this.__gi1.nl2() + ']' );
            donnees_retournees.__xst=__xer;
            return({"__xst" : __xer});
        }
    }
    ...
    */
    async filtre1( mat , d , donnees_recues , donnees_retournees , options_generales , __db1=null ){
        ...
        let tt130=await this.__gi1.sql_iii(
        /*sql_inclure_deb*/ /*#
        SELECT 
        `T0`.`chi_id_groupe` , `T0`.`chp_nom_groupe` , `T0`.`chx_parent_groupe` , `T1`.`chp_nom_groupe`
         FROM b1.tbl_groupes T0
