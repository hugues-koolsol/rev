    ...
    */
    async page_voir1( mat , d ){
        ...
        */
        ...
        let __aetapv=await this.actions_et_tests_apres_page_voir( mat , d , tt1131[__xva][0] , __db1 );
    ...
    */
    async sous_liste2( mat , d ){
        ...
        if(true || contexte === 'nom_du_contexte'){
            ...
            liste2=await this.__ig1.generique_sous_liste2( mat , d , 1130 , criteres_1130 , __nbMax , __db1 );
        }
