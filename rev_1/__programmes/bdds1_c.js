...
class bdds1{
    ...
    */
    f1( mat , d , le_message_du_serveur=null ){
        switch (mat[d][1]){
            case 'forcer_fermeture_fichier_wal' : 
    ...
    */
    verifier_modifier1( mat , d , données ){
        ...
        if(fo1['chp_fournisseur_basedd'] === ''){
            this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : 'la valeur pour "fournisseur" doit être renseigné'} );
            this.__ig1.affiche_les_messages();
            this.__ig1.retablir_les_boutons_masques();
            try{
    ...
    */
    page_modification1( mat , d , le_message_du_serveur=null ){
        ...
        this.__ig1.afficher_le_titre_des_zones( 'vv_ecran_modification' , 'entree_module' , this.DUN_DUNE_ELEMENT_GERE , enreg['T0.chi_id_basedd'] , this.moi , 'chi_id_basedd' );
        let o1='';
        /*
          =====================================================================================================
        */
        ...
        o1+=this.__ig1.fi2( enreg['T0.chp_commentaire_basedd'] );
        o1+='</textarea>';
        o1+='        </div>';
        o1+='    </div>';
        o1+='  </div>';
        ...
        */
        ...
        o1+=this.__ig1.fi2( enreg['T0.chp_rev_travail_basedd'] );
        o1+='</textarea>';
        o1+='        </div>';
        o1+='    </div>';
        o1+='  </div>';
        ...
        */
        ...
        o1+='      <input  type="text" style="height: var(--t_hauteur_input1);" id="chp_fournisseur_basedd"  size="64"   maxlength="64"  value="' + this.__ig1.fi2( enreg['T0.chp_fournisseur_basedd'] ) + '"  autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" />';
    ...
    */
    page_confirmation_supprimer1( mat , d , le_message_du_serveur=null ){
        ...
        this.__ig1.afficher_le_titre_des_zones( 'vv_ecran_suppression' , 'entree_module' , this.DUN_DUNE_ELEMENT_GERE , enreg['T0.chi_id_basedd'] , this.moi , 'chi_id_basedd' );
        let o1='';
        /*
          =====================================================================================================
        */
        ...
        o1+='    <div class="yy_edition_valeur1">';
        o1+='        <div class="yy_conteneur_txtara">';
        o1+='            <textarea disabled id="chp_commentaire_basedd" rows="2"  cols="50" >' + this.__ig1.fi2( le_message_du_serveur.__xva.page_confirmation_supprimer1.__xva[0]['T0.chp_commentaire_basedd'] ) + '</textarea>';
        o1+='        </div>';
        o1+='    </div>';
        o1+='  </div>';
        /*
        ...
        */
        ...
        o1+='    <div class="yy_edition_valeur1">';
        o1+='        <div class="yy_conteneur_txtara">';
        o1+='            <textarea disabled id="chp_rev_travail_basedd" rows="2"  cols="50" >' + this.__ig1.fi2( le_message_du_serveur.__xva.page_confirmation_supprimer1.__xva[0]['T0.chp_rev_travail_basedd'] ) + '</textarea>';
        o1+='        </div>';
        o1+='    </div>';
        o1+='  </div>';
        /*
        ...
        */
        ...
        o1+='    </div>';
        o1+='    <div class="yy_edition_valeur1">';
        o1+='      <input disabled  type="text" id="chp_fournisseur_basedd"  size="64"   maxlength="64"  value="' + this.__ig1.fi2( le_message_du_serveur.__xva.page_confirmation_supprimer1.__xva[0]['T0.chp_fournisseur_basedd'] ) + '"   />';
        o1+='    </div>';
        o1+='  </div>';
        /*
          =====================================================================================================
    ...
    page_creer1( mat , d , dupliquer=null ){
        ...
        */
        ...
        if(dupliquer && dupliquer.hasOwnProperty( 'T0.chp_commentaire_basedd' )){
            o1+=this.__ig1.fi2( dupliquer['T0.chp_commentaire_basedd'] );
        }else{
            o1+='';
        }
        o1+='</textarea>';
    ...
    */
    sous_liste1( mat , d , le_message_du_serveur=null ){
        ...
        return(this.__ig1.sous_liste_generique1( mat , d , le_message_du_serveur , this , 'chi_id_basedd' ));
    }
    /*
      =============================================================================================================
    */
    liste1( mat , d , le_message_du_serveur=null ){
        ...
        if(a === null){
            this.__ig1.initialisation_des_zones( this.moi , 'chi_id_basedd' );
    ...
    zones_liste1( le_message_du_serveur ){
        ...
        if(le_message_du_serveur !== null && le_message_du_serveur.__xva.hasOwnProperty( this.fonction_liste )){
            ...
            for(let i in le_message_du_serveur.__xva[this.fonction_liste].__xva){
                ...
                lst+='<div class="rev_b_svg yy__3" data-rev_click="pm1(m1(n1(' + this.moi + '),f1(page_modification1(chi_id_basedd(' + elem['T0.chi_id_basedd'] + ')))))">' + this.__ig1.les_svg.editer + '</div>';
                lst+='<div class="rev_b_svg yy__4" data-rev_click="pm1(m1(n1(' + this.moi + '),f1(page_duplication1(chi_id_basedd(' + elem['T0.chi_id_basedd'] + ')))))">' + this.__ig1.les_svg.dupliquer + '</div>';
                lst+='<div class="rev_b_svg" data-rev_click="pm1(m1(n1(' + this.moi + '),f1(dump_de_la_base(chi_id_basedd(' + elem['T0.chi_id_basedd'] + ')))))" title="faire un dump de la base">' + this.__ig1.les_svg.disquette + '</div>';
                lst+='<div class="rev_b_svg yy__3" data-rev_click="pm1(m1(n1(v_svg_bdd1),f1(editer_les_schemas2(les_bases_a_editer(\'' + elem['T0.chi_id_basedd'] + '\')))))">' + this.__ig1.les_svg.bdd + '</div>';
                if(le_message_du_serveur._CA_ === 1 && le_message_du_serveur.chi_id_projet === 1){
                    ...
                    /*  */
                    lst+='<div class="rev_bouton" data-rev_click="';
                    lst+='pm1(m1(n1(' + this.moi + ')f1(forcer_fermeture_fichier_wal(chi_id_basedd(' + elem['T0.chi_id_basedd'] + ')))))';
                ...
                */
                ...
                if(elem['T0.chp_commentaire_basedd'] !== null){
                    lst+=this.__ig1.fi2( elem['T0.chp_commentaire_basedd'].substr( 0 , 200 ) );
                }
                lst+='</td>';
                lst+='</tr>';
            }
