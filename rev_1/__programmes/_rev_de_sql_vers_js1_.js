...
class _rev_de_sql_vers_js1{
    ...
    */
    constructor( __ig1 ){
        this.__ig1=__ig1;
        if(__ig1.hasOwnProperty( 'css_dimensions' )){
    ...
    */
    obtenir_le_tableau_des_conditions( formule , obj3 , type_de_requete=null ){
        ...
        var matriceFonction=this.__ig1.__rev1.rev_tm( formule );
                ...
                if(tab[i][1] === '#' && tab[i][2] === 'f'){
                    ...
                    if((tab[i][1] === 'et' || tab[i][1] === 'ou') && tab[i][2] === 'f'){
                        for( var j=i + 1 ; j < l01 ; j=tab[j][12] ){
                            if(tab[j][2] === 'f'
                                ...
                                if(obj.__xst === __xsu){
                                    ...
                                    const regex=/tup\.[\w]+/g;
                                    const parametre=obj.t_js.match( regex );
                                    if(parametre === null){
                        ...
                        if(obj.__xst === __xsu){
                            ...
                            this.__ig1.ajoute_message( {"__xst" : __xal ,"__xme" : 'erreur sur la condition du champ ' + this.__ig1.__rev1.nl2()} );
    ...
    */
    transformer_requete_en_fonction_js1( type_de_requete , obj3 , id_requete_en_base , matrice_requete ){
        ...
        for( let i=1 ; i < lmr01 ; i=matrice_requete[i][12] ){
            if((matrice_requete[i][1] === 'sélectionner'
                       || 'liste_ecran' === matrice_requete[i][1]
                       || 'insérer' === matrice_requete[i][1]
                       || 'modifier' === matrice_requete[i][1]
                       || 'supprimer' === matrice_requete[i][1])
                   && matrice_requete[i][2] === 'f'
            ){
        ...
        if(obj3.id_base_principale === 0){
            ...
            */
            ...
            if(obj3.id_base_principale === 'BASE_REFERENCE'){
                ...
                if(this.__ig1.est_num( obj3.id_base_principale )){
        ...
        if((type_de_requete === 'update'
            ...
            for( let k=1 ; k < l03 ; k=mat1[k][12] ){
                if(mat1[k][1] === 'meta' && mat1[k][2] === 'f'){
                    for( let l=k + 1 ; l < l03 ; l=mat1[l][12] ){
                        if(mat1[l][1] === 'fonctions_coherence1' && mat1[l][2] === 'f' && mat1[l][8] === 1 && mat1[l + 1][2] === 'c'){
                            /*  */
                            fonctions_coherence1=mat1[l + 1][1].replace( /¶CRLF¶/g , '\r\n' ).replace( /¶LF¶/g , '\n' ).replace( /¶CR¶/g , '\r' ).trim();
                            fonctions_coherence1=fonctions_coherence1.replace( /\\\'/g , '\'' ).replace( /\\\\/g , '\\' );
                            /*  */
                        }
                    }
                }
            }
            if(fonctions_coherence1 !== ''){
            ...
            for(let i in liste_des_champs){
                ...
                if(liste_des_champs[i].genre_objet_du_champ.cht_parmis_genre
                    ...
                    for( let j=1 ; j < l01 ; j=mat0[j][12] ){
                        if(mat0[j][4] === 0 ){
                            tableau_des_valeurs.push( mat0[j][1].toLowerCase() );
                        }else if(mat0[j][4] === 1 ){
                            tableau_des_valeurs.push( '\'' + mat0[j][1] + '\'' );
                        }else if(mat0[j][4] === 2 ){
                            tableau_des_valeurs.push( '`' + mat0[j][1].replace() + '`' );
                        }else if(mat0[j][4] === 3 ){
                            tableau_des_valeurs.push( '"' + mat0[j][1] + '"' );
                        }else{
                            debugger
            ...
            */
            ...
            for(let i in liste_des_champs){
                ...
                if(liste_des_champs[i].genre_objet_du_champ.hasOwnProperty( 'cht_parmis_genre' )
                       && liste_des_champs[i].genre_objet_du_champ.cht_parmis_genre !== ''
                       && liste_des_champs[i].genre_objet_du_champ.cht_parmis_genre !== null
                ){
                    let tableau_des_valeurs=[];
                    let obj0=this.__ig1.__rev1.rev_tm( liste_des_champs[i].genre_objet_du_champ.cht_parmis_genre , true );
                    if(obj0.__xst !== __xsu){
        ...
        if(contenu_fonction_verifier_parmis_genre_insert !== '' && type_de_requete === 'insert'){
            t+='    /*\r\n';
            t+='      ================================' + type_de_requete + '=============================================================================\r\n';
            t+='    */\r\n';
            t+='    verifier_parmis( tup ){\r\n';
            t+='        let tete=this.moi + \' : valeur incorrecte : \';\r\n';
            t+='        this.__ig1.options_generales.erreur_controlee=true;\r\n';
            t+=contenu_fonction_verifier_parmis_genre_insert;
            t+='        this.__ig1.options_generales.erreur_controlee=false;\r\n';
            t+='        return({"__xst" : __xsu});\r\n';
            t+='    }\r\n';
        }
        if(contenu_fonction_verifier_parmis_genre_update !== '' && type_de_requete === 'update'){
            t+='    /*\r\n';
            t+='      ================================' + type_de_requete + '=============================================================================\r\n';
            t+='    */\r\n';
            t+='    verifier_parmis( tup ){\r\n';
            t+='        let tete=this.moi + \' : valeur incorrecte : \';\r\n';
            t+='        this.__ig1.options_generales.erreur_controlee=true;\r\n';
            t+=contenu_fonction_verifier_parmis_genre_update;
            t+='        this.__ig1.options_generales.erreur_controlee=false;\r\n';
            t+='        return({"__xst" : __xsu});\r\n';
            t+='    }\r\n';
        }
        ...
        if(type_de_requete === 'requete_manuelle'){
            ...
            try{
                ...
                let obj1=this.__ig1.__rev1.matrice_vers_source_rev1( mat1 , 0 , true , 1 );
                if(obj1.__xst === __xsu){
                    text_rev=obj1.__xva;
                }else{
                    return(this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : this.__ig1.__rev1.nl2() + 'requete manuelle avec rev incorrecte '} ));
                }
            }
        }
        if(type_de_requete === 'requete_manuelle'){
            ...
            if(matches !== null){
                ...
                for( let n=0 ; n < matches.length ; n++ ){
                    ...
                    nouvelle_chaine=nouvelle_chaine.replace( rgx , '\' . tup.' + matches[n].substr( 1 ) + ' . \'' );
                }
            }
            ...
            t+='        `;' + CRLF;
            t+='    /* this.__ig1.ma_trace1(\' sql0 = \' + sql0 ); */' + CRLF;
            ...
            */
            ...
            if(this.#obj_webs.ne_pas_tester_les_dependances_de_suppression === 0){
                if(nom_du_champ_cle !== ''){
                    ...
                    t+='"id_enregistrement" : tup.' + nom_du_champ_cle + ' ,';
                    t+='"__db1" : this.__db1 ,';
            ...
            if(this.#obj_webs.bases[base_reference].tables[table_reference].detail_table.txt_meta.indexOf( 'ne_pas_supprimer_id_un' )){
                ...
                */
                ...
                if(this.#obj_webs.ne_pas_exclure_les_id_a_ne_pas_supprimer === 0){
            ...
            if(this.#obj_webs.ne_pas_tester_les_dependances_de_suppression === 0){
                ...
                if(nom_du_champ_cle !== ''){
                    ...
                    t+='                await this.__ig1.afficher_les_dependances1( {';
                    t+='"table_parente" : \'' + nom_de_la_table + '\' ,';
                    t+='"champ_parent" : \'' + nom_du_champ_cle + '\' ,';
                    t+='"id_enregistrement" : tup.' + nom_du_champ_cle + ' ,';
                    t+='"__db1" : this.__db1} );\r\n';
            ...
            */
            ...
            t+='        try{' + CRLF;
            if(this.#obj_webs.insert_brut === 1){
                t+='            for( let i=0 ; i < les_tups.length ; i++ ){' + CRLF;
                t+='                const tup=les_tups[i];' + CRLF;
            }else{
                t+='            for( let i=0 ; i < les_tups.donnees.length ; i++ ){' + CRLF;
                t+='                const tup=les_tups.donnees[i];' + CRLF;
            }
            /*
            */
            if(this.#obj_webs.insert_brut === 1){
                t+='                /* pas de test pour insert brut */' + CRLF;
            }else{
                ...
                for( i=0 ; i < obj3.tableau_des_valeurs_pour_insert_ou_update_js.length ; i++ ){
                    ...
                    if(detail_champ.genre_objet_du_champ
                        ...
                        t+='                /*' + CRLF;
                        t+='                  === pas === de test sur le champ "' + nom_du_champ + '"' + CRLF;
                        t+='                */' + CRLF;
                        /*  */
                    }else{
                        ...
                        if(detail_champ.genre_objet_du_champ && detail_champ.genre_objet_du_champ.cht_fonctions_genre !== null){
                            ...
                            for( let j=1 ; j < l01 ; j=mat1[j][12] ){
                                if(mat1[j][2] === 'f'){
                                    t+='                /*\n';
                                    t+='                  === test spécifique sur le champ "' + nom_du_champ + '" ===\n';
                                    t+='                */\n';
                                    t+='                let __test_' + i + '_' + j + '=this.__ig1.__fnts_c_et_s.' + mat1[j][1] + '(';
                                    if(mat1[j][8] === 0){
                                    }else{
                                        for( let k=j + 1 ; k < l01 ; k=mat1[k][12] ){
                                            if(mat1[k][2] === 'c'){
                                                if(mat1[k][4] === 0){
                                                    ...
                                                    t+='\'' + mat1[k][1].replace( /\\/g , '\\\\' ).replace( /`'/g , '\\\'' ) + '\',';
                                                }else{
                                                    /* afr */
                                                    debugger;
                                                    return({"__xst" : __xer ,"__xme" : ' [' + this.__ig1.nl2() + ']'});
                                    ...
                                    t+='                    return{"__xst" : __xer ,"__xme" : this.moi + \' : \' + __test_' + i + '_' + j + '.__xme};\r\n';
                                    t+='                }\n\n';
                                }else{
                                    return({"__xst" : __xer ,"__xme" : ' [' + this.__ig1.nl2() + ']'});
                                }
            ...
            if(this.#obj_webs.insert_brut === 1){
                t+='                /* pas de vérification "parmis" pour insert brut */\r\n';
            }else{
                if(contenu_fonction_verifier_parmis_genre_insert !== ''){
                    t+='                /*\r\n';
                    t+='                  =====================================================================================================\r\n';
                    t+='                  ================== appel de la fonction parmis qui fait un throw ====================================\r\n';
                    t+='                  =====================================================================================================\r\n';
                    t+='                */\r\n';
                    t+='                this.verifier_parmis( tup );\r\n';
                    t+='                /*\r\n';
                    t+='                  =====================================================================================================\r\n';
                    t+='                  ================== appel de la fonction parmis qui fait un throw ====================================\r\n';
                    t+='                  =====================================================================================================\r\n';
            ...
            */
            if(this.#obj_webs.insert_brut === 1){
                t+='                /* pas de vérification numérique pour insert brut */\r\n';
            }else{
                for( i=0 ; i < obj3.tableau_des_valeurs_pour_insert_ou_update_js.length ; i++ ){
                    /* console.log(this.#obj_webs.tableau_des_bases_tables_champs[id_numerique_base_principale][nom_de_la_table]['champs'][obj3.tableau_des_valeurs_pour_insert_ou_update_js[i][1]]); */
                    let nom_du_champ=obj3.tableau_des_valeurs_pour_insert_ou_update_js[i][1];
                    ...
                    if(this.#obj_webs.insert_brut === 0){
                        if(detail_champ.espece_du_champ === 'DECIMAL' || detail_champ.espece_du_champ === 'FLOAT'){
                            t+='                if(tup.' + nom_du_champ + ' !== null && isNaN( parseFloat( tup.' + nom_du_champ + ' ) )){\r\n';
                            t+='                    return({"__xst" : __xer ,"__xme" : this.moi + \' : la valeur pour "' + detail_champ.meta.nom_bref_du_champ.replace( /\\/g , '\\\\' ).replace( /\'/g , '\\\'' ) + '" doit être numérique \'+( i === 0 ? \'\' : \' pour i="\'+i+\'"\')});\r\n';
                            t+='                }\r\n';
                        }else if(detail_champ.espece_du_champ === 'INTEGER'){
                            t+='                if(tup.' + nom_du_champ + ' !== null && isNaN( parseInt( tup.' + nom_du_champ + ' , 10 ) ) ){\r\n';
                            t+='                    return({"__xst" : __xer ,"__xme" : this.moi + \' : la valeur pour "' + detail_champ.meta.nom_bref_du_champ.replace( /\\/g , '\\\\' ).replace( /\'/g , '\\\'' ) + '" doit être numérique \'+(i === 0 ? \'\' : \' pour i="\'+i+\'"\')});\r\n';
                            t+='                }\r\n';
                        }
                    }
            ...
            for( i=0 ; i < obj3.tableau_des_valeurs_pour_insert_ou_update_js.length ; i++ ){
                ...
                if(this.#obj_webs.insert_brut === 1){
                    ...
                    if(detail_champ.espece_du_champ.toUpperCase() === 'VARCHAR'
                        ...
                        tableau_des_insert.push( '                liste_des_valeurs+=\'\\r\\n      \' + ( tup[' + i + '] === \'\' ? \'NULL\' : this.__ig1.__fnt1.sq1( tup[' + i + '] ) ) + \'\' + \'' + virgule + '\'; // ' + obj3.tableau_des_valeurs_pour_insert_ou_update_js[i][1] + '\r\n' );
                    }else{
                        tableau_des_insert.push( '                liste_des_valeurs+=\'\\r\\n      \' + this.__ig1.__fnt1.sq1( tup[' + i + '] ) + \'\' + \'' + virgule + '\'; // ' + obj3.tableau_des_valeurs_pour_insert_ou_update_js[i][1] + '\r\n' );
                    }
                    ...
                    let spec='';
                    try{
                        spec=detail_champ.genre_objet_du_champ.chp_espece_genre.toLowerCase();
                    }catch(e){
            ...
            /* this.__ig1.ma_trace1('tableau_des_insert=',tableau_des_insert); */
            if(this.#obj_webs.insert_brut === 1){
            ...
            if(tableau_des_insert.length > 0){
                ...
                return(this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : this.__ig1.__rev1.nl2() + 'pas de valeur pour insert'} ));
            }
            t+=CRLF;
            t+='                liste_des_valeurs+=\')\';' + CRLF;
            t+='            }' + CRLF;
            ...
            t+='                /* this.__ig1.ma_trace1( \'sql_' + id_requete_en_base + '=\' + sql0 ); */\r\n';
            ...
            */
            ...
            for( i=0 ; i < obj3.tableau_des_valeurs_pour_insert_ou_update_js.length ; i++ ){
                ...
                */
                ...
                if(detail_champ.genre_objet_du_champ
                    ...
                    if(detail_champ.genre_numerique_du_champ === 5){
                        t+='        /* test 0,1 sur le champ "' + nom_du_champ + '" */' + CRLF;
                        t+='        if(!( tup.n_' + nom_du_champ + ' === 0 ||  tup.n_' + nom_du_champ + ' === 1 ) ){\n';
                        t+='            return({"__xst" : __xer ,"__xme" : this.moi + \' : la valeur pour "' + detail_champ.meta.libelle_du_champ + '" doit être renseignée [\' + this.__ig1.nl2() + \']\'});\r\n';
                        t+='        }\n';
                    }else if(detail_champ.non_nulle === true){
                        t+='        /* test "non nul" sur le champ "' + nom_du_champ + '" */' + CRLF;
            ...
            /*
            */
            let liste_ne_pas_modifier='';
            if(this.#che_est_souche_requete === 1
                   && this.#obj_webs['bases'][id_numerique_base_principale]['tables'][nom_de_la_table]['detail_table']["txt_meta"].indexOf( 'ne_pas_modifier(' ) >= 0
            ){
                /* console.log(this.#obj_webs['bases'][id_numerique_base_principale]['tables'][nom_de_la_table]['detail_table']); */
                let mat_meta=this.#obj_webs['bases'][id_numerique_base_principale]['tables'][nom_de_la_table]['detail_table']['mat_meta'];
                let l01=mat_meta.length;
                for( let i=1 ; i < l01 ; i=mat_meta[i][12] ){
                    if(mat_meta[i][1] === 'meta' && mat_meta[i][2] === 'f'){
                        for( let j=i + 1 ; j < l01 ; j=mat_meta[j][12] ){
                            if(mat_meta[j][1] === 'fonctions_spéciales1'
                                   && mat_meta[j][2] === 'f'
                                   && mat_meta[j][8] === 1
                                   && mat_meta[j + 1][2] === 'c'
                            ){
                                let obj_tr=this.__ig1.__rev1.rev_tm( mat_meta[j + 1][1] );
                                if(obj_tr.__xst === __xsu){
                                    let l02=obj_tr.__xva.length;
                                    for( let k=1 ; k < l02 ; k=obj_tr.__xva[k][12] ){
                                        if(obj_tr.__xva[k][1] === 'ne_pas_modifier' && obj_tr.__xva[k][2] === 'f'){
                                            for( let l=k + 1 ; l < l02 ; l=obj_tr.__xva[l][12] ){
                                                if(obj_tr.__xva[l][2] === 'c' && obj_tr.__xva[l][8] === 0){
                                                    liste_ne_pas_modifier+=',' + obj_tr.__xva[l][1];
                                                }
                                            }
                                        }
                                    }
                                }
                                if(liste_ne_pas_modifier !== ''){
                                    liste_ne_pas_modifier=liste_ne_pas_modifier.substr( 1 );
                                    t+='        /*\r\n';
                                    t+='          dans la définition de la table : fonctions_spéciales1(ne_pas_modifier(' + liste_ne_pas_modifier + '))\r\n';
                                    t+='        */\r\n';
                                    t+='        if(tup.hasOwnProperty( \'c_' + nom_du_champ_cle + '\' ) && [' + liste_ne_pas_modifier + '].includes( tup.c_' + nom_du_champ_cle + ' )){\r\n';
                                    t+='            return({"__xst" : __xer ,"__xme" : \'Vous ne pouvez pas modifier cet enregistrement car il y a une règle "ne_pas_modifier"\'});\r\n';
                                    t+='        }\r\n';
                                }
                            }
                        }
            ...
            if(contenu_fonction_verifier_parmis_genre_update !== ''){
                t+='        /*\r\n';
                t+='          =====================================================================================================\r\n';
                t+='          ================== appel de la fonction parmis qui fait un throw ====================================\r\n';
                t+='          =====================================================================================================\r\n';
            ...
            for( champ_sortie=0 ; champ_sortie < this.#obj_webs['champs_sortie'].length ; champ_sortie++ ){
                if(this.#obj_webs['champs_sortie'][champ_sortie].type_d_element === 'formule'){
                    ...
                    /*
                      var tableau1=this.__ig1.__rev1.txt_en_tableau(formule);
                    ...
                    */
                                            ...
                                            if(tab[m][2] === 'f'){
                                                ...
                                                if(tab[m][1].toLowerCase() === 'null' && tab[m][4] === 0){
                                                    ...
                                                    if(tab[m][1].substr( 0 , 1 ) === ':'){
                                                        valeur_du_champ='\' + this.__ig1.__fnt1.sq0( tup.' + tab[m][1].substr( 1 ) + ' , \'' + tab[m][1].substr( 1 ) + '\' ) + \'';
                    ...
                    tableau_des_champs_en_sortie.push( {
                            "non_du_champ_en_bdd" : nom_du_champ ,
                            "valeur_du_champ" : '\'.sq0( tup.n_' + nom_du_champ + ' ).\'' ,
                            "encadrement_variable" : encadrement_variable ,
                            "non_null" : champ_de_la_base.hasOwnProperty( 'non_nulle' ) && champ_de_la_base.non_nulle === true ? ( true ) : ( false ) ,
                            "type_de_champ" : 'variable' ,
                            "champ_en_bdd" : this.#obj_webs['bases'][id_numerique_base_principale].tables[nom_de_la_table].champs[ind]
            ...
            if(tableau_des_champs_en_sortie.length === 0){
                return(this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : this.__ig1.__rev1.nl2() + ' il manque les champs en sortie '} ));
            }
            for( let i=0 ; i < tableau_des_champs_en_sortie.length ; i++ ){
                let elem=tableau_des_champs_en_sortie[i];
                if(elem.type_de_champ === 'variable'){
                    if(elem.valeur_du_champ.indexOf( elem.non_du_champ_en_bdd ) < 0){
                        console.log( '%cAttention, c\'est peut être normal mais\nle champ "' + elem.non_du_champ_en_bdd + '" n\'est pas dans la formule ' + elem.valeur_du_champ , 'background:orange;color:black;' );
                    }
                }
            }
            ...
            for( var i=0 ; i < tableau_des_champs_en_sortie.length ; i++ ){
                ...
                if(la_sortie.champ_en_bdd.genre_numerique_du_champ === 5){
                ...
                if(this.#obj_webs.tableau_des_bases_tables_champs[id_numerique_base_principale][nom_de_la_table]['champs'][la_sortie.non_du_champ_en_bdd].genre_objet_du_champ
                    ...
                    liste_des_champs_pour_update3+='            if(tup.n_' + la_sortie.non_du_champ_en_bdd + ' === undefined || tup.n_' + la_sortie.non_du_champ_en_bdd + ' === \'\' || tup.n_' + la_sortie.non_du_champ_en_bdd + ' === null){' + CRLF;
                    ...
                    if(la_sortie.champ_en_bdd.espece_du_champ === 'DECIMAL'
                        ...
                        if(la_sortie.champ_en_bdd.espece_du_champ === 'INTEGER'){
                            liste_des_champs_pour_update3+='                if(isNaN(parseInt( tup.n_' + la_sortie.non_du_champ_en_bdd + ' , 10 ))){\r\n';
                            ...
                            liste_des_champs_pour_update3+='                if(isNaN(parseFloat( tup.n_' + la_sortie.non_du_champ_en_bdd + ' ))){\r\n';
                            liste_des_champs_pour_update3+='                    return({"__xst" : __xer ,"__xme" : \'le champ "' + la_sortie.champ_en_bdd.meta.nom_bref_du_champ.replace( /\\/g , '\\\\' ).replace( /\'/g , '\\\'' ) + '" doit être numérique\'});\r\n';
                            liste_des_champs_pour_update3+='                }\r\n';
                        }
                    }
            ...
            if(this.#obj_webs.conditions.length === 0){
                ...
                */
                ...
                if(liste_ne_pas_modifier !== ''){
                    ...
                    t+='              dans la définition de la table : fonctions_spéciales1(ne_pas_modifier(' + liste_ne_pas_modifier + '))\r\n';
                    t+='            */\r\n';
                    t+='            where0+=\' AND `' + nom_du_champ_cle + '` NOT IN (' + liste_ne_pas_modifier + ') \';' + CRLF;
                }
            ...
            for( i=0 ; i < tableau_des_conditions.length ; i++ ){
                ...
                if(elem.type_condition === 'constante'){
                    ...
                    if((elem.type.toLowerCase() === 'integer'
                        ...
                        t+='            where0+=\'\\r\\n\' + this.__ig1.__fnt1.construction_where_sql_sur_id1(\'' + elem.nom_du_champ_pour_where + '\',' + elem.condition + ');' + CRLF;
                    }else{
            ...
            t+='            sql0+=where0;' + CRLF;
            t+='        }catch(e){\r\n';
            t+='            return({__xst:__xer , __xme: this.__ig1.nl2(e)});\r\n';
            t+='        }\r\n';
            t+='        /* this.__ig1.ma_trace1(\' sql_' + id_requete_en_base + '= \' + sql0 ); */' + CRLF;
            t+='        try{\r\n';
            t+='            let res=await this.__db1.exec( sql0 );' + CRLF;
            if(this.#che_est_souche_requete === 1){
                t+='            /* si c\'est une requete souche la maj DOIT se faire */\r\n';
                t+='            if(res === 0){\r\n';
                if(liste_ne_pas_modifier !== ''){
                    t+='                return({"__xst" : __xer ,"changements" : res ,"__xme" : \'aucun changement effectué (contraintes)\'});\r\n';
                }else{
                    t+='                return({"__xst" : __xer ,"changements" : res ,"__xme" : \'pas d\\\'enregistrement à modifier\'});\r\n';
                }
                t+='            }\r\n';
            }
            t+='            return({"__xst" : __xsu ,"changements" : res});' + CRLF;
            ...
            */
            ...
            if(this.#obj_webs.conditions.length === 0){
                ...
                */
                ...
                if(les_conditions.__xst === __xsu){
                    ...
                    return(this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : this.__ig1.__rev1.nl2() + ' conversion en php '} ));
                }
            }
            t+='        sql0+=where0;' + CRLF;
            ...
            t+='        /* this.__ig1.ma_trace1(\'sql_' + id_requete_en_base + ' sql0=\',sql0); */\r\n';
            t+='        let lignes=[];\r\n';
            t+='        try{\r\n';
            ...
            for( i=0 ; i < obj3.tableau_des_champs_pour_select_js.length ; i++ ){
                if(obj3.tableau_des_champs_pour_select_js[i].type === 'champ'
                       && obj3.tableau_des_champs_pour_select_js[i].alias !== undefined
                ){
                    /*
            ...
            */
            ...
            if(this.#obj_webs.bases[base_reference].tables[table_reference].hasOwnProperty( 'est_table_virtuelle' )
                   && this.#obj_webs.bases[base_reference].tables[table_reference].est_table_virtuelle === 1
            ){
            ...
            */
            ...
            if(this.#obj_webs.conditions.length === 0){
                ...
                */
                ...
                t+='        /* this.__ig1.ma_trace1( \'tup=\' , tup ); */' + CRLF;
                t+='        try{' + CRLF;
                if(est_table_virtuelle === 1){
                    debugger;
                    t+='            if(tup.hasOwnProperty( \'les_match\' )  && tup.les_match !== \'\'){\r\n';
                    t+='                where0+=` AND ' + table_reference + ' match ` + this.__ig1.__fnt1.sq1( tup.les_match ) + \'\\r\\n\';\r\n';
                    t+='            }else{\r\n';
                    ...
                    t+='                }\r\n';
                    t+='                this.__ig1.ma_trace1(__nbEnregs);\r\n';
                    t+='                let fin=performance.now();\r\n';
                    t+='              this.__ig1.ma_trace1(\'ms=\'+parseInt((fin-debut),10));\r\n';
                    t+='              return({\r\n';
                    t+='                       /*  */\r\n';
                    t+='                      "__xst" : __xer ,\r\n';
                    ...
                    */
                    ...
                    var options={
                        ...
                        "tableau_des_noms_des_variables" : []
                    };
                    for( var i=1 ; i < l01 ; i++ ){
                        if(tab[i][7] === 0){
                            if(tab[i][1] === '#' && tab[i][2] === 'f'){
                                ...
                                if(tab[i][1] === 'et' && tab[i][2] === 'f'){
                                    ...
                                    for( j=i + 1 ; j < l01 && tab[j][3] > tab[i][3] ; j++ ){
                                        if(tab[j][7] === i){
                                            if(tab[j][2] === 'f'
                                                ...
                                                var obj=this.__m_rev_vers_sql1.traite_sqlite_fonction_de_champ( tab , j , 0 , options );
                                                if(obj.__xst === __xsu){
                                                    /* var parametre=obj.t_js.match( /\tup\.(.*)/ ); */
                                                    const regex=/tup\.[\w]+/g;
                                                    const parametre=obj.t_js.match( regex );
                                                    if(parametre === null){
                                                        tableau_des_conditions.push( {
                                                                ...
                                                                "tableau_des_noms_des_variables" : obj.tableau_des_noms_des_variables
                                                            } );
                                                    }else{
                                                        tableau_des_conditions.push( {
                                                                "type_condition" : 'variable' ,
                                    ...
                                    var obj=this.__m_rev_vers_sql1.traite_sqlite_fonction_de_champ( tab , i , 0 , options );
                                    if(obj.__xst === __xsu){
                                        /* var parametre=obj.__xva.match( /\tup\.(.*)/ ); */
                                        const regex=/tup\.[\w]+/g;
                                        const parametre=obj.t_js.match( regex );
                                        if(parametre === null){
                                            tableau_des_conditions.push( {
                ...
                for( var i=0 ; i < tableau_des_conditions.length ; i++ ){
                    ...
                    if(elem.type_condition === 'constante'){
                        ...
                        /* console.log("ici valeur="+valeur) */
                        if(valeur.indexOf( 'session(chi_id_utilisateur)' ) >= 0 || valeur.indexOf( 'session(chi_id_projet)' ) >= 0){
                            ...
                            let nom_du_champ_a_tester=elem.tableau_des_champs[0][0] + '_' + elem.tableau_des_champs[0][1];
                            t+='            if(tup.' + nom_du_champ_a_tester + ' !== undefined && tup.' + nom_du_champ_a_tester + ' !== \'\' ){' + CRLF;
                            t+='                where0+=` AND ' + valeur + '`;' + CRLF;
                            t+='            }' + CRLF;
                        }
                    }else if(elem.type_condition === 'variable'){
                        /*#
                          if(elem.condition.indexOf('indoo')>=0){
                              debugger
                          }
                        */
                        ...
                        if(genre_numerique_du_champ === 25){
                            /* a voir */
                            debugger;
                            t+='            if(tup.hasOwnProperty( \'' + elem.tableau_des_noms_des_variables[0] + '\' )){' + CRLF;
                        }else{
                            if(elem.tableau_des_noms_des_variables.length === 1){
                                t+='            if(tup.hasOwnProperty( \'' + elem.tableau_des_noms_des_variables[0] + '\' ) && tup.' + elem.tableau_des_noms_des_variables[0] + ' !== \'\'){' + CRLF;
                            }else{
                                /* a voir pourquoi peut-on avoir 0 ou n variables */
                                debugger;
                            }
                        }
                        if((elem.espece_du_champ_pour_where.toLowerCase() === 'integer'
                            ...
                            if(genre_numerique_du_champ === 25){
                                let prefixe_champ=elem.tableau_des_champs[0][0];
                                let nom_simple_du_champ=elem.tableau_des_champs[0][1];
                                let cle_par=prefixe_champ + '_' + nom_simple_du_champ;
                                t+='                if(tup.' + cle_par + ' === \'-1\'){\r\n';
                                t+='                    where0+=\' AND `' + prefixe_champ + '`.`' + nom_simple_du_champ + '` IS NULL \\r\\n\';\r\n';
                                t+='                }else if(tup.' + cle_par + ' === \'\'){\r\n';
                                t+='                    /* */\r\n';
                                t+='                }else{\r\n';
                                t+='                    where0+=` AND \\`' + prefixe_champ + '\\`.\\`' + nom_simple_du_champ + '\\` = ` + this.__ig1.__fnt1.sq1( tup.' + cle_par + ' , \'' + cle_par + '\' ) + `` + \'\\r\\n\';\r\n';
                                t+='                }\r\n';
                            }else if(genre_numerique_du_champ === 5){
                                /* si c'est un 0/1 */
                                t+='                where0+=` AND ' + elem.valeur + '` + \'\\r\\n\';' + CRLF;
                            }else{
                                if(elem.tableau_des_noms_des_variables.length === 1){
                                    t+='                if(tup.' + elem.tableau_des_noms_des_variables[0] + ' === 0){\r\n';
                                    t+='                    where0+=\' AND ' + elem.nom_du_champ_pour_where + ' IS NULL \\r\\n\';\r\n';
                                    t+='                }else{\r\n';
                                    t+='                    where0+=\'\\r\\n\' + this.__ig1.__fnt1.construction_where_sql_sur_id1( \'' + elem.nom_du_champ_pour_where + '\' , tup.' + elem.tableau_des_noms_des_variables[0] + ' );' + CRLF;
                                    t+='                }\r\n';
                                }else{
                                    /* a voir pourquoi peut-on avoir 0 ou n variables */
                                    debugger;
                ...
                t+='        }catch(e){' + CRLF;
                t+='            return({"__xst" : __xer , "__xme" : \'erreur de construction de la requête [\' + this.__ig1.nl2(e) + \' ] \' });\r\n';
                t+='            ' + CRLF;
                t+='        }' + CRLF;
            }
            t+='        sql0+=where0;' + CRLF;
            ...
            for( let i=0 ; i < obj3.tableau_des_champs_pour_select_js.length ; i++ ){
                ...
                if(longueur_du_champ.indexOf( '.' ) > 0){
                    ...
                    t+='                    "' + obj3.tableau_des_champs_pour_select_js[i].alias + '_' + obj3.tableau_des_champs_pour_select_js[i].nom_du_champ + '" : lignes[numero_de_ligne][' + i + ']';
                }
                if(i < obj3.tableau_des_champs_pour_select_js.length - 1){
                    t+=' ,';
                }
    ...
    */
    convertir_rev_pour_construction( mat , d , bases ){
        ...
        */
                                            ...
                                            if(tab[m][1] === 'nom_de_la_table' && tab[m][2] === 'f'){
                                                for( var n=m + 1 ; n < l01 ; n=tab[n][12] ){
                                                    if(tab[n][1] === 'alias' && tab[n][2] === 'f' && tab[n][8] === 1 && tab[n + 1][2] === 'c'){
                                                        ...
                                                        ordre_de_table.prefix_numerique_table=parseInt( tab[n + 1][1].substr( 1 ) , 10 );
                                        ...
                                        for( let indtbl=0 ; indtbl < this.#obj_webs['ordre_des_tables'].length ; indtbl++ ){
                                            if(tab_jointure_gauche[indj].alias_de_la_table_pour_le_champ === this.#obj_webs['ordre_des_tables'][indtbl].alias_de_la_table
                                                ...
                                                ordre_de_table.champs_jointure_gauche['champ_table_mere']={
                                                    ...
                                                    "prefix_numerique_table" : parseInt( tab_jointure_gauche[indj].alias_de_la_table_pour_le_champ.substr( 1 ) , 10 )
                                                };
        ...
        for( let i=1 ; i < l01 ; i=tab[i][12] ){
            ...
            if(tab[i][2] === 'f'){
                for( let j=i + 1 ; j < l01 ; j=tab[j][12] ){
                    if(tab[j][1] === 'valeurs' && tab[j][2] === 'f' && tab[j][8] > 0){
                        var obj=this.__ig1.__rev1.matrice_vers_source_rev1( tab , j , true , j + 1 );
                        if(obj.__xst === __xsu){
        ...
        this.#obj_webs.ne_pas_exclure_les_id_a_ne_pas_supprimer=0;
        this.#obj_webs.ne_pas_traiter_la_maj_ts_modification=0;
        this.#obj_webs.ne_pas_traiter_la_maj_ts_creation=0;
        ...
        for( var i=0 ; i < l01 ; i++ ){
            if(tab[i][3] === 0 && tab[i][1] === '#' && tab[i][2] === 'f' && tab[i][13].indexOf( 'meta(' ) >= 0){
                ...
                var obj2=this.__ig1.__rev1.rev_tm( tab[i][13] );
                if(obj2.__xst !== __xsu){
                    continue;
                }
                for( let j=1 ; j < obj2.__xva.length ; j=obj2.__xva[j][12] ){
                    if(obj2.__xva[j][1] === 'meta' && obj2.__xva[j][2] === 'f'){
                        for( let k=j + 1 ; k < obj2.__xva.length ; k=obj2.__xva[k][12] ){
                            ...
                            }else if(obj2.__xva[k][1] === 'ne_pas_exclure_les_id_a_ne_pas_supprimer'
                                   && obj2.__xva[k][2] === 'f'
                                   && obj2.__xva[k + 1][2] === 'c'
                                   && obj2.__xva[k][8] === 1
                            ){
                                if(obj2.__xva[k + 1][1] === '1'){
                                    this.#obj_webs.ne_pas_exclure_les_id_a_ne_pas_supprimer=1;
                                }
                    ...
                    */
                    ...
                    if(trouve === true){
                        ...
                        */
                        ...
                        if(tab_jointure_gauche.length === 2){
                            for( let j=0 ; j < tab_jointure_gauche.length ; j++ ){
                                for( let k=0 ; k < this.#obj_webs['ordre_des_tables'].length ; k++ ){
        ...
        for( let i=1 ; i < l01 ; i++ ){
            if(tab[i][2] === 'f' && 'valeurs' === tab[i][1] && tab[i][3] === 1){
                  ...
                  for( let j=i + 1 ;  j < l01 && tab[j][3] > tab[i][3] ; j=tab[j][12] ){
                      ...
                      if(tab[j][2] === 'c'){
                          ...
                          if(tab[j][8] === 2){
                              ...
                              for( let k=j + 1 ; k < l01 && tab[k][3] > tab[j][3] ; k++ ){
                                  if(tab[k][2] === 'c'){
                                      nom_du_champ=tab[k][1];
                                  }
                              }
                          ...
                          if(nom_du_champ !== ''){
                              // il faut vérifier que ce champ appartient bien à une table référencée à la fois dans la base et dans la requête
                              ...
                              for( let k=0 ; k < nom_des_table_pouvant_contenir_le_champ.length && trouve === false ; k++ ){
                                  ...
                                  var l02=tab2.length;
                                  for( let l=1 ; l < l02 && trouve === false ; l=tab2[l][12] ){
                                      if(tab2[l][1] === 'créer_table' && tab2[l][2] === 'f'){
                                          for( let m=l + 1 ; m < l02 && trouve === false ; m=tab2[m][12] ){
                                              if(tab2[m][1] === 'nom_de_la_table' && tab2[m][8] === 1 && tab2[m + 1][2] === 'c'){
                                                  if(tab2[m + 1][1] === nom_des_table_pouvant_contenir_le_champ[k].nom_de_la_table){
                              ...
                              if(trouve !== false && tab[j][7] === i){
                                  // si c'est une référence de champ directe sous le 'valeurs' alors c'est un champ en sortie, sinon il est dans une formule
                          ...
                          if(this.#obj_webs.type_de_requete === 'update' || this.#obj_webs.type_de_requete === 'insert'){
                              ...
                              if(tab[j][1] === 'affecte' && tab[j][2] === 'f'){
                                  // si le premier paramètre de affecte est un champ et le deuxième est une variable, alors c'est un champ en sortie
                                  ...
                                  for( let k=j + 1 ; k < l01 ; k=tab[k][12] ){
                                      if(tab[k][1] === 'champ' && tab[k][2] === 'f'){
                                          ...
                                          // c'est une fonction, par exemple requetes 1107,1159,1158 le traitement se fera plus loin
                                      }else{
                                          debugger;
                                      }
                                  }
                                  if(indice_de_la_variable > 0 && indice_du_champ > 0){
                                      ...
                                      if(tab[j][1] === 'affecte'){
                                          ...
                                          var obj=this.__ig1.__rev1.matrice_vers_source_rev1( tab , tab[j][7] , true , j );
                                          if(obj.__xst === __xsu){
                                              this.#obj_webs['champs_sortie'].push( {"type_d_element" : 'formule' ,"formule" : obj.__xva} );
                                          }
                                      }
                ...
                */
                ...
                if(tab[i][8] > 0){
                    var obj=this.__ig1.__rev1.matrice_vers_source_rev1( tab , tab[i + 1][7] , true , i + 1 );
                    if(obj.__xst === __xsu){
    ...
    */
    traiter_donnees_bases_rev( mat , d , bases ){
        for(let i in bases){
            /* donnees.__xva]{ */
            if(bases[i]['T0_chp_rev_travail_basedd'] === null){
                this.#obj_webs['bases'][bases[i]['T0_chi_id_basedd']]={"chi_id_basedd" : bases[i]['T0_chi_id_basedd'] ,"chp_rev_travail_basedd" : '' ,"matrice" : [] ,"tables" : {} ,"selectionne" : false};
            }else{
                this.#obj_webs['bases'][bases[i]['T0_chi_id_basedd']]={
                    "chi_id_basedd" : bases[i]['T0_chi_id_basedd'] ,
                    "chp_rev_travail_basedd" : bases[i]['T0_chp_rev_travail_basedd'] ,
        ...
        for(let ind in this.#obj_webs['bases']){
            ...
            for( let i=1 ; i < l01 ; i=tab[i][12] ){
                ...
                if(tab[i][1] === 'créer_table' && tab[i][2] === 'f'){
                    ...
                    for( let j=i + 1 ; j < l01 ; j=tab[j][12] ){
                        if("nom_de_la_table" === tab[j][1] && tab[j][2] === 'f'){
                            ...
                            this.#obj_webs['bases'][ind]['tables'][nom_de_la_table]={
                                 /*  */
                                "active" : false ,
                                "est_table_virtuelle" : est_table_virtuelle ,
                                "champs" : [] ,
                                "detail_table" : {"txt_meta" : '' ,"mat_meta" : []}
                            };
                            break;
                        }
                    }
                                    ...
                                    if(tab[m][1] === 'field' || tab[m][1] === 'champ'){
                                        ...
                                        for( let n=m + 1 ; n < l01 ; n=tab[n][12] ){
                                            if(tab[n][1] === 'nom_du_champ'){
                                                ...
                                                this.#obj_webs.tableau_des_bases_tables_champs[ind][nom_de_la_table]['champs'][nom_du_champ]={"nom_du_champ" : nom_du_champ ,"meta" : {}};
                                            }
                                        }
                                        if(nom_du_champ !== ''){
                                            for( let n=m + 1 ; n < l01 ; n=tab[n][12] ){
                                                if(tab[n][1] === 'type'){
                                                    ...
                                                    for( let o=n + 1 ; o < l01 ; o=tab[o][12] ){
                                                        if(tab[o][1] === 'genre' && tab[o][2] === 'f' && tab[o][8] === 1 && tab[o + 1][2] === 'c'){
                                                            ...
                                                            this.#obj_webs.tableau_des_bases_tables_champs[ind][nom_de_la_table]['champs'][nom_du_champ]['genre_objet_du_champ']=this.__ig1.__liste_des_genres[tab[o + 1][1]];
                                                            this.#obj_webs.tableau_des_bases_tables_champs[ind][nom_de_la_table]['champs'][nom_du_champ]['meta']['genre']=parseInt( tab[o + 1][1] , 10 );
                                                            /*
                                                              debugger
                                                            ...
                                                            */
                                                            ...
                                                            if(tab[o][2] === 'f' && tab[o][8] === 0){
                                                                this.#obj_webs.tableau_des_bases_tables_champs[ind][nom_de_la_table]['champs'][nom_du_champ]['meta'][tab[o][1]]=null;
                                                            }else if(tab[o][2] === 'f' && tab[o][8] === 1 && tab[o + 1][2] === 'c'){
                ...
                if(nom_de_la_table !== ''){
                    /* console.log("nom_de_la_table="+nom_de_la_table) */
                    for( let l=i + 1 ; l < l01 ; l=tab[l][12] ){
                        if(tab[l][1] === 'meta'){
                            /* console.log("nom_de_la_table et l="+nom_de_la_table + ' ' +l) */
                            let obj_meta=this.__ig1.__rev1.matrice_vers_source_rev1( tab , l , true , l + 1 );
                            if(obj_meta.__xst !== __xsu){
                                return({
                                        "__xst" : __xer ,
                                        "__xme" : 'erreur de transformation du meta table mat en txt "' + nom_de_la_table + '"   [' + this.__ig1.nl2() + ']'
                                    });
                            }
                            /* console.log("nom_de_la_table et l="+nom_de_la_table + ' ' +l) */
                            this.#obj_webs['bases'][ind]['tables'][nom_de_la_table]['detail_table']['txt_meta']=obj_meta.__xva;
                            let mat_table=this.__ig1.__rev1.copier_morceau_de_matrice( tab , l );
                            if(mat_table.__xst !== __xsu){
                                return({"__xst" : __xer ,"__xme" : 'erreur de copie du meta table mat "' + nom_de_la_table + '" [' + this.__ig1.nl2() + ']'});
                            }
                            this.#obj_webs['bases'][ind]['tables'][nom_de_la_table]['detail_table']['mat_meta']=mat_table.__xva;
                            break;
                        }
                    }
                }
    ...
    */
    traite_les_donnees_base_et_requetes_du_serveur( mat , d , le_colis1=null ){
        ...
        for(let indice_de_la_base in bases){
            var obj1=this.__ig1.__rev1.rev_tm( bases[indice_de_la_base]['T0_chp_rev_travail_basedd'] );
            if(obj1.__xst !== __xsu){
                return;
            }
        ...
        */
        ...
        if(chi_id_requete > 0){
            this.#globale_id_requete=le_colis1.__xva.requete['T0_chi_id_requete'];
            this.#globale_rev_requete=le_colis1.__xva.requete['T0_cht_rev_requete'];
            this.#globale_type_requete=le_colis1.__xva.requete['T0_chp_type_requete'];
            this.#globale_commentaire_requete=le_colis1.__xva.requete['T0_cht_commentaire_requete']??'';
            this.#globale_chp_table_reference_requete=le_colis1.__xva.requete['T0_chp_table_reference_requete']??'';
            this.#globale_che_base_reference_requete=le_colis1.__xva.requete['T0_che_base_reference_requete']??1;
            this.#che_est_souche_requete=le_colis1.__xva.requete['T0_che_est_souche_requete'];
            /*
    ...
    */
    compiler_requete_vers_js1( mat , d , les_bases_et_la_requete ){
        ...
        */
        ...
        /*  */
        for(let indice_de_la_base in bases){
            let obj0=this.__ig1.__rev1.rev_tm( bases[indice_de_la_base]['T0_chp_rev_travail_basedd'] );
            if(obj0.__xst !== __xsu){
        ...
        if(this.#globale_id_requete > 0){
            this.#globale_id_requete=les_bases_et_la_requete.__xva.requete['T0_chi_id_requete'];
            this.#globale_rev_requete=les_bases_et_la_requete.__xva.requete['T0_cht_rev_requete'];
            this.#globale_type_requete=les_bases_et_la_requete.__xva.requete['T0_chp_type_requete'];
            this.#globale_commentaire_requete=les_bases_et_la_requete.__xva.requete['T0_cht_commentaire_requete']??'';
            this.#globale_chp_table_reference_requete=les_bases_et_la_requete.__xva.requete['T0_chp_table_reference_requete']??'';
            this.#globale_che_base_reference_requete=les_bases_et_la_requete.__xva.requete['T0_che_base_reference_requete']??1;
            this.#che_est_souche_requete=les_bases_et_la_requete.__xva.requete['T0_che_est_souche_requete'];
            this.convertir_rev_pour_construction( mat , d , les_bases_et_la_requete );
        }
        /*
          2°] le partie transform_source_rev_vers_sql( le_colis1.__xva.requete['T0_cht_rev_requete'] , chi_id_requete );
        */
        var obj1=this.__ig1.__rev1.rev_tm( this.#globale_rev_requete );
        if(obj1.__xst !== __xsu){
        ...
        if(obj2.__xst !== __xsu){
            return(this.__ig1.ajoute_message( {"__xst" : __xer ,"__xme" : this.__ig1.__rev1.nl2() + 'conversion en sql '} ));
        }
        ...
        if(obj3.__xst !== __xsu){
            return(this.__ig1.ajoute_message( {"__xst" : __xer ,"source_sql" : obj2.__xva ,"message" : this.__ig1.__rev1.nl2() + 'conversion en sql '} ));
        }
