class projets1{
    ...
    */
    page_modification1( mat , d , le_colis1=null ){
        ...
        this.__ig1.afficher_le_titre_des_zones( 'vv_ecran_modification' , 'entree_module' , this.DUN_DUNE_ELEMENT_GERE , tup.T0_chi_id_projet , this.moi , 'chi_id_projet' );
        let o1='';
        /*
          =====================================================================================================
        */
        ...
        if(tup.T0_chp_nom_projet === undefined){
        ...
        */
        ...
        o1+='    </div>';
        o1+='    <div class="yy_edition_valeur1">';
        if(tup.T0_cht_commentaire_projet === undefined){
            o1+='        <div class="yy__0">ATTENTION, ERREUR DE SQL :  LE CHAMP n\'est pas inclus dans le SELECT</div>';
        }
        o1+='        <div class="yy_conteneur_txtara">';
        o1+='<div>\r\n';
        ...
        /*
          =====================================================================================================
        */
        o1+='      <input type="hidden" id="chi_id_projet" value="' + tup.T0_chi_id_projet + '">';
        /*
          =====================================================================================================
        */
        let cmd='';
    ...
    */
    page_confirmation_supprimer1( mat , d , le_colis1=null ){
        ...
        if(tup.T0_chi_id_projet === undefined){
            return({"__xst" : __xer ,"__xme" : "Attention, le champ T0_chi_id_projet n'est pas en sortie dans la requête select "});
        }
        this.__ig1.afficher_le_titre_des_zones( 'vv_ecran_suppression' , 'entree_module' , this.DUN_DUNE_ELEMENT_GERE , tup.T0_chi_id_projet , this.moi , 'chi_id_projet' );
        let o1='';
        /*
          =====================================================================================================
        */
        ...
        o1+='</div>\r\n';
        o1+='            <textarea disabled id="chp_nom_projet" rows="2"  cols="50" >' + this.__ig1.fi2( tup.T0_chp_nom_projet ) + '</textarea>';
        o1+='        </div>';
        o1+='    </div>';
        o1+='  </div>';
        /*
        ...
        */
        ...
        o1+='</div>\r\n';
        o1+='            <textarea disabled id="cht_commentaire_projet" rows="2"  cols="50" >' + this.__ig1.fi2( tup.T0_cht_commentaire_projet ) + '</textarea>';
        o1+='        </div>';
        o1+='    </div>';
        o1+='  </div>';
        /*
