...
class metiers1{
    ...
    */
    async actions_et_tests_avant_modifier( mat , d , fo1 , __xva_avant , __db1 ){
        if(this.__ig1.donnees_retournees._CA_ > 2
               ...
               && __xva_avant.T0_chi_id_metier <= 2
        ){
            return({"__xst" : __xer ,"__xme" : ' vous ne pouvez pas modifier le métier (' + __xva_avant.T0_chi_id_metier + ')'});
        }
        return({"__xst" : __xsu});
    }
    /*
    ...
    */
    async modifier1( mat , d ){
        ...
        let criteres_select_1125={"T0_chi_id_metier" : fo1.chi_id_metier};
        ...
        let __aetavm=await this.actions_et_tests_avant_modifier( mat , d , fo1 , tt1125.__xva[0] , __db1 );
        ...
        let criteres_1127={
             /*  */
            "c_chi_id_metier" : fo1.chi_id_metier ,
            "n_chp_nom_metier" : fo1.chp_nom_metier ,
        ...
        */
        ...
        let __taam=await this.tests_et_actions_apres_modifier( mat , d , fo1 , tt1125.__xva[0] , __db1 );
    ...
    */
    async page_modification1( mat , d , chi_id_metier=null , __db1=null ){
        if(chi_id_metier === null){
            const l01=mat.length;
            for( let i=d + 1 ; i < l01 ; i=mat[i][12] ){
                if(mat[i][1] === 'chi_id_metier' && mat[i][2] === 'f' && mat[i][8] === 1 && mat[i + 1][2] === 'c'){
    ...
    */
    async supprimer1( mat , d ){
        ...
        /*  */
        let __db1=await this.__ig1.ouvrir_bdd( this.__ig1.options_generales.base_de_travail );
        let tt1125=await this.recup_chi_id_metier( {"T0_chi_id_metier" : fo1.chi_id_metier} , __db1 );
        if(tt1125.__xst !== __xsu || tt1125.__xva.length !== 1){
            return({"__xst" : __xer ,"__xme" : 'enregistrement non trouvé : suppression impossible [1125 ' + this.__ig1.nl2() + ']'});
        }
        /*  */
        let tas=await this.test_avant_supprimer( mat , d , fo1 , tt1125.__xva[0] , __db1 );
        if(tas.__xst !== __xsu){
        ...
        */
        ...
        let __aavc=await this.actions_apres_supprimer( mat , d , fo1 , tt1125.__xva[0] , __db1 );
    ...
    */
    async creer1( mat , d ){
        ...
        let criteres_1126={
            "donnees" : [{"chp_nom_metier" : fo1.chp_nom_metier ,"chx_parent_metier" : fo1.chx_parent_metier === '' ? ( null ) : ( fo1.chx_parent_metier )}]
        };
        /*  */
        await __db1.exec( 'BEGIN TRANSACTION;' );
        ...
        */
        ...
        let __aapc=await this.action_apres_creer( mat , d , tt1126['nouvel_id'] , fo1 , __db1 );
