...
class metiers1{
    ...
    */
    async modifier1( mat , d , donnees_recues , donnees_retournees , options_generales ){
        ...
        let __test_0_1=this.__ig1.__fnt1.test_du_nom_technique1( form['chp_nom_metier'] , 'nom' );
        ...
        if(tt125[__xst] === __xsu && tt125[__xva].length === 1){
            ...
            */
            ...
            if(tt127[__xst] !== __xsu){
                if(tt127['__xme'] !== ''){
                    donnees_retournees.__xsi[__xer].push( tt127['__xme'] + ' [' + this.__ig1.nl2() );
                }else{
    ...
    async creer1( mat , d , donnees_recues , donnees_retournees , options_generales ){
        ...
        */
        ...
        if(tt126[__xst] === __xsu){
            ...
            donnees_retournees.__xsi[__xer].push( tt126['__xme'] + '\nl\'insertion a échoué [' + this.__ig1.nl2() + ']' );
            return({"__xst" : __xer});
        }
    }
    /*
