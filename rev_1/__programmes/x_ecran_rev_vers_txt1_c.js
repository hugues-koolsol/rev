...
/*
*/
class x_ecran_rev_vers_txt1{
    moi='x_ecran_rev_vers_txt1';
    /*
      =============================================================================================================
    */
        ...
        if(zone_source !== '' && zone_resultat !== ''){
            ...
            if(t1 && t2){
                if(mettre_en_stockage_local === 1){
                    this.sauvegarder_contenu_en_localstorage( 'x_ecran_rev_vers_txt1' , t1.value );
                }
                try{
...
export{x_ecran_rev_vers_txt1 as x_ecran_rev_vers_txt1};