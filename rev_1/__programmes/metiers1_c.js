class metiers1{
    ...
    */
    tableau_des_filtres={
        ...
        "sous_liste2" : {
            ...
            "T0_chi_id_metier" : {"défaut" : '' ,"masqué" : false ,"nom" : 'id' ,"taille" : 9} ,
            "T0_chp_nom_metier" : {"défaut" : '' ,"masqué" : false ,"nom" : 'nom' ,"taille" : 9} ,
            "T0_chx_parent_metier" : {"défaut" : '' ,"masqué" : false ,"nom" : 'id parent' ,"taille" : 9} ,
            "T1_chp_nom_metier" : {"défaut" : '' ,"masqué" : false ,"nom" : 'métier parent' ,"taille" : 9}
        }
    };
    /*
    */
    ...
    */
    page_modification1( mat , d , le_colis1=null ){
        ...
        this.__ig1.afficher_le_titre_des_zones( 'vv_ecran_modification' , 'entree_module' , this.DUN_DUNE_ELEMENT_GERE , tup.T0_chi_id_metier , this.moi , 'chi_id_metier' );
        let o1='';
        /*
          =====================================================================================================
        */
        ...
        */
        ...
        /*
          =====================================================================================================
        */
        o1+='      <input type="hidden" id="chi_id_metier" value="' + tup.T0_chi_id_metier + '">';
        /*
          =====================================================================================================
        */
        let cmd='';
    ...
    */
    page_confirmation_supprimer1( mat , d , le_colis1=null ){
        ...
        if(tup.T0_chi_id_metier === undefined){
            return({"__xst" : __xer ,"__xme" : "Attention, le champ T0_chi_id_metier n'est pas en sortie dans la requête select "});
        }
        this.__ig1.afficher_le_titre_des_zones( 'vv_ecran_suppression' , 'entree_module' , this.DUN_DUNE_ELEMENT_GERE , tup.T0_chi_id_metier , this.moi , 'chi_id_metier' );
        let o1='';
        /*
          =====================================================================================================
        */
    ...
    */
    page_voir1( mat , d , le_colis1=null ){
        ...
        this.__ig1.afficher_le_titre_des_zones( 'vv_ecran_visualisation' , 'entree_module' , this.DUN_DUNE_ELEMENT_GERE , tup.T0_chi_id_metier , this.moi , 'chi_id_metier' );
        let o1='';
        /*
          =====================================================================================================
        */
        ...
        o1+='    </div>';
        o1+='    <div class="yy_edition_valeur1">';
        o1+='      <input type="text" id="chp_nom_metier"  maxlength="128"  value="' + this.__ig1.fi2( tup.T0_chp_nom_metier ) + '" />';
        o1+=this.__ig1.__fnt1.boutons_suppression2( 'chp_nom_metier' );
        o1+='    </div>';
        o1+='  </div>';
        /*
    ...
    */
    liste_des_boutons_action1( tup , le_colis1 ){
        ...
        if(tup.T0_chi_id_metier <= 2){
            ...
            lst+='pm1(m1(n1(' + this.moi + '),f1(page_confirmation_supprimer1(chi_id_metier(' + tup.T0_chi_id_metier + ')))))';
            lst+='">' + this.__ig1.les_svg.poubelle + '</div>';
        }
        if(le_colis1._CA_ > 2 && le_colis1.chi_id_utilisateur > 1 && tup.T0_chi_id_metier <= 2){
            ...
            lst+='<div class="rev_b_svg yy__3" data-rev_click="pm1(m1(n1(' + this.moi + '),f1(page_modification1(chi_id_metier(' + tup.T0_chi_id_metier + ')))))">' + this.__ig1.les_svg.editer + '</div>';
            lst+='<div class="rev_b_svg yy__4" data-rev_click="pm1(m1(n1(' + this.moi + '),f1(page_duplication1(chi_id_metier(' + tup.T0_chi_id_metier + ')))))">' + this.__ig1.les_svg.dupliquer + '</div>';
        }
        lst+='</div>';
        return lst;
    }
