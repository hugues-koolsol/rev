    ...
    */
    page_modification1( mat , d , le_colis1=null ){
        ...
        */
        ...
        o1+='      <input  type="text" style="height: var(--t_hauteur_input1);" id="chp_nom_metier"   maxlength="128"  value="' + this.__ig1.fi2( enreg['T0.chp_nom_metier'] ) + '"  autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" />';
