class metiers1{
    ...
    */
    verifier_modifier1( mat , d , données ){
        ...
        let __test_0_1=this.__gi1.__fnt1.test_du_nom_technique1( fo1['chp_nom_metier'] , 'nom' );
    ...
    */
    page_modification1( mat , d , le_message_du_serveur=null ){
        ...
        this.__gi1.afficher_le_titre_des_zones( 'vv_ecran_modification' , 'entree_module' , this.DUN_DUNE_ELEMENT_GERE , enreg['T0.chi_id_metier'] , this.moi );
        let o1='';
        /*
          =====================================================================================================
        */
        ...
        o1+='      <input  type="text" style="height: var(--t_hauteur_input1);" id="chp_nom_metier"   maxlength="128"  value="' + this.__gi1.fi2( enreg['T0.chp_nom_metier'] ) + '"  autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" />';
        o1+=this.__gi1.__fnt1.boutons_edition_text( 'chp_nom_metier' );
        o1+='    </div>';
        o1+='  </div>';
        /*
          =====================================================================================================
        */
        ...
        o1+='(' + enreg['T0.chx_parent_metier'] + ') ';
        o1+=this.__gi1.fi2( enreg['T1.chp_nom_metier'] );
        o1+='</span>';
        o1+=this.__gi1.lien_parent( 'metiers1' , 'chx_parent_metier' , 'chx_parent_metier_libelle' );
        o1+='    </div>';
        o1+='  </div>';
        /*
          =====================================================================================================
    ...
    */
    page_confirmation_supprimer1( mat , d , le_message_du_serveur=null ){
        ...
        this.__gi1.afficher_le_titre_des_zones( 'vv_ecran_suppression' , 'entree_module' , this.DUN_DUNE_ELEMENT_GERE , enreg['T0.chi_id_metier'] , this.moi );
        let o1='';
        /*
          =====================================================================================================
        */
        ...
        o1+='    </div>';
        o1+='    <div class="yy_edition_valeur1">';
        o1+='      <input disabled  type="text" id="chp_nom_metier"   maxlength="128"  value="' + this.__gi1.fi2( enreg['T0.chp_nom_metier'] ) + '"   />';
        o1+='    </div>';
        o1+='  </div>';
        /*
          =====================================================================================================
    ...
    */
    verifier_creer1( mat , d , données ){
        ...
        var __test=this.__gi1.__fnt1.test_du_nom_technique1( fo1['chp_nom_metier'] , 'nom' );
    ...
    */
    page_creer1( mat , d , dupliquer=null ){
        ...
        */
        ...
        o1+='    </div>';
        o1+='    <div class="yy_edition_valeur1">';
        o1+='      <input  type="text"   maxlength="128"  id="chp_nom_metier" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"  value="';
        if(dupliquer && dupliquer.hasOwnProperty( 'T0.chp_nom_metier' )){
            o1+=this.__gi1.fi2( dupliquer['T0.chp_nom_metier'] );
        }else{
            o1+='';
        }
        o1+='" />';
        ...
        */
        ...
        if(dupliquer && dupliquer.hasOwnProperty( 'T0.chx_parent_metier' )){
            o1+=this.__gi1.fi2( dupliquer['T0.chx_parent_metier'] );
        }else{
            o1+='';
        }
        o1+='"';
        ...
        if(dupliquer && dupliquer.hasOwnProperty( 'T0.chx_parent_metier' )){
            if(dupliquer['T0.chx_parent_metier'] === null){
                ...
                o1+=this.__gi1.fi2( dupliquer['T1.chp_nom_metier'] );
            }
        }else{
            o1+='NULL';
        }
            ...
            for(let i in le_message_du_serveur.__xva[this.fonction_liste].__xva){
                ...
                */
                ...
                if(elem['T0.chp_nom_metier'] !== null){
                    lst+=this.__gi1.fi2( elem['T0.chp_nom_metier'].substr( 0 , 100 ) );
                }
                lst+='</td>';
                lst+='</tr>';
            }
    ...
    zones_liste1( le_message_du_serveur ){
        ...
        if(le_message_du_serveur !== null && le_message_du_serveur.__xva.hasOwnProperty( this.fonction_liste )){
            ...
            for(let i in le_message_du_serveur.__xva[this.fonction_liste].__xva){
                ...
                lst+='<div class="rev_b_svg yy__3" data-rev_click="pm1(m1(n1(' + this.moi + '),f1(page_modification1(chi_id_metier(' + elem['T0.chi_id_metier'] + ')))))">' + this.__gi1.les_svg.editer + '</div>';
                lst+='<div class="rev_b_svg yy__4" data-rev_click="pm1(m1(n1(' + this.moi + '),f1(page_duplication1(chi_id_metier(' + elem['T0.chi_id_metier'] + ')))))">' + this.__gi1.les_svg.dupliquer + '</div>';
                lst+='</div>';
                lst+='</td>';
                /*
                */
                ...
                */
                lst+='<td style="text-align:center;">';
                if(elem['T0.chp_nom_metier'] !== null){
                    lst+=this.__gi1.fi2( elem['T0.chp_nom_metier'] );
                }
                lst+='</td>';
                /*
                */
                ...
                if(elem['T1.chp_nom_metier'] !== null){
                    lst+=this.__gi1.fi2( elem['T1.chp_nom_metier'] );
                }
                lst+='</td>';
                /*
                */
            ...
            if(lst !== ''){
                ...
                o1+=/* chp_nom_metier */'<th>nom</th>';
                o1+=/* chp_nom_metier */'<th>nom</th>';
                o1+=/* chx_parent_metier */'<th>parent</th>';
                o1+='</tr>';
                o1+=lst;
                o1+='</table>';
                o1+='</div>';
