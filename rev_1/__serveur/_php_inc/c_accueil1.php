    ...
    */
    function recupere_de_la_page_initiale(&$donnees_retournees,&$mat,&$donnees_recues){
        ...
        if($tab['nouveau_cookie'] === true){
            ...
            $donnees_retournees[__x_signaux][__xif][]='<span style="font-size:3em;">😊 Bienvenue !</span>';
            ...
            if(time() - $tab['ancienne_date'] > 3600 * 24){
                ...
                $donnees_retournees[__x_signaux][__xif][]='<span style="font-size:4em;">😀 Content de vous revoir !</span>';
            ...
            $donnees_retournees[__x_page] .= <<<EOT
                ...
                <div id="vv_nav">
                    ...
                    <div id="vv_nav_droite">
                        <div data-id_menu="-2" class="hug_bouton hug_bouton_carre" id="vv_bouton_aide" data-hug_click="c_aides1.recupere_la_page_d_aide()" title="aide et paramètres">
                        ...
                        <div data-id_menu="-3" class="hug_bouton hug_bouton_carre" id="vv_bouton_connexion" data-hug_click="c_connexion1.recupere_la_page_de_connexion(),indice_menu(2)" title="connexion ou déconnexion">
...
EOT;
        ...
        $donnees_retournees[__x_page] .= '<div class="hug_bouton yy__x_signaux_2" id="vv_supprimer_les_messages_3" data-hug_click="interface1.supprimer_les_messages()" style="position: fixed;left:calc( 50vw - 80px);top: var(--h_barre);z-index:100;visibility:hidden;">🗑 les messages</div>';
