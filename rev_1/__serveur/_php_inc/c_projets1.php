        ...
        */
        ...
        if($chi_id_projet === 1){
            ...
            if($tt160[__xst] === __xsu && count($tt160[__xva]) === 1){
                ...
                if($tt160[__xva][0][0] === null){


                }else{

                    /*
                      $donnees_retournees[__x_signaux][__xal][]=__LINE__.' '.var_export($tt160[__xva][0][0],true);
                      return;
                    */
                    $chemin=$this->chemin_de_id_dossier($tt160[__xva][0][0],$db);
                    /*
                ...
                if($tt160[__xva][0][1] === null){
                    ...
                    /*
                      ...
                      return;
                    */
                    $chemin=$this->chemin_de_id_dossier($tt160[__xva][0][1],$db);
                    /*
                      $donnees_retournees[__x_signaux][__xal][]=__LINE__.' '.var_export($chemin,true);
                      return;
                    */
    ...
    */
    function vv_projets_creer1(&$donnees_retournees,/*matrice*/&$mat,&$donnees_recues){
        ...
        */
        ...
        if($tt136[__xst] === __xer){

            $donnees_retournees[__x_signaux][__xer][]=__LINE__ . ' erreur lors de l\'insertion';

        }else if($tt136['changements'] === 1){

            $nouvel_id=$tt136['nouvel_id'];
            /*
              ok, tout va bien
            */
    ...
    */
    function initialiser_le_clone(&$donnees_retournees,/*matrice*/&$mat,&$donnees_recues){
        ...
        */
        ...
        /*
          $tt8=$this->sql0->sql_iii(
          8,
          array( 'chx_projet_id_source' => 1),
          $donnees_retournees
          );
          echo __FILE__ . ' ' . __LINE__ . ' __LINE__ = <pre>' . var_export( $tt8 , true ) . '</pre>' ; exit(0);
                ...
                if($v1['chi_id_dossier'] === 0){
                    ...
                    if($chx_parent_dossier > 0){
                        ...
                        $tt137=/*sql_inclure_deb*/
                            ...
                            */
                            /*sql_inclure_fin*/
                            $this->sql0->sql_iii(137,array( array( 'chp_nom_dossier' => $nom_du_dossier, 'chx_projet_dossier' => 1, 'chx_parent_dossier' => $chx_parent_dossier === '' ? null : $chx_parent_dossier)),$donnees_retournees);
                        ...
                        $liste_des_dossiers[$k1]['chi_id_dossier']=$tt137['nouvel_id'];
    ...
    function initialiser_un_projet(&$donnees_retournees,&$mat,&$donnees_recues){
        ...
        */
        ...
        foreach($tt306[__xva] as $k1 => $v1){
            ...
            $tableau_des_dossiers[$v1['T0.chi_id_dossier']]=array( 'chp_nom_dossier' => $v1['T0.chp_nom_dossier']);
        }
