<?php
function sql_98($par,&$donnees_retournees,$that){
    if($GLOBALS[DEVER_SRV]>=2){
        $donnees_retournees[__x_signaux][__xif][]='info <b>sql_98</b>';
    }
    $champs0='
    ...
    try{
        ...
        while(($tab0=$res0->fetchArray(SQLITE3_NUM))){
            $donnees0[]=array(
                ...
                'T0.chp_prerequis_menu' => $tab0[3],
                'T1.chp_nom_page' => $tab0[4],
                'T2.chp_nom_acces' => $tab0[5],
                'T3.chp_nom_groupe' => $tab0[6],
                'T2.chx_groupe_acces' => $tab0[7],
                'T2.chi_id_acces' => $tab0[8],
                'T4.chp_nom_metier' => $tab0[9],
                'T2.chx_metier_acces' => $tab0[10],
                'T1.chp_complement_page' => $tab0[11],
                'T1.chp_contenu_methode_page' => $tab0[12],
            );
        }
        $stmt0->close();
        ...
        return array(__xst => __xer , 'source_requete' => $sql0 , 'texte_requete' => 'la liste sur les menus' , 'exception' => $e , 'id_bdd' => BDD_NUMERO_1 );
    }
}
