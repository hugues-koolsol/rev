<?php
function sql_189($par,&$donnees_retournees,$that){
    $sql0='
    ...
    for($i=0;($i < count($par));$i++){
        ...
        $liste_des_valeurs.=PHP_EOL.'      '.sq1($par[$i]['cht_complement_page']).''.',';
        $liste_des_valeurs.=PHP_EOL.'      '.sq1($par[$i]['cht_contenu_methode_page']).'';
        $liste_des_valeurs.=')';
    }
