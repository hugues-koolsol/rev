<?php
function sql_175($par,&$donnees_retournees,$that){
    $champs0='
    ...
    try{
        ...
        return array(__xst => __xer , 'source_requete' => $sql0 , 'texte_requete' => 'la selection sur les groupes' , 'exception' => $e , 'id_bdd' => BDD_NUMERO_1 );
    }
}
