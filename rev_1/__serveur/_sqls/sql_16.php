<?php
function sql_16($par,&$donnees_retournees,$that){
    ...
    if(isset($par['n_chp_genere_basedd'])){
        if($par['n_chp_genere_basedd']==='' || $par['n_chp_genere_basedd']===NULL ){
            $tableau_champs[]='`chp_genere_basedd` = NULL';
        }else{
            $tableau_champs[]='`chp_genere_basedd` = \''.sq0($par['n_chp_genere_basedd']).'\'';
        }
    }
