...
//    echo __FILE__ . ' ' . __LINE__ . ' $sql0 = <pre>' .  $sql0  . '</pre>' ; exit(0);
    ...
    try{
        ...
        echo __FILE__ . ' ' . __LINE__ . ' __LINE__ = <pre>' . var_export( $e->getMessage() , true ) . '</pre>' ; exit(0);
        return array(__xst => __xer , 'source_requete' => $sql0 , 'texte_requete' => 'la selection sur les projets' , 'exception' => $e->getMessage() , 'id_bdd' => BDD_NUMERO_1 );
    }
}
