<?php
function sql_93($par,&$donnees_retournees,$that){
    if($GLOBALS[DEVER_SRV]>=2){
        $donnees_retournees[__x_signaux][__xif][]='info <b>sql_93</b>';
    }
    $champs0='
    ...
    try{
        ...
        return array(__xst => __xer , 'source_requete' => $sql0 , 'texte_requete' => 'la liste sur les acces' , 'exception' => $e , 'id_bdd' => BDD_NUMERO_1 );
    }
}
