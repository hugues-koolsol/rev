<?php
function sql_190($par,&$donnees_retournees,$that){
    $champs0='
    ...
    ';
    $sql0.=$from0;
    $where0=' WHERE `T0`.`chi_id_page` = '.sq1($par['T0_chi_id_page']).''.PHP_EOL;
    $sql0.=$where0;
    $donnees0=array();
    ...
    try{
        ...
        while(($tab0=$res0->fetchArray(SQLITE3_NUM))){
            $donnees0[]=array(
                ...
                'T0.cht_complement_page' => $tab0[9],
                'T0.cht_contenu_methode_page' => $tab0[10],
            );
        }
        return array(
           __xst  => __xsu  ,
