<?php
function sql_45($par,&$donnees_retournees,$that){
    $sql0='
    ...
    if($dep>0){
        $donnees_retournees[__x_signaux][__xer][]=' erreur lors de la suppression, il existe des dépendances sql_45() [' . __LINE__ . ']';
        return array(
            __xst => __xer,
            'source_requete' => $sql0,
