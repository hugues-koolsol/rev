<?php
function sql_126($par,&$donnees_retournees,$that){
    $champs0='
    ...
    ';
    $sql0.=$from0;
    $where0=' WHERE (`T0`.`chi_id_basedd` = '.sq1($par['T0_chi_id_basedd']).' AND `T0`.`chx_projet_id_basedd` = '.sq1($par['T0_chx_projet_id_basedd']).')'.PHP_EOL;
    $sql0.=$where0;
    $donnees0=array();
    ...
    try{
        ...
        while(($tab0=$res0->fetchArray(SQLITE3_NUM))){
            $donnees0[]=array(
                ...
                'T0.chp_commentaire_basedd' => $tab0[3],
                'T0.chp_rev_travail_basedd' => $tab0[4],
                'T0.chp_fournisseur_basedd' => $tab0[5],
                'T1.chi_id_dossier' => $tab0[6],
                'T1.chx_projet_dossier' => $tab0[7],
                'T1.chp_nom_dossier' => $tab0[8],
                'T2.chi_id_projet' => $tab0[9],
                'T2.chp_nom_projet' => $tab0[10],
            );
        }
        return array(
           __xst  => __xsu  ,
