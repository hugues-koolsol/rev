...
class c_svg_bdd1{
    ...
    */
    ...
    #genres_de_reference=['INTEGER','VARCHAR(64)','TEXT','FLOAT'];
    #especes_de_reference=['INTEGER','VARCHAR','TEXT','FLOAT'];
    #liste_des_meta_table=[
        {nom_du_meta_table : 'distinction_pour_liste' , exemple : '"liste des ..."' },
        {nom_du_meta_table : 'distinction_pour_isad' , exemple : '"d\'un  ..."' },
        {nom_du_meta_table : 'default_charset' , exemple : '"utf8mb4"'},
        {nom_du_meta_table : 'collate' , exemple:'"utf8mb4_unicode_ci"'},
    ];
    #chemin_module1='';
    ...
    */
    supprimer_en_bdd_le_champ_de_modale( mat ){
        ...
        /*
          maj+='methode_module_dynamique1(';
          maj+='  nom_du_module2("_js/c_svg_bdd1.js"),';
          maj+='  methode2(apres_supprimer_un_champs1),';
          maj+='  valeurs2(';
          maj+='    id_bdd_de_la_base(' + id_bdd_de_la_base_en_cours + ')';
          maj+='    id_svg_conteneur_table(' + id_svg_conteneur_table + ')';
          maj+='    id_svg_champ_en_cours(' + id_svg_champ_en_cours + ')';
          maj+='    nom_de_la_table(\'' + nom_de_la_table.replace( /\\/g , '\\\\' ).replace( /\'/g , '\\\'' ) + '\')';
          maj+='    nom_du_champ(\'' + nom_du_champ.replace( /\\/g , '\\\\' ).replace( /\'/g , '\\\'' ) + '\')';
          maj+='  )';
          maj+=')';
        */
        debugger;
        let obj={
             /*  */
            "__x_action" : 'c_bases1.executer_sql3(id_bdd_de_la_base(' + id_bdd_de_la_base_en_cours + '),contexte(supprimer_en_bdd_le_champ))' ,
            "__xva" : {
                 /*  */
                "source_sql" : source_sql ,
    ...
    */
    ...
    /*
      =============================================================================================================
        ...
        cmd+='  zone_du_champ(nom_du_champ)';
        cmd+='  meta_champ(bref)';
        cmd+=' )';
        cmd+=')';
    ...
    modale_modifier_le_champ( mat ){
        ...
        */
        ...
        for( let ind=0 ; ind < this.#especes_de_reference.length ; ind++ ){
            ...
            cmd+=' parametre3(';
            cmd+='  id_du_champ(espece_du_champ),';
            cmd+='  valeur(\'' + this.#especes_de_reference[ind] + '\')';
            cmd+=' )';
            cmd+=')';
            t+='<div class="hug_bouton yy__x_signaux_3" data-hug_click="' + cmd + '" >' + this.#especes_de_reference[ind] + '</div>';
        }
        t+='<br />longueur  : <input id="longueur_du_champ" type="text" value="' + longueur_du_champ + '" autocapitalize="off" />';
        ...
        if(sel !== ''){
            ...
            cmd+='interface1.module1(';
            cmd+='  chemin_module1(\'' + this.#chemin_module1 + '\'),';
            cmd+='  methode3(lister_les_champs_de_la_table),';
            cmd+='  parametre3(';
        ...
        */
        ...
        cmd+=' )';
        cmd+=')';
        t+='<div class="hug_bouton yy__x_signaux_0" data-hug_click="' + cmd + '" >supprimer le champ en bdd</div>';
        t+='<hr />';
        /*
          document.getElementById( '__contenu_modale' ).innerHTML=t;
          __gi1.global_modale2.showModal();
    ...
    */
    afficher_resultat_comparaison_base_physique_et_base_virtuelle( par ){
        ...
        */
        ...
        t+='<div data-hug_click="';
        t+='interface1.module1(';
        t+='chemin_module1(\'_js/c_svg_bdd1.js\'),';
        t+='methode3(modale_modifier_la_base),';
        t+='parametre3(id_bdd_de_la_base(' + par.id_bdd_de_la_base_en_cours + ')))"';
        t+=' style="fill:blue;cursor:pointer;" ';
        t+=' class="hug_bouton yy__x_signaux_3">base(' + par.id_bdd_de_la_base_en_cours + ')</div>';
        if(differences_entre_les_tables === false
        ...
        if(differences_entre_les_tables === false
            ...
            if(difference_d_ordre === true){
                document.getElementById( 'vv_meme_ordre' ).innerHTML='<div class="yy__x_signaux_2">l\'ordre est différent ' + cle_differente + '</div>';
            }else{
                document.getElementById( 'vv_meme_ordre' ).innerHTML='<div class="yy__x_signaux_1">l\'ordre est le même</div>';
            }
        }
        /*  */
        vv_sous_fenetre1.showModal();
    ...
    */
    remplir_les_metas_de_la_table(mat){
        let id_de_la_zone=0;
        let masculin='d\'une ';
        for( let i=0 ; i < mat.length ; i++ ){
            if(mat[i][1] === 'id_de_la_zone' && mat[i][2] === 'f' && mat[i][8] === 1 && mat[i + 1][2] === 'c'){
                id_de_la_zone=mat[i + 1][1];
            }else if(mat[i][1] === 'masculin' && mat[i][2] === 'f' && mat[i][8] === 1 && mat[i + 1][2] === 'c'){
        ...
        if(id_de_la_zone!==''){
            ...
            try{
                document.getElementById('vv_distinction_pour_isad').value=masculin+nom_de_la_table.substr(4,nom_de_la_table.length-5);
            }catch{}
        }
    }
    /*
    ...
    */
    modale_modifier_la_base( element_g ){
        ...
        rev+=' methode3(remplir_les_metas_de_la_table),';
        rev+=' parametre3(';
        rev+='  id_de_la_zone(\'vv_nom_de_la_nouvelle_table\')';
        rev+='  masculin(1)';
        rev+=' )';
        rev+=')';
        t+='<div class="hug_bouton yy__x_signaux_3" data-hug_click="' + rev + '">remplir les champs masculin</div>';
        rev+='interface1.module1(';
        rev+=' chemin_module1(\'' + this.#chemin_module1 + '\'),';
        rev+=' methode3(remplir_les_metas_de_la_table),';
        rev+=' parametre3(';
        ...
        rev+=' )';
        rev+=')';
        t+='<div class="hug_bouton yy__x_signaux_3" data-hug_click="' + rev + '">remplir les champs féminin</div>';
        t+='<br />';
        
        for(let i in this.#liste_des_meta_table){
           t+=this.#liste_des_meta_table[i].nom_du_meta_table.replace(/_/,' ')+' : <input id="vv_'+this.#liste_des_meta_table[i].nom_du_meta_table+'" type="text" value="" autocapitalize="off" />';
    ...
    */
    modale_gerer_la_table( mat ){
        ...
        */
        ...
        cmd+=' methode3(maj_typologie),';
        cmd+=' parametre3(';
        cmd+='  nom_zone(typologie),';
        ...
        t+='<br />espece  : <input id="espece_du_champ" type="text" value="" autocapitalize="off" />';
        for( let ind=0 ; ind < this.#especes_de_reference.length ; ind++ ){
            var cmd='';
            cmd+='interface1.module1(';
            cmd+=' chemin_module1(\'' + this.#chemin_module1 + '\'),';
    ...
    */
    modifier_la_table_de_modale( mat ){
        ...
        let nouveau_meta=this.#corrige_meta_table( document.getElementById( id_svg_rectangle_de_la_table ).getAttribute( 'meta_rev_de_la_table' ) , obj);
        this.#arbre[this.#id_bdd_de_la_base_en_cours].arbre_svg[id_svg_rectangle_de_la_table].proprietes.meta_rev_de_la_table=nouveau_meta.texte;
        __gi1.fermer_fenetre1();
        this.#dessiner_le_svg();
    }
    ...
    */
    #creer_definition_table_en_rev( element_svg_rectangle_de_table , nom_de_table_alternatif=null , liste_des_ids_des_rectangles_des_champs_nouveau=null ){
        ...
        let nouveau_meta=this.#corrige_meta_table( element_svg_rectangle_de_table.getAttribute( 'meta_rev_de_la_table' ) , modification_meta );
    ...
    */
    #corrige_meta_table( texte_meta_rev , nouvelles_valeurs={} ){
        ...
        */
        ...
        let distinction_pour_liste='';
        let distinction_pour_liste_brut='';
        
        let distinction_pour_isad='';
        let distinction_pour_isad_brut='';
            ...
            for( let l=1 ; l < l01 ; l=mat2[l][12] ){
                if(mat2[l][1] === 'meta' && mat2[l][2] === 'f'){
                    for( let k=l + 1 ; k < l01 ; k=mat2[k][12] ){
                        ...
                        }else if(mat2[k][1] === 'distinction_pour_liste' && mat2[k][2] === 'f' ){
                            if(mat2[k][8] === 1 && mat2[k + 1][2] === 'c'){
                         
                                if(nouvelles_valeurs.hasOwnProperty( 'distinction_pour_liste' )){
                                    mat2[k + 1][1]=nouvelles_valeurs.distinction_pour_liste;
                                }
                                distinction_pour_liste=__gi1.__m_rev1.ma_constante(mat2[k+1]);
                                distinction_pour_liste_brut=__gi1.__m_rev1.ma_constante_inverse(mat2[k+1]);
                            }else{
                                distinction_pour_liste='\'\'';
                                distinction_pour_liste_brut='';
                            }
                        }else if(mat2[k][1] === 'distinction_pour_isad' && mat2[k][2] === 'f' ){
                            if(mat2[k][8] === 1 && mat2[k + 1][2] === 'c'){
                                if(nouvelles_valeurs.hasOwnProperty( 'distinction_pour_isad' )){
                                    mat2[k + 1][1]=nouvelles_valeurs.distinction_pour_isad;
                                }
                                distinction_pour_isad=__gi1.__m_rev1.ma_constante(mat2[k+1]);
                                distinction_pour_isad_brut=__gi1.__m_rev1.ma_constante_inverse(mat2[k+1]);
                            }else{
                                distinction_pour_isad='\'\'';
                                distinction_pour_isad_brut='';
                            }
        ...
        o1+=' distinction_pour_liste(' + distinction_pour_liste + '),';
        o1+=' distinction_pour_isad(' + distinction_pour_isad + '),';
        ...
        return({
                ...
                "distinction_pour_liste" : distinction_pour_liste_brut ,
                "distinction_pour_isad" : distinction_pour_isad_brut ,
            });
    }
    /*
      =============================================================================================================
    ...
    */
    #ajouter_index_a_table( id_bdd_de_la_base , indice_courant , nom_de_l_index , id_svg_conteneur_table , nom_de_la_table , donnees_rev_de_l_index , champs , unique ){
        ...
        cmd+='interface1.module1(';
        cmd+=' chemin_module1(\'' + this.#chemin_module1 + '\'),';
        cmd+=' methode3(modale_modifier_l_index),';
        cmd+=' parametre3(';
        cmd+='  id_svg_conteneur_table(' + id_svg_conteneur_table + ')';
        cmd+='  nom_de_l_index(\'' + nom_de_l_index.replace( /\\/g , '\\\\' ).replace( /\'/g , '\\\'' ) + '\')';
        ...
        */
        ...
        /*#
          ...
          contenu += '<tspan';
          contenu += ' style="cursor:pointer;" ';
          contenu += ' data-hug_click="' + '';
          contenu += 'interface1.module1(';
          contenu += ' chemin_module1(\'' + this.#chemin_module1 + '\'),';
          contenu += ' methode3(modale_modifier_l_index),';
          contenu += ' parametre3(';
          contenu += '  id_svg_conteneur_table(' + id_svg_conteneur_table + ')';
          contenu += '  nom_de_l_index(\'' + nom_de_l_index.replace( /\\/g , '\\\\' ).replace( /\'/g , '\\\'' ) + '\')';
          contenu += '  id_svg_conteneur_d_index(' + id_svg_de_l_index + ')';
          contenu += ' )';
          contenu += ')"';
          contenu += '>';
          contenu += '🟩';
          contenu += ' </tspan>' + nom_de_l_index;
        */
