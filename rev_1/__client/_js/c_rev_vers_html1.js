    ...
    #tabToHtml2( id , dansHead , dansBody , dansJs , noHead , dansPhp , dansCss , niveau ){
        ...
        if(dansPhp && this.#tb[id][1] === 'source'){
            ...
            if(ob.__xst === __xsu){
                ...
                return(this.__m_rev1.empiler_erreur( {"__xst" : __xer ,"__xva" : t ,"__xme" : this.__m_rev1.nl2() + 'erreur de script dans un html'} ));
            }
            t+=' ?>';
            return({
                    "__xst" : __xsu ,
            ...
            if(this.#tb[id][1] === '#' && this.#tb[id][2] === 'f'){
                if(this.#tb[id][13] === ''){
                    ...
                    var commentaire=this.__m_rev1.tr_co_src( this.#tb[id][13] , niveau , id );
                    if(commentaire !== ''){
                        ...
                        if(this.#tb[i][8] <= 2){
                            if(this.#tb[i][8] == 2 && this.#tb[i + 1][2] == 'c' && this.#tb[i + 2][2] == 'c'){
                                ...
                                */
                                ...
                                return(this.__m_rev1.empiler_erreur( {"__xst" : __xer ,"id" : i ,"__xva" : t ,"__xme" : this.__m_rev1.nl2() + 'les propriété d\'un tag html doivent contenir une ou deux constantes'} ));
                            }
                        }else{
                            debugger;
                            return(this.__m_rev1.empiler_erreur( {"__xst" : __xer ,"id" : i ,"__xva" : t ,"__xme" : this.__m_rev1.nl2() + 'les propriété d\'un tag html doivent contenir une ou deux constantes'} ));
                        ...
                        if(this.#tb[i][1].toLowerCase() === '@'){
                            ...
                            */
                                ...
                                */
                                ...
                                if(ob.__xst === __xsu){
                                    ...
                                    */
                                    ...
                                    return(this.__m_rev1.empiler_erreur( {"__xst" : __xer ,"__xme" : this.__m_rev1.nl2() + ' javascript contenu dans un html par la fonction ldplusjsondanshtml '} ));
                                }
                            }
                            ...
                            if(obj.__xst === __xsu){
                                ...
                                return(this.__m_rev1.empiler_erreur( {"__xst" : __xer ,"__xme" : this.__m_rev1.nl2() + 'erreur dans un javascript contenu dans un html par la fonction javascriptdanshtml'} ));
                            }
                        }else{
                            /*
                              =============================================================
            ...
            if(this.#tb[indiceDebutJs][8] === 0){
                ...
                if(ob.__xst === __xsu){
                    ...
                    */
                    ...
                    debugger;
                    return(this.__m_rev1.empiler_erreur( {"__xst" : __xer ,"__xme" : this.__m_rev1.nl2() + 'javascriptdanshtml'} ));
                }
            }
        }
    ...
    */
    c_tab_vers_html_old( matrice , options_traitement={} ){
        ...
        if(obj.__xst === __xsu){
            ...
            return(this.#rev_html_le( {"__xst" : __xer ,"__xme" : this.__m_rev1.nl2() + 'erreur de conversion en html'} ));
        }
    }
    /*
      =============================================================================================================
    ...
    */
    c_rev_vers_html( source_rev , options_traitement={} ){
        ...
        if(obj.__xst === __xsu){
            ...
            return(this.#rev_html_le( {"__xst" : __xer ,"__xme" : this.__m_rev1.nl2() + 'erreur dans un rev'} ));
        }
    }
}
